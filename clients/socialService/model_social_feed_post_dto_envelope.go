...
// checks if the SocialFeedPostDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialFeedPostDtoEnvelope{}

// SocialFeedPostDtoEnvelope struct for SocialFeedPostDtoEnvelope
type SocialFeedPostDtoEnvelope struct {
...
func NewSocialFeedPostDtoEnvelope() *SocialFeedPostDtoEnvelope {
	this := SocialFeedPostDtoEnvelope{}
	return &this
}
...
func (o *SocialFeedPostDtoEnvelope) SetErrorMessageNil() {
...
func (o *SocialFeedPostDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SocialFeedPostDtoEnvelope) SetHttpStatusNil() {
...
func (o *SocialFeedPostDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialFeedPostDtoEnvelope) SetActivityIdNil() {
...
func (o SocialFeedPostDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialFeedPostDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialFeedPostDtoEnvelope struct {
	value *SocialFeedPostDtoEnvelope
	isSet bool
}

func (v NullableSocialFeedPostDtoEnvelope) Get() *SocialFeedPostDtoEnvelope {
	return v.value
}

func (v *NullableSocialFeedPostDtoEnvelope) Set(val *SocialFeedPostDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialFeedPostDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialFeedPostDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialFeedPostDtoEnvelope(val *SocialFeedPostDtoEnvelope) *NullableSocialFeedPostDtoEnvelope {
	return &NullableSocialFeedPostDtoEnvelope{value: val, isSet: true}
}

func (v NullableSocialFeedPostDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialFeedPostDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
