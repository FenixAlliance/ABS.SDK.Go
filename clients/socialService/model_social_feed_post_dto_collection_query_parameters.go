...
// checks if the SocialFeedPostDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialFeedPostDtoCollectionQueryParameters{}

// SocialFeedPostDtoCollectionQueryParameters struct for SocialFeedPostDtoCollectionQueryParameters
type SocialFeedPostDtoCollectionQueryParameters struct {
...
func NewSocialFeedPostDtoCollectionQueryParameters() *SocialFeedPostDtoCollectionQueryParameters {
	this := SocialFeedPostDtoCollectionQueryParameters{}
	return &this
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *SocialFeedPostDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o SocialFeedPostDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o SocialFeedPostDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableSocialFeedPostDtoCollectionQueryParameters struct {
	value *SocialFeedPostDtoCollectionQueryParameters
	isSet bool
}

func (v NullableSocialFeedPostDtoCollectionQueryParameters) Get() *SocialFeedPostDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableSocialFeedPostDtoCollectionQueryParameters) Set(val *SocialFeedPostDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialFeedPostDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialFeedPostDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialFeedPostDtoCollectionQueryParameters(val *SocialFeedPostDtoCollectionQueryParameters) *NullableSocialFeedPostDtoCollectionQueryParameters {
	return &NullableSocialFeedPostDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableSocialFeedPostDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialFeedPostDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
