...
// checks if the SocialCommentReactionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialCommentReactionDtoEnvelope{}

// SocialCommentReactionDtoEnvelope struct for SocialCommentReactionDtoEnvelope
type SocialCommentReactionDtoEnvelope struct {
...
func NewSocialCommentReactionDtoEnvelope() *SocialCommentReactionDtoEnvelope {
	this := SocialCommentReactionDtoEnvelope{}
	return &this
}
...
func (o *SocialCommentReactionDtoEnvelope) SetErrorMessageNil() {
...
func (o *SocialCommentReactionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SocialCommentReactionDtoEnvelope) SetHttpStatusNil() {
...
func (o *SocialCommentReactionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialCommentReactionDtoEnvelope) SetActivityIdNil() {
...
func (o SocialCommentReactionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialCommentReactionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialCommentReactionDtoEnvelope struct {
	value *SocialCommentReactionDtoEnvelope
	isSet bool
}

func (v NullableSocialCommentReactionDtoEnvelope) Get() *SocialCommentReactionDtoEnvelope {
	return v.value
}

func (v *NullableSocialCommentReactionDtoEnvelope) Set(val *SocialCommentReactionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialCommentReactionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialCommentReactionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialCommentReactionDtoEnvelope(val *SocialCommentReactionDtoEnvelope) *NullableSocialCommentReactionDtoEnvelope {
	return &NullableSocialCommentReactionDtoEnvelope{value: val, isSet: true}
}

func (v NullableSocialCommentReactionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialCommentReactionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
