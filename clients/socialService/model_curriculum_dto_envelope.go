...
// checks if the CurriculumDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurriculumDtoEnvelope{}

// CurriculumDtoEnvelope struct for CurriculumDtoEnvelope
type CurriculumDtoEnvelope struct {
...
func (o *CurriculumDtoEnvelope) SetErrorMessageNil() {
...
func (o *CurriculumDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CurriculumDtoEnvelope) SetHttpStatusNil() {
...
func (o *CurriculumDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CurriculumDtoEnvelope) SetActivityIdNil() {
...
func (o CurriculumDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CurriculumDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCurriculumDtoEnvelope struct {
	value *CurriculumDtoEnvelope
	isSet bool
}

func (v NullableCurriculumDtoEnvelope) Get() *CurriculumDtoEnvelope {
	return v.value
}

func (v *NullableCurriculumDtoEnvelope) Set(val *CurriculumDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCurriculumDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCurriculumDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurriculumDtoEnvelope(val *CurriculumDtoEnvelope) *NullableCurriculumDtoEnvelope {
	return &NullableCurriculumDtoEnvelope{value: val, isSet: true}
}

func (v NullableCurriculumDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurriculumDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
