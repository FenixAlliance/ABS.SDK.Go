...
// checks if the SocialReactionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialReactionDtoEnvelope{}

// SocialReactionDtoEnvelope struct for SocialReactionDtoEnvelope
type SocialReactionDtoEnvelope struct {
...
func NewSocialReactionDtoEnvelope() *SocialReactionDtoEnvelope {
	this := SocialReactionDtoEnvelope{}
	return &this
}
...
func (o *SocialReactionDtoEnvelope) SetErrorMessageNil() {
...
func (o *SocialReactionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SocialReactionDtoEnvelope) SetHttpStatusNil() {
...
func (o *SocialReactionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialReactionDtoEnvelope) SetActivityIdNil() {
...
func (o SocialReactionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialReactionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialReactionDtoEnvelope struct {
	value *SocialReactionDtoEnvelope
	isSet bool
}

func (v NullableSocialReactionDtoEnvelope) Get() *SocialReactionDtoEnvelope {
	return v.value
}

func (v *NullableSocialReactionDtoEnvelope) Set(val *SocialReactionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialReactionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialReactionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialReactionDtoEnvelope(val *SocialReactionDtoEnvelope) *NullableSocialReactionDtoEnvelope {
	return &NullableSocialReactionDtoEnvelope{value: val, isSet: true}
}

func (v NullableSocialReactionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialReactionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
