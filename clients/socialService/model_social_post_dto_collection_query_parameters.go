...
// checks if the SocialPostDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialPostDtoCollectionQueryParameters{}

// SocialPostDtoCollectionQueryParameters struct for SocialPostDtoCollectionQueryParameters
type SocialPostDtoCollectionQueryParameters struct {
...
func NewSocialPostDtoCollectionQueryParameters() *SocialPostDtoCollectionQueryParameters {
	this := SocialPostDtoCollectionQueryParameters{}
	return &this
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *SocialPostDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o SocialPostDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o SocialPostDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableSocialPostDtoCollectionQueryParameters struct {
	value *SocialPostDtoCollectionQueryParameters
	isSet bool
}

func (v NullableSocialPostDtoCollectionQueryParameters) Get() *SocialPostDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableSocialPostDtoCollectionQueryParameters) Set(val *SocialPostDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialPostDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialPostDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialPostDtoCollectionQueryParameters(val *SocialPostDtoCollectionQueryParameters) *NullableSocialPostDtoCollectionQueryParameters {
	return &NullableSocialPostDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableSocialPostDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialPostDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
