...
// checks if the SocialProfileDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialProfileDtoCollectionQueryParameters{}

// SocialProfileDtoCollectionQueryParameters struct for SocialProfileDtoCollectionQueryParameters
type SocialProfileDtoCollectionQueryParameters struct {
...
func NewSocialProfileDtoCollectionQueryParameters() *SocialProfileDtoCollectionQueryParameters {
	this := SocialProfileDtoCollectionQueryParameters{}
	return &this
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *SocialProfileDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o SocialProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o SocialProfileDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableSocialProfileDtoCollectionQueryParameters struct {
	value *SocialProfileDtoCollectionQueryParameters
	isSet bool
}

func (v NullableSocialProfileDtoCollectionQueryParameters) Get() *SocialProfileDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableSocialProfileDtoCollectionQueryParameters) Set(val *SocialProfileDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialProfileDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialProfileDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialProfileDtoCollectionQueryParameters(val *SocialProfileDtoCollectionQueryParameters) *NullableSocialProfileDtoCollectionQueryParameters {
	return &NullableSocialProfileDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableSocialProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialProfileDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
