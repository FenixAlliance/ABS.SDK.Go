...
// checks if the SocialFeedDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialFeedDtoListEnvelope{}

// SocialFeedDtoListEnvelope struct for SocialFeedDtoListEnvelope
type SocialFeedDtoListEnvelope struct {
...
func NewSocialFeedDtoListEnvelope() *SocialFeedDtoListEnvelope {
	this := SocialFeedDtoListEnvelope{}
	return &this
}
...
func (o *SocialFeedDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SocialFeedDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SocialFeedDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SocialFeedDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialFeedDtoListEnvelope) SetActivityIdNil() {
...
func (o SocialFeedDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialFeedDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialFeedDtoListEnvelope struct {
	value *SocialFeedDtoListEnvelope
	isSet bool
}

func (v NullableSocialFeedDtoListEnvelope) Get() *SocialFeedDtoListEnvelope {
	return v.value
}

func (v *NullableSocialFeedDtoListEnvelope) Set(val *SocialFeedDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialFeedDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialFeedDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialFeedDtoListEnvelope(val *SocialFeedDtoListEnvelope) *NullableSocialFeedDtoListEnvelope {
	return &NullableSocialFeedDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSocialFeedDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialFeedDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
