...
// checks if the SocialPostDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialPostDtoEnvelope{}

// SocialPostDtoEnvelope struct for SocialPostDtoEnvelope
type SocialPostDtoEnvelope struct {
...
func (o *SocialPostDtoEnvelope) SetErrorMessageNil() {
...
func (o *SocialPostDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SocialPostDtoEnvelope) SetHttpStatusNil() {
...
func (o *SocialPostDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialPostDtoEnvelope) SetActivityIdNil() {
...
func (o SocialPostDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialPostDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialPostDtoEnvelope struct {
	value *SocialPostDtoEnvelope
	isSet bool
}

func (v NullableSocialPostDtoEnvelope) Get() *SocialPostDtoEnvelope {
	return v.value
}

func (v *NullableSocialPostDtoEnvelope) Set(val *SocialPostDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialPostDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialPostDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialPostDtoEnvelope(val *SocialPostDtoEnvelope) *NullableSocialPostDtoEnvelope {
	return &NullableSocialPostDtoEnvelope{value: val, isSet: true}
}

func (v NullableSocialPostDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialPostDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
