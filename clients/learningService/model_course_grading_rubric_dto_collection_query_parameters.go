...
// checks if the CourseGradingRubricDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseGradingRubricDtoCollectionQueryParameters{}

// CourseGradingRubricDtoCollectionQueryParameters struct for CourseGradingRubricDtoCollectionQueryParameters
type CourseGradingRubricDtoCollectionQueryParameters struct {
...
func NewCourseGradingRubricDtoCollectionQueryParameters() *CourseGradingRubricDtoCollectionQueryParameters {
	this := CourseGradingRubricDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CourseGradingRubricDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CourseGradingRubricDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CourseGradingRubricDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCourseGradingRubricDtoCollectionQueryParameters struct {
	value *CourseGradingRubricDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCourseGradingRubricDtoCollectionQueryParameters) Get() *CourseGradingRubricDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCourseGradingRubricDtoCollectionQueryParameters) Set(val *CourseGradingRubricDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseGradingRubricDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseGradingRubricDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseGradingRubricDtoCollectionQueryParameters(val *CourseGradingRubricDtoCollectionQueryParameters) *NullableCourseGradingRubricDtoCollectionQueryParameters {
	return &NullableCourseGradingRubricDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCourseGradingRubricDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseGradingRubricDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
