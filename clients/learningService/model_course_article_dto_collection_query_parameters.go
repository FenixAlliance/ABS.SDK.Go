...
// checks if the CourseArticleDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseArticleDtoCollectionQueryParameters{}

// CourseArticleDtoCollectionQueryParameters struct for CourseArticleDtoCollectionQueryParameters
type CourseArticleDtoCollectionQueryParameters struct {
...
func NewCourseArticleDtoCollectionQueryParameters() *CourseArticleDtoCollectionQueryParameters {
	this := CourseArticleDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CourseArticleDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CourseArticleDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CourseArticleDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCourseArticleDtoCollectionQueryParameters struct {
	value *CourseArticleDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCourseArticleDtoCollectionQueryParameters) Get() *CourseArticleDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCourseArticleDtoCollectionQueryParameters) Set(val *CourseArticleDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseArticleDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseArticleDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseArticleDtoCollectionQueryParameters(val *CourseArticleDtoCollectionQueryParameters) *NullableCourseArticleDtoCollectionQueryParameters {
	return &NullableCourseArticleDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCourseArticleDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseArticleDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
