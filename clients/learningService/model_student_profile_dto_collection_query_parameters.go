...
// checks if the StudentProfileDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StudentProfileDtoCollectionQueryParameters{}

// StudentProfileDtoCollectionQueryParameters struct for StudentProfileDtoCollectionQueryParameters
type StudentProfileDtoCollectionQueryParameters struct {
...
func NewStudentProfileDtoCollectionQueryParameters() *StudentProfileDtoCollectionQueryParameters {
	this := StudentProfileDtoCollectionQueryParameters{}
	return &this
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *StudentProfileDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o StudentProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o StudentProfileDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableStudentProfileDtoCollectionQueryParameters struct {
	value *StudentProfileDtoCollectionQueryParameters
	isSet bool
}

func (v NullableStudentProfileDtoCollectionQueryParameters) Get() *StudentProfileDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableStudentProfileDtoCollectionQueryParameters) Set(val *StudentProfileDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableStudentProfileDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableStudentProfileDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStudentProfileDtoCollectionQueryParameters(val *StudentProfileDtoCollectionQueryParameters) *NullableStudentProfileDtoCollectionQueryParameters {
	return &NullableStudentProfileDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableStudentProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStudentProfileDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
