...
func main() {
	...
	courseProblemSetCreateDto := *openapiclient.NewCourseProblemSetCreateDto("Title_example", "CourseID_example", "BusinessID_example") // CourseProblemSetCreateDto |  (optional)
