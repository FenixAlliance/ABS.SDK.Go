...
func main() {
	...
	courseUnitCreateDto := *openapiclient.NewCourseUnitCreateDto("Title_example", "CourseID_example", "CourseSectionID_example", "BusinessID_example") // CourseUnitCreateDto |  (optional)
