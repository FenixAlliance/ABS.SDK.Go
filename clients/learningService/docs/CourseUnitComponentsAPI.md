...
> []CourseUnitComponentDto GetCourseUnitComponentsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).CourseUnitComponentDtoCollectionQueryParameters(courseUnitComponentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CourseUnitComponentsAPI.GetCourseUnitComponentsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).CourseUnitComponentDtoCollectionQueryParameters(courseUnitComponentDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> int32 GetCourseUnitComponentsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).CourseUnitComponentDtoCollectionQueryParameters(courseUnitComponentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CourseUnitComponentsAPI.GetCourseUnitComponentsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).CourseUnitComponentDtoCollectionQueryParameters(courseUnitComponentDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchCourseUnitComponentAsync(ctx, componentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CourseUnitComponentsAPI.PatchCourseUnitComponentAsync(context.Background(), componentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CourseUnitComponentsAPI.PatchCourseUnitComponentAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchCourseUnitComponentAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `CourseUnitComponentsAPI.PatchCourseUnitComponentAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchCourseUnitComponentAsyncRequest struct via the builder pattern
