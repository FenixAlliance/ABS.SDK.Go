...
func main() {
	...
	courseUnitComponentCreateDto := *openapiclient.NewCourseUnitComponentCreateDto("Title_example", "CourseID_example", "BusinessID_example") // CourseUnitComponentCreateDto |  (optional)
