...
func main() {
	...
	courseArticleCreateDto := *openapiclient.NewCourseArticleCreateDto("Title_example", "CourseID_example", "CourseWikiID_example", "BusinessID_example") // CourseArticleCreateDto |  (optional)
