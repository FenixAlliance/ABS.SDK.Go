...
// checks if the CourseUnitDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseUnitDtoCollectionQueryParameters{}

// CourseUnitDtoCollectionQueryParameters struct for CourseUnitDtoCollectionQueryParameters
type CourseUnitDtoCollectionQueryParameters struct {
...
func NewCourseUnitDtoCollectionQueryParameters() *CourseUnitDtoCollectionQueryParameters {
	this := CourseUnitDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CourseUnitDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CourseUnitDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CourseUnitDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCourseUnitDtoCollectionQueryParameters struct {
	value *CourseUnitDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCourseUnitDtoCollectionQueryParameters) Get() *CourseUnitDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCourseUnitDtoCollectionQueryParameters) Set(val *CourseUnitDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseUnitDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseUnitDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseUnitDtoCollectionQueryParameters(val *CourseUnitDtoCollectionQueryParameters) *NullableCourseUnitDtoCollectionQueryParameters {
	return &NullableCourseUnitDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCourseUnitDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseUnitDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
