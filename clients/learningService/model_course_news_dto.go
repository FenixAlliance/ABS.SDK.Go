...
// checks if the CourseNewsDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseNewsDto{}

// CourseNewsDto struct for CourseNewsDto
type CourseNewsDto struct {
...
func (o *CourseNewsDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *CourseNewsDto) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *CourseNewsDto) SetDescriptionNil() {
...
func (o *CourseNewsDto) SetContentNil() {
	o.Content.Set(nil)
}
...
func (o *CourseNewsDto) SetCourseIdNil() {
	o.CourseId.Set(nil)
}
...
func (o *CourseNewsDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *CourseNewsDto) SetEnrollmentIdNil() {
...
func (o CourseNewsDto) MarshalJSON() ([]byte, error) {
...
func (o CourseNewsDto) ToMap() (map[string]interface{}, error) {
...
type NullableCourseNewsDto struct {
	value *CourseNewsDto
	isSet bool
}

func (v NullableCourseNewsDto) Get() *CourseNewsDto {
	return v.value
}

func (v *NullableCourseNewsDto) Set(val *CourseNewsDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseNewsDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseNewsDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseNewsDto(val *CourseNewsDto) *NullableCourseNewsDto {
	return &NullableCourseNewsDto{value: val, isSet: true}
}

func (v NullableCourseNewsDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseNewsDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
