...
// checks if the CourseForumDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseForumDtoCollectionQueryParameters{}

// CourseForumDtoCollectionQueryParameters struct for CourseForumDtoCollectionQueryParameters
type CourseForumDtoCollectionQueryParameters struct {
...
func NewCourseForumDtoCollectionQueryParameters() *CourseForumDtoCollectionQueryParameters {
	this := CourseForumDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CourseForumDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CourseForumDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CourseForumDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCourseForumDtoCollectionQueryParameters struct {
	value *CourseForumDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCourseForumDtoCollectionQueryParameters) Get() *CourseForumDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCourseForumDtoCollectionQueryParameters) Set(val *CourseForumDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseForumDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseForumDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseForumDtoCollectionQueryParameters(val *CourseForumDtoCollectionQueryParameters) *NullableCourseForumDtoCollectionQueryParameters {
	return &NullableCourseForumDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCourseForumDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseForumDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
