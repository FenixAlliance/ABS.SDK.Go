...
// checks if the CourseLibraryDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseLibraryDto{}

// CourseLibraryDto struct for CourseLibraryDto
type CourseLibraryDto struct {
...
func (o *CourseLibraryDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *CourseLibraryDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *CourseLibraryDto) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *CourseLibraryDto) SetDescriptionNil() {
...
func (o *CourseLibraryDto) SetCourseIdNil() {
	o.CourseId.Set(nil)
}
...
func (o *CourseLibraryDto) SetCourseUnitIdNil() {
...
func (o *CourseLibraryDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *CourseLibraryDto) SetEnrollmentIdNil() {
...
func (o CourseLibraryDto) MarshalJSON() ([]byte, error) {
...
func (o CourseLibraryDto) ToMap() (map[string]interface{}, error) {
...
type NullableCourseLibraryDto struct {
	value *CourseLibraryDto
	isSet bool
}

func (v NullableCourseLibraryDto) Get() *CourseLibraryDto {
	return v.value
}

func (v *NullableCourseLibraryDto) Set(val *CourseLibraryDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseLibraryDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseLibraryDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseLibraryDto(val *CourseLibraryDto) *NullableCourseLibraryDto {
	return &NullableCourseLibraryDto{value: val, isSet: true}
}

func (v NullableCourseLibraryDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseLibraryDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
