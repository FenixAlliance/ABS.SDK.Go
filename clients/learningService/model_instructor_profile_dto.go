...
func (o *InstructorProfileDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *InstructorProfileDto) SetTypeNil() {
	o.Type.Set(nil)
}
...
func (o *InstructorProfileDto) SetEnrollmentIdNil() {
...
func (o *InstructorProfileDto) SetVerificationTimestampNil() {
