...
// checks if the CourseDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseDtoIReadOnlyListEnvelope{}

// CourseDtoIReadOnlyListEnvelope struct for CourseDtoIReadOnlyListEnvelope
type CourseDtoIReadOnlyListEnvelope struct {
	...
	Result []CourseDto `json:"result,omitempty"`
}
...
func NewCourseDtoIReadOnlyListEnvelope() *CourseDtoIReadOnlyListEnvelope {
	this := CourseDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *CourseDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *CourseDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *CourseDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *CourseDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CourseDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []CourseDto and assigns it to the Result field.
func (o *CourseDtoIReadOnlyListEnvelope) SetResult(v []CourseDto) {
	o.Result = v
}

func (o CourseDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CourseDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCourseDtoIReadOnlyListEnvelope struct {
	value *CourseDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableCourseDtoIReadOnlyListEnvelope) Get() *CourseDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableCourseDtoIReadOnlyListEnvelope) Set(val *CourseDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseDtoIReadOnlyListEnvelope(val *CourseDtoIReadOnlyListEnvelope) *NullableCourseDtoIReadOnlyListEnvelope {
	return &NullableCourseDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableCourseDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
