...
// checks if the CourseContentGroupDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CourseContentGroupDtoCollectionQueryParameters{}

// CourseContentGroupDtoCollectionQueryParameters struct for CourseContentGroupDtoCollectionQueryParameters
type CourseContentGroupDtoCollectionQueryParameters struct {
...
func NewCourseContentGroupDtoCollectionQueryParameters() *CourseContentGroupDtoCollectionQueryParameters {
	this := CourseContentGroupDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CourseContentGroupDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CourseContentGroupDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CourseContentGroupDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCourseContentGroupDtoCollectionQueryParameters struct {
	value *CourseContentGroupDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCourseContentGroupDtoCollectionQueryParameters) Get() *CourseContentGroupDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCourseContentGroupDtoCollectionQueryParameters) Set(val *CourseContentGroupDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCourseContentGroupDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCourseContentGroupDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCourseContentGroupDtoCollectionQueryParameters(val *CourseContentGroupDtoCollectionQueryParameters) *NullableCourseContentGroupDtoCollectionQueryParameters {
	return &NullableCourseContentGroupDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCourseContentGroupDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCourseContentGroupDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
