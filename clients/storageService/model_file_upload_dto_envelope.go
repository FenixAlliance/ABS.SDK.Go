...
// checks if the FileUploadDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FileUploadDtoEnvelope{}

// FileUploadDtoEnvelope struct for FileUploadDtoEnvelope
type FileUploadDtoEnvelope struct {
	...
	Result *FileUploadDto `json:"result,omitempty"`
}
...
func (o *FileUploadDtoEnvelope) SetErrorMessageNil() {
...
func (o *FileUploadDtoEnvelope) SetCorrelationIdNil() {
...
func (o *FileUploadDtoEnvelope) SetHttpStatusNil() {
...
func (o *FileUploadDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *FileUploadDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given FileUploadDto and assigns it to the Result field.
func (o *FileUploadDtoEnvelope) SetResult(v FileUploadDto) {
	o.Result = &v
}

func (o FileUploadDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o FileUploadDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableFileUploadDtoEnvelope struct {
	value *FileUploadDtoEnvelope
	isSet bool
}

func (v NullableFileUploadDtoEnvelope) Get() *FileUploadDtoEnvelope {
	return v.value
}

func (v *NullableFileUploadDtoEnvelope) Set(val *FileUploadDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableFileUploadDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableFileUploadDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFileUploadDtoEnvelope(val *FileUploadDtoEnvelope) *NullableFileUploadDtoEnvelope {
	return &NullableFileUploadDtoEnvelope{value: val, isSet: true}
}

func (v NullableFileUploadDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFileUploadDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
