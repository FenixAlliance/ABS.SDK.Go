...
type Assembly struct {
	...
	SecurityRuleSet *string `json:"securityRuleSet,omitempty"`
}
...
// SetSecurityRuleSet gets a reference to the given string and assigns it to the SecurityRuleSet field.
