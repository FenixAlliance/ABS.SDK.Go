...
// checks if the BlockchainBlockDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockchainBlockDtoListEnvelope{}

// BlockchainBlockDtoListEnvelope struct for BlockchainBlockDtoListEnvelope
type BlockchainBlockDtoListEnvelope struct {
	...
	Result []BlockchainBlockDto `json:"result,omitempty"`
}
...
func NewBlockchainBlockDtoListEnvelope() *BlockchainBlockDtoListEnvelope {
	this := BlockchainBlockDtoListEnvelope{}
	return &this
}
...
func (o *BlockchainBlockDtoListEnvelope) SetErrorMessageNil() {
...
func (o *BlockchainBlockDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *BlockchainBlockDtoListEnvelope) SetHttpStatusNil() {
...
func (o *BlockchainBlockDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BlockchainBlockDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []BlockchainBlockDto and assigns it to the Result field.
func (o *BlockchainBlockDtoListEnvelope) SetResult(v []BlockchainBlockDto) {
	o.Result = v
}

func (o BlockchainBlockDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BlockchainBlockDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBlockchainBlockDtoListEnvelope struct {
	value *BlockchainBlockDtoListEnvelope
	isSet bool
}

func (v NullableBlockchainBlockDtoListEnvelope) Get() *BlockchainBlockDtoListEnvelope {
	return v.value
}

func (v *NullableBlockchainBlockDtoListEnvelope) Set(val *BlockchainBlockDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockchainBlockDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockchainBlockDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockchainBlockDtoListEnvelope(val *BlockchainBlockDtoListEnvelope) *NullableBlockchainBlockDtoListEnvelope {
	return &NullableBlockchainBlockDtoListEnvelope{value: val, isSet: true}
}

func (v NullableBlockchainBlockDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockchainBlockDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
