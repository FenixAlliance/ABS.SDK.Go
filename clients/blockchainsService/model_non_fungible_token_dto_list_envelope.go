...
// checks if the NonFungibleTokenDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NonFungibleTokenDtoListEnvelope{}

// NonFungibleTokenDtoListEnvelope struct for NonFungibleTokenDtoListEnvelope
type NonFungibleTokenDtoListEnvelope struct {
	...
	Result []NonFungibleTokenDto `json:"result,omitempty"`
}
...
func NewNonFungibleTokenDtoListEnvelope() *NonFungibleTokenDtoListEnvelope {
	this := NonFungibleTokenDtoListEnvelope{}
	return &this
}
...
func (o *NonFungibleTokenDtoListEnvelope) SetErrorMessageNil() {
...
func (o *NonFungibleTokenDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *NonFungibleTokenDtoListEnvelope) SetHttpStatusNil() {
...
func (o *NonFungibleTokenDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *NonFungibleTokenDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []NonFungibleTokenDto and assigns it to the Result field.
func (o *NonFungibleTokenDtoListEnvelope) SetResult(v []NonFungibleTokenDto) {
	o.Result = v
}

func (o NonFungibleTokenDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o NonFungibleTokenDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableNonFungibleTokenDtoListEnvelope struct {
	value *NonFungibleTokenDtoListEnvelope
	isSet bool
}

func (v NullableNonFungibleTokenDtoListEnvelope) Get() *NonFungibleTokenDtoListEnvelope {
	return v.value
}

func (v *NullableNonFungibleTokenDtoListEnvelope) Set(val *NonFungibleTokenDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableNonFungibleTokenDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableNonFungibleTokenDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNonFungibleTokenDtoListEnvelope(val *NonFungibleTokenDtoListEnvelope) *NullableNonFungibleTokenDtoListEnvelope {
	return &NullableNonFungibleTokenDtoListEnvelope{value: val, isSet: true}
}

func (v NullableNonFungibleTokenDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNonFungibleTokenDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
