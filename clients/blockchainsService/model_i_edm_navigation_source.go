...
type IEdmNavigationSource struct {
	...
	EntityType *IEdmEntityType `json:"entityType,omitempty"`
}
...
// SetEntityType gets a reference to the given IEdmEntityType and assigns it to the EntityType field.
