...
**ContainerElementKind** | Pointer to **string** |  | [optional] [readonly] 
...
`func (o *IEdmEntityContainerElement) GetContainerElementKind() string`

GetContainerElementKind returns the ContainerElementKind field if non-nil, zero value otherwise.

### GetContainerElementKindOk

`func (o *IEdmEntityContainerElement) GetContainerElementKindOk() (*string, bool)`
...
`func (o *IEdmEntityContainerElement) SetContainerElementKind(v string)`
