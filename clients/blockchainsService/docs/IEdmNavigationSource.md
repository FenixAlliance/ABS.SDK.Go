...
**EntityType** | Pointer to [**IEdmEntityType**](IEdmEntityType.md) |  | [optional] 
...
`func (o *IEdmNavigationSource) GetEntityType() IEdmEntityType`

GetEntityType returns the EntityType field if non-nil, zero value otherwise.

### GetEntityTypeOk

`func (o *IEdmNavigationSource) GetEntityTypeOk() (*IEdmEntityType, bool)`
...
`func (o *IEdmNavigationSource) SetEntityType(v IEdmEntityType)`

SetEntityType sets EntityType field to given value.

### HasEntityType

`func (o *IEdmNavigationSource) HasEntityType() bool`
