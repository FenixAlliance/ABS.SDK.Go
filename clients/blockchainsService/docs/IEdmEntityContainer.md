...
`func (o *IEdmEntityContainer) GetSchemaElementKind() string`

GetSchemaElementKind returns the SchemaElementKind field if non-nil, zero value otherwise.

### GetSchemaElementKindOk

`func (o *IEdmEntityContainer) GetSchemaElementKindOk() (*string, bool)`
...
`func (o *IEdmEntityContainer) SetSchemaElementKind(v string)`
