...
> NonFungibleTokenDtoListEnvelope GetNonFungibleTokensAsync(ctx).TenantId(tenantId).ODataQueryOptions(oDataQueryOptions).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
...
func main() {
	tenantId := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | 
	oDataQueryOptions := *openapiclient.NewNonFungibleTokenDtoODataQueryOptions() // NonFungibleTokenDtoODataQueryOptions |  (optional)
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NonFungibleTokensAPI.GetNonFungibleTokensAsync(context.Background()).TenantId(tenantId).ODataQueryOptions(oDataQueryOptions).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
	if err != nil {
...
------------- | ------------- | ------------- | -------------
 **tenantId** | **string** |  | 
 **oDataQueryOptions** | [**NonFungibleTokenDtoODataQueryOptions**](NonFungibleTokenDtoODataQueryOptions.md) |  | 
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
...
> Int32Envelope GetNonFungibleTokensCountAsync(ctx).TenantId(tenantId).ODataQueryOptions(oDataQueryOptions).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NonFungibleTokensAPI.GetNonFungibleTokensCountAsync(context.Background()).TenantId(tenantId).ODataQueryOptions(oDataQueryOptions).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
	if err != nil {
