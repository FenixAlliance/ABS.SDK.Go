...
------------ | ------------- | ------------- | -------------
**AddressFamily** | Pointer to **string** |  | [optional] [readonly] 
...
`func (o *IPAddress) GetAddressFamily() string`

GetAddressFamily returns the AddressFamily field if non-nil, zero value otherwise.

### GetAddressFamilyOk

`func (o *IPAddress) GetAddressFamilyOk() (*string, bool)`
...
`func (o *IPAddress) SetAddressFamily(v string)`
