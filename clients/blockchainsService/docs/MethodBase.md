...
`func (o *MethodBase) GetMemberType() string`

GetMemberType returns the MemberType field if non-nil, zero value otherwise.

### GetMemberTypeOk

`func (o *MethodBase) GetMemberTypeOk() (*string, bool)`
...
`func (o *MethodBase) SetMemberType(v string)`
...
`func (o *MethodBase) GetAttributes() string`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *MethodBase) GetAttributesOk() (*string, bool)`
...
`func (o *MethodBase) SetAttributes(v string)`
...
`func (o *MethodBase) GetMethodImplementationFlags() string`
...
`func (o *MethodBase) GetMethodImplementationFlagsOk() (*string, bool)`
...
`func (o *MethodBase) SetMethodImplementationFlags(v string)`
...
`func (o *MethodBase) SetCallingConvention(v string)`
