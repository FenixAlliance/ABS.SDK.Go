...
// checks if the SkipQueryOption type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SkipQueryOption{}
...
type NullableSkipQueryOption struct {
	value *SkipQueryOption
	isSet bool
}

func (v NullableSkipQueryOption) Get() *SkipQueryOption {
	return v.value
}

func (v *NullableSkipQueryOption) Set(val *SkipQueryOption) {
	v.value = val
	v.isSet = true
}
...
func NewNullableSkipQueryOption(val *SkipQueryOption) *NullableSkipQueryOption {
	return &NullableSkipQueryOption{value: val, isSet: true}
}
