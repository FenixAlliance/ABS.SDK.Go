...
type HttpRequest struct {
	...
	Body Nullable*os.File `json:"body,omitempty"`
	BodyReader Nullable*os.File `json:"bodyReader,omitempty"`
...
// GetBodyReader returns the BodyReader field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *HttpRequest) GetBodyReader() *os.File {
	if o == nil || IsNil(o.BodyReader.Get()) {
		var ret *os.File
		return ret
	}
	return *o.BodyReader.Get()
}
...
// SetBodyReader gets a reference to the given Nullable*os.File and assigns it to the BodyReader field.
func (o *HttpRequest) SetBodyReader(v *os.File) {
	o.BodyReader.Set(&v)
}
// SetBodyReaderNil sets the value for BodyReader to be an explicit nil
func (o *HttpRequest) SetBodyReaderNil() {
	o.BodyReader.Set(nil)
}
...
func (o HttpRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.BodyReader.IsSet() {
		toSerialize["bodyReader"] = o.BodyReader.Get()
	}
