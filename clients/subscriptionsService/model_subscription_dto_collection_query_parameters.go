...
// checks if the SubscriptionDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionDtoCollectionQueryParameters{}

// SubscriptionDtoCollectionQueryParameters struct for SubscriptionDtoCollectionQueryParameters
type SubscriptionDtoCollectionQueryParameters struct {
...
func NewSubscriptionDtoCollectionQueryParameters() *SubscriptionDtoCollectionQueryParameters {
	this := SubscriptionDtoCollectionQueryParameters{}
	return &this
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *SubscriptionDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o SubscriptionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionDtoCollectionQueryParameters struct {
	value *SubscriptionDtoCollectionQueryParameters
	isSet bool
}

func (v NullableSubscriptionDtoCollectionQueryParameters) Get() *SubscriptionDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableSubscriptionDtoCollectionQueryParameters) Set(val *SubscriptionDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionDtoCollectionQueryParameters(val *SubscriptionDtoCollectionQueryParameters) *NullableSubscriptionDtoCollectionQueryParameters {
	return &NullableSubscriptionDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableSubscriptionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
