...
// checks if the SubscriptionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionDtoEnvelope{}

// SubscriptionDtoEnvelope struct for SubscriptionDtoEnvelope
type SubscriptionDtoEnvelope struct {
	...
	Result *SubscriptionDto `json:"result,omitempty"`
}
...
func (o *SubscriptionDtoEnvelope) SetErrorMessageNil() {
...
func (o *SubscriptionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SubscriptionDtoEnvelope) SetHttpStatusNil() {
...
func (o *SubscriptionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SubscriptionDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given SubscriptionDto and assigns it to the Result field.
func (o *SubscriptionDtoEnvelope) SetResult(v SubscriptionDto) {
	o.Result = &v
}

func (o SubscriptionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionDtoEnvelope struct {
	value *SubscriptionDtoEnvelope
	isSet bool
}

func (v NullableSubscriptionDtoEnvelope) Get() *SubscriptionDtoEnvelope {
	return v.value
}

func (v *NullableSubscriptionDtoEnvelope) Set(val *SubscriptionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionDtoEnvelope(val *SubscriptionDtoEnvelope) *NullableSubscriptionDtoEnvelope {
	return &NullableSubscriptionDtoEnvelope{value: val, isSet: true}
}

func (v NullableSubscriptionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
