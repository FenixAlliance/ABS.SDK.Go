...
// checks if the SubscriptionDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionDtoIReadOnlyListEnvelope{}

// SubscriptionDtoIReadOnlyListEnvelope struct for SubscriptionDtoIReadOnlyListEnvelope
type SubscriptionDtoIReadOnlyListEnvelope struct {
...
func NewSubscriptionDtoIReadOnlyListEnvelope() *SubscriptionDtoIReadOnlyListEnvelope {
	this := SubscriptionDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *SubscriptionDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *SubscriptionDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *SubscriptionDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *SubscriptionDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SubscriptionDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o SubscriptionDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionDtoIReadOnlyListEnvelope struct {
	value *SubscriptionDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableSubscriptionDtoIReadOnlyListEnvelope) Get() *SubscriptionDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableSubscriptionDtoIReadOnlyListEnvelope) Set(val *SubscriptionDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionDtoIReadOnlyListEnvelope(val *SubscriptionDtoIReadOnlyListEnvelope) *NullableSubscriptionDtoIReadOnlyListEnvelope {
	return &NullableSubscriptionDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableSubscriptionDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
