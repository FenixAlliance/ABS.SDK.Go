...
// checks if the BlogPostCommentDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlogPostCommentDtoCollectionQueryParameters{}

// BlogPostCommentDtoCollectionQueryParameters struct for BlogPostCommentDtoCollectionQueryParameters
type BlogPostCommentDtoCollectionQueryParameters struct {
...
func NewBlogPostCommentDtoCollectionQueryParameters() *BlogPostCommentDtoCollectionQueryParameters {
	this := BlogPostCommentDtoCollectionQueryParameters{}
	return &this
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *BlogPostCommentDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o BlogPostCommentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o BlogPostCommentDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableBlogPostCommentDtoCollectionQueryParameters struct {
	value *BlogPostCommentDtoCollectionQueryParameters
	isSet bool
}

func (v NullableBlogPostCommentDtoCollectionQueryParameters) Get() *BlogPostCommentDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableBlogPostCommentDtoCollectionQueryParameters) Set(val *BlogPostCommentDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableBlogPostCommentDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableBlogPostCommentDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlogPostCommentDtoCollectionQueryParameters(val *BlogPostCommentDtoCollectionQueryParameters) *NullableBlogPostCommentDtoCollectionQueryParameters {
	return &NullableBlogPostCommentDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableBlogPostCommentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlogPostCommentDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
