...
// checks if the LocalizationStringDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocalizationStringDtoListEnvelope{}

// LocalizationStringDtoListEnvelope struct for LocalizationStringDtoListEnvelope
type LocalizationStringDtoListEnvelope struct {
...
func NewLocalizationStringDtoListEnvelope() *LocalizationStringDtoListEnvelope {
	this := LocalizationStringDtoListEnvelope{}
	return &this
}
...
func (o *LocalizationStringDtoListEnvelope) SetErrorMessageNil() {
...
func (o *LocalizationStringDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *LocalizationStringDtoListEnvelope) SetHttpStatusNil() {
...
func (o *LocalizationStringDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LocalizationStringDtoListEnvelope) SetActivityIdNil() {
...
func (o LocalizationStringDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LocalizationStringDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLocalizationStringDtoListEnvelope struct {
	value *LocalizationStringDtoListEnvelope
	isSet bool
}

func (v NullableLocalizationStringDtoListEnvelope) Get() *LocalizationStringDtoListEnvelope {
	return v.value
}

func (v *NullableLocalizationStringDtoListEnvelope) Set(val *LocalizationStringDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalizationStringDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalizationStringDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalizationStringDtoListEnvelope(val *LocalizationStringDtoListEnvelope) *NullableLocalizationStringDtoListEnvelope {
	return &NullableLocalizationStringDtoListEnvelope{value: val, isSet: true}
}

func (v NullableLocalizationStringDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalizationStringDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
