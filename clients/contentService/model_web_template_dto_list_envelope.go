...
// checks if the WebTemplateDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebTemplateDtoListEnvelope{}

// WebTemplateDtoListEnvelope struct for WebTemplateDtoListEnvelope
type WebTemplateDtoListEnvelope struct {
...
func NewWebTemplateDtoListEnvelope() *WebTemplateDtoListEnvelope {
	this := WebTemplateDtoListEnvelope{}
	return &this
}
...
func (o *WebTemplateDtoListEnvelope) SetErrorMessageNil() {
...
func (o *WebTemplateDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *WebTemplateDtoListEnvelope) SetHttpStatusNil() {
...
func (o *WebTemplateDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WebTemplateDtoListEnvelope) SetActivityIdNil() {
...
func (o WebTemplateDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WebTemplateDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWebTemplateDtoListEnvelope struct {
	value *WebTemplateDtoListEnvelope
	isSet bool
}

func (v NullableWebTemplateDtoListEnvelope) Get() *WebTemplateDtoListEnvelope {
	return v.value
}

func (v *NullableWebTemplateDtoListEnvelope) Set(val *WebTemplateDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWebTemplateDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWebTemplateDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebTemplateDtoListEnvelope(val *WebTemplateDtoListEnvelope) *NullableWebTemplateDtoListEnvelope {
	return &NullableWebTemplateDtoListEnvelope{value: val, isSet: true}
}

func (v NullableWebTemplateDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebTemplateDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
