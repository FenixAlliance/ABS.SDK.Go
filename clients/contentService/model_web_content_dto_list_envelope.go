...
// checks if the WebContentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebContentDtoListEnvelope{}

// WebContentDtoListEnvelope struct for WebContentDtoListEnvelope
type WebContentDtoListEnvelope struct {
...
func NewWebContentDtoListEnvelope() *WebContentDtoListEnvelope {
	this := WebContentDtoListEnvelope{}
	return &this
}
...
func (o *WebContentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *WebContentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *WebContentDtoListEnvelope) SetHttpStatusNil() {
...
func (o *WebContentDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WebContentDtoListEnvelope) SetActivityIdNil() {
...
func (o WebContentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WebContentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWebContentDtoListEnvelope struct {
	value *WebContentDtoListEnvelope
	isSet bool
}

func (v NullableWebContentDtoListEnvelope) Get() *WebContentDtoListEnvelope {
	return v.value
}

func (v *NullableWebContentDtoListEnvelope) Set(val *WebContentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWebContentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWebContentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebContentDtoListEnvelope(val *WebContentDtoListEnvelope) *NullableWebContentDtoListEnvelope {
	return &NullableWebContentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableWebContentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebContentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
