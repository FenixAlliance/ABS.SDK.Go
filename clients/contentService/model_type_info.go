...
type TypeInfo struct {
	...
	GenericParameterAttributes *string `json:"genericParameterAttributes,omitempty"`
...
// SetGenericParameterAttributes gets a reference to the given string and assigns it to the GenericParameterAttributes field.
