...
// checks if the BlogPostCategoryDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlogPostCategoryDtoCollectionQueryParameters{}

// BlogPostCategoryDtoCollectionQueryParameters struct for BlogPostCategoryDtoCollectionQueryParameters
type BlogPostCategoryDtoCollectionQueryParameters struct {
...
func NewBlogPostCategoryDtoCollectionQueryParameters() *BlogPostCategoryDtoCollectionQueryParameters {
	this := BlogPostCategoryDtoCollectionQueryParameters{}
	return &this
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *BlogPostCategoryDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o BlogPostCategoryDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o BlogPostCategoryDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableBlogPostCategoryDtoCollectionQueryParameters struct {
	value *BlogPostCategoryDtoCollectionQueryParameters
	isSet bool
}

func (v NullableBlogPostCategoryDtoCollectionQueryParameters) Get() *BlogPostCategoryDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableBlogPostCategoryDtoCollectionQueryParameters) Set(val *BlogPostCategoryDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableBlogPostCategoryDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableBlogPostCategoryDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlogPostCategoryDtoCollectionQueryParameters(val *BlogPostCategoryDtoCollectionQueryParameters) *NullableBlogPostCategoryDtoCollectionQueryParameters {
	return &NullableBlogPostCategoryDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableBlogPostCategoryDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlogPostCategoryDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
