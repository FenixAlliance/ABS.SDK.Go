...
// checks if the BlogPostDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlogPostDtoCollectionQueryParameters{}

// BlogPostDtoCollectionQueryParameters struct for BlogPostDtoCollectionQueryParameters
type BlogPostDtoCollectionQueryParameters struct {
...
func NewBlogPostDtoCollectionQueryParameters() *BlogPostDtoCollectionQueryParameters {
	this := BlogPostDtoCollectionQueryParameters{}
	return &this
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *BlogPostDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o BlogPostDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o BlogPostDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableBlogPostDtoCollectionQueryParameters struct {
	value *BlogPostDtoCollectionQueryParameters
	isSet bool
}

func (v NullableBlogPostDtoCollectionQueryParameters) Get() *BlogPostDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableBlogPostDtoCollectionQueryParameters) Set(val *BlogPostDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableBlogPostDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableBlogPostDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlogPostDtoCollectionQueryParameters(val *BlogPostDtoCollectionQueryParameters) *NullableBlogPostDtoCollectionQueryParameters {
	return &NullableBlogPostDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableBlogPostDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlogPostDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
