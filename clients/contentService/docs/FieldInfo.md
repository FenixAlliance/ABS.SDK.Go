...
`func (o *FieldInfo) GetMemberType() string`

GetMemberType returns the MemberType field if non-nil, zero value otherwise.

### GetMemberTypeOk

`func (o *FieldInfo) GetMemberTypeOk() (*string, bool)`
...
`func (o *FieldInfo) SetMemberType(v string)`
...
`func (o *FieldInfo) GetAttributes() string`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *FieldInfo) GetAttributesOk() (*string, bool)`
...
`func (o *FieldInfo) SetAttributes(v string)`
