...
**SiteTheme** | Pointer to **string** |  | [optional] 
...
`func (o *UserSettingsDto) GetSiteTheme() string`

GetSiteTheme returns the SiteTheme field if non-nil, zero value otherwise.

### GetSiteThemeOk

`func (o *UserSettingsDto) GetSiteThemeOk() (*string, bool)`
...
`func (o *UserSettingsDto) SetSiteTheme(v string)`
