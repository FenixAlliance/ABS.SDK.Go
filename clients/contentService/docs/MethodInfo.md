...
`func (o *MethodInfo) GetAttributes() string`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *MethodInfo) GetAttributesOk() (*string, bool)`
...
`func (o *MethodInfo) SetAttributes(v string)`
...
`func (o *MethodInfo) GetMethodImplementationFlags() string`
...
`func (o *MethodInfo) GetMethodImplementationFlagsOk() (*string, bool)`
...
`func (o *MethodInfo) SetMethodImplementationFlags(v string)`
...
`func (o *MethodInfo) SetCallingConvention(v string)`
...
`func (o *MethodInfo) GetMemberType() string`

GetMemberType returns the MemberType field if non-nil, zero value otherwise.

### GetMemberTypeOk

`func (o *MethodInfo) GetMemberTypeOk() (*string, bool)`
...
`func (o *MethodInfo) SetMemberType(v string)`
