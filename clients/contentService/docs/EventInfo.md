...
`func (o *EventInfo) GetMemberType() string`

GetMemberType returns the MemberType field if non-nil, zero value otherwise.

### GetMemberTypeOk

`func (o *EventInfo) GetMemberTypeOk() (*string, bool)`
...
`func (o *EventInfo) SetMemberType(v string)`
...
`func (o *EventInfo) GetAttributes() string`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *EventInfo) GetAttributesOk() (*string, bool)`
...
`func (o *EventInfo) SetAttributes(v string)`
