...
> Int32Envelope CountWebPageCategoriesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebPageCategoryDtoCollectionQueryParameters(webPageCategoryDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	resp, r, err := apiClient.WebPageCategoriesAPI.CountWebPageCategoriesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebPageCategoryDtoCollectionQueryParameters(webPageCategoryDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> WebPageCategoryDtoListEnvelope GetWebPageCategoriesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebPageCategoryDtoCollectionQueryParameters(webPageCategoryDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WebPageCategoriesAPI.GetWebPageCategoriesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebPageCategoryDtoCollectionQueryParameters(webPageCategoryDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchWebPageCategoryAsync(ctx, webPageCategoryId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WebPageCategoriesAPI.PatchWebPageCategoryAsync(context.Background(), webPageCategoryId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WebPageCategoriesAPI.PatchWebPageCategoryAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchWebPageCategoryAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `WebPageCategoriesAPI.PatchWebPageCategoryAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchWebPageCategoryAsyncRequest struct via the builder pattern
