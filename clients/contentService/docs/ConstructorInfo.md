...
**Attributes** | Pointer to **string** |  | [optional] [readonly] 
**MethodImplementationFlags** | Pointer to **string** |  | [optional] [readonly] 
**CallingConvention** | Pointer to **string** |  | [optional] [readonly] 
...
**MemberType** | Pointer to **string** |  | [optional] [readonly] 
...
`func (o *ConstructorInfo) GetAttributes() string`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *ConstructorInfo) GetAttributesOk() (*string, bool)`
...
`func (o *ConstructorInfo) SetAttributes(v string)`
...
`func (o *ConstructorInfo) GetMethodImplementationFlags() string`
...
`func (o *ConstructorInfo) GetMethodImplementationFlagsOk() (*string, bool)`
...
`func (o *ConstructorInfo) SetMethodImplementationFlags(v string)`
...
`func (o *ConstructorInfo) SetCallingConvention(v string)`
...
`func (o *ConstructorInfo) GetMemberType() string`

GetMemberType returns the MemberType field if non-nil, zero value otherwise.

### GetMemberTypeOk

`func (o *ConstructorInfo) GetMemberTypeOk() (*string, bool)`
...
`func (o *ConstructorInfo) SetMemberType(v string)`
