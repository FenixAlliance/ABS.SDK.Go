...
**Body** | Pointer to **Nullable*os.File** |  | [optional] 
**BodyReader** | Pointer to **Nullable*os.File** |  | [optional] [readonly] 
...
`func (o *HttpRequest) SetBodyNil(b bool)`

 SetBodyNil sets the value for Body to be an explicit nil

### UnsetBody
`func (o *HttpRequest) UnsetBody()`
...
`func (o *HttpRequest) SetBodyReaderNil(b bool)`

 SetBodyReaderNil sets the value for BodyReader to be an explicit nil

### UnsetBodyReader
`func (o *HttpRequest) UnsetBodyReader()`

UnsetBodyReader ensures that no value is present for BodyReader, not even an explicit nil
