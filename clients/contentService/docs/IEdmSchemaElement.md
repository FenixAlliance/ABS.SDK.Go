...
`func (o *IEdmSchemaElement) GetSchemaElementKind() string`

GetSchemaElementKind returns the SchemaElementKind field if non-nil, zero value otherwise.

### GetSchemaElementKindOk

`func (o *IEdmSchemaElement) GetSchemaElementKindOk() (*string, bool)`
...
`func (o *IEdmSchemaElement) SetSchemaElementKind(v string)`
