...
**UsesDefault** | Pointer to **bool** |  | [optional] [readonly] 
...
`func (o *IEdmVocabularyAnnotation) GetUsesDefault() bool`

GetUsesDefault returns the UsesDefault field if non-nil, zero value otherwise.

### GetUsesDefaultOk

`func (o *IEdmVocabularyAnnotation) GetUsesDefaultOk() (*bool, bool)`

GetUsesDefaultOk returns a tuple with the UsesDefault field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetUsesDefault

`func (o *IEdmVocabularyAnnotation) SetUsesDefault(v bool)`

SetUsesDefault sets UsesDefault field to given value.

### HasUsesDefault

`func (o *IEdmVocabularyAnnotation) HasUsesDefault() bool`

HasUsesDefault returns a boolean if a field has been set.
