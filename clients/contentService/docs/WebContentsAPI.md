...
> Int32Envelope CountWebContentsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebContentDtoCollectionQueryParameters(webContentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	webContentDtoCollectionQueryParameters := *openapiclient.NewWebContentDtoCollectionQueryParameters() // WebContentDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WebContentsAPI.CountWebContentsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebContentDtoCollectionQueryParameters(webContentDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **webContentDtoCollectionQueryParameters** | [**WebContentDtoCollectionQueryParameters**](WebContentDtoCollectionQueryParameters.md) |  | 
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	webContentCreateDto := *openapiclient.NewWebContentCreateDto("Title_example") // WebContentCreateDto |  (optional)
...
> WebContentDtoListEnvelope GetWebContentsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebContentDtoCollectionQueryParameters(webContentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WebContentsAPI.GetWebContentsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WebContentDtoCollectionQueryParameters(webContentDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchWebContentAsync(ctx, webContentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WebContentsAPI.PatchWebContentAsync(context.Background(), webContentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WebContentsAPI.PatchWebContentAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchWebContentAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `WebContentsAPI.PatchWebContentAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchWebContentAsyncRequest struct via the builder pattern
