...
`func (o *PropertyInfo) GetMemberType() string`

GetMemberType returns the MemberType field if non-nil, zero value otherwise.

### GetMemberTypeOk

`func (o *PropertyInfo) GetMemberTypeOk() (*string, bool)`
...
`func (o *PropertyInfo) SetMemberType(v string)`
...
`func (o *PropertyInfo) GetAttributes() string`

GetAttributes returns the Attributes field if non-nil, zero value otherwise.

### GetAttributesOk

`func (o *PropertyInfo) GetAttributesOk() (*string, bool)`
...
`func (o *PropertyInfo) SetAttributes(v string)`
