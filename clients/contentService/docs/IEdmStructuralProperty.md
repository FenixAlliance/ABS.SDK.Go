...
`func (o *IEdmStructuralProperty) GetPropertyKind() string`

GetPropertyKind returns the PropertyKind field if non-nil, zero value otherwise.

### GetPropertyKindOk

`func (o *IEdmStructuralProperty) GetPropertyKindOk() (*string, bool)`
...
`func (o *IEdmStructuralProperty) SetPropertyKind(v string)`
