...
// checks if the WebComponentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebComponentDtoListEnvelope{}

// WebComponentDtoListEnvelope struct for WebComponentDtoListEnvelope
type WebComponentDtoListEnvelope struct {
...
func NewWebComponentDtoListEnvelope() *WebComponentDtoListEnvelope {
	this := WebComponentDtoListEnvelope{}
	return &this
}
...
func (o *WebComponentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *WebComponentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *WebComponentDtoListEnvelope) SetHttpStatusNil() {
...
func (o *WebComponentDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WebComponentDtoListEnvelope) SetActivityIdNil() {
...
func (o WebComponentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WebComponentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWebComponentDtoListEnvelope struct {
	value *WebComponentDtoListEnvelope
	isSet bool
}

func (v NullableWebComponentDtoListEnvelope) Get() *WebComponentDtoListEnvelope {
	return v.value
}

func (v *NullableWebComponentDtoListEnvelope) Set(val *WebComponentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWebComponentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWebComponentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebComponentDtoListEnvelope(val *WebComponentDtoListEnvelope) *NullableWebComponentDtoListEnvelope {
	return &NullableWebComponentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableWebComponentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebComponentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
