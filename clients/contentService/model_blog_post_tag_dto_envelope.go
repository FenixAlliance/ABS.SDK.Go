...
// checks if the BlogPostTagDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlogPostTagDtoEnvelope{}

// BlogPostTagDtoEnvelope struct for BlogPostTagDtoEnvelope
type BlogPostTagDtoEnvelope struct {
...
func (o *BlogPostTagDtoEnvelope) SetErrorMessageNil() {
...
func (o *BlogPostTagDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BlogPostTagDtoEnvelope) SetHttpStatusNil() {
...
func (o *BlogPostTagDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BlogPostTagDtoEnvelope) SetActivityIdNil() {
...
func (o BlogPostTagDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BlogPostTagDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBlogPostTagDtoEnvelope struct {
	value *BlogPostTagDtoEnvelope
	isSet bool
}

func (v NullableBlogPostTagDtoEnvelope) Get() *BlogPostTagDtoEnvelope {
	return v.value
}

func (v *NullableBlogPostTagDtoEnvelope) Set(val *BlogPostTagDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBlogPostTagDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBlogPostTagDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlogPostTagDtoEnvelope(val *BlogPostTagDtoEnvelope) *NullableBlogPostTagDtoEnvelope {
	return &NullableBlogPostTagDtoEnvelope{value: val, isSet: true}
}

func (v NullableBlogPostTagDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlogPostTagDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
