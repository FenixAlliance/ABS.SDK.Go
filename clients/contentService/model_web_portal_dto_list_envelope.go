...
// checks if the WebPortalDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebPortalDtoListEnvelope{}

// WebPortalDtoListEnvelope struct for WebPortalDtoListEnvelope
type WebPortalDtoListEnvelope struct {
...
func (o *WebPortalDtoListEnvelope) SetErrorMessageNil() {
...
func (o *WebPortalDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *WebPortalDtoListEnvelope) SetHttpStatusNil() {
...
func (o *WebPortalDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WebPortalDtoListEnvelope) SetActivityIdNil() {
...
func (o WebPortalDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WebPortalDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWebPortalDtoListEnvelope struct {
	value *WebPortalDtoListEnvelope
	isSet bool
}

func (v NullableWebPortalDtoListEnvelope) Get() *WebPortalDtoListEnvelope {
	return v.value
}

func (v *NullableWebPortalDtoListEnvelope) Set(val *WebPortalDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWebPortalDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWebPortalDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebPortalDtoListEnvelope(val *WebPortalDtoListEnvelope) *NullableWebPortalDtoListEnvelope {
	return &NullableWebPortalDtoListEnvelope{value: val, isSet: true}
}

func (v NullableWebPortalDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebPortalDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
