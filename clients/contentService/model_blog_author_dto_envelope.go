...
// checks if the BlogAuthorDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlogAuthorDtoEnvelope{}

// BlogAuthorDtoEnvelope struct for BlogAuthorDtoEnvelope
type BlogAuthorDtoEnvelope struct {
...
func (o *BlogAuthorDtoEnvelope) SetErrorMessageNil() {
...
func (o *BlogAuthorDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BlogAuthorDtoEnvelope) SetHttpStatusNil() {
...
func (o *BlogAuthorDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BlogAuthorDtoEnvelope) SetActivityIdNil() {
...
func (o BlogAuthorDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BlogAuthorDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBlogAuthorDtoEnvelope struct {
	value *BlogAuthorDtoEnvelope
	isSet bool
}

func (v NullableBlogAuthorDtoEnvelope) Get() *BlogAuthorDtoEnvelope {
	return v.value
}

func (v *NullableBlogAuthorDtoEnvelope) Set(val *BlogAuthorDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBlogAuthorDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBlogAuthorDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlogAuthorDtoEnvelope(val *BlogAuthorDtoEnvelope) *NullableBlogAuthorDtoEnvelope {
	return &NullableBlogAuthorDtoEnvelope{value: val, isSet: true}
}

func (v NullableBlogAuthorDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlogAuthorDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
