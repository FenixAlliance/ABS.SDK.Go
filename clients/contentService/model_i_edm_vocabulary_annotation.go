...
type IEdmVocabularyAnnotation struct {
	...
	UsesDefault *bool `json:"usesDefault,omitempty"`
}
...
// GetUsesDefault returns the UsesDefault field value if set, zero value otherwise.
func (o *IEdmVocabularyAnnotation) GetUsesDefault() bool {
	if o == nil || IsNil(o.UsesDefault) {
		var ret bool
		return ret
	}
	return *o.UsesDefault
}

// GetUsesDefaultOk returns a tuple with the UsesDefault field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *IEdmVocabularyAnnotation) GetUsesDefaultOk() (*bool, bool) {
	if o == nil || IsNil(o.UsesDefault) {
		return nil, false
	}
	return o.UsesDefault, true
}
...
// SetUsesDefault gets a reference to the given bool and assigns it to the UsesDefault field.
...
func (o IEdmVocabularyAnnotation) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.UsesDefault) {
		toSerialize["usesDefault"] = o.UsesDefault
	}
