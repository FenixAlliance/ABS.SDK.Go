...
// checks if the BlogPostCategoryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlogPostCategoryDtoEnvelope{}

// BlogPostCategoryDtoEnvelope struct for BlogPostCategoryDtoEnvelope
type BlogPostCategoryDtoEnvelope struct {
...
func NewBlogPostCategoryDtoEnvelope() *BlogPostCategoryDtoEnvelope {
	this := BlogPostCategoryDtoEnvelope{}
	return &this
}
...
func (o *BlogPostCategoryDtoEnvelope) SetErrorMessageNil() {
...
func (o *BlogPostCategoryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BlogPostCategoryDtoEnvelope) SetHttpStatusNil() {
...
func (o *BlogPostCategoryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BlogPostCategoryDtoEnvelope) SetActivityIdNil() {
...
func (o BlogPostCategoryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BlogPostCategoryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBlogPostCategoryDtoEnvelope struct {
	value *BlogPostCategoryDtoEnvelope
	isSet bool
}

func (v NullableBlogPostCategoryDtoEnvelope) Get() *BlogPostCategoryDtoEnvelope {
	return v.value
}

func (v *NullableBlogPostCategoryDtoEnvelope) Set(val *BlogPostCategoryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBlogPostCategoryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBlogPostCategoryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlogPostCategoryDtoEnvelope(val *BlogPostCategoryDtoEnvelope) *NullableBlogPostCategoryDtoEnvelope {
	return &NullableBlogPostCategoryDtoEnvelope{value: val, isSet: true}
}

func (v NullableBlogPostCategoryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlogPostCategoryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
