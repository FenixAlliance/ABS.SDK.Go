...
// checks if the MenuContextDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MenuContextDtoCollectionQueryParameters{}

// MenuContextDtoCollectionQueryParameters struct for MenuContextDtoCollectionQueryParameters
type MenuContextDtoCollectionQueryParameters struct {
...
func NewMenuContextDtoCollectionQueryParameters() *MenuContextDtoCollectionQueryParameters {
	this := MenuContextDtoCollectionQueryParameters{}
	return &this
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *MenuContextDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o MenuContextDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o MenuContextDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableMenuContextDtoCollectionQueryParameters struct {
	value *MenuContextDtoCollectionQueryParameters
	isSet bool
}

func (v NullableMenuContextDtoCollectionQueryParameters) Get() *MenuContextDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableMenuContextDtoCollectionQueryParameters) Set(val *MenuContextDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableMenuContextDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableMenuContextDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMenuContextDtoCollectionQueryParameters(val *MenuContextDtoCollectionQueryParameters) *NullableMenuContextDtoCollectionQueryParameters {
	return &NullableMenuContextDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableMenuContextDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMenuContextDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
