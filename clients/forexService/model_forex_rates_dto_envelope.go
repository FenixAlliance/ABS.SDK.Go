...
// checks if the ForexRatesDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForexRatesDtoEnvelope{}

// ForexRatesDtoEnvelope struct for ForexRatesDtoEnvelope
type ForexRatesDtoEnvelope struct {
	...
	Result *ForexRatesDto `json:"result,omitempty"`
}
...
func (o *ForexRatesDtoEnvelope) SetErrorMessageNil() {
...
func (o *ForexRatesDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ForexRatesDtoEnvelope) SetHttpStatusNil() {
...
func (o *ForexRatesDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ForexRatesDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given ForexRatesDto and assigns it to the Result field.
func (o *ForexRatesDtoEnvelope) SetResult(v ForexRatesDto) {
	o.Result = &v
}

func (o ForexRatesDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ForexRatesDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableForexRatesDtoEnvelope struct {
	value *ForexRatesDtoEnvelope
	isSet bool
}

func (v NullableForexRatesDtoEnvelope) Get() *ForexRatesDtoEnvelope {
	return v.value
}

func (v *NullableForexRatesDtoEnvelope) Set(val *ForexRatesDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableForexRatesDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableForexRatesDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForexRatesDtoEnvelope(val *ForexRatesDtoEnvelope) *NullableForexRatesDtoEnvelope {
	return &NullableForexRatesDtoEnvelope{value: val, isSet: true}
}

func (v NullableForexRatesDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForexRatesDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
