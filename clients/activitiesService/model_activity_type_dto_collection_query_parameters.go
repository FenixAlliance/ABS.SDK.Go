...
// checks if the ActivityTypeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivityTypeDtoCollectionQueryParameters{}

// ActivityTypeDtoCollectionQueryParameters struct for ActivityTypeDtoCollectionQueryParameters
type ActivityTypeDtoCollectionQueryParameters struct {
...
func NewActivityTypeDtoCollectionQueryParameters() *ActivityTypeDtoCollectionQueryParameters {
	this := ActivityTypeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ActivityTypeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ActivityTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ActivityTypeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableActivityTypeDtoCollectionQueryParameters struct {
	value *ActivityTypeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableActivityTypeDtoCollectionQueryParameters) Get() *ActivityTypeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableActivityTypeDtoCollectionQueryParameters) Set(val *ActivityTypeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityTypeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityTypeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityTypeDtoCollectionQueryParameters(val *ActivityTypeDtoCollectionQueryParameters) *NullableActivityTypeDtoCollectionQueryParameters {
	return &NullableActivityTypeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableActivityTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityTypeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
