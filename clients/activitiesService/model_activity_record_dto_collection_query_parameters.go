...
// checks if the ActivityRecordDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivityRecordDtoCollectionQueryParameters{}

// ActivityRecordDtoCollectionQueryParameters struct for ActivityRecordDtoCollectionQueryParameters
type ActivityRecordDtoCollectionQueryParameters struct {
...
func NewActivityRecordDtoCollectionQueryParameters() *ActivityRecordDtoCollectionQueryParameters {
	this := ActivityRecordDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ActivityRecordDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ActivityRecordDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ActivityRecordDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableActivityRecordDtoCollectionQueryParameters struct {
	value *ActivityRecordDtoCollectionQueryParameters
	isSet bool
}

func (v NullableActivityRecordDtoCollectionQueryParameters) Get() *ActivityRecordDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableActivityRecordDtoCollectionQueryParameters) Set(val *ActivityRecordDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityRecordDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityRecordDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityRecordDtoCollectionQueryParameters(val *ActivityRecordDtoCollectionQueryParameters) *NullableActivityRecordDtoCollectionQueryParameters {
	return &NullableActivityRecordDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableActivityRecordDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityRecordDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
