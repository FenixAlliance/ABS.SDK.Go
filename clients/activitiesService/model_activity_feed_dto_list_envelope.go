...
// checks if the ActivityFeedDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivityFeedDtoListEnvelope{}

// ActivityFeedDtoListEnvelope struct for ActivityFeedDtoListEnvelope
type ActivityFeedDtoListEnvelope struct {
...
func NewActivityFeedDtoListEnvelope() *ActivityFeedDtoListEnvelope {
	this := ActivityFeedDtoListEnvelope{}
	return &this
}
...
func (o *ActivityFeedDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ActivityFeedDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ActivityFeedDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ActivityFeedDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ActivityFeedDtoListEnvelope) SetActivityIdNil() {
...
func (o ActivityFeedDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ActivityFeedDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableActivityFeedDtoListEnvelope struct {
	value *ActivityFeedDtoListEnvelope
	isSet bool
}

func (v NullableActivityFeedDtoListEnvelope) Get() *ActivityFeedDtoListEnvelope {
	return v.value
}

func (v *NullableActivityFeedDtoListEnvelope) Set(val *ActivityFeedDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityFeedDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityFeedDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityFeedDtoListEnvelope(val *ActivityFeedDtoListEnvelope) *NullableActivityFeedDtoListEnvelope {
	return &NullableActivityFeedDtoListEnvelope{value: val, isSet: true}
}

func (v NullableActivityFeedDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityFeedDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
