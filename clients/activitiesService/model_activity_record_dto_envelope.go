...
// checks if the ActivityRecordDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ActivityRecordDtoEnvelope{}

// ActivityRecordDtoEnvelope struct for ActivityRecordDtoEnvelope
type ActivityRecordDtoEnvelope struct {
...
func NewActivityRecordDtoEnvelope() *ActivityRecordDtoEnvelope {
	this := ActivityRecordDtoEnvelope{}
	return &this
}
...
func (o *ActivityRecordDtoEnvelope) SetErrorMessageNil() {
...
func (o *ActivityRecordDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ActivityRecordDtoEnvelope) SetHttpStatusNil() {
...
func (o *ActivityRecordDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ActivityRecordDtoEnvelope) SetActivityIdNil() {
...
func (o ActivityRecordDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ActivityRecordDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableActivityRecordDtoEnvelope struct {
	value *ActivityRecordDtoEnvelope
	isSet bool
}

func (v NullableActivityRecordDtoEnvelope) Get() *ActivityRecordDtoEnvelope {
	return v.value
}

func (v *NullableActivityRecordDtoEnvelope) Set(val *ActivityRecordDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableActivityRecordDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableActivityRecordDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableActivityRecordDtoEnvelope(val *ActivityRecordDtoEnvelope) *NullableActivityRecordDtoEnvelope {
	return &NullableActivityRecordDtoEnvelope{value: val, isSet: true}
}

func (v NullableActivityRecordDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableActivityRecordDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
