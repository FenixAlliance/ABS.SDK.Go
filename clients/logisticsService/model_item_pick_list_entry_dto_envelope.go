...
// checks if the ItemPickListEntryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemPickListEntryDtoEnvelope{}

// ItemPickListEntryDtoEnvelope struct for ItemPickListEntryDtoEnvelope
type ItemPickListEntryDtoEnvelope struct {
...
func NewItemPickListEntryDtoEnvelope() *ItemPickListEntryDtoEnvelope {
	this := ItemPickListEntryDtoEnvelope{}
	return &this
}
...
func (o *ItemPickListEntryDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemPickListEntryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemPickListEntryDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemPickListEntryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemPickListEntryDtoEnvelope) SetActivityIdNil() {
...
func (o ItemPickListEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemPickListEntryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemPickListEntryDtoEnvelope struct {
	value *ItemPickListEntryDtoEnvelope
	isSet bool
}

func (v NullableItemPickListEntryDtoEnvelope) Get() *ItemPickListEntryDtoEnvelope {
	return v.value
}

func (v *NullableItemPickListEntryDtoEnvelope) Set(val *ItemPickListEntryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemPickListEntryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemPickListEntryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemPickListEntryDtoEnvelope(val *ItemPickListEntryDtoEnvelope) *NullableItemPickListEntryDtoEnvelope {
	return &NullableItemPickListEntryDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemPickListEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemPickListEntryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
