...
// checks if the SeawayBillDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeawayBillDtoListEnvelope{}

// SeawayBillDtoListEnvelope struct for SeawayBillDtoListEnvelope
type SeawayBillDtoListEnvelope struct {
...
func NewSeawayBillDtoListEnvelope() *SeawayBillDtoListEnvelope {
	this := SeawayBillDtoListEnvelope{}
	return &this
}
...
func (o *SeawayBillDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SeawayBillDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SeawayBillDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SeawayBillDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SeawayBillDtoListEnvelope) SetActivityIdNil() {
...
func (o SeawayBillDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SeawayBillDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSeawayBillDtoListEnvelope struct {
	value *SeawayBillDtoListEnvelope
	isSet bool
}

func (v NullableSeawayBillDtoListEnvelope) Get() *SeawayBillDtoListEnvelope {
	return v.value
}

func (v *NullableSeawayBillDtoListEnvelope) Set(val *SeawayBillDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSeawayBillDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSeawayBillDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeawayBillDtoListEnvelope(val *SeawayBillDtoListEnvelope) *NullableSeawayBillDtoListEnvelope {
	return &NullableSeawayBillDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSeawayBillDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSeawayBillDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
