...
> VesselDtoListEnvelope GetVesselsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).VesselDtoCollectionQueryParameters(vesselDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	vesselDtoCollectionQueryParameters := *openapiclient.NewVesselDtoCollectionQueryParameters() // VesselDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.VesselsAPI.GetVesselsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).VesselDtoCollectionQueryParameters(vesselDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **vesselDtoCollectionQueryParameters** | [**VesselDtoCollectionQueryParameters**](VesselDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetVesselsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).VesselDtoCollectionQueryParameters(vesselDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.VesselsAPI.GetVesselsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).VesselDtoCollectionQueryParameters(vesselDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchVesselAsync(ctx, vesselId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.VesselsAPI.PatchVesselAsync(context.Background(), vesselId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
