...
> WarehouseDtoListEnvelope GetWarehousesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WarehouseDtoCollectionQueryParameters(warehouseDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	warehouseDtoCollectionQueryParameters := *openapiclient.NewWarehouseDtoCollectionQueryParameters() // WarehouseDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WarehousesAPI.GetWarehousesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WarehouseDtoCollectionQueryParameters(warehouseDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **warehouseDtoCollectionQueryParameters** | [**WarehouseDtoCollectionQueryParameters**](WarehouseDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetWarehousesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WarehouseDtoCollectionQueryParameters(warehouseDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WarehousesAPI.GetWarehousesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).WarehouseDtoCollectionQueryParameters(warehouseDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchWarehouseAsync(ctx, warehouseId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WarehousesAPI.PatchWarehouseAsync(context.Background(), warehouseId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
