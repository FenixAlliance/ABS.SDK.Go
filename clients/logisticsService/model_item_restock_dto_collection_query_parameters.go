...
// checks if the ItemRestockDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemRestockDtoCollectionQueryParameters{}

// ItemRestockDtoCollectionQueryParameters struct for ItemRestockDtoCollectionQueryParameters
type ItemRestockDtoCollectionQueryParameters struct {
...
func NewItemRestockDtoCollectionQueryParameters() *ItemRestockDtoCollectionQueryParameters {
	this := ItemRestockDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ItemRestockDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ItemRestockDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ItemRestockDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableItemRestockDtoCollectionQueryParameters struct {
	value *ItemRestockDtoCollectionQueryParameters
	isSet bool
}

func (v NullableItemRestockDtoCollectionQueryParameters) Get() *ItemRestockDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableItemRestockDtoCollectionQueryParameters) Set(val *ItemRestockDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRestockDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRestockDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRestockDtoCollectionQueryParameters(val *ItemRestockDtoCollectionQueryParameters) *NullableItemRestockDtoCollectionQueryParameters {
	return &NullableItemRestockDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableItemRestockDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRestockDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
