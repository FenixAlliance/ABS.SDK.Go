...
// checks if the RailWaybillDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RailWaybillDtoEnvelope{}

// RailWaybillDtoEnvelope struct for RailWaybillDtoEnvelope
type RailWaybillDtoEnvelope struct {
...
func (o *RailWaybillDtoEnvelope) SetErrorMessageNil() {
...
func (o *RailWaybillDtoEnvelope) SetCorrelationIdNil() {
...
func (o *RailWaybillDtoEnvelope) SetHttpStatusNil() {
...
func (o *RailWaybillDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *RailWaybillDtoEnvelope) SetActivityIdNil() {
...
func (o RailWaybillDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o RailWaybillDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableRailWaybillDtoEnvelope struct {
	value *RailWaybillDtoEnvelope
	isSet bool
}

func (v NullableRailWaybillDtoEnvelope) Get() *RailWaybillDtoEnvelope {
	return v.value
}

func (v *NullableRailWaybillDtoEnvelope) Set(val *RailWaybillDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableRailWaybillDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableRailWaybillDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRailWaybillDtoEnvelope(val *RailWaybillDtoEnvelope) *NullableRailWaybillDtoEnvelope {
	return &NullableRailWaybillDtoEnvelope{value: val, isSet: true}
}

func (v NullableRailWaybillDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRailWaybillDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
