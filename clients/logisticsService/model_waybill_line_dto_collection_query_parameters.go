...
// checks if the WaybillLineDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WaybillLineDtoCollectionQueryParameters{}

// WaybillLineDtoCollectionQueryParameters struct for WaybillLineDtoCollectionQueryParameters
type WaybillLineDtoCollectionQueryParameters struct {
...
func NewWaybillLineDtoCollectionQueryParameters() *WaybillLineDtoCollectionQueryParameters {
	this := WaybillLineDtoCollectionQueryParameters{}
	return &this
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *WaybillLineDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o WaybillLineDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o WaybillLineDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableWaybillLineDtoCollectionQueryParameters struct {
	value *WaybillLineDtoCollectionQueryParameters
	isSet bool
}

func (v NullableWaybillLineDtoCollectionQueryParameters) Get() *WaybillLineDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableWaybillLineDtoCollectionQueryParameters) Set(val *WaybillLineDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableWaybillLineDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableWaybillLineDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWaybillLineDtoCollectionQueryParameters(val *WaybillLineDtoCollectionQueryParameters) *NullableWaybillLineDtoCollectionQueryParameters {
	return &NullableWaybillLineDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableWaybillLineDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWaybillLineDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
