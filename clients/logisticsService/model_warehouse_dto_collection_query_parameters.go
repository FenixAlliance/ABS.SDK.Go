...
// checks if the WarehouseDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WarehouseDtoCollectionQueryParameters{}

// WarehouseDtoCollectionQueryParameters struct for WarehouseDtoCollectionQueryParameters
type WarehouseDtoCollectionQueryParameters struct {
...
func NewWarehouseDtoCollectionQueryParameters() *WarehouseDtoCollectionQueryParameters {
	this := WarehouseDtoCollectionQueryParameters{}
	return &this
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *WarehouseDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o WarehouseDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o WarehouseDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableWarehouseDtoCollectionQueryParameters struct {
	value *WarehouseDtoCollectionQueryParameters
	isSet bool
}

func (v NullableWarehouseDtoCollectionQueryParameters) Get() *WarehouseDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableWarehouseDtoCollectionQueryParameters) Set(val *WarehouseDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableWarehouseDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableWarehouseDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWarehouseDtoCollectionQueryParameters(val *WarehouseDtoCollectionQueryParameters) *NullableWarehouseDtoCollectionQueryParameters {
	return &NullableWarehouseDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableWarehouseDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWarehouseDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
