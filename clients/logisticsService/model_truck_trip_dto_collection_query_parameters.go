...
// checks if the TruckTripDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TruckTripDtoCollectionQueryParameters{}

// TruckTripDtoCollectionQueryParameters struct for TruckTripDtoCollectionQueryParameters
type TruckTripDtoCollectionQueryParameters struct {
...
func NewTruckTripDtoCollectionQueryParameters() *TruckTripDtoCollectionQueryParameters {
	this := TruckTripDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TruckTripDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TruckTripDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TruckTripDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTruckTripDtoCollectionQueryParameters struct {
	value *TruckTripDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTruckTripDtoCollectionQueryParameters) Get() *TruckTripDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTruckTripDtoCollectionQueryParameters) Set(val *TruckTripDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTruckTripDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTruckTripDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTruckTripDtoCollectionQueryParameters(val *TruckTripDtoCollectionQueryParameters) *NullableTruckTripDtoCollectionQueryParameters {
	return &NullableTruckTripDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTruckTripDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTruckTripDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
