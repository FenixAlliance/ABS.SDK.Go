...
// checks if the RoadWaybillDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoadWaybillDtoEnvelope{}

// RoadWaybillDtoEnvelope struct for RoadWaybillDtoEnvelope
type RoadWaybillDtoEnvelope struct {
...
func (o *RoadWaybillDtoEnvelope) SetErrorMessageNil() {
...
func (o *RoadWaybillDtoEnvelope) SetCorrelationIdNil() {
...
func (o *RoadWaybillDtoEnvelope) SetHttpStatusNil() {
...
func (o *RoadWaybillDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *RoadWaybillDtoEnvelope) SetActivityIdNil() {
...
func (o RoadWaybillDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o RoadWaybillDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableRoadWaybillDtoEnvelope struct {
	value *RoadWaybillDtoEnvelope
	isSet bool
}

func (v NullableRoadWaybillDtoEnvelope) Get() *RoadWaybillDtoEnvelope {
	return v.value
}

func (v *NullableRoadWaybillDtoEnvelope) Set(val *RoadWaybillDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableRoadWaybillDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableRoadWaybillDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoadWaybillDtoEnvelope(val *RoadWaybillDtoEnvelope) *NullableRoadWaybillDtoEnvelope {
	return &NullableRoadWaybillDtoEnvelope{value: val, isSet: true}
}

func (v NullableRoadWaybillDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoadWaybillDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
