...
// checks if the ItemPackingSlipDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemPackingSlipDtoListEnvelope{}

// ItemPackingSlipDtoListEnvelope struct for ItemPackingSlipDtoListEnvelope
type ItemPackingSlipDtoListEnvelope struct {
...
func NewItemPackingSlipDtoListEnvelope() *ItemPackingSlipDtoListEnvelope {
	this := ItemPackingSlipDtoListEnvelope{}
	return &this
}
...
func (o *ItemPackingSlipDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemPackingSlipDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemPackingSlipDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemPackingSlipDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemPackingSlipDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemPackingSlipDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemPackingSlipDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemPackingSlipDtoListEnvelope struct {
	value *ItemPackingSlipDtoListEnvelope
	isSet bool
}

func (v NullableItemPackingSlipDtoListEnvelope) Get() *ItemPackingSlipDtoListEnvelope {
	return v.value
}

func (v *NullableItemPackingSlipDtoListEnvelope) Set(val *ItemPackingSlipDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemPackingSlipDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemPackingSlipDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemPackingSlipDtoListEnvelope(val *ItemPackingSlipDtoListEnvelope) *NullableItemPackingSlipDtoListEnvelope {
	return &NullableItemPackingSlipDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemPackingSlipDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemPackingSlipDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
