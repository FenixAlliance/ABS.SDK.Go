...
// checks if the TruckDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TruckDtoEnvelope{}

// TruckDtoEnvelope struct for TruckDtoEnvelope
type TruckDtoEnvelope struct {
...
func (o *TruckDtoEnvelope) SetErrorMessageNil() {
...
func (o *TruckDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TruckDtoEnvelope) SetHttpStatusNil() {
...
func (o *TruckDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TruckDtoEnvelope) SetActivityIdNil() {
...
func (o TruckDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TruckDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTruckDtoEnvelope struct {
	value *TruckDtoEnvelope
	isSet bool
}

func (v NullableTruckDtoEnvelope) Get() *TruckDtoEnvelope {
	return v.value
}

func (v *NullableTruckDtoEnvelope) Set(val *TruckDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTruckDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTruckDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTruckDtoEnvelope(val *TruckDtoEnvelope) *NullableTruckDtoEnvelope {
	return &NullableTruckDtoEnvelope{value: val, isSet: true}
}

func (v NullableTruckDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTruckDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
