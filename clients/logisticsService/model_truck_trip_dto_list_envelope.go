...
// checks if the TruckTripDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TruckTripDtoListEnvelope{}

// TruckTripDtoListEnvelope struct for TruckTripDtoListEnvelope
type TruckTripDtoListEnvelope struct {
	...
	Result []TruckTripDto `json:"result,omitempty"`
}
...
func (o *TruckTripDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TruckTripDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TruckTripDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TruckTripDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TruckTripDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []TruckTripDto and assigns it to the Result field.
func (o *TruckTripDtoListEnvelope) SetResult(v []TruckTripDto) {
	o.Result = v
}

func (o TruckTripDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TruckTripDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTruckTripDtoListEnvelope struct {
	value *TruckTripDtoListEnvelope
	isSet bool
}

func (v NullableTruckTripDtoListEnvelope) Get() *TruckTripDtoListEnvelope {
	return v.value
}

func (v *NullableTruckTripDtoListEnvelope) Set(val *TruckTripDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTruckTripDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTruckTripDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTruckTripDtoListEnvelope(val *TruckTripDtoListEnvelope) *NullableTruckTripDtoListEnvelope {
	return &NullableTruckTripDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTruckTripDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTruckTripDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
