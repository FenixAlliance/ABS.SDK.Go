...
// checks if the VesselDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VesselDtoListEnvelope{}

// VesselDtoListEnvelope struct for VesselDtoListEnvelope
type VesselDtoListEnvelope struct {
...
func (o *VesselDtoListEnvelope) SetErrorMessageNil() {
...
func (o *VesselDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *VesselDtoListEnvelope) SetHttpStatusNil() {
...
func (o *VesselDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *VesselDtoListEnvelope) SetActivityIdNil() {
...
func (o VesselDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o VesselDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableVesselDtoListEnvelope struct {
	value *VesselDtoListEnvelope
	isSet bool
}

func (v NullableVesselDtoListEnvelope) Get() *VesselDtoListEnvelope {
	return v.value
}

func (v *NullableVesselDtoListEnvelope) Set(val *VesselDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableVesselDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableVesselDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVesselDtoListEnvelope(val *VesselDtoListEnvelope) *NullableVesselDtoListEnvelope {
	return &NullableVesselDtoListEnvelope{value: val, isSet: true}
}

func (v NullableVesselDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVesselDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
