...
// checks if the RailWaybillDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RailWaybillDtoCollectionQueryParameters{}

// RailWaybillDtoCollectionQueryParameters struct for RailWaybillDtoCollectionQueryParameters
type RailWaybillDtoCollectionQueryParameters struct {
...
func NewRailWaybillDtoCollectionQueryParameters() *RailWaybillDtoCollectionQueryParameters {
	this := RailWaybillDtoCollectionQueryParameters{}
	return &this
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *RailWaybillDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o RailWaybillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o RailWaybillDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableRailWaybillDtoCollectionQueryParameters struct {
	value *RailWaybillDtoCollectionQueryParameters
	isSet bool
}

func (v NullableRailWaybillDtoCollectionQueryParameters) Get() *RailWaybillDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableRailWaybillDtoCollectionQueryParameters) Set(val *RailWaybillDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableRailWaybillDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableRailWaybillDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRailWaybillDtoCollectionQueryParameters(val *RailWaybillDtoCollectionQueryParameters) *NullableRailWaybillDtoCollectionQueryParameters {
	return &NullableRailWaybillDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableRailWaybillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRailWaybillDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
