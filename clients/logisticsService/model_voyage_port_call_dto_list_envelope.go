...
// checks if the VoyagePortCallDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VoyagePortCallDtoListEnvelope{}

// VoyagePortCallDtoListEnvelope struct for VoyagePortCallDtoListEnvelope
type VoyagePortCallDtoListEnvelope struct {
	...
	Result []VoyagePortCallDto `json:"result,omitempty"`
}
...
func NewVoyagePortCallDtoListEnvelope() *VoyagePortCallDtoListEnvelope {
	this := VoyagePortCallDtoListEnvelope{}
	return &this
}
...
func (o *VoyagePortCallDtoListEnvelope) SetErrorMessageNil() {
...
func (o *VoyagePortCallDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *VoyagePortCallDtoListEnvelope) SetHttpStatusNil() {
...
func (o *VoyagePortCallDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *VoyagePortCallDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []VoyagePortCallDto and assigns it to the Result field.
func (o *VoyagePortCallDtoListEnvelope) SetResult(v []VoyagePortCallDto) {
	o.Result = v
}

func (o VoyagePortCallDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o VoyagePortCallDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableVoyagePortCallDtoListEnvelope struct {
	value *VoyagePortCallDtoListEnvelope
	isSet bool
}

func (v NullableVoyagePortCallDtoListEnvelope) Get() *VoyagePortCallDtoListEnvelope {
	return v.value
}

func (v *NullableVoyagePortCallDtoListEnvelope) Set(val *VoyagePortCallDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableVoyagePortCallDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableVoyagePortCallDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVoyagePortCallDtoListEnvelope(val *VoyagePortCallDtoListEnvelope) *NullableVoyagePortCallDtoListEnvelope {
	return &NullableVoyagePortCallDtoListEnvelope{value: val, isSet: true}
}

func (v NullableVoyagePortCallDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVoyagePortCallDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
