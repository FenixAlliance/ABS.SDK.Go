...
// checks if the ItemRestockCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemRestockCreateDto{}

// ItemRestockCreateDto struct for ItemRestockCreateDto
type ItemRestockCreateDto struct {
...
func (o *ItemRestockCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ItemRestockCreateDto) SetDescriptionNil() {
...
func (o ItemRestockCreateDto) MarshalJSON() ([]byte, error) {
...
func (o ItemRestockCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableItemRestockCreateDto struct {
	value *ItemRestockCreateDto
	isSet bool
}

func (v NullableItemRestockCreateDto) Get() *ItemRestockCreateDto {
	return v.value
}

func (v *NullableItemRestockCreateDto) Set(val *ItemRestockCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRestockCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRestockCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRestockCreateDto(val *ItemRestockCreateDto) *NullableItemRestockCreateDto {
	return &NullableItemRestockCreateDto{value: val, isSet: true}
}

func (v NullableItemRestockCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRestockCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
