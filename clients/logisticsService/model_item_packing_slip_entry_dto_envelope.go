...
// checks if the ItemPackingSlipEntryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemPackingSlipEntryDtoEnvelope{}

// ItemPackingSlipEntryDtoEnvelope struct for ItemPackingSlipEntryDtoEnvelope
type ItemPackingSlipEntryDtoEnvelope struct {
...
func NewItemPackingSlipEntryDtoEnvelope() *ItemPackingSlipEntryDtoEnvelope {
	this := ItemPackingSlipEntryDtoEnvelope{}
	return &this
}
...
func (o *ItemPackingSlipEntryDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemPackingSlipEntryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemPackingSlipEntryDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemPackingSlipEntryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemPackingSlipEntryDtoEnvelope) SetActivityIdNil() {
...
func (o ItemPackingSlipEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemPackingSlipEntryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemPackingSlipEntryDtoEnvelope struct {
	value *ItemPackingSlipEntryDtoEnvelope
	isSet bool
}

func (v NullableItemPackingSlipEntryDtoEnvelope) Get() *ItemPackingSlipEntryDtoEnvelope {
	return v.value
}

func (v *NullableItemPackingSlipEntryDtoEnvelope) Set(val *ItemPackingSlipEntryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemPackingSlipEntryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemPackingSlipEntryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemPackingSlipEntryDtoEnvelope(val *ItemPackingSlipEntryDtoEnvelope) *NullableItemPackingSlipEntryDtoEnvelope {
	return &NullableItemPackingSlipEntryDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemPackingSlipEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemPackingSlipEntryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
