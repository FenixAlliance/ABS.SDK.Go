...
// checks if the ItemRestockEntryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemRestockEntryDtoEnvelope{}

// ItemRestockEntryDtoEnvelope struct for ItemRestockEntryDtoEnvelope
type ItemRestockEntryDtoEnvelope struct {
...
func NewItemRestockEntryDtoEnvelope() *ItemRestockEntryDtoEnvelope {
	this := ItemRestockEntryDtoEnvelope{}
	return &this
}
...
func (o *ItemRestockEntryDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemRestockEntryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemRestockEntryDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemRestockEntryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemRestockEntryDtoEnvelope) SetActivityIdNil() {
...
func (o ItemRestockEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemRestockEntryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemRestockEntryDtoEnvelope struct {
	value *ItemRestockEntryDtoEnvelope
	isSet bool
}

func (v NullableItemRestockEntryDtoEnvelope) Get() *ItemRestockEntryDtoEnvelope {
	return v.value
}

func (v *NullableItemRestockEntryDtoEnvelope) Set(val *ItemRestockEntryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRestockEntryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRestockEntryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRestockEntryDtoEnvelope(val *ItemRestockEntryDtoEnvelope) *NullableItemRestockEntryDtoEnvelope {
	return &NullableItemRestockEntryDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemRestockEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRestockEntryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
