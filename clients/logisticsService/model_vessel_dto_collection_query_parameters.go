...
// checks if the VesselDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VesselDtoCollectionQueryParameters{}

// VesselDtoCollectionQueryParameters struct for VesselDtoCollectionQueryParameters
type VesselDtoCollectionQueryParameters struct {
...
func NewVesselDtoCollectionQueryParameters() *VesselDtoCollectionQueryParameters {
	this := VesselDtoCollectionQueryParameters{}
	return &this
}
...
func (o *VesselDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *VesselDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *VesselDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *VesselDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *VesselDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *VesselDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *VesselDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o VesselDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o VesselDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableVesselDtoCollectionQueryParameters struct {
	value *VesselDtoCollectionQueryParameters
	isSet bool
}

func (v NullableVesselDtoCollectionQueryParameters) Get() *VesselDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableVesselDtoCollectionQueryParameters) Set(val *VesselDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableVesselDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableVesselDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVesselDtoCollectionQueryParameters(val *VesselDtoCollectionQueryParameters) *NullableVesselDtoCollectionQueryParameters {
	return &NullableVesselDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableVesselDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVesselDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
