...
// checks if the ItemRetainSampleDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemRetainSampleDtoEnvelope{}

// ItemRetainSampleDtoEnvelope struct for ItemRetainSampleDtoEnvelope
type ItemRetainSampleDtoEnvelope struct {
...
func NewItemRetainSampleDtoEnvelope() *ItemRetainSampleDtoEnvelope {
	this := ItemRetainSampleDtoEnvelope{}
	return &this
}
...
func (o *ItemRetainSampleDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemRetainSampleDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemRetainSampleDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemRetainSampleDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemRetainSampleDtoEnvelope) SetActivityIdNil() {
...
func (o ItemRetainSampleDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemRetainSampleDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemRetainSampleDtoEnvelope struct {
	value *ItemRetainSampleDtoEnvelope
	isSet bool
}

func (v NullableItemRetainSampleDtoEnvelope) Get() *ItemRetainSampleDtoEnvelope {
	return v.value
}

func (v *NullableItemRetainSampleDtoEnvelope) Set(val *ItemRetainSampleDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRetainSampleDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRetainSampleDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRetainSampleDtoEnvelope(val *ItemRetainSampleDtoEnvelope) *NullableItemRetainSampleDtoEnvelope {
	return &NullableItemRetainSampleDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemRetainSampleDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRetainSampleDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
