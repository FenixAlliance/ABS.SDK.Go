...
// checks if the SeawayBillDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SeawayBillDtoCollectionQueryParameters{}

// SeawayBillDtoCollectionQueryParameters struct for SeawayBillDtoCollectionQueryParameters
type SeawayBillDtoCollectionQueryParameters struct {
...
func NewSeawayBillDtoCollectionQueryParameters() *SeawayBillDtoCollectionQueryParameters {
	this := SeawayBillDtoCollectionQueryParameters{}
	return &this
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *SeawayBillDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o SeawayBillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o SeawayBillDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableSeawayBillDtoCollectionQueryParameters struct {
	value *SeawayBillDtoCollectionQueryParameters
	isSet bool
}

func (v NullableSeawayBillDtoCollectionQueryParameters) Get() *SeawayBillDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableSeawayBillDtoCollectionQueryParameters) Set(val *SeawayBillDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableSeawayBillDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableSeawayBillDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSeawayBillDtoCollectionQueryParameters(val *SeawayBillDtoCollectionQueryParameters) *NullableSeawayBillDtoCollectionQueryParameters {
	return &NullableSeawayBillDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableSeawayBillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSeawayBillDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
