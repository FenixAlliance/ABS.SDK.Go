...
// checks if the ItemRetainSampleDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemRetainSampleDtoListEnvelope{}

// ItemRetainSampleDtoListEnvelope struct for ItemRetainSampleDtoListEnvelope
type ItemRetainSampleDtoListEnvelope struct {
	...
	Result []ItemRetainSampleDto `json:"result,omitempty"`
}
...
func NewItemRetainSampleDtoListEnvelope() *ItemRetainSampleDtoListEnvelope {
	this := ItemRetainSampleDtoListEnvelope{}
	return &this
}
...
func (o *ItemRetainSampleDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemRetainSampleDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemRetainSampleDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemRetainSampleDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemRetainSampleDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ItemRetainSampleDto and assigns it to the Result field.
func (o *ItemRetainSampleDtoListEnvelope) SetResult(v []ItemRetainSampleDto) {
	o.Result = v
}

func (o ItemRetainSampleDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemRetainSampleDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemRetainSampleDtoListEnvelope struct {
	value *ItemRetainSampleDtoListEnvelope
	isSet bool
}

func (v NullableItemRetainSampleDtoListEnvelope) Get() *ItemRetainSampleDtoListEnvelope {
	return v.value
}

func (v *NullableItemRetainSampleDtoListEnvelope) Set(val *ItemRetainSampleDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRetainSampleDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRetainSampleDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRetainSampleDtoListEnvelope(val *ItemRetainSampleDtoListEnvelope) *NullableItemRetainSampleDtoListEnvelope {
	return &NullableItemRetainSampleDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemRetainSampleDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRetainSampleDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
