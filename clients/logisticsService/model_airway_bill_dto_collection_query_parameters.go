...
// checks if the AirwayBillDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AirwayBillDtoCollectionQueryParameters{}

// AirwayBillDtoCollectionQueryParameters struct for AirwayBillDtoCollectionQueryParameters
type AirwayBillDtoCollectionQueryParameters struct {
...
func NewAirwayBillDtoCollectionQueryParameters() *AirwayBillDtoCollectionQueryParameters {
	this := AirwayBillDtoCollectionQueryParameters{}
	return &this
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *AirwayBillDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o AirwayBillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o AirwayBillDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableAirwayBillDtoCollectionQueryParameters struct {
	value *AirwayBillDtoCollectionQueryParameters
	isSet bool
}

func (v NullableAirwayBillDtoCollectionQueryParameters) Get() *AirwayBillDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableAirwayBillDtoCollectionQueryParameters) Set(val *AirwayBillDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableAirwayBillDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableAirwayBillDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAirwayBillDtoCollectionQueryParameters(val *AirwayBillDtoCollectionQueryParameters) *NullableAirwayBillDtoCollectionQueryParameters {
	return &NullableAirwayBillDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableAirwayBillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAirwayBillDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
