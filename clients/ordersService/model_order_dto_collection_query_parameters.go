...
// checks if the OrderDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderDtoCollectionQueryParameters{}

// OrderDtoCollectionQueryParameters struct for OrderDtoCollectionQueryParameters
type OrderDtoCollectionQueryParameters struct {
...
func NewOrderDtoCollectionQueryParameters() *OrderDtoCollectionQueryParameters {
	this := OrderDtoCollectionQueryParameters{}
	return &this
}
...
func (o *OrderDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *OrderDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *OrderDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *OrderDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *OrderDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *OrderDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *OrderDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o OrderDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o OrderDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableOrderDtoCollectionQueryParameters struct {
	value *OrderDtoCollectionQueryParameters
	isSet bool
}

func (v NullableOrderDtoCollectionQueryParameters) Get() *OrderDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableOrderDtoCollectionQueryParameters) Set(val *OrderDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderDtoCollectionQueryParameters(val *OrderDtoCollectionQueryParameters) *NullableOrderDtoCollectionQueryParameters {
	return &NullableOrderDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableOrderDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
