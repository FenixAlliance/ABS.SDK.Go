...
// checks if the OrderLineDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderLineDtoCollectionQueryParameters{}

// OrderLineDtoCollectionQueryParameters struct for OrderLineDtoCollectionQueryParameters
type OrderLineDtoCollectionQueryParameters struct {
...
func NewOrderLineDtoCollectionQueryParameters() *OrderLineDtoCollectionQueryParameters {
	this := OrderLineDtoCollectionQueryParameters{}
	return &this
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *OrderLineDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o OrderLineDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o OrderLineDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableOrderLineDtoCollectionQueryParameters struct {
	value *OrderLineDtoCollectionQueryParameters
	isSet bool
}

func (v NullableOrderLineDtoCollectionQueryParameters) Get() *OrderLineDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableOrderLineDtoCollectionQueryParameters) Set(val *OrderLineDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderLineDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderLineDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderLineDtoCollectionQueryParameters(val *OrderLineDtoCollectionQueryParameters) *NullableOrderLineDtoCollectionQueryParameters {
	return &NullableOrderLineDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableOrderLineDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderLineDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
