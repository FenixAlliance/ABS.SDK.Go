...
`func (o *ExtendedUserDto) GetHandler() string`

GetHandler returns the Handler field if non-nil, zero value otherwise.

### GetHandlerOk

`func (o *ExtendedUserDto) GetHandlerOk() (*string, bool)`
...
`func (o *ExtendedUserDto) SetHandler(v string)`

SetHandler sets Handler field to given value.

### HasHandler

`func (o *ExtendedUserDto) HasHandler() bool`

HasHandler returns a boolean if a field has been set.

### SetHandlerNil

`func (o *ExtendedUserDto) SetHandlerNil(b bool)`

 SetHandlerNil sets the value for Handler to be an explicit nil

### UnsetHandler
`func (o *ExtendedUserDto) UnsetHandler()`
...
`func (o *ExtendedUserDto) GetGender() string`

GetGender returns the Gender field if non-nil, zero value otherwise.

### GetGenderOk

`func (o *ExtendedUserDto) GetGenderOk() (*string, bool)`
...
`func (o *ExtendedUserDto) SetGender(v string)`
...
`func (o *ExtendedUserDto) GetAvailability() string`

GetAvailability returns the Availability field if non-nil, zero value otherwise.

### GetAvailabilityOk

`func (o *ExtendedUserDto) GetAvailabilityOk() (*string, bool)`
...
`func (o *ExtendedUserDto) SetAvailability(v string)`
...
`func (o *ExtendedUserDto) GetSiteTheme() string`

GetSiteTheme returns the SiteTheme field if non-nil, zero value otherwise.

### GetSiteThemeOk

`func (o *ExtendedUserDto) GetSiteThemeOk() (*string, bool)`
...
`func (o *ExtendedUserDto) SetSiteTheme(v string)`
