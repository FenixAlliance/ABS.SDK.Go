...
`func NewUserSettingsUpdateDto(dateFormat string, currencyFormat string, dateTimeFormat string, siteTheme string, ) *UserSettingsUpdateDto`
...
`func (o *UserSettingsUpdateDto) GetSiteTheme() string`

GetSiteTheme returns the SiteTheme field if non-nil, zero value otherwise.

### GetSiteThemeOk

`func (o *UserSettingsUpdateDto) GetSiteThemeOk() (*string, bool)`
...
`func (o *UserSettingsUpdateDto) SetSiteTheme(v string)`
