...
// checks if the ExtendedTenantDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedTenantDtoListEnvelope{}

// ExtendedTenantDtoListEnvelope struct for ExtendedTenantDtoListEnvelope
type ExtendedTenantDtoListEnvelope struct {
	...
	Result []ExtendedTenantDto `json:"result,omitempty"`
}
...
func NewExtendedTenantDtoListEnvelope() *ExtendedTenantDtoListEnvelope {
	this := ExtendedTenantDtoListEnvelope{}
	return &this
}
...
func (o *ExtendedTenantDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedTenantDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedTenantDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedTenantDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedTenantDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ExtendedTenantDto and assigns it to the Result field.
func (o *ExtendedTenantDtoListEnvelope) SetResult(v []ExtendedTenantDto) {
	o.Result = v
}

func (o ExtendedTenantDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedTenantDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedTenantDtoListEnvelope struct {
	value *ExtendedTenantDtoListEnvelope
	isSet bool
}

func (v NullableExtendedTenantDtoListEnvelope) Get() *ExtendedTenantDtoListEnvelope {
	return v.value
}

func (v *NullableExtendedTenantDtoListEnvelope) Set(val *ExtendedTenantDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedTenantDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedTenantDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedTenantDtoListEnvelope(val *ExtendedTenantDtoListEnvelope) *NullableExtendedTenantDtoListEnvelope {
	return &NullableExtendedTenantDtoListEnvelope{value: val, isSet: true}
}

func (v NullableExtendedTenantDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedTenantDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
