...
// checks if the AddressDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AddressDtoCollectionQueryParameters{}

// AddressDtoCollectionQueryParameters struct for AddressDtoCollectionQueryParameters
type AddressDtoCollectionQueryParameters struct {
...
func NewAddressDtoCollectionQueryParameters() *AddressDtoCollectionQueryParameters {
	this := AddressDtoCollectionQueryParameters{}
	return &this
}
...
func (o *AddressDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *AddressDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *AddressDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *AddressDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *AddressDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *AddressDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *AddressDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o AddressDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o AddressDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableAddressDtoCollectionQueryParameters struct {
	value *AddressDtoCollectionQueryParameters
	isSet bool
}

func (v NullableAddressDtoCollectionQueryParameters) Get() *AddressDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableAddressDtoCollectionQueryParameters) Set(val *AddressDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableAddressDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableAddressDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddressDtoCollectionQueryParameters(val *AddressDtoCollectionQueryParameters) *NullableAddressDtoCollectionQueryParameters {
	return &NullableAddressDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableAddressDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddressDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
