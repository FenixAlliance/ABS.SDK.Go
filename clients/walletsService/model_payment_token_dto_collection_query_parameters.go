...
// checks if the PaymentTokenDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentTokenDtoCollectionQueryParameters{}

// PaymentTokenDtoCollectionQueryParameters struct for PaymentTokenDtoCollectionQueryParameters
type PaymentTokenDtoCollectionQueryParameters struct {
...
func NewPaymentTokenDtoCollectionQueryParameters() *PaymentTokenDtoCollectionQueryParameters {
	this := PaymentTokenDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PaymentTokenDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PaymentTokenDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PaymentTokenDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentTokenDtoCollectionQueryParameters struct {
	value *PaymentTokenDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePaymentTokenDtoCollectionQueryParameters) Get() *PaymentTokenDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePaymentTokenDtoCollectionQueryParameters) Set(val *PaymentTokenDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentTokenDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentTokenDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentTokenDtoCollectionQueryParameters(val *PaymentTokenDtoCollectionQueryParameters) *NullablePaymentTokenDtoCollectionQueryParameters {
	return &NullablePaymentTokenDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePaymentTokenDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentTokenDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
