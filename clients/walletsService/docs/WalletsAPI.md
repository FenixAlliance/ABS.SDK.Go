...
func main() {
	...
	// response from `PatchWalletBankAccountAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `WalletsAPI.PatchWalletBankAccountAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchWalletBankAccountAsyncRequest struct via the builder pattern
...
func main() {
	...
	// response from `PatchWalletTokenAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `WalletsAPI.PatchWalletTokenAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchWalletTokenAsyncRequest struct via the builder pattern
