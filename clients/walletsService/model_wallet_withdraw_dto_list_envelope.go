...
// checks if the WalletWithdrawDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletWithdrawDtoListEnvelope{}

// WalletWithdrawDtoListEnvelope struct for WalletWithdrawDtoListEnvelope
type WalletWithdrawDtoListEnvelope struct {
	...
	Result []WalletWithdrawDto `json:"result,omitempty"`
}
...
func NewWalletWithdrawDtoListEnvelope() *WalletWithdrawDtoListEnvelope {
	this := WalletWithdrawDtoListEnvelope{}
	return &this
}
...
func (o *WalletWithdrawDtoListEnvelope) SetErrorMessageNil() {
...
func (o *WalletWithdrawDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *WalletWithdrawDtoListEnvelope) SetHttpStatusNil() {
...
func (o *WalletWithdrawDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WalletWithdrawDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []WalletWithdrawDto and assigns it to the Result field.
func (o *WalletWithdrawDtoListEnvelope) SetResult(v []WalletWithdrawDto) {
	o.Result = v
}

func (o WalletWithdrawDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WalletWithdrawDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWalletWithdrawDtoListEnvelope struct {
	value *WalletWithdrawDtoListEnvelope
	isSet bool
}

func (v NullableWalletWithdrawDtoListEnvelope) Get() *WalletWithdrawDtoListEnvelope {
	return v.value
}

func (v *NullableWalletWithdrawDtoListEnvelope) Set(val *WalletWithdrawDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletWithdrawDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletWithdrawDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletWithdrawDtoListEnvelope(val *WalletWithdrawDtoListEnvelope) *NullableWalletWithdrawDtoListEnvelope {
	return &NullableWalletWithdrawDtoListEnvelope{value: val, isSet: true}
}

func (v NullableWalletWithdrawDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletWithdrawDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
