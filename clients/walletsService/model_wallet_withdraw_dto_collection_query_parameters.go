...
// checks if the WalletWithdrawDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletWithdrawDtoCollectionQueryParameters{}

// WalletWithdrawDtoCollectionQueryParameters struct for WalletWithdrawDtoCollectionQueryParameters
type WalletWithdrawDtoCollectionQueryParameters struct {
...
func NewWalletWithdrawDtoCollectionQueryParameters() *WalletWithdrawDtoCollectionQueryParameters {
	this := WalletWithdrawDtoCollectionQueryParameters{}
	return &this
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *WalletWithdrawDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o WalletWithdrawDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o WalletWithdrawDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableWalletWithdrawDtoCollectionQueryParameters struct {
	value *WalletWithdrawDtoCollectionQueryParameters
	isSet bool
}

func (v NullableWalletWithdrawDtoCollectionQueryParameters) Get() *WalletWithdrawDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableWalletWithdrawDtoCollectionQueryParameters) Set(val *WalletWithdrawDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletWithdrawDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletWithdrawDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletWithdrawDtoCollectionQueryParameters(val *WalletWithdrawDtoCollectionQueryParameters) *NullableWalletWithdrawDtoCollectionQueryParameters {
	return &NullableWalletWithdrawDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableWalletWithdrawDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletWithdrawDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
