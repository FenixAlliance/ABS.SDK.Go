...
// checks if the PaymentTokenDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentTokenDtoEnvelope{}

// PaymentTokenDtoEnvelope struct for PaymentTokenDtoEnvelope
type PaymentTokenDtoEnvelope struct {
...
func (o *PaymentTokenDtoEnvelope) SetErrorMessageNil() {
...
func (o *PaymentTokenDtoEnvelope) SetCorrelationIdNil() {
...
func (o *PaymentTokenDtoEnvelope) SetHttpStatusNil() {
...
func (o *PaymentTokenDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PaymentTokenDtoEnvelope) SetActivityIdNil() {
...
func (o PaymentTokenDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PaymentTokenDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentTokenDtoEnvelope struct {
	value *PaymentTokenDtoEnvelope
	isSet bool
}

func (v NullablePaymentTokenDtoEnvelope) Get() *PaymentTokenDtoEnvelope {
	return v.value
}

func (v *NullablePaymentTokenDtoEnvelope) Set(val *PaymentTokenDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentTokenDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentTokenDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentTokenDtoEnvelope(val *PaymentTokenDtoEnvelope) *NullablePaymentTokenDtoEnvelope {
	return &NullablePaymentTokenDtoEnvelope{value: val, isSet: true}
}

func (v NullablePaymentTokenDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentTokenDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
