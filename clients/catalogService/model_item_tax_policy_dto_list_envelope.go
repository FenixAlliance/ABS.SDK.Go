...
// checks if the ItemTaxPolicyDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemTaxPolicyDtoListEnvelope{}

// ItemTaxPolicyDtoListEnvelope struct for ItemTaxPolicyDtoListEnvelope
type ItemTaxPolicyDtoListEnvelope struct {
	...
	Result []ItemTaxPolicyDto `json:"result,omitempty"`
}
...
func NewItemTaxPolicyDtoListEnvelope() *ItemTaxPolicyDtoListEnvelope {
	this := ItemTaxPolicyDtoListEnvelope{}
	return &this
}
...
func (o *ItemTaxPolicyDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemTaxPolicyDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemTaxPolicyDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemTaxPolicyDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemTaxPolicyDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ItemTaxPolicyDto and assigns it to the Result field.
func (o *ItemTaxPolicyDtoListEnvelope) SetResult(v []ItemTaxPolicyDto) {
	o.Result = v
}

func (o ItemTaxPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemTaxPolicyDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemTaxPolicyDtoListEnvelope struct {
	value *ItemTaxPolicyDtoListEnvelope
	isSet bool
}

func (v NullableItemTaxPolicyDtoListEnvelope) Get() *ItemTaxPolicyDtoListEnvelope {
	return v.value
}

func (v *NullableItemTaxPolicyDtoListEnvelope) Set(val *ItemTaxPolicyDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemTaxPolicyDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemTaxPolicyDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemTaxPolicyDtoListEnvelope(val *ItemTaxPolicyDtoListEnvelope) *NullableItemTaxPolicyDtoListEnvelope {
	return &NullableItemTaxPolicyDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemTaxPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemTaxPolicyDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
