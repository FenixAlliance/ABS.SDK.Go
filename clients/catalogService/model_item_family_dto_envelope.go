...
// checks if the ItemFamilyDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemFamilyDtoEnvelope{}

// ItemFamilyDtoEnvelope struct for ItemFamilyDtoEnvelope
type ItemFamilyDtoEnvelope struct {
...
func (o *ItemFamilyDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemFamilyDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemFamilyDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemFamilyDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemFamilyDtoEnvelope) SetActivityIdNil() {
...
func (o ItemFamilyDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemFamilyDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemFamilyDtoEnvelope struct {
	value *ItemFamilyDtoEnvelope
	isSet bool
}

func (v NullableItemFamilyDtoEnvelope) Get() *ItemFamilyDtoEnvelope {
	return v.value
}

func (v *NullableItemFamilyDtoEnvelope) Set(val *ItemFamilyDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemFamilyDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemFamilyDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemFamilyDtoEnvelope(val *ItemFamilyDtoEnvelope) *NullableItemFamilyDtoEnvelope {
	return &NullableItemFamilyDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemFamilyDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemFamilyDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
