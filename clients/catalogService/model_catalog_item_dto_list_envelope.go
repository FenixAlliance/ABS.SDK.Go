...
// checks if the CatalogItemDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogItemDtoListEnvelope{}

// CatalogItemDtoListEnvelope struct for CatalogItemDtoListEnvelope
type CatalogItemDtoListEnvelope struct {
	...
	Result []CatalogItemDto `json:"result,omitempty"`
}
...
func NewCatalogItemDtoListEnvelope() *CatalogItemDtoListEnvelope {
	this := CatalogItemDtoListEnvelope{}
	return &this
}
...
func (o *CatalogItemDtoListEnvelope) SetErrorMessageNil() {
...
func (o *CatalogItemDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *CatalogItemDtoListEnvelope) SetHttpStatusNil() {
...
func (o *CatalogItemDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CatalogItemDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []CatalogItemDto and assigns it to the Result field.
func (o *CatalogItemDtoListEnvelope) SetResult(v []CatalogItemDto) {
	o.Result = v
}

func (o CatalogItemDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CatalogItemDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogItemDtoListEnvelope struct {
	value *CatalogItemDtoListEnvelope
	isSet bool
}

func (v NullableCatalogItemDtoListEnvelope) Get() *CatalogItemDtoListEnvelope {
	return v.value
}

func (v *NullableCatalogItemDtoListEnvelope) Set(val *CatalogItemDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogItemDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogItemDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogItemDtoListEnvelope(val *CatalogItemDtoListEnvelope) *NullableCatalogItemDtoListEnvelope {
	return &NullableCatalogItemDtoListEnvelope{value: val, isSet: true}
}

func (v NullableCatalogItemDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogItemDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
