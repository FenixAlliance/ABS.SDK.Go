...
// checks if the PricingRuleDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PricingRuleDtoListEnvelope{}

// PricingRuleDtoListEnvelope struct for PricingRuleDtoListEnvelope
type PricingRuleDtoListEnvelope struct {
...
func NewPricingRuleDtoListEnvelope() *PricingRuleDtoListEnvelope {
	this := PricingRuleDtoListEnvelope{}
	return &this
}
...
func (o *PricingRuleDtoListEnvelope) SetErrorMessageNil() {
...
func (o *PricingRuleDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *PricingRuleDtoListEnvelope) SetHttpStatusNil() {
...
func (o *PricingRuleDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PricingRuleDtoListEnvelope) SetActivityIdNil() {
...
func (o PricingRuleDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PricingRuleDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePricingRuleDtoListEnvelope struct {
	value *PricingRuleDtoListEnvelope
	isSet bool
}

func (v NullablePricingRuleDtoListEnvelope) Get() *PricingRuleDtoListEnvelope {
	return v.value
}

func (v *NullablePricingRuleDtoListEnvelope) Set(val *PricingRuleDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePricingRuleDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePricingRuleDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePricingRuleDtoListEnvelope(val *PricingRuleDtoListEnvelope) *NullablePricingRuleDtoListEnvelope {
	return &NullablePricingRuleDtoListEnvelope{value: val, isSet: true}
}

func (v NullablePricingRuleDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePricingRuleDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
