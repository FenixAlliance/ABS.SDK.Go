...
// checks if the ItemReviewDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemReviewDtoListEnvelope{}

// ItemReviewDtoListEnvelope struct for ItemReviewDtoListEnvelope
type ItemReviewDtoListEnvelope struct {
...
func NewItemReviewDtoListEnvelope() *ItemReviewDtoListEnvelope {
	this := ItemReviewDtoListEnvelope{}
	return &this
}
...
func (o *ItemReviewDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemReviewDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemReviewDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemReviewDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemReviewDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemReviewDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemReviewDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemReviewDtoListEnvelope struct {
	value *ItemReviewDtoListEnvelope
	isSet bool
}

func (v NullableItemReviewDtoListEnvelope) Get() *ItemReviewDtoListEnvelope {
	return v.value
}

func (v *NullableItemReviewDtoListEnvelope) Set(val *ItemReviewDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemReviewDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemReviewDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemReviewDtoListEnvelope(val *ItemReviewDtoListEnvelope) *NullableItemReviewDtoListEnvelope {
	return &NullableItemReviewDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemReviewDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemReviewDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
