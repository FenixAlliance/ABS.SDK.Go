...
// checks if the ItemTaxPolicyDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemTaxPolicyDtoEnvelope{}

// ItemTaxPolicyDtoEnvelope struct for ItemTaxPolicyDtoEnvelope
type ItemTaxPolicyDtoEnvelope struct {
...
func (o *ItemTaxPolicyDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemTaxPolicyDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemTaxPolicyDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemTaxPolicyDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemTaxPolicyDtoEnvelope) SetActivityIdNil() {
...
func (o ItemTaxPolicyDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemTaxPolicyDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemTaxPolicyDtoEnvelope struct {
	value *ItemTaxPolicyDtoEnvelope
	isSet bool
}

func (v NullableItemTaxPolicyDtoEnvelope) Get() *ItemTaxPolicyDtoEnvelope {
	return v.value
}

func (v *NullableItemTaxPolicyDtoEnvelope) Set(val *ItemTaxPolicyDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemTaxPolicyDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemTaxPolicyDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemTaxPolicyDtoEnvelope(val *ItemTaxPolicyDtoEnvelope) *NullableItemTaxPolicyDtoEnvelope {
	return &NullableItemTaxPolicyDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemTaxPolicyDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemTaxPolicyDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
