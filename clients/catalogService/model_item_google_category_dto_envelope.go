...
// checks if the ItemGoogleCategoryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemGoogleCategoryDtoEnvelope{}

// ItemGoogleCategoryDtoEnvelope struct for ItemGoogleCategoryDtoEnvelope
type ItemGoogleCategoryDtoEnvelope struct {
...
func NewItemGoogleCategoryDtoEnvelope() *ItemGoogleCategoryDtoEnvelope {
	this := ItemGoogleCategoryDtoEnvelope{}
	return &this
}
...
func (o *ItemGoogleCategoryDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemGoogleCategoryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemGoogleCategoryDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemGoogleCategoryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemGoogleCategoryDtoEnvelope) SetActivityIdNil() {
...
func (o ItemGoogleCategoryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemGoogleCategoryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemGoogleCategoryDtoEnvelope struct {
	value *ItemGoogleCategoryDtoEnvelope
	isSet bool
}

func (v NullableItemGoogleCategoryDtoEnvelope) Get() *ItemGoogleCategoryDtoEnvelope {
	return v.value
}

func (v *NullableItemGoogleCategoryDtoEnvelope) Set(val *ItemGoogleCategoryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemGoogleCategoryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemGoogleCategoryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemGoogleCategoryDtoEnvelope(val *ItemGoogleCategoryDtoEnvelope) *NullableItemGoogleCategoryDtoEnvelope {
	return &NullableItemGoogleCategoryDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemGoogleCategoryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemGoogleCategoryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
