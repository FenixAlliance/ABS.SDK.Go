...
// checks if the ItemBrandDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemBrandDtoListEnvelope{}

// ItemBrandDtoListEnvelope struct for ItemBrandDtoListEnvelope
type ItemBrandDtoListEnvelope struct {
...
func (o *ItemBrandDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemBrandDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemBrandDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemBrandDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemBrandDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemBrandDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemBrandDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemBrandDtoListEnvelope struct {
	value *ItemBrandDtoListEnvelope
	isSet bool
}

func (v NullableItemBrandDtoListEnvelope) Get() *ItemBrandDtoListEnvelope {
	return v.value
}

func (v *NullableItemBrandDtoListEnvelope) Set(val *ItemBrandDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemBrandDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemBrandDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemBrandDtoListEnvelope(val *ItemBrandDtoListEnvelope) *NullableItemBrandDtoListEnvelope {
	return &NullableItemBrandDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemBrandDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemBrandDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
