...
// checks if the ItemAttributeCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemAttributeCreateDto{}

// ItemAttributeCreateDto struct for ItemAttributeCreateDto
type ItemAttributeCreateDto struct {
...
func (o *ItemAttributeCreateDto) SetDescriptionNil() {
...
func (o ItemAttributeCreateDto) ToMap() (map[string]interface{}, error) {
...
func (o *ItemAttributeCreateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varItemAttributeCreateDto := _ItemAttributeCreateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varItemAttributeCreateDto)

	if err != nil {
		return err
	}

	*o = ItemAttributeCreateDto(varItemAttributeCreateDto)

	return err
}

type NullableItemAttributeCreateDto struct {
	value *ItemAttributeCreateDto
	isSet bool
}

func (v NullableItemAttributeCreateDto) Get() *ItemAttributeCreateDto {
	return v.value
}

func (v *NullableItemAttributeCreateDto) Set(val *ItemAttributeCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableItemAttributeCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableItemAttributeCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemAttributeCreateDto(val *ItemAttributeCreateDto) *NullableItemAttributeCreateDto {
	return &NullableItemAttributeCreateDto{value: val, isSet: true}
}

func (v NullableItemAttributeCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemAttributeCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
