...
// checks if the ItemWarrantyPolicyDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemWarrantyPolicyDtoListEnvelope{}

// ItemWarrantyPolicyDtoListEnvelope struct for ItemWarrantyPolicyDtoListEnvelope
type ItemWarrantyPolicyDtoListEnvelope struct {
...
func NewItemWarrantyPolicyDtoListEnvelope() *ItemWarrantyPolicyDtoListEnvelope {
	this := ItemWarrantyPolicyDtoListEnvelope{}
	return &this
}
...
func (o *ItemWarrantyPolicyDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemWarrantyPolicyDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemWarrantyPolicyDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemWarrantyPolicyDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemWarrantyPolicyDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemWarrantyPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemWarrantyPolicyDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemWarrantyPolicyDtoListEnvelope struct {
	value *ItemWarrantyPolicyDtoListEnvelope
	isSet bool
}

func (v NullableItemWarrantyPolicyDtoListEnvelope) Get() *ItemWarrantyPolicyDtoListEnvelope {
	return v.value
}

func (v *NullableItemWarrantyPolicyDtoListEnvelope) Set(val *ItemWarrantyPolicyDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemWarrantyPolicyDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemWarrantyPolicyDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemWarrantyPolicyDtoListEnvelope(val *ItemWarrantyPolicyDtoListEnvelope) *NullableItemWarrantyPolicyDtoListEnvelope {
	return &NullableItemWarrantyPolicyDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemWarrantyPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemWarrantyPolicyDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
