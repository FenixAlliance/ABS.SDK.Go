...
// checks if the ItemImageDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemImageDtoListEnvelope{}

// ItemImageDtoListEnvelope struct for ItemImageDtoListEnvelope
type ItemImageDtoListEnvelope struct {
...
func (o *ItemImageDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemImageDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemImageDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemImageDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemImageDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemImageDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemImageDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemImageDtoListEnvelope struct {
	value *ItemImageDtoListEnvelope
	isSet bool
}

func (v NullableItemImageDtoListEnvelope) Get() *ItemImageDtoListEnvelope {
	return v.value
}

func (v *NullableItemImageDtoListEnvelope) Set(val *ItemImageDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemImageDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemImageDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemImageDtoListEnvelope(val *ItemImageDtoListEnvelope) *NullableItemImageDtoListEnvelope {
	return &NullableItemImageDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemImageDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemImageDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
