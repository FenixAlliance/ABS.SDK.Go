...
// checks if the ItemAttachmentDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemAttachmentDtoEnvelope{}

// ItemAttachmentDtoEnvelope struct for ItemAttachmentDtoEnvelope
type ItemAttachmentDtoEnvelope struct {
...
func NewItemAttachmentDtoEnvelope() *ItemAttachmentDtoEnvelope {
	this := ItemAttachmentDtoEnvelope{}
	return &this
}
...
func (o *ItemAttachmentDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemAttachmentDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemAttachmentDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemAttachmentDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemAttachmentDtoEnvelope) SetActivityIdNil() {
...
func (o ItemAttachmentDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemAttachmentDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemAttachmentDtoEnvelope struct {
	value *ItemAttachmentDtoEnvelope
	isSet bool
}

func (v NullableItemAttachmentDtoEnvelope) Get() *ItemAttachmentDtoEnvelope {
	return v.value
}

func (v *NullableItemAttachmentDtoEnvelope) Set(val *ItemAttachmentDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemAttachmentDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemAttachmentDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemAttachmentDtoEnvelope(val *ItemAttachmentDtoEnvelope) *NullableItemAttachmentDtoEnvelope {
	return &NullableItemAttachmentDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemAttachmentDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemAttachmentDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
