...
// checks if the CatalogItemDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogItemDtoEnvelope{}

// CatalogItemDtoEnvelope struct for CatalogItemDtoEnvelope
type CatalogItemDtoEnvelope struct {
...
func (o *CatalogItemDtoEnvelope) SetErrorMessageNil() {
...
func (o *CatalogItemDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CatalogItemDtoEnvelope) SetHttpStatusNil() {
...
func (o *CatalogItemDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CatalogItemDtoEnvelope) SetActivityIdNil() {
...
func (o CatalogItemDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CatalogItemDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogItemDtoEnvelope struct {
	value *CatalogItemDtoEnvelope
	isSet bool
}

func (v NullableCatalogItemDtoEnvelope) Get() *CatalogItemDtoEnvelope {
	return v.value
}

func (v *NullableCatalogItemDtoEnvelope) Set(val *CatalogItemDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogItemDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogItemDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogItemDtoEnvelope(val *CatalogItemDtoEnvelope) *NullableCatalogItemDtoEnvelope {
	return &NullableCatalogItemDtoEnvelope{value: val, isSet: true}
}

func (v NullableCatalogItemDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogItemDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
