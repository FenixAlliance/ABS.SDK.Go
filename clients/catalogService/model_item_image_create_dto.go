...
// checks if the ItemImageCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemImageCreateDto{}

// ItemImageCreateDto struct for ItemImageCreateDto
...
func (o *ItemImageCreateDto) SetItemIDNil() {
	o.ItemID.Set(nil)
}
...
func (o *ItemImageCreateDto) SetMD5HashNil() {
	o.MD5Hash.Set(nil)
}
...
func (o *ItemImageCreateDto) SetMetadataNil() {
	o.Metadata.Set(nil)
}
...
func (o *ItemImageCreateDto) SetFileUploadURLNil() {
...
func (o *ItemImageCreateDto) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *ItemImageCreateDto) SetAbstractNil() {
	o.Abstract.Set(nil)
}
...
func (o *ItemImageCreateDto) SetAuthorNil() {
	o.Author.Set(nil)
}
...
func (o *ItemImageCreateDto) SetKeyWordsNil() {
	o.KeyWords.Set(nil)
}
...
func (o *ItemImageCreateDto) SetNotesNil() {
	o.Notes.Set(nil)
}
...
func (o *ItemImageCreateDto) SetContentTypeNil() {
...
func (o *ItemImageCreateDto) SetSocialProfileIDNil() {
...
func (o *ItemImageCreateDto) SetParentFileUploadIDNil() {
...
func (o ItemImageCreateDto) ToMap() (map[string]interface{}, error) {
...
func (o *ItemImageCreateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varItemImageCreateDto := _ItemImageCreateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varItemImageCreateDto)

	if err != nil {
		return err
	}

	*o = ItemImageCreateDto(varItemImageCreateDto)

	return err
}

type NullableItemImageCreateDto struct {
	value *ItemImageCreateDto
	isSet bool
}

func (v NullableItemImageCreateDto) Get() *ItemImageCreateDto {
	return v.value
}

func (v *NullableItemImageCreateDto) Set(val *ItemImageCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableItemImageCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableItemImageCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemImageCreateDto(val *ItemImageCreateDto) *NullableItemImageCreateDto {
	return &NullableItemImageCreateDto{value: val, isSet: true}
}

func (v NullableItemImageCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemImageCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
