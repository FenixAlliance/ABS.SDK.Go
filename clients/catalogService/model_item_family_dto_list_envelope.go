...
// checks if the ItemFamilyDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemFamilyDtoListEnvelope{}

// ItemFamilyDtoListEnvelope struct for ItemFamilyDtoListEnvelope
type ItemFamilyDtoListEnvelope struct {
	...
	Result []ItemFamilyDto `json:"result,omitempty"`
}
...
func NewItemFamilyDtoListEnvelope() *ItemFamilyDtoListEnvelope {
	this := ItemFamilyDtoListEnvelope{}
	return &this
}
...
func (o *ItemFamilyDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemFamilyDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemFamilyDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemFamilyDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemFamilyDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ItemFamilyDto and assigns it to the Result field.
func (o *ItemFamilyDtoListEnvelope) SetResult(v []ItemFamilyDto) {
	o.Result = v
}

func (o ItemFamilyDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemFamilyDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemFamilyDtoListEnvelope struct {
	value *ItemFamilyDtoListEnvelope
	isSet bool
}

func (v NullableItemFamilyDtoListEnvelope) Get() *ItemFamilyDtoListEnvelope {
	return v.value
}

func (v *NullableItemFamilyDtoListEnvelope) Set(val *ItemFamilyDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemFamilyDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemFamilyDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemFamilyDtoListEnvelope(val *ItemFamilyDtoListEnvelope) *NullableItemFamilyDtoListEnvelope {
	return &NullableItemFamilyDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemFamilyDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemFamilyDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
