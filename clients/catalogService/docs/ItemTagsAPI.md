...
func main() {
	...
	itemTagCreateDto := *openapiclient.NewItemTagCreateDto("Title_example") // ItemTagCreateDto |  (optional)
...
> ItemTagDtoEnvelope GetItemTagByIdAsync(ctx, itemTagId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ItemTagsAPI.GetItemTagByIdAsync(context.Background(), itemTagId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
	if err != nil {
...
> ItemTagDtoListEnvelope GetItemTagsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemTagDtoCollectionQueryParameters(itemTagDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ItemTagsAPI.GetItemTagsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemTagDtoCollectionQueryParameters(itemTagDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> PatchItemTagAsync(ctx, itemTagId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ItemTagsAPI.PatchItemTagAsync(context.Background(), itemTagId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ItemTagsAPI.PatchItemTagAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiPatchItemTagAsyncRequest struct via the builder pattern
