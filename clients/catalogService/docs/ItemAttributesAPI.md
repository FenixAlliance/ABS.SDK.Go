...
> Int32Envelope CountItemAttributesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemAttributeDtoCollectionQueryParameters(itemAttributeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	itemAttributeDtoCollectionQueryParameters := *openapiclient.NewItemAttributeDtoCollectionQueryParameters() // ItemAttributeDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ItemAttributesAPI.CountItemAttributesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemAttributeDtoCollectionQueryParameters(itemAttributeDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **itemAttributeDtoCollectionQueryParameters** | [**ItemAttributeDtoCollectionQueryParameters**](ItemAttributeDtoCollectionQueryParameters.md) |  | 
...
> ItemAttributeDtoListEnvelope GetItemAttributesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemAttributeDtoCollectionQueryParameters(itemAttributeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ItemAttributesAPI.GetItemAttributesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemAttributeDtoCollectionQueryParameters(itemAttributeDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> PatchItemAttributeAsync(ctx, itemAttributeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ItemAttributesAPI.PatchItemAttributeAsync(context.Background(), itemAttributeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ItemAttributesAPI.PatchItemAttributeAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiPatchItemAttributeAsyncRequest struct via the builder pattern
