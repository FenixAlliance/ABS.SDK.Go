...
> Int32Envelope CountItemTypesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemTypeDtoCollectionQueryParameters(itemTypeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	resp, r, err := apiClient.ItemTypesAPI.CountItemTypesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemTypeDtoCollectionQueryParameters(itemTypeDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> ItemTypeDtoEnvelope GetItemTypeByIdAsync(ctx, itemTypeID).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ItemTypesAPI.GetItemTypeByIdAsync(context.Background(), itemTypeID).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).Execute()
	if err != nil {
...
> ItemTypeDtoListEnvelope GetItemTypesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemTypeDtoCollectionQueryParameters(itemTypeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ItemTypesAPI.GetItemTypesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ItemTypeDtoCollectionQueryParameters(itemTypeDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> PatchItemTypeAsync(ctx, itemTypeID).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.ItemTypesAPI.PatchItemTypeAsync(context.Background(), itemTypeID).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
