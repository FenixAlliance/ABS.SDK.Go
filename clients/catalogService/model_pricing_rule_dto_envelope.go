...
// checks if the PricingRuleDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PricingRuleDtoEnvelope{}

// PricingRuleDtoEnvelope struct for PricingRuleDtoEnvelope
type PricingRuleDtoEnvelope struct {
	...
	Result *PricingRuleDto `json:"result,omitempty"`
}
...
func (o *PricingRuleDtoEnvelope) SetErrorMessageNil() {
...
func (o *PricingRuleDtoEnvelope) SetCorrelationIdNil() {
...
func (o *PricingRuleDtoEnvelope) SetHttpStatusNil() {
...
func (o *PricingRuleDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PricingRuleDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given PricingRuleDto and assigns it to the Result field.
func (o *PricingRuleDtoEnvelope) SetResult(v PricingRuleDto) {
	o.Result = &v
}

func (o PricingRuleDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PricingRuleDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePricingRuleDtoEnvelope struct {
	value *PricingRuleDtoEnvelope
	isSet bool
}

func (v NullablePricingRuleDtoEnvelope) Get() *PricingRuleDtoEnvelope {
	return v.value
}

func (v *NullablePricingRuleDtoEnvelope) Set(val *PricingRuleDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePricingRuleDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePricingRuleDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePricingRuleDtoEnvelope(val *PricingRuleDtoEnvelope) *NullablePricingRuleDtoEnvelope {
	return &NullablePricingRuleDtoEnvelope{value: val, isSet: true}
}

func (v NullablePricingRuleDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePricingRuleDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
