...
// checks if the ItemAttributeOptionDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemAttributeOptionDtoListEnvelope{}

// ItemAttributeOptionDtoListEnvelope struct for ItemAttributeOptionDtoListEnvelope
type ItemAttributeOptionDtoListEnvelope struct {
...
func NewItemAttributeOptionDtoListEnvelope() *ItemAttributeOptionDtoListEnvelope {
	this := ItemAttributeOptionDtoListEnvelope{}
	return &this
}
...
func (o *ItemAttributeOptionDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemAttributeOptionDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemAttributeOptionDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemAttributeOptionDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemAttributeOptionDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemAttributeOptionDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemAttributeOptionDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemAttributeOptionDtoListEnvelope struct {
	value *ItemAttributeOptionDtoListEnvelope
	isSet bool
}

func (v NullableItemAttributeOptionDtoListEnvelope) Get() *ItemAttributeOptionDtoListEnvelope {
	return v.value
}

func (v *NullableItemAttributeOptionDtoListEnvelope) Set(val *ItemAttributeOptionDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemAttributeOptionDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemAttributeOptionDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemAttributeOptionDtoListEnvelope(val *ItemAttributeOptionDtoListEnvelope) *NullableItemAttributeOptionDtoListEnvelope {
	return &NullableItemAttributeOptionDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemAttributeOptionDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemAttributeOptionDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
