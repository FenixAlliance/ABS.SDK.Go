...
// checks if the ItemRefundPolicyDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemRefundPolicyDtoEnvelope{}

// ItemRefundPolicyDtoEnvelope struct for ItemRefundPolicyDtoEnvelope
type ItemRefundPolicyDtoEnvelope struct {
...
func NewItemRefundPolicyDtoEnvelope() *ItemRefundPolicyDtoEnvelope {
	this := ItemRefundPolicyDtoEnvelope{}
	return &this
}
...
func (o *ItemRefundPolicyDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemRefundPolicyDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemRefundPolicyDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemRefundPolicyDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemRefundPolicyDtoEnvelope) SetActivityIdNil() {
...
func (o ItemRefundPolicyDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemRefundPolicyDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemRefundPolicyDtoEnvelope struct {
	value *ItemRefundPolicyDtoEnvelope
	isSet bool
}

func (v NullableItemRefundPolicyDtoEnvelope) Get() *ItemRefundPolicyDtoEnvelope {
	return v.value
}

func (v *NullableItemRefundPolicyDtoEnvelope) Set(val *ItemRefundPolicyDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemRefundPolicyDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemRefundPolicyDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemRefundPolicyDtoEnvelope(val *ItemRefundPolicyDtoEnvelope) *NullableItemRefundPolicyDtoEnvelope {
	return &NullableItemRefundPolicyDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemRefundPolicyDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemRefundPolicyDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
