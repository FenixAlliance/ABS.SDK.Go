...
// checks if the ItemGoogleCategoryDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemGoogleCategoryDtoListEnvelope{}

// ItemGoogleCategoryDtoListEnvelope struct for ItemGoogleCategoryDtoListEnvelope
type ItemGoogleCategoryDtoListEnvelope struct {
	...
	Result []ItemGoogleCategoryDto `json:"result,omitempty"`
}
...
func NewItemGoogleCategoryDtoListEnvelope() *ItemGoogleCategoryDtoListEnvelope {
	this := ItemGoogleCategoryDtoListEnvelope{}
	return &this
}
...
func (o *ItemGoogleCategoryDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemGoogleCategoryDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemGoogleCategoryDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemGoogleCategoryDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemGoogleCategoryDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ItemGoogleCategoryDto and assigns it to the Result field.
func (o *ItemGoogleCategoryDtoListEnvelope) SetResult(v []ItemGoogleCategoryDto) {
	o.Result = v
}

func (o ItemGoogleCategoryDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemGoogleCategoryDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemGoogleCategoryDtoListEnvelope struct {
	value *ItemGoogleCategoryDtoListEnvelope
	isSet bool
}

func (v NullableItemGoogleCategoryDtoListEnvelope) Get() *ItemGoogleCategoryDtoListEnvelope {
	return v.value
}

func (v *NullableItemGoogleCategoryDtoListEnvelope) Set(val *ItemGoogleCategoryDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemGoogleCategoryDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemGoogleCategoryDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemGoogleCategoryDtoListEnvelope(val *ItemGoogleCategoryDtoListEnvelope) *NullableItemGoogleCategoryDtoListEnvelope {
	return &NullableItemGoogleCategoryDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemGoogleCategoryDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemGoogleCategoryDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
