...
// checks if the ItemBundleDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemBundleDtoListEnvelope{}

// ItemBundleDtoListEnvelope struct for ItemBundleDtoListEnvelope
type ItemBundleDtoListEnvelope struct {
...
func NewItemBundleDtoListEnvelope() *ItemBundleDtoListEnvelope {
	this := ItemBundleDtoListEnvelope{}
	return &this
}
...
func (o *ItemBundleDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemBundleDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemBundleDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemBundleDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemBundleDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemBundleDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemBundleDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemBundleDtoListEnvelope struct {
	value *ItemBundleDtoListEnvelope
	isSet bool
}

func (v NullableItemBundleDtoListEnvelope) Get() *ItemBundleDtoListEnvelope {
	return v.value
}

func (v *NullableItemBundleDtoListEnvelope) Set(val *ItemBundleDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemBundleDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemBundleDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemBundleDtoListEnvelope(val *ItemBundleDtoListEnvelope) *NullableItemBundleDtoListEnvelope {
	return &NullableItemBundleDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemBundleDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemBundleDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
