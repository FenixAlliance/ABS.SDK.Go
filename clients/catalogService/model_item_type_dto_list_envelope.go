...
// checks if the ItemTypeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemTypeDtoListEnvelope{}

// ItemTypeDtoListEnvelope struct for ItemTypeDtoListEnvelope
type ItemTypeDtoListEnvelope struct {
	...
	Result []ItemTypeDto `json:"result,omitempty"`
}
...
func (o *ItemTypeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemTypeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemTypeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemTypeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemTypeDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ItemTypeDto and assigns it to the Result field.
func (o *ItemTypeDtoListEnvelope) SetResult(v []ItemTypeDto) {
	o.Result = v
}

func (o ItemTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemTypeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemTypeDtoListEnvelope struct {
	value *ItemTypeDtoListEnvelope
	isSet bool
}

func (v NullableItemTypeDtoListEnvelope) Get() *ItemTypeDtoListEnvelope {
	return v.value
}

func (v *NullableItemTypeDtoListEnvelope) Set(val *ItemTypeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemTypeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemTypeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemTypeDtoListEnvelope(val *ItemTypeDtoListEnvelope) *NullableItemTypeDtoListEnvelope {
	return &NullableItemTypeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemTypeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
