...
// checks if the ItemAttributeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemAttributeDtoListEnvelope{}

// ItemAttributeDtoListEnvelope struct for ItemAttributeDtoListEnvelope
type ItemAttributeDtoListEnvelope struct {
...
func NewItemAttributeDtoListEnvelope() *ItemAttributeDtoListEnvelope {
	this := ItemAttributeDtoListEnvelope{}
	return &this
}
...
func (o *ItemAttributeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemAttributeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemAttributeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemAttributeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemAttributeDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemAttributeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemAttributeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemAttributeDtoListEnvelope struct {
	value *ItemAttributeDtoListEnvelope
	isSet bool
}

func (v NullableItemAttributeDtoListEnvelope) Get() *ItemAttributeDtoListEnvelope {
	return v.value
}

func (v *NullableItemAttributeDtoListEnvelope) Set(val *ItemAttributeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemAttributeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemAttributeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemAttributeDtoListEnvelope(val *ItemAttributeDtoListEnvelope) *NullableItemAttributeDtoListEnvelope {
	return &NullableItemAttributeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemAttributeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemAttributeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
