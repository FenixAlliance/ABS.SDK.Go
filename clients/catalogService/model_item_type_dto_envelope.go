...
// checks if the ItemTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemTypeDtoEnvelope{}

// ItemTypeDtoEnvelope struct for ItemTypeDtoEnvelope
type ItemTypeDtoEnvelope struct {
...
func (o *ItemTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemTypeDtoEnvelope) SetActivityIdNil() {
...
func (o ItemTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemTypeDtoEnvelope struct {
	value *ItemTypeDtoEnvelope
	isSet bool
}

func (v NullableItemTypeDtoEnvelope) Get() *ItemTypeDtoEnvelope {
	return v.value
}

func (v *NullableItemTypeDtoEnvelope) Set(val *ItemTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemTypeDtoEnvelope(val *ItemTypeDtoEnvelope) *NullableItemTypeDtoEnvelope {
	return &NullableItemTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
