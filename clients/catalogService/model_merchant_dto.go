...
// checks if the MerchantDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantDto{}

// MerchantDto struct for MerchantDto
type MerchantDto struct {
	...
	MerchantRating NullableFloat64 `json:"merchantRating,omitempty"`
}
...
func (o *MerchantDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *MerchantDto) SetQualifiedNameNil() {
...
func (o *MerchantDto) SetTaxIdNil() {
	o.TaxId.Set(nil)
}
...
func (o *MerchantDto) SetAboutNil() {
	o.About.Set(nil)
}
...
func (o *MerchantDto) SetWalletIdNil() {
	o.WalletId.Set(nil)
}
...
func (o *MerchantDto) SetSocialFeedIdNil() {
...
func (o *MerchantDto) SetBusinessIndustryIdNil() {
...
func (o *MerchantDto) SetBusinessSegmentIdNil() {
...
func (o *MerchantDto) SetSocialProfileIdNil() {
...
func (o *MerchantDto) SetLanguageIdNil() {
...
func (o *MerchantDto) SetSloganNil() {
	o.Slogan.Set(nil)
}
...
func (o *MerchantDto) SetLegalNameNil() {
	o.LegalName.Set(nil)
}
...
func (o *MerchantDto) SetCoverUrlNil() {
	o.CoverUrl.Set(nil)
}
...
func (o *MerchantDto) SetAvatarUrlNil() {
	o.AvatarUrl.Set(nil)
}
...
func (o *MerchantDto) SetCartIdNil() {
	o.CartId.Set(nil)
}
...
func (o *MerchantDto) SetCurrencyIdNil() {
...
func (o *MerchantDto) SetTimezoneIdNil() {
...
func (o *MerchantDto) SetCountryIdNil() {
	o.CountryId.Set(nil)
}
...
func (o *MerchantDto) SetStateIdNil() {
	o.StateId.Set(nil)
}
...
func (o *MerchantDto) SetCityIdNil() {
	o.CityId.Set(nil)
}
...
func (o *MerchantDto) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *MerchantDto) SetPhoneNil() {
	o.Phone.Set(nil)
}
...
func (o *MerchantDto) SetWebUrlNil() {
	o.WebUrl.Set(nil)
}
...
func (o *MerchantDto) SetFacebookUrlNil() {
...
func (o *MerchantDto) SetTwitterUrlNil() {
...
func (o *MerchantDto) SetGitHubUrlNil() {
	o.GitHubUrl.Set(nil)
}
...
func (o *MerchantDto) SetLinkedInUrlNil() {
...
func (o *MerchantDto) SetInstagramUrlNil() {
...
func (o *MerchantDto) SetYouTubeUrlNil() {
...
func (o *MerchantDto) SetWhatsAppNumberNil() {
...
func (o *MerchantDto) SetSupportPhoneNumberNil() {
...
func (o *MerchantDto) SetBusinessNameNil() {
...
func (o *MerchantDto) SetBusinessLegalNameNil() {
...
func (o *MerchantDto) SetTwitterUsernameNil() {
...
// GetMerchantRating returns the MerchantRating field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *MerchantDto) GetMerchantRating() float64 {
	if o == nil || IsNil(o.MerchantRating.Get()) {
		var ret float64
		return ret
	}
	return *o.MerchantRating.Get()
}

// GetMerchantRatingOk returns a tuple with the MerchantRating field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetMerchantRating gets a reference to the given NullableFloat64 and assigns it to the MerchantRating field.
func (o *MerchantDto) SetMerchantRating(v float64) {
	o.MerchantRating.Set(&v)
}
// SetMerchantRatingNil sets the value for MerchantRating to be an explicit nil
func (o *MerchantDto) SetMerchantRatingNil() {
	o.MerchantRating.Set(nil)
}
...
func (o *MerchantDto) UnsetMerchantRating() {
	o.MerchantRating.Unset()
}

func (o MerchantDto) MarshalJSON() ([]byte, error) {
...
func (o MerchantDto) ToMap() (map[string]interface{}, error) {
	...
	if o.MerchantRating.IsSet() {
		toSerialize["merchantRating"] = o.MerchantRating.Get()
	}
	return toSerialize, nil
}

type NullableMerchantDto struct {
	value *MerchantDto
	isSet bool
}

func (v NullableMerchantDto) Get() *MerchantDto {
	return v.value
}

func (v *NullableMerchantDto) Set(val *MerchantDto) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantDto) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantDto(val *MerchantDto) *NullableMerchantDto {
	return &NullableMerchantDto{value: val, isSet: true}
}

func (v NullableMerchantDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
