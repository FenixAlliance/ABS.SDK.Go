...
// checks if the ShippingRegionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingRegionDtoEnvelope{}

// ShippingRegionDtoEnvelope struct for ShippingRegionDtoEnvelope
type ShippingRegionDtoEnvelope struct {
...
func NewShippingRegionDtoEnvelope() *ShippingRegionDtoEnvelope {
	this := ShippingRegionDtoEnvelope{}
	return &this
}
...
func (o *ShippingRegionDtoEnvelope) SetErrorMessageNil() {
...
func (o *ShippingRegionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ShippingRegionDtoEnvelope) SetHttpStatusNil() {
...
func (o *ShippingRegionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShippingRegionDtoEnvelope) SetActivityIdNil() {
...
func (o ShippingRegionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShippingRegionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShippingRegionDtoEnvelope struct {
	value *ShippingRegionDtoEnvelope
	isSet bool
}

func (v NullableShippingRegionDtoEnvelope) Get() *ShippingRegionDtoEnvelope {
	return v.value
}

func (v *NullableShippingRegionDtoEnvelope) Set(val *ShippingRegionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingRegionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingRegionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingRegionDtoEnvelope(val *ShippingRegionDtoEnvelope) *NullableShippingRegionDtoEnvelope {
	return &NullableShippingRegionDtoEnvelope{value: val, isSet: true}
}

func (v NullableShippingRegionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingRegionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
