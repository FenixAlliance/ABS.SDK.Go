...
// checks if the BillOfLadingDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillOfLadingDtoEnvelope{}

// BillOfLadingDtoEnvelope struct for BillOfLadingDtoEnvelope
type BillOfLadingDtoEnvelope struct {
...
func (o *BillOfLadingDtoEnvelope) SetErrorMessageNil() {
...
func (o *BillOfLadingDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BillOfLadingDtoEnvelope) SetHttpStatusNil() {
...
func (o *BillOfLadingDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BillOfLadingDtoEnvelope) SetActivityIdNil() {
...
func (o BillOfLadingDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BillOfLadingDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBillOfLadingDtoEnvelope struct {
	value *BillOfLadingDtoEnvelope
	isSet bool
}

func (v NullableBillOfLadingDtoEnvelope) Get() *BillOfLadingDtoEnvelope {
	return v.value
}

func (v *NullableBillOfLadingDtoEnvelope) Set(val *BillOfLadingDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBillOfLadingDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBillOfLadingDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillOfLadingDtoEnvelope(val *BillOfLadingDtoEnvelope) *NullableBillOfLadingDtoEnvelope {
	return &NullableBillOfLadingDtoEnvelope{value: val, isSet: true}
}

func (v NullableBillOfLadingDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillOfLadingDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
