...
// checks if the ItemShippingPolicyDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemShippingPolicyDtoEnvelope{}

// ItemShippingPolicyDtoEnvelope struct for ItemShippingPolicyDtoEnvelope
type ItemShippingPolicyDtoEnvelope struct {
...
func NewItemShippingPolicyDtoEnvelope() *ItemShippingPolicyDtoEnvelope {
	this := ItemShippingPolicyDtoEnvelope{}
	return &this
}
...
func (o *ItemShippingPolicyDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemShippingPolicyDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemShippingPolicyDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemShippingPolicyDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemShippingPolicyDtoEnvelope) SetActivityIdNil() {
...
func (o ItemShippingPolicyDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemShippingPolicyDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemShippingPolicyDtoEnvelope struct {
	value *ItemShippingPolicyDtoEnvelope
	isSet bool
}

func (v NullableItemShippingPolicyDtoEnvelope) Get() *ItemShippingPolicyDtoEnvelope {
	return v.value
}

func (v *NullableItemShippingPolicyDtoEnvelope) Set(val *ItemShippingPolicyDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemShippingPolicyDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemShippingPolicyDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemShippingPolicyDtoEnvelope(val *ItemShippingPolicyDtoEnvelope) *NullableItemShippingPolicyDtoEnvelope {
	return &NullableItemShippingPolicyDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemShippingPolicyDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemShippingPolicyDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
