...
// checks if the ItemShippingPolicyDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemShippingPolicyDtoListEnvelope{}

// ItemShippingPolicyDtoListEnvelope struct for ItemShippingPolicyDtoListEnvelope
type ItemShippingPolicyDtoListEnvelope struct {
	...
	Result []ItemShippingPolicyDto `json:"result,omitempty"`
}
...
func NewItemShippingPolicyDtoListEnvelope() *ItemShippingPolicyDtoListEnvelope {
	this := ItemShippingPolicyDtoListEnvelope{}
	return &this
}
...
func (o *ItemShippingPolicyDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemShippingPolicyDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemShippingPolicyDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemShippingPolicyDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemShippingPolicyDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ItemShippingPolicyDto and assigns it to the Result field.
func (o *ItemShippingPolicyDtoListEnvelope) SetResult(v []ItemShippingPolicyDto) {
	o.Result = v
}

func (o ItemShippingPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemShippingPolicyDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemShippingPolicyDtoListEnvelope struct {
	value *ItemShippingPolicyDtoListEnvelope
	isSet bool
}

func (v NullableItemShippingPolicyDtoListEnvelope) Get() *ItemShippingPolicyDtoListEnvelope {
	return v.value
}

func (v *NullableItemShippingPolicyDtoListEnvelope) Set(val *ItemShippingPolicyDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemShippingPolicyDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemShippingPolicyDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemShippingPolicyDtoListEnvelope(val *ItemShippingPolicyDtoListEnvelope) *NullableItemShippingPolicyDtoListEnvelope {
	return &NullableItemShippingPolicyDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemShippingPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemShippingPolicyDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
