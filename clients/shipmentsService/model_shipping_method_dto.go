...
// checks if the ShippingMethodDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingMethodDto{}

// ShippingMethodDto struct for ShippingMethodDto
...
func (o *ShippingMethodDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *ShippingMethodDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *ShippingMethodDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ShippingMethodDto) SetDescriptionNil() {
...
func (o *ShippingMethodDto) SetCurrencyIDNil() {
...
func (o *ShippingMethodDto) SetBusinessIDNil() {
...
func (o ShippingMethodDto) MarshalJSON() ([]byte, error) {
...
func (o ShippingMethodDto) ToMap() (map[string]interface{}, error) {
...
type NullableShippingMethodDto struct {
	value *ShippingMethodDto
	isSet bool
}

func (v NullableShippingMethodDto) Get() *ShippingMethodDto {
	return v.value
}

func (v *NullableShippingMethodDto) Set(val *ShippingMethodDto) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingMethodDto) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingMethodDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingMethodDto(val *ShippingMethodDto) *NullableShippingMethodDto {
	return &NullableShippingMethodDto{value: val, isSet: true}
}

func (v NullableShippingMethodDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingMethodDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
