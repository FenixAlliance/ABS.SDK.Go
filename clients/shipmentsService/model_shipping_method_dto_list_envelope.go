...
// checks if the ShippingMethodDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingMethodDtoListEnvelope{}

// ShippingMethodDtoListEnvelope struct for ShippingMethodDtoListEnvelope
type ShippingMethodDtoListEnvelope struct {
...
func NewShippingMethodDtoListEnvelope() *ShippingMethodDtoListEnvelope {
	this := ShippingMethodDtoListEnvelope{}
	return &this
}
...
func (o *ShippingMethodDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ShippingMethodDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ShippingMethodDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ShippingMethodDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShippingMethodDtoListEnvelope) SetActivityIdNil() {
...
func (o ShippingMethodDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShippingMethodDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShippingMethodDtoListEnvelope struct {
	value *ShippingMethodDtoListEnvelope
	isSet bool
}

func (v NullableShippingMethodDtoListEnvelope) Get() *ShippingMethodDtoListEnvelope {
	return v.value
}

func (v *NullableShippingMethodDtoListEnvelope) Set(val *ShippingMethodDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingMethodDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingMethodDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingMethodDtoListEnvelope(val *ShippingMethodDtoListEnvelope) *NullableShippingMethodDtoListEnvelope {
	return &NullableShippingMethodDtoListEnvelope{value: val, isSet: true}
}

func (v NullableShippingMethodDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingMethodDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
