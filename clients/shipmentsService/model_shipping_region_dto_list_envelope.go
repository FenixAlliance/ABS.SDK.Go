...
// checks if the ShippingRegionDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingRegionDtoListEnvelope{}

// ShippingRegionDtoListEnvelope struct for ShippingRegionDtoListEnvelope
type ShippingRegionDtoListEnvelope struct {
	...
	Result []ShippingRegionDto `json:"result,omitempty"`
}
...
func NewShippingRegionDtoListEnvelope() *ShippingRegionDtoListEnvelope {
	this := ShippingRegionDtoListEnvelope{}
	return &this
}
...
func (o *ShippingRegionDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ShippingRegionDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ShippingRegionDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ShippingRegionDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShippingRegionDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ShippingRegionDto and assigns it to the Result field.
func (o *ShippingRegionDtoListEnvelope) SetResult(v []ShippingRegionDto) {
	o.Result = v
}

func (o ShippingRegionDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShippingRegionDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShippingRegionDtoListEnvelope struct {
	value *ShippingRegionDtoListEnvelope
	isSet bool
}

func (v NullableShippingRegionDtoListEnvelope) Get() *ShippingRegionDtoListEnvelope {
	return v.value
}

func (v *NullableShippingRegionDtoListEnvelope) Set(val *ShippingRegionDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingRegionDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingRegionDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingRegionDtoListEnvelope(val *ShippingRegionDtoListEnvelope) *NullableShippingRegionDtoListEnvelope {
	return &NullableShippingRegionDtoListEnvelope{value: val, isSet: true}
}

func (v NullableShippingRegionDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingRegionDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
