...
// checks if the ShippingClassDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingClassDtoEnvelope{}

// ShippingClassDtoEnvelope struct for ShippingClassDtoEnvelope
type ShippingClassDtoEnvelope struct {
...
func (o *ShippingClassDtoEnvelope) SetErrorMessageNil() {
...
func (o *ShippingClassDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ShippingClassDtoEnvelope) SetHttpStatusNil() {
...
func (o *ShippingClassDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShippingClassDtoEnvelope) SetActivityIdNil() {
...
func (o ShippingClassDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShippingClassDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShippingClassDtoEnvelope struct {
	value *ShippingClassDtoEnvelope
	isSet bool
}

func (v NullableShippingClassDtoEnvelope) Get() *ShippingClassDtoEnvelope {
	return v.value
}

func (v *NullableShippingClassDtoEnvelope) Set(val *ShippingClassDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingClassDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingClassDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingClassDtoEnvelope(val *ShippingClassDtoEnvelope) *NullableShippingClassDtoEnvelope {
	return &NullableShippingClassDtoEnvelope{value: val, isSet: true}
}

func (v NullableShippingClassDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingClassDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
