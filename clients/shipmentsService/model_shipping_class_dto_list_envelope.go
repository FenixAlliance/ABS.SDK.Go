...
// checks if the ShippingClassDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingClassDtoListEnvelope{}

// ShippingClassDtoListEnvelope struct for ShippingClassDtoListEnvelope
type ShippingClassDtoListEnvelope struct {
	...
	Result []ShippingClassDto `json:"result,omitempty"`
}
...
func NewShippingClassDtoListEnvelope() *ShippingClassDtoListEnvelope {
	this := ShippingClassDtoListEnvelope{}
	return &this
}
...
func (o *ShippingClassDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ShippingClassDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ShippingClassDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ShippingClassDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShippingClassDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ShippingClassDto and assigns it to the Result field.
func (o *ShippingClassDtoListEnvelope) SetResult(v []ShippingClassDto) {
	o.Result = v
}

func (o ShippingClassDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShippingClassDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShippingClassDtoListEnvelope struct {
	value *ShippingClassDtoListEnvelope
	isSet bool
}

func (v NullableShippingClassDtoListEnvelope) Get() *ShippingClassDtoListEnvelope {
	return v.value
}

func (v *NullableShippingClassDtoListEnvelope) Set(val *ShippingClassDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingClassDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingClassDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingClassDtoListEnvelope(val *ShippingClassDtoListEnvelope) *NullableShippingClassDtoListEnvelope {
	return &NullableShippingClassDtoListEnvelope{value: val, isSet: true}
}

func (v NullableShippingClassDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingClassDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
