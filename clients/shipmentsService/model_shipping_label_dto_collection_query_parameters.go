...
// checks if the ShippingLabelDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingLabelDtoCollectionQueryParameters{}

// ShippingLabelDtoCollectionQueryParameters struct for ShippingLabelDtoCollectionQueryParameters
type ShippingLabelDtoCollectionQueryParameters struct {
...
func NewShippingLabelDtoCollectionQueryParameters() *ShippingLabelDtoCollectionQueryParameters {
	this := ShippingLabelDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ShippingLabelDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ShippingLabelDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ShippingLabelDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableShippingLabelDtoCollectionQueryParameters struct {
	value *ShippingLabelDtoCollectionQueryParameters
	isSet bool
}

func (v NullableShippingLabelDtoCollectionQueryParameters) Get() *ShippingLabelDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableShippingLabelDtoCollectionQueryParameters) Set(val *ShippingLabelDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingLabelDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingLabelDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingLabelDtoCollectionQueryParameters(val *ShippingLabelDtoCollectionQueryParameters) *NullableShippingLabelDtoCollectionQueryParameters {
	return &NullableShippingLabelDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableShippingLabelDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingLabelDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
