...
> ShippingClassDtoListEnvelope GetShippingClassesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ShippingClassDtoCollectionQueryParameters(shippingClassDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	shippingClassDtoCollectionQueryParameters := *openapiclient.NewShippingClassDtoCollectionQueryParameters() // ShippingClassDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ShippingClassesAPI.GetShippingClassesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ShippingClassDtoCollectionQueryParameters(shippingClassDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **shippingClassDtoCollectionQueryParameters** | [**ShippingClassDtoCollectionQueryParameters**](ShippingClassDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetShippingClassesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ShippingClassDtoCollectionQueryParameters(shippingClassDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ShippingClassesAPI.GetShippingClassesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ShippingClassDtoCollectionQueryParameters(shippingClassDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchShippingClassAsync(ctx, classId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ShippingClassesAPI.PatchShippingClassAsync(context.Background(), classId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
