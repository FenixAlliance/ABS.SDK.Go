...
// checks if the ShippingZoneDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShippingZoneDtoEnvelope{}

// ShippingZoneDtoEnvelope struct for ShippingZoneDtoEnvelope
type ShippingZoneDtoEnvelope struct {
...
func (o *ShippingZoneDtoEnvelope) SetErrorMessageNil() {
...
func (o *ShippingZoneDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ShippingZoneDtoEnvelope) SetHttpStatusNil() {
...
func (o *ShippingZoneDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShippingZoneDtoEnvelope) SetActivityIdNil() {
...
func (o ShippingZoneDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShippingZoneDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShippingZoneDtoEnvelope struct {
	value *ShippingZoneDtoEnvelope
	isSet bool
}

func (v NullableShippingZoneDtoEnvelope) Get() *ShippingZoneDtoEnvelope {
	return v.value
}

func (v *NullableShippingZoneDtoEnvelope) Set(val *ShippingZoneDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingZoneDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShippingZoneDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShippingZoneDtoEnvelope(val *ShippingZoneDtoEnvelope) *NullableShippingZoneDtoEnvelope {
	return &NullableShippingZoneDtoEnvelope{value: val, isSet: true}
}

func (v NullableShippingZoneDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShippingZoneDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
