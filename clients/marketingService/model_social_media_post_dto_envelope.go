...
// checks if the SocialMediaPostDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialMediaPostDtoEnvelope{}

// SocialMediaPostDtoEnvelope struct for SocialMediaPostDtoEnvelope
type SocialMediaPostDtoEnvelope struct {
...
func NewSocialMediaPostDtoEnvelope() *SocialMediaPostDtoEnvelope {
	this := SocialMediaPostDtoEnvelope{}
	return &this
}
...
func (o *SocialMediaPostDtoEnvelope) SetErrorMessageNil() {
...
func (o *SocialMediaPostDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SocialMediaPostDtoEnvelope) SetHttpStatusNil() {
...
func (o *SocialMediaPostDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialMediaPostDtoEnvelope) SetActivityIdNil() {
...
func (o SocialMediaPostDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialMediaPostDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialMediaPostDtoEnvelope struct {
	value *SocialMediaPostDtoEnvelope
	isSet bool
}

func (v NullableSocialMediaPostDtoEnvelope) Get() *SocialMediaPostDtoEnvelope {
	return v.value
}

func (v *NullableSocialMediaPostDtoEnvelope) Set(val *SocialMediaPostDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialMediaPostDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialMediaPostDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialMediaPostDtoEnvelope(val *SocialMediaPostDtoEnvelope) *NullableSocialMediaPostDtoEnvelope {
	return &NullableSocialMediaPostDtoEnvelope{value: val, isSet: true}
}

func (v NullableSocialMediaPostDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialMediaPostDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
