...
// checks if the EmailSignatureDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailSignatureDtoListEnvelope{}

// EmailSignatureDtoListEnvelope struct for EmailSignatureDtoListEnvelope
type EmailSignatureDtoListEnvelope struct {
	...
	Result []EmailSignatureDto `json:"result,omitempty"`
}
...
func NewEmailSignatureDtoListEnvelope() *EmailSignatureDtoListEnvelope {
	this := EmailSignatureDtoListEnvelope{}
	return &this
}
...
func (o *EmailSignatureDtoListEnvelope) SetErrorMessageNil() {
...
func (o *EmailSignatureDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *EmailSignatureDtoListEnvelope) SetHttpStatusNil() {
...
func (o *EmailSignatureDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *EmailSignatureDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []EmailSignatureDto and assigns it to the Result field.
func (o *EmailSignatureDtoListEnvelope) SetResult(v []EmailSignatureDto) {
	o.Result = v
}

func (o EmailSignatureDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o EmailSignatureDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableEmailSignatureDtoListEnvelope struct {
	value *EmailSignatureDtoListEnvelope
	isSet bool
}

func (v NullableEmailSignatureDtoListEnvelope) Get() *EmailSignatureDtoListEnvelope {
	return v.value
}

func (v *NullableEmailSignatureDtoListEnvelope) Set(val *EmailSignatureDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailSignatureDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailSignatureDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailSignatureDtoListEnvelope(val *EmailSignatureDtoListEnvelope) *NullableEmailSignatureDtoListEnvelope {
	return &NullableEmailSignatureDtoListEnvelope{value: val, isSet: true}
}

func (v NullableEmailSignatureDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailSignatureDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
