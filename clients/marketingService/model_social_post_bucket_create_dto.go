...
// checks if the SocialPostBucketCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialPostBucketCreateDto{}

// SocialPostBucketCreateDto struct for SocialPostBucketCreateDto
type SocialPostBucketCreateDto struct {
...
func NewSocialPostBucketCreateDto() *SocialPostBucketCreateDto {
	this := SocialPostBucketCreateDto{}
	return &this
}
...
func (o *SocialPostBucketCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *SocialPostBucketCreateDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *SocialPostBucketCreateDto) SetEnrollmentIdNil() {
...
func (o SocialPostBucketCreateDto) MarshalJSON() ([]byte, error) {
...
func (o SocialPostBucketCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableSocialPostBucketCreateDto struct {
	value *SocialPostBucketCreateDto
	isSet bool
}

func (v NullableSocialPostBucketCreateDto) Get() *SocialPostBucketCreateDto {
	return v.value
}

func (v *NullableSocialPostBucketCreateDto) Set(val *SocialPostBucketCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialPostBucketCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialPostBucketCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialPostBucketCreateDto(val *SocialPostBucketCreateDto) *NullableSocialPostBucketCreateDto {
	return &NullableSocialPostBucketCreateDto{value: val, isSet: true}
}

func (v NullableSocialPostBucketCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialPostBucketCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
