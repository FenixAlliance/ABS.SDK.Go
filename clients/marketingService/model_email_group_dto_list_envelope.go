...
// checks if the EmailGroupDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailGroupDtoListEnvelope{}

// EmailGroupDtoListEnvelope struct for EmailGroupDtoListEnvelope
type EmailGroupDtoListEnvelope struct {
...
func NewEmailGroupDtoListEnvelope() *EmailGroupDtoListEnvelope {
	this := EmailGroupDtoListEnvelope{}
	return &this
}
...
func (o *EmailGroupDtoListEnvelope) SetErrorMessageNil() {
...
func (o *EmailGroupDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *EmailGroupDtoListEnvelope) SetHttpStatusNil() {
...
func (o *EmailGroupDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *EmailGroupDtoListEnvelope) SetActivityIdNil() {
...
func (o EmailGroupDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o EmailGroupDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableEmailGroupDtoListEnvelope struct {
	value *EmailGroupDtoListEnvelope
	isSet bool
}

func (v NullableEmailGroupDtoListEnvelope) Get() *EmailGroupDtoListEnvelope {
	return v.value
}

func (v *NullableEmailGroupDtoListEnvelope) Set(val *EmailGroupDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailGroupDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailGroupDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailGroupDtoListEnvelope(val *EmailGroupDtoListEnvelope) *NullableEmailGroupDtoListEnvelope {
	return &NullableEmailGroupDtoListEnvelope{value: val, isSet: true}
}

func (v NullableEmailGroupDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailGroupDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
