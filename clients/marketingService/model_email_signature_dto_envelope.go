...
// checks if the EmailSignatureDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailSignatureDtoEnvelope{}

// EmailSignatureDtoEnvelope struct for EmailSignatureDtoEnvelope
type EmailSignatureDtoEnvelope struct {
...
func NewEmailSignatureDtoEnvelope() *EmailSignatureDtoEnvelope {
	this := EmailSignatureDtoEnvelope{}
	return &this
}
...
func (o *EmailSignatureDtoEnvelope) SetErrorMessageNil() {
...
func (o *EmailSignatureDtoEnvelope) SetCorrelationIdNil() {
...
func (o *EmailSignatureDtoEnvelope) SetHttpStatusNil() {
...
func (o *EmailSignatureDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *EmailSignatureDtoEnvelope) SetActivityIdNil() {
...
func (o EmailSignatureDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o EmailSignatureDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableEmailSignatureDtoEnvelope struct {
	value *EmailSignatureDtoEnvelope
	isSet bool
}

func (v NullableEmailSignatureDtoEnvelope) Get() *EmailSignatureDtoEnvelope {
	return v.value
}

func (v *NullableEmailSignatureDtoEnvelope) Set(val *EmailSignatureDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailSignatureDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailSignatureDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailSignatureDtoEnvelope(val *EmailSignatureDtoEnvelope) *NullableEmailSignatureDtoEnvelope {
	return &NullableEmailSignatureDtoEnvelope{value: val, isSet: true}
}

func (v NullableEmailSignatureDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailSignatureDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
