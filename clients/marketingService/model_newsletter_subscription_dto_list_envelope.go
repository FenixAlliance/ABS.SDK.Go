...
// checks if the NewsletterSubscriptionDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NewsletterSubscriptionDtoListEnvelope{}

// NewsletterSubscriptionDtoListEnvelope struct for NewsletterSubscriptionDtoListEnvelope
type NewsletterSubscriptionDtoListEnvelope struct {
...
func NewNewsletterSubscriptionDtoListEnvelope() *NewsletterSubscriptionDtoListEnvelope {
	this := NewsletterSubscriptionDtoListEnvelope{}
	return &this
}
...
func (o *NewsletterSubscriptionDtoListEnvelope) SetErrorMessageNil() {
...
func (o *NewsletterSubscriptionDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *NewsletterSubscriptionDtoListEnvelope) SetHttpStatusNil() {
...
func (o *NewsletterSubscriptionDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *NewsletterSubscriptionDtoListEnvelope) SetActivityIdNil() {
...
func (o NewsletterSubscriptionDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o NewsletterSubscriptionDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableNewsletterSubscriptionDtoListEnvelope struct {
	value *NewsletterSubscriptionDtoListEnvelope
	isSet bool
}

func (v NullableNewsletterSubscriptionDtoListEnvelope) Get() *NewsletterSubscriptionDtoListEnvelope {
	return v.value
}

func (v *NullableNewsletterSubscriptionDtoListEnvelope) Set(val *NewsletterSubscriptionDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableNewsletterSubscriptionDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableNewsletterSubscriptionDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNewsletterSubscriptionDtoListEnvelope(val *NewsletterSubscriptionDtoListEnvelope) *NullableNewsletterSubscriptionDtoListEnvelope {
	return &NullableNewsletterSubscriptionDtoListEnvelope{value: val, isSet: true}
}

func (v NullableNewsletterSubscriptionDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNewsletterSubscriptionDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
