...
type MarketingListDto struct {
	...
	MarketingListType *string `json:"marketingListType,omitempty"`
	MarketingListTarget *string `json:"marketingListTarget,omitempty"`
}
...
func (o *MarketingListDto) SetEnrollmentIdNil() {
...
// SetMarketingListType gets a reference to the given string and assigns it to the MarketingListType field.
...
// SetMarketingListTarget gets a reference to the given string and assigns it to the MarketingListTarget field.
