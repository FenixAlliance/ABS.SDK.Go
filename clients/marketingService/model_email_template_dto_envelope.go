...
// checks if the EmailTemplateDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailTemplateDtoEnvelope{}

// EmailTemplateDtoEnvelope struct for EmailTemplateDtoEnvelope
type EmailTemplateDtoEnvelope struct {
...
func (o *EmailTemplateDtoEnvelope) SetErrorMessageNil() {
...
func (o *EmailTemplateDtoEnvelope) SetCorrelationIdNil() {
...
func (o *EmailTemplateDtoEnvelope) SetHttpStatusNil() {
...
func (o *EmailTemplateDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *EmailTemplateDtoEnvelope) SetActivityIdNil() {
...
func (o EmailTemplateDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o EmailTemplateDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableEmailTemplateDtoEnvelope struct {
	value *EmailTemplateDtoEnvelope
	isSet bool
}

func (v NullableEmailTemplateDtoEnvelope) Get() *EmailTemplateDtoEnvelope {
	return v.value
}

func (v *NullableEmailTemplateDtoEnvelope) Set(val *EmailTemplateDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailTemplateDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailTemplateDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailTemplateDtoEnvelope(val *EmailTemplateDtoEnvelope) *NullableEmailTemplateDtoEnvelope {
	return &NullableEmailTemplateDtoEnvelope{value: val, isSet: true}
}

func (v NullableEmailTemplateDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailTemplateDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
