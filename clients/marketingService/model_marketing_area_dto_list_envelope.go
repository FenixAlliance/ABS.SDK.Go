...
// checks if the MarketingAreaDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketingAreaDtoListEnvelope{}

// MarketingAreaDtoListEnvelope struct for MarketingAreaDtoListEnvelope
type MarketingAreaDtoListEnvelope struct {
...
func NewMarketingAreaDtoListEnvelope() *MarketingAreaDtoListEnvelope {
	this := MarketingAreaDtoListEnvelope{}
	return &this
}
...
func (o *MarketingAreaDtoListEnvelope) SetErrorMessageNil() {
...
func (o *MarketingAreaDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *MarketingAreaDtoListEnvelope) SetHttpStatusNil() {
...
func (o *MarketingAreaDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *MarketingAreaDtoListEnvelope) SetActivityIdNil() {
...
func (o MarketingAreaDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o MarketingAreaDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableMarketingAreaDtoListEnvelope struct {
	value *MarketingAreaDtoListEnvelope
	isSet bool
}

func (v NullableMarketingAreaDtoListEnvelope) Get() *MarketingAreaDtoListEnvelope {
	return v.value
}

func (v *NullableMarketingAreaDtoListEnvelope) Set(val *MarketingAreaDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketingAreaDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketingAreaDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketingAreaDtoListEnvelope(val *MarketingAreaDtoListEnvelope) *NullableMarketingAreaDtoListEnvelope {
	return &NullableMarketingAreaDtoListEnvelope{value: val, isSet: true}
}

func (v NullableMarketingAreaDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketingAreaDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
