...
// checks if the EmailGroupDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmailGroupDtoCollectionQueryParameters{}

// EmailGroupDtoCollectionQueryParameters struct for EmailGroupDtoCollectionQueryParameters
type EmailGroupDtoCollectionQueryParameters struct {
...
func NewEmailGroupDtoCollectionQueryParameters() *EmailGroupDtoCollectionQueryParameters {
	this := EmailGroupDtoCollectionQueryParameters{}
	return &this
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *EmailGroupDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o EmailGroupDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o EmailGroupDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableEmailGroupDtoCollectionQueryParameters struct {
	value *EmailGroupDtoCollectionQueryParameters
	isSet bool
}

func (v NullableEmailGroupDtoCollectionQueryParameters) Get() *EmailGroupDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableEmailGroupDtoCollectionQueryParameters) Set(val *EmailGroupDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableEmailGroupDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableEmailGroupDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmailGroupDtoCollectionQueryParameters(val *EmailGroupDtoCollectionQueryParameters) *NullableEmailGroupDtoCollectionQueryParameters {
	return &NullableEmailGroupDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableEmailGroupDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmailGroupDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
