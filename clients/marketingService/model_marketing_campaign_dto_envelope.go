...
// checks if the MarketingCampaignDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketingCampaignDtoEnvelope{}

// MarketingCampaignDtoEnvelope struct for MarketingCampaignDtoEnvelope
type MarketingCampaignDtoEnvelope struct {
	...
	Result *MarketingCampaignDto `json:"result,omitempty"`
}
...
func NewMarketingCampaignDtoEnvelope() *MarketingCampaignDtoEnvelope {
	this := MarketingCampaignDtoEnvelope{}
	return &this
}
...
func (o *MarketingCampaignDtoEnvelope) SetErrorMessageNil() {
...
func (o *MarketingCampaignDtoEnvelope) SetCorrelationIdNil() {
...
func (o *MarketingCampaignDtoEnvelope) SetHttpStatusNil() {
...
func (o *MarketingCampaignDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *MarketingCampaignDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given MarketingCampaignDto and assigns it to the Result field.
func (o *MarketingCampaignDtoEnvelope) SetResult(v MarketingCampaignDto) {
	o.Result = &v
}

func (o MarketingCampaignDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o MarketingCampaignDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableMarketingCampaignDtoEnvelope struct {
	value *MarketingCampaignDtoEnvelope
	isSet bool
}

func (v NullableMarketingCampaignDtoEnvelope) Get() *MarketingCampaignDtoEnvelope {
	return v.value
}

func (v *NullableMarketingCampaignDtoEnvelope) Set(val *MarketingCampaignDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketingCampaignDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketingCampaignDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketingCampaignDtoEnvelope(val *MarketingCampaignDtoEnvelope) *NullableMarketingCampaignDtoEnvelope {
	return &NullableMarketingCampaignDtoEnvelope{value: val, isSet: true}
}

func (v NullableMarketingCampaignDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketingCampaignDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
