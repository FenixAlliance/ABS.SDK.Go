...
// checks if the MarketingListCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MarketingListCreateDto{}

// MarketingListCreateDto struct for MarketingListCreateDto
type MarketingListCreateDto struct {
...
func (o *MarketingListCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *MarketingListCreateDto) SetPurposeNil() {
	o.Purpose.Set(nil)
}
...
func (o *MarketingListCreateDto) SetDescriptionNil() {
...
func (o *MarketingListCreateDto) SetSourceNil() {
	o.Source.Set(nil)
}
...
func (o *MarketingListCreateDto) SetCurrencyIdNil() {
...
func (o *MarketingListCreateDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *MarketingListCreateDto) SetEnrollmentIdNil() {
...
func (o MarketingListCreateDto) MarshalJSON() ([]byte, error) {
...
func (o MarketingListCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableMarketingListCreateDto struct {
	value *MarketingListCreateDto
	isSet bool
}

func (v NullableMarketingListCreateDto) Get() *MarketingListCreateDto {
	return v.value
}

func (v *NullableMarketingListCreateDto) Set(val *MarketingListCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketingListCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketingListCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketingListCreateDto(val *MarketingListCreateDto) *NullableMarketingListCreateDto {
	return &NullableMarketingListCreateDto{value: val, isSet: true}
}

func (v NullableMarketingListCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketingListCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
