...
// checks if the SocialPostBucketDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialPostBucketDtoEnvelope{}

// SocialPostBucketDtoEnvelope struct for SocialPostBucketDtoEnvelope
type SocialPostBucketDtoEnvelope struct {
...
func NewSocialPostBucketDtoEnvelope() *SocialPostBucketDtoEnvelope {
	this := SocialPostBucketDtoEnvelope{}
	return &this
}
...
func (o *SocialPostBucketDtoEnvelope) SetErrorMessageNil() {
...
func (o *SocialPostBucketDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SocialPostBucketDtoEnvelope) SetHttpStatusNil() {
...
func (o *SocialPostBucketDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialPostBucketDtoEnvelope) SetActivityIdNil() {
...
func (o SocialPostBucketDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialPostBucketDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialPostBucketDtoEnvelope struct {
	value *SocialPostBucketDtoEnvelope
	isSet bool
}

func (v NullableSocialPostBucketDtoEnvelope) Get() *SocialPostBucketDtoEnvelope {
	return v.value
}

func (v *NullableSocialPostBucketDtoEnvelope) Set(val *SocialPostBucketDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialPostBucketDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialPostBucketDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialPostBucketDtoEnvelope(val *SocialPostBucketDtoEnvelope) *NullableSocialPostBucketDtoEnvelope {
	return &NullableSocialPostBucketDtoEnvelope{value: val, isSet: true}
}

func (v NullableSocialPostBucketDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialPostBucketDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
