...
// checks if the SocialPostBucketDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocialPostBucketDtoListEnvelope{}

// SocialPostBucketDtoListEnvelope struct for SocialPostBucketDtoListEnvelope
type SocialPostBucketDtoListEnvelope struct {
	...
	Result []SocialPostBucketDto `json:"result,omitempty"`
}
...
func NewSocialPostBucketDtoListEnvelope() *SocialPostBucketDtoListEnvelope {
	this := SocialPostBucketDtoListEnvelope{}
	return &this
}
...
func (o *SocialPostBucketDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SocialPostBucketDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SocialPostBucketDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SocialPostBucketDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SocialPostBucketDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []SocialPostBucketDto and assigns it to the Result field.
func (o *SocialPostBucketDtoListEnvelope) SetResult(v []SocialPostBucketDto) {
	o.Result = v
}

func (o SocialPostBucketDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SocialPostBucketDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSocialPostBucketDtoListEnvelope struct {
	value *SocialPostBucketDtoListEnvelope
	isSet bool
}

func (v NullableSocialPostBucketDtoListEnvelope) Get() *SocialPostBucketDtoListEnvelope {
	return v.value
}

func (v *NullableSocialPostBucketDtoListEnvelope) Set(val *SocialPostBucketDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSocialPostBucketDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSocialPostBucketDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSocialPostBucketDtoListEnvelope(val *SocialPostBucketDtoListEnvelope) *NullableSocialPostBucketDtoListEnvelope {
	return &NullableSocialPostBucketDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSocialPostBucketDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSocialPostBucketDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
