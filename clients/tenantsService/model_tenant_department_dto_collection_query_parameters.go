...
// checks if the TenantDepartmentDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantDepartmentDtoCollectionQueryParameters{}

// TenantDepartmentDtoCollectionQueryParameters struct for TenantDepartmentDtoCollectionQueryParameters
type TenantDepartmentDtoCollectionQueryParameters struct {
...
func NewTenantDepartmentDtoCollectionQueryParameters() *TenantDepartmentDtoCollectionQueryParameters {
	this := TenantDepartmentDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TenantDepartmentDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TenantDepartmentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TenantDepartmentDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTenantDepartmentDtoCollectionQueryParameters struct {
	value *TenantDepartmentDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTenantDepartmentDtoCollectionQueryParameters) Get() *TenantDepartmentDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTenantDepartmentDtoCollectionQueryParameters) Set(val *TenantDepartmentDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantDepartmentDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantDepartmentDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantDepartmentDtoCollectionQueryParameters(val *TenantDepartmentDtoCollectionQueryParameters) *NullableTenantDepartmentDtoCollectionQueryParameters {
	return &NullableTenantDepartmentDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTenantDepartmentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantDepartmentDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
