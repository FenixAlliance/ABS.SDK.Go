...
// APIClient manages communication with the TenantsService API v2.0.0.0
...
type APIClient struct {
	...
	BusinessRelationshipsAPI *BusinessRelationshipsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BusinessRelationshipsAPI = (*BusinessRelationshipsAPIService)(&c.common)
