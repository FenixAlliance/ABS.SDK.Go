...
// checks if the TenantSizeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantSizeDtoListEnvelope{}

// TenantSizeDtoListEnvelope struct for TenantSizeDtoListEnvelope
type TenantSizeDtoListEnvelope struct {
...
func NewTenantSizeDtoListEnvelope() *TenantSizeDtoListEnvelope {
	this := TenantSizeDtoListEnvelope{}
	return &this
}
...
func (o *TenantSizeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TenantSizeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TenantSizeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TenantSizeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantSizeDtoListEnvelope) SetActivityIdNil() {
...
func (o TenantSizeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantSizeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantSizeDtoListEnvelope struct {
	value *TenantSizeDtoListEnvelope
	isSet bool
}

func (v NullableTenantSizeDtoListEnvelope) Get() *TenantSizeDtoListEnvelope {
	return v.value
}

func (v *NullableTenantSizeDtoListEnvelope) Set(val *TenantSizeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantSizeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantSizeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantSizeDtoListEnvelope(val *TenantSizeDtoListEnvelope) *NullableTenantSizeDtoListEnvelope {
	return &NullableTenantSizeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTenantSizeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantSizeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
