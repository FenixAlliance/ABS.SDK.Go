...
// checks if the WalletDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WalletDtoEnvelope{}

// WalletDtoEnvelope struct for WalletDtoEnvelope
type WalletDtoEnvelope struct {
	...
	Result *WalletDto `json:"result,omitempty"`
}
...
func (o *WalletDtoEnvelope) SetErrorMessageNil() {
...
func (o *WalletDtoEnvelope) SetCorrelationIdNil() {
...
func (o *WalletDtoEnvelope) SetHttpStatusNil() {
...
func (o *WalletDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WalletDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given WalletDto and assigns it to the Result field.
func (o *WalletDtoEnvelope) SetResult(v WalletDto) {
	o.Result = &v
}

func (o WalletDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WalletDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWalletDtoEnvelope struct {
	value *WalletDtoEnvelope
	isSet bool
}

func (v NullableWalletDtoEnvelope) Get() *WalletDtoEnvelope {
	return v.value
}

func (v *NullableWalletDtoEnvelope) Set(val *WalletDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWalletDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWalletDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWalletDtoEnvelope(val *WalletDtoEnvelope) *NullableWalletDtoEnvelope {
	return &NullableWalletDtoEnvelope{value: val, isSet: true}
}

func (v NullableWalletDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWalletDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
