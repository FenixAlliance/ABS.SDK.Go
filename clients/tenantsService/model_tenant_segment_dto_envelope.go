...
// checks if the TenantSegmentDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantSegmentDtoEnvelope{}

// TenantSegmentDtoEnvelope struct for TenantSegmentDtoEnvelope
type TenantSegmentDtoEnvelope struct {
...
func (o *TenantSegmentDtoEnvelope) SetErrorMessageNil() {
...
func (o *TenantSegmentDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TenantSegmentDtoEnvelope) SetHttpStatusNil() {
...
func (o *TenantSegmentDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantSegmentDtoEnvelope) SetActivityIdNil() {
...
func (o TenantSegmentDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantSegmentDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantSegmentDtoEnvelope struct {
	value *TenantSegmentDtoEnvelope
	isSet bool
}

func (v NullableTenantSegmentDtoEnvelope) Get() *TenantSegmentDtoEnvelope {
	return v.value
}

func (v *NullableTenantSegmentDtoEnvelope) Set(val *TenantSegmentDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantSegmentDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantSegmentDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantSegmentDtoEnvelope(val *TenantSegmentDtoEnvelope) *NullableTenantSegmentDtoEnvelope {
	return &NullableTenantSegmentDtoEnvelope{value: val, isSet: true}
}

func (v NullableTenantSegmentDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantSegmentDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
