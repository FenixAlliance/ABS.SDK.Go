...
// checks if the TenantTerritoryDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantTerritoryDtoListEnvelope{}

// TenantTerritoryDtoListEnvelope struct for TenantTerritoryDtoListEnvelope
type TenantTerritoryDtoListEnvelope struct {
	...
	Result []TenantTerritoryDto `json:"result,omitempty"`
}
...
func NewTenantTerritoryDtoListEnvelope() *TenantTerritoryDtoListEnvelope {
	this := TenantTerritoryDtoListEnvelope{}
	return &this
}
...
func (o *TenantTerritoryDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TenantTerritoryDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TenantTerritoryDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TenantTerritoryDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantTerritoryDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []TenantTerritoryDto and assigns it to the Result field.
func (o *TenantTerritoryDtoListEnvelope) SetResult(v []TenantTerritoryDto) {
	o.Result = v
}

func (o TenantTerritoryDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantTerritoryDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantTerritoryDtoListEnvelope struct {
	value *TenantTerritoryDtoListEnvelope
	isSet bool
}

func (v NullableTenantTerritoryDtoListEnvelope) Get() *TenantTerritoryDtoListEnvelope {
	return v.value
}

func (v *NullableTenantTerritoryDtoListEnvelope) Set(val *TenantTerritoryDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantTerritoryDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantTerritoryDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantTerritoryDtoListEnvelope(val *TenantTerritoryDtoListEnvelope) *NullableTenantTerritoryDtoListEnvelope {
	return &NullableTenantTerritoryDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTenantTerritoryDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantTerritoryDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
