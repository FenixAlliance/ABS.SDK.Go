...
// checks if the BusinessRelationshipDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessRelationshipDtoEnvelope{}

// BusinessRelationshipDtoEnvelope struct for BusinessRelationshipDtoEnvelope
type BusinessRelationshipDtoEnvelope struct {
	...
	Result *BusinessRelationshipDto `json:"result,omitempty"`
}
...
func NewBusinessRelationshipDtoEnvelope() *BusinessRelationshipDtoEnvelope {
	this := BusinessRelationshipDtoEnvelope{}
	return &this
}
...
func (o *BusinessRelationshipDtoEnvelope) SetErrorMessageNil() {
...
func (o *BusinessRelationshipDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BusinessRelationshipDtoEnvelope) SetHttpStatusNil() {
...
func (o *BusinessRelationshipDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BusinessRelationshipDtoEnvelope) SetActivityIdNil() {
...
func (o *BusinessRelationshipDtoEnvelope) GetResult() BusinessRelationshipDto {
	if o == nil || IsNil(o.Result) {
		var ret BusinessRelationshipDto
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given BusinessRelationshipDto and assigns it to the Result field.
func (o *BusinessRelationshipDtoEnvelope) SetResult(v BusinessRelationshipDto) {
	o.Result = &v
}

func (o BusinessRelationshipDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BusinessRelationshipDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBusinessRelationshipDtoEnvelope struct {
	value *BusinessRelationshipDtoEnvelope
	isSet bool
}

func (v NullableBusinessRelationshipDtoEnvelope) Get() *BusinessRelationshipDtoEnvelope {
	return v.value
}

func (v *NullableBusinessRelationshipDtoEnvelope) Set(val *BusinessRelationshipDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessRelationshipDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessRelationshipDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessRelationshipDtoEnvelope(val *BusinessRelationshipDtoEnvelope) *NullableBusinessRelationshipDtoEnvelope {
	return &NullableBusinessRelationshipDtoEnvelope{value: val, isSet: true}
}

func (v NullableBusinessRelationshipDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessRelationshipDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
