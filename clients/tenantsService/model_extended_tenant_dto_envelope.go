...
// checks if the ExtendedTenantDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedTenantDtoEnvelope{}

// ExtendedTenantDtoEnvelope struct for ExtendedTenantDtoEnvelope
type ExtendedTenantDtoEnvelope struct {
...
func NewExtendedTenantDtoEnvelope() *ExtendedTenantDtoEnvelope {
	this := ExtendedTenantDtoEnvelope{}
	return &this
}
...
func (o *ExtendedTenantDtoEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedTenantDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedTenantDtoEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedTenantDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedTenantDtoEnvelope) SetActivityIdNil() {
...
func (o ExtendedTenantDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedTenantDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedTenantDtoEnvelope struct {
	value *ExtendedTenantDtoEnvelope
	isSet bool
}

func (v NullableExtendedTenantDtoEnvelope) Get() *ExtendedTenantDtoEnvelope {
	return v.value
}

func (v *NullableExtendedTenantDtoEnvelope) Set(val *ExtendedTenantDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedTenantDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedTenantDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedTenantDtoEnvelope(val *ExtendedTenantDtoEnvelope) *NullableExtendedTenantDtoEnvelope {
	return &NullableExtendedTenantDtoEnvelope{value: val, isSet: true}
}

func (v NullableExtendedTenantDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedTenantDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
