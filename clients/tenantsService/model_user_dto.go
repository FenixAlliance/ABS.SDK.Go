...
type UserDto struct {
	...
	SiteTheme NullableString `json:"siteTheme,omitempty"`
}
...
// SetSiteTheme gets a reference to the given NullableString and assigns it to the SiteTheme field.
