...
// checks if the UnitDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UnitDtoEnvelope{}

// UnitDtoEnvelope struct for UnitDtoEnvelope
type UnitDtoEnvelope struct {
...
func (o *UnitDtoEnvelope) SetErrorMessageNil() {
...
func (o *UnitDtoEnvelope) SetCorrelationIdNil() {
...
func (o *UnitDtoEnvelope) SetHttpStatusNil() {
...
func (o *UnitDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *UnitDtoEnvelope) SetActivityIdNil() {
...
func (o UnitDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o UnitDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableUnitDtoEnvelope struct {
	value *UnitDtoEnvelope
	isSet bool
}

func (v NullableUnitDtoEnvelope) Get() *UnitDtoEnvelope {
	return v.value
}

func (v *NullableUnitDtoEnvelope) Set(val *UnitDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableUnitDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableUnitDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUnitDtoEnvelope(val *UnitDtoEnvelope) *NullableUnitDtoEnvelope {
	return &NullableUnitDtoEnvelope{value: val, isSet: true}
}

func (v NullableUnitDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUnitDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
