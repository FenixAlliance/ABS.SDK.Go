...
// checks if the TenantTerritoryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantTerritoryDtoEnvelope{}

// TenantTerritoryDtoEnvelope struct for TenantTerritoryDtoEnvelope
type TenantTerritoryDtoEnvelope struct {
...
func NewTenantTerritoryDtoEnvelope() *TenantTerritoryDtoEnvelope {
	this := TenantTerritoryDtoEnvelope{}
	return &this
}
...
func (o *TenantTerritoryDtoEnvelope) SetErrorMessageNil() {
...
func (o *TenantTerritoryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TenantTerritoryDtoEnvelope) SetHttpStatusNil() {
...
func (o *TenantTerritoryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantTerritoryDtoEnvelope) SetActivityIdNil() {
...
func (o TenantTerritoryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantTerritoryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantTerritoryDtoEnvelope struct {
	value *TenantTerritoryDtoEnvelope
	isSet bool
}

func (v NullableTenantTerritoryDtoEnvelope) Get() *TenantTerritoryDtoEnvelope {
	return v.value
}

func (v *NullableTenantTerritoryDtoEnvelope) Set(val *TenantTerritoryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantTerritoryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantTerritoryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantTerritoryDtoEnvelope(val *TenantTerritoryDtoEnvelope) *NullableTenantTerritoryDtoEnvelope {
	return &NullableTenantTerritoryDtoEnvelope{value: val, isSet: true}
}

func (v NullableTenantTerritoryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantTerritoryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
