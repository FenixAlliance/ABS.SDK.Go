...
// checks if the TenantUnitDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantUnitDtoCollectionQueryParameters{}

// TenantUnitDtoCollectionQueryParameters struct for TenantUnitDtoCollectionQueryParameters
type TenantUnitDtoCollectionQueryParameters struct {
...
func NewTenantUnitDtoCollectionQueryParameters() *TenantUnitDtoCollectionQueryParameters {
	this := TenantUnitDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TenantUnitDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TenantUnitDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TenantUnitDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTenantUnitDtoCollectionQueryParameters struct {
	value *TenantUnitDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTenantUnitDtoCollectionQueryParameters) Get() *TenantUnitDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTenantUnitDtoCollectionQueryParameters) Set(val *TenantUnitDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantUnitDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantUnitDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantUnitDtoCollectionQueryParameters(val *TenantUnitDtoCollectionQueryParameters) *NullableTenantUnitDtoCollectionQueryParameters {
	return &NullableTenantUnitDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTenantUnitDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantUnitDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
