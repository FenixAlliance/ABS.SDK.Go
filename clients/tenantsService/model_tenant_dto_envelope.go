...
// checks if the TenantDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantDtoEnvelope{}

// TenantDtoEnvelope struct for TenantDtoEnvelope
type TenantDtoEnvelope struct {
...
func (o *TenantDtoEnvelope) SetErrorMessageNil() {
...
func (o *TenantDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TenantDtoEnvelope) SetHttpStatusNil() {
...
func (o *TenantDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantDtoEnvelope) SetActivityIdNil() {
...
func (o TenantDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantDtoEnvelope struct {
	value *TenantDtoEnvelope
	isSet bool
}

func (v NullableTenantDtoEnvelope) Get() *TenantDtoEnvelope {
	return v.value
}

func (v *NullableTenantDtoEnvelope) Set(val *TenantDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantDtoEnvelope(val *TenantDtoEnvelope) *NullableTenantDtoEnvelope {
	return &NullableTenantDtoEnvelope{value: val, isSet: true}
}

func (v NullableTenantDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
