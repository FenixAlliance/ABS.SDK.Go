...
// checks if the TenantTeamEmployeeEnrollmentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantTeamEmployeeEnrollmentDtoListEnvelope{}

// TenantTeamEmployeeEnrollmentDtoListEnvelope struct for TenantTeamEmployeeEnrollmentDtoListEnvelope
type TenantTeamEmployeeEnrollmentDtoListEnvelope struct {
...
func NewTenantTeamEmployeeEnrollmentDtoListEnvelope() *TenantTeamEmployeeEnrollmentDtoListEnvelope {
	this := TenantTeamEmployeeEnrollmentDtoListEnvelope{}
	return &this
}
...
func (o *TenantTeamEmployeeEnrollmentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TenantTeamEmployeeEnrollmentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TenantTeamEmployeeEnrollmentDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TenantTeamEmployeeEnrollmentDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantTeamEmployeeEnrollmentDtoListEnvelope) SetActivityIdNil() {
...
func (o TenantTeamEmployeeEnrollmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantTeamEmployeeEnrollmentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantTeamEmployeeEnrollmentDtoListEnvelope struct {
	value *TenantTeamEmployeeEnrollmentDtoListEnvelope
	isSet bool
}

func (v NullableTenantTeamEmployeeEnrollmentDtoListEnvelope) Get() *TenantTeamEmployeeEnrollmentDtoListEnvelope {
	return v.value
}

func (v *NullableTenantTeamEmployeeEnrollmentDtoListEnvelope) Set(val *TenantTeamEmployeeEnrollmentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantTeamEmployeeEnrollmentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantTeamEmployeeEnrollmentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantTeamEmployeeEnrollmentDtoListEnvelope(val *TenantTeamEmployeeEnrollmentDtoListEnvelope) *NullableTenantTeamEmployeeEnrollmentDtoListEnvelope {
	return &NullableTenantTeamEmployeeEnrollmentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTenantTeamEmployeeEnrollmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantTeamEmployeeEnrollmentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
