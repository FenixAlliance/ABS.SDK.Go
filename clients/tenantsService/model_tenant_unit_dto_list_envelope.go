...
// checks if the TenantUnitDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantUnitDtoListEnvelope{}

// TenantUnitDtoListEnvelope struct for TenantUnitDtoListEnvelope
type TenantUnitDtoListEnvelope struct {
...
func NewTenantUnitDtoListEnvelope() *TenantUnitDtoListEnvelope {
	this := TenantUnitDtoListEnvelope{}
	return &this
}
...
func (o *TenantUnitDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TenantUnitDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TenantUnitDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TenantUnitDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantUnitDtoListEnvelope) SetActivityIdNil() {
...
func (o TenantUnitDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantUnitDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantUnitDtoListEnvelope struct {
	value *TenantUnitDtoListEnvelope
	isSet bool
}

func (v NullableTenantUnitDtoListEnvelope) Get() *TenantUnitDtoListEnvelope {
	return v.value
}

func (v *NullableTenantUnitDtoListEnvelope) Set(val *TenantUnitDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantUnitDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantUnitDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantUnitDtoListEnvelope(val *TenantUnitDtoListEnvelope) *NullableTenantUnitDtoListEnvelope {
	return &NullableTenantUnitDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTenantUnitDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantUnitDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
