...
// checks if the SuiteLicenseAssignmentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuiteLicenseAssignmentDtoListEnvelope{}

// SuiteLicenseAssignmentDtoListEnvelope struct for SuiteLicenseAssignmentDtoListEnvelope
type SuiteLicenseAssignmentDtoListEnvelope struct {
	...
	Result []SuiteLicenseAssignmentDto `json:"result,omitempty"`
}
...
func NewSuiteLicenseAssignmentDtoListEnvelope() *SuiteLicenseAssignmentDtoListEnvelope {
	this := SuiteLicenseAssignmentDtoListEnvelope{}
	return &this
}
...
func (o *SuiteLicenseAssignmentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SuiteLicenseAssignmentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SuiteLicenseAssignmentDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SuiteLicenseAssignmentDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SuiteLicenseAssignmentDtoListEnvelope) SetActivityIdNil() {
...
func (o *SuiteLicenseAssignmentDtoListEnvelope) GetResult() []SuiteLicenseAssignmentDto {
	if o == nil {
		var ret []SuiteLicenseAssignmentDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []SuiteLicenseAssignmentDto and assigns it to the Result field.
func (o *SuiteLicenseAssignmentDtoListEnvelope) SetResult(v []SuiteLicenseAssignmentDto) {
	o.Result = v
}

func (o SuiteLicenseAssignmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SuiteLicenseAssignmentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSuiteLicenseAssignmentDtoListEnvelope struct {
	value *SuiteLicenseAssignmentDtoListEnvelope
	isSet bool
}

func (v NullableSuiteLicenseAssignmentDtoListEnvelope) Get() *SuiteLicenseAssignmentDtoListEnvelope {
	return v.value
}

func (v *NullableSuiteLicenseAssignmentDtoListEnvelope) Set(val *SuiteLicenseAssignmentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSuiteLicenseAssignmentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSuiteLicenseAssignmentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuiteLicenseAssignmentDtoListEnvelope(val *SuiteLicenseAssignmentDtoListEnvelope) *NullableSuiteLicenseAssignmentDtoListEnvelope {
	return &NullableSuiteLicenseAssignmentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSuiteLicenseAssignmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuiteLicenseAssignmentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
