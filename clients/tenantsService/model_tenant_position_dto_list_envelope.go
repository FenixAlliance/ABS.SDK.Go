...
// checks if the TenantPositionDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantPositionDtoListEnvelope{}

// TenantPositionDtoListEnvelope struct for TenantPositionDtoListEnvelope
type TenantPositionDtoListEnvelope struct {
...
func NewTenantPositionDtoListEnvelope() *TenantPositionDtoListEnvelope {
	this := TenantPositionDtoListEnvelope{}
	return &this
}
...
func (o *TenantPositionDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TenantPositionDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TenantPositionDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TenantPositionDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantPositionDtoListEnvelope) SetActivityIdNil() {
...
func (o TenantPositionDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantPositionDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantPositionDtoListEnvelope struct {
	value *TenantPositionDtoListEnvelope
	isSet bool
}

func (v NullableTenantPositionDtoListEnvelope) Get() *TenantPositionDtoListEnvelope {
	return v.value
}

func (v *NullableTenantPositionDtoListEnvelope) Set(val *TenantPositionDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantPositionDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantPositionDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantPositionDtoListEnvelope(val *TenantPositionDtoListEnvelope) *NullableTenantPositionDtoListEnvelope {
	return &NullableTenantPositionDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTenantPositionDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantPositionDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
