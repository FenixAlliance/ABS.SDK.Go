...
// checks if the TenantTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantTypeDtoEnvelope{}

// TenantTypeDtoEnvelope struct for TenantTypeDtoEnvelope
type TenantTypeDtoEnvelope struct {
...
func (o *TenantTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *TenantTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TenantTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *TenantTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TenantTypeDtoEnvelope) SetActivityIdNil() {
...
func (o TenantTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantTypeDtoEnvelope struct {
	value *TenantTypeDtoEnvelope
	isSet bool
}

func (v NullableTenantTypeDtoEnvelope) Get() *TenantTypeDtoEnvelope {
	return v.value
}

func (v *NullableTenantTypeDtoEnvelope) Set(val *TenantTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantTypeDtoEnvelope(val *TenantTypeDtoEnvelope) *NullableTenantTypeDtoEnvelope {
	return &NullableTenantTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableTenantTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
