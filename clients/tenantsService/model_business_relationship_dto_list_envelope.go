...
// checks if the BusinessRelationshipDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BusinessRelationshipDtoListEnvelope{}

// BusinessRelationshipDtoListEnvelope struct for BusinessRelationshipDtoListEnvelope
type BusinessRelationshipDtoListEnvelope struct {
...
func NewBusinessRelationshipDtoListEnvelope() *BusinessRelationshipDtoListEnvelope {
	this := BusinessRelationshipDtoListEnvelope{}
	return &this
}
...
func (o *BusinessRelationshipDtoListEnvelope) SetErrorMessageNil() {
...
func (o *BusinessRelationshipDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *BusinessRelationshipDtoListEnvelope) SetHttpStatusNil() {
...
func (o *BusinessRelationshipDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BusinessRelationshipDtoListEnvelope) SetActivityIdNil() {
...
func (o BusinessRelationshipDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BusinessRelationshipDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBusinessRelationshipDtoListEnvelope struct {
	value *BusinessRelationshipDtoListEnvelope
	isSet bool
}

func (v NullableBusinessRelationshipDtoListEnvelope) Get() *BusinessRelationshipDtoListEnvelope {
	return v.value
}

func (v *NullableBusinessRelationshipDtoListEnvelope) Set(val *BusinessRelationshipDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBusinessRelationshipDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBusinessRelationshipDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBusinessRelationshipDtoListEnvelope(val *BusinessRelationshipDtoListEnvelope) *NullableBusinessRelationshipDtoListEnvelope {
	return &NullableBusinessRelationshipDtoListEnvelope{value: val, isSet: true}
}

func (v NullableBusinessRelationshipDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBusinessRelationshipDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
