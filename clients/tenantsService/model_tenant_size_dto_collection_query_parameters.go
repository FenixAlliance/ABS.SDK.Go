...
// checks if the TenantSizeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantSizeDtoCollectionQueryParameters{}

// TenantSizeDtoCollectionQueryParameters struct for TenantSizeDtoCollectionQueryParameters
type TenantSizeDtoCollectionQueryParameters struct {
...
func NewTenantSizeDtoCollectionQueryParameters() *TenantSizeDtoCollectionQueryParameters {
	this := TenantSizeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TenantSizeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TenantSizeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TenantSizeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTenantSizeDtoCollectionQueryParameters struct {
	value *TenantSizeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTenantSizeDtoCollectionQueryParameters) Get() *TenantSizeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTenantSizeDtoCollectionQueryParameters) Set(val *TenantSizeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantSizeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantSizeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantSizeDtoCollectionQueryParameters(val *TenantSizeDtoCollectionQueryParameters) *NullableTenantSizeDtoCollectionQueryParameters {
	return &NullableTenantSizeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTenantSizeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantSizeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
