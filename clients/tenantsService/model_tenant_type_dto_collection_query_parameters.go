...
// checks if the TenantTypeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantTypeDtoCollectionQueryParameters{}

// TenantTypeDtoCollectionQueryParameters struct for TenantTypeDtoCollectionQueryParameters
type TenantTypeDtoCollectionQueryParameters struct {
...
func NewTenantTypeDtoCollectionQueryParameters() *TenantTypeDtoCollectionQueryParameters {
	this := TenantTypeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TenantTypeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TenantTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TenantTypeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTenantTypeDtoCollectionQueryParameters struct {
	value *TenantTypeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTenantTypeDtoCollectionQueryParameters) Get() *TenantTypeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTenantTypeDtoCollectionQueryParameters) Set(val *TenantTypeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantTypeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantTypeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantTypeDtoCollectionQueryParameters(val *TenantTypeDtoCollectionQueryParameters) *NullableTenantTypeDtoCollectionQueryParameters {
	return &NullableTenantTypeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTenantTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantTypeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
