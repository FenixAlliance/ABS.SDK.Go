...
> TenantTerritoryDtoListEnvelope GetTenantTerritories(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTerritoryDtoCollectionQueryParameters(tenantTerritoryDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	tenantTerritoryDtoCollectionQueryParameters := *openapiclient.NewTenantTerritoryDtoCollectionQueryParameters() // TenantTerritoryDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TerritoriesAPI.GetTenantTerritories(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTerritoryDtoCollectionQueryParameters(tenantTerritoryDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **tenantTerritoryDtoCollectionQueryParameters** | [**TenantTerritoryDtoCollectionQueryParameters**](TenantTerritoryDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetTenantTerritoriesCount(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTerritoryDtoCollectionQueryParameters(tenantTerritoryDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TerritoriesAPI.GetTenantTerritoriesCount(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTerritoryDtoCollectionQueryParameters(tenantTerritoryDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchTenantTerritory(ctx, tenantTerritoryId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TerritoriesAPI.PatchTenantTerritory(context.Background(), tenantTerritoryId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TerritoriesAPI.PatchTenantTerritory``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchTenantTerritory`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `TerritoriesAPI.PatchTenantTerritory`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTenantTerritoryRequest struct via the builder pattern
