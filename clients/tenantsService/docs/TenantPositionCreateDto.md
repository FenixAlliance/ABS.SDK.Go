...
`func (o *TenantPositionCreateDto) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *TenantPositionCreateDto) GetTypeOk() (*string, bool)`
...
`func (o *TenantPositionCreateDto) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *TenantPositionCreateDto) HasType() bool`

HasType returns a boolean if a field has been set.

### SetTypeNil

`func (o *TenantPositionCreateDto) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *TenantPositionCreateDto) UnsetType()`
