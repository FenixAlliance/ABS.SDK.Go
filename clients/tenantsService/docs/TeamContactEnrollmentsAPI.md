...
> TenantTeamContactEnrollmentDtoListEnvelope GetTenantTeamContactEnrollments(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTeamContactEnrollmentDtoCollectionQueryParameters(tenantTeamContactEnrollmentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	tenantTeamContactEnrollmentDtoCollectionQueryParameters := *openapiclient.NewTenantTeamContactEnrollmentDtoCollectionQueryParameters() // TenantTeamContactEnrollmentDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TeamContactEnrollmentsAPI.GetTenantTeamContactEnrollments(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTeamContactEnrollmentDtoCollectionQueryParameters(tenantTeamContactEnrollmentDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **tenantTeamContactEnrollmentDtoCollectionQueryParameters** | [**TenantTeamContactEnrollmentDtoCollectionQueryParameters**](TenantTeamContactEnrollmentDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetTenantTeamContactEnrollmentsCount(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTeamContactEnrollmentDtoCollectionQueryParameters(tenantTeamContactEnrollmentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TeamContactEnrollmentsAPI.GetTenantTeamContactEnrollmentsCount(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTeamContactEnrollmentDtoCollectionQueryParameters(tenantTeamContactEnrollmentDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchTenantTeamContactEnrollment(ctx, tenantTeamContactEnrollmentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TeamContactEnrollmentsAPI.PatchTenantTeamContactEnrollment(context.Background(), tenantTeamContactEnrollmentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
