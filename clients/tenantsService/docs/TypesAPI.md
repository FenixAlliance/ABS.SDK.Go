...
[**PatchTenantType**](TypesAPI.md#PatchTenantType) | **Patch** /api/v2/TenantsService/Types/{tenantTypeId} | Patch a tenant type
...
> TenantTypeDtoListEnvelope GetTenantTypes(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTypeDtoCollectionQueryParameters(tenantTypeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	tenantTypeDtoCollectionQueryParameters := *openapiclient.NewTenantTypeDtoCollectionQueryParameters() // TenantTypeDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TypesAPI.GetTenantTypes(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTypeDtoCollectionQueryParameters(tenantTypeDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **tenantTypeDtoCollectionQueryParameters** | [**TenantTypeDtoCollectionQueryParameters**](TenantTypeDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetTenantTypesCount(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTypeDtoCollectionQueryParameters(tenantTypeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TypesAPI.GetTenantTypesCount(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantTypeDtoCollectionQueryParameters(tenantTypeDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchTenantType(ctx, tenantTypeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TypesAPI.PatchTenantType(context.Background(), tenantTypeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TypesAPI.PatchTenantType``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchTenantType`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `TypesAPI.PatchTenantType`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTenantTypeRequest struct via the builder pattern
