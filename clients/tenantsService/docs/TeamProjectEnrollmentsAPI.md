...
> EmptyEnvelope PatchTenantTeamProjectEnrollment(ctx, tenantTeamProjectEnrollmentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).Operation(operation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TeamProjectEnrollmentsAPI.PatchTenantTeamProjectEnrollment(context.Background(), tenantTeamProjectEnrollmentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).Operation(operation).Execute()
	if err != nil {
