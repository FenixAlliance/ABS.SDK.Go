...
> TenantSegmentDtoListEnvelope GetTenantSegments(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantSegmentDtoCollectionQueryParameters(tenantSegmentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	tenantSegmentDtoCollectionQueryParameters := *openapiclient.NewTenantSegmentDtoCollectionQueryParameters() // TenantSegmentDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SegmentsAPI.GetTenantSegments(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantSegmentDtoCollectionQueryParameters(tenantSegmentDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **tenantSegmentDtoCollectionQueryParameters** | [**TenantSegmentDtoCollectionQueryParameters**](TenantSegmentDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetTenantSegmentsCount(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantSegmentDtoCollectionQueryParameters(tenantSegmentDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SegmentsAPI.GetTenantSegmentsCount(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).TenantSegmentDtoCollectionQueryParameters(tenantSegmentDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchTenantSegment(ctx, tenantSegmentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SegmentsAPI.PatchTenantSegment(context.Background(), tenantSegmentId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SegmentsAPI.PatchTenantSegment``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchTenantSegment`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `SegmentsAPI.PatchTenantSegment`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchTenantSegmentRequest struct via the builder pattern
