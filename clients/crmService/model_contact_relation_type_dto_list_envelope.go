...
// checks if the ContactRelationTypeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactRelationTypeDtoListEnvelope{}

// ContactRelationTypeDtoListEnvelope struct for ContactRelationTypeDtoListEnvelope
type ContactRelationTypeDtoListEnvelope struct {
	...
	Result []ContactRelationTypeDto `json:"result,omitempty"`
}
...
func NewContactRelationTypeDtoListEnvelope() *ContactRelationTypeDtoListEnvelope {
	this := ContactRelationTypeDtoListEnvelope{}
	return &this
}
...
func (o *ContactRelationTypeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ContactRelationTypeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ContactRelationTypeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ContactRelationTypeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ContactRelationTypeDtoListEnvelope) SetActivityIdNil() {
...
func (o *ContactRelationTypeDtoListEnvelope) GetResult() []ContactRelationTypeDto {
	if o == nil {
		var ret []ContactRelationTypeDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []ContactRelationTypeDto and assigns it to the Result field.
func (o *ContactRelationTypeDtoListEnvelope) SetResult(v []ContactRelationTypeDto) {
	o.Result = v
}

func (o ContactRelationTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ContactRelationTypeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableContactRelationTypeDtoListEnvelope struct {
	value *ContactRelationTypeDtoListEnvelope
	isSet bool
}

func (v NullableContactRelationTypeDtoListEnvelope) Get() *ContactRelationTypeDtoListEnvelope {
	return v.value
}

func (v *NullableContactRelationTypeDtoListEnvelope) Set(val *ContactRelationTypeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableContactRelationTypeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableContactRelationTypeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactRelationTypeDtoListEnvelope(val *ContactRelationTypeDtoListEnvelope) *NullableContactRelationTypeDtoListEnvelope {
	return &NullableContactRelationTypeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableContactRelationTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactRelationTypeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
