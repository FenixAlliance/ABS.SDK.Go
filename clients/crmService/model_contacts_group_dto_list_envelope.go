...
// checks if the ContactsGroupDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactsGroupDtoListEnvelope{}

// ContactsGroupDtoListEnvelope struct for ContactsGroupDtoListEnvelope
type ContactsGroupDtoListEnvelope struct {
	...
	Result []ContactsGroupDto `json:"result,omitempty"`
}
...
func NewContactsGroupDtoListEnvelope() *ContactsGroupDtoListEnvelope {
	this := ContactsGroupDtoListEnvelope{}
	return &this
}
...
func (o *ContactsGroupDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ContactsGroupDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ContactsGroupDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ContactsGroupDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ContactsGroupDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ContactsGroupDto and assigns it to the Result field.
func (o *ContactsGroupDtoListEnvelope) SetResult(v []ContactsGroupDto) {
	o.Result = v
}

func (o ContactsGroupDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ContactsGroupDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableContactsGroupDtoListEnvelope struct {
	value *ContactsGroupDtoListEnvelope
	isSet bool
}

func (v NullableContactsGroupDtoListEnvelope) Get() *ContactsGroupDtoListEnvelope {
	return v.value
}

func (v *NullableContactsGroupDtoListEnvelope) Set(val *ContactsGroupDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableContactsGroupDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableContactsGroupDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactsGroupDtoListEnvelope(val *ContactsGroupDtoListEnvelope) *NullableContactsGroupDtoListEnvelope {
	return &NullableContactsGroupDtoListEnvelope{value: val, isSet: true}
}

func (v NullableContactsGroupDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactsGroupDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
