...
// checks if the ContactProfileDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactProfileDtoListEnvelope{}

// ContactProfileDtoListEnvelope struct for ContactProfileDtoListEnvelope
type ContactProfileDtoListEnvelope struct {
	...
	Result []ContactProfileDto `json:"result,omitempty"`
}
...
func NewContactProfileDtoListEnvelope() *ContactProfileDtoListEnvelope {
	this := ContactProfileDtoListEnvelope{}
	return &this
}
...
func (o *ContactProfileDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ContactProfileDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ContactProfileDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ContactProfileDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ContactProfileDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ContactProfileDto and assigns it to the Result field.
func (o *ContactProfileDtoListEnvelope) SetResult(v []ContactProfileDto) {
	o.Result = v
}

func (o ContactProfileDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ContactProfileDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableContactProfileDtoListEnvelope struct {
	value *ContactProfileDtoListEnvelope
	isSet bool
}

func (v NullableContactProfileDtoListEnvelope) Get() *ContactProfileDtoListEnvelope {
	return v.value
}

func (v *NullableContactProfileDtoListEnvelope) Set(val *ContactProfileDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableContactProfileDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableContactProfileDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactProfileDtoListEnvelope(val *ContactProfileDtoListEnvelope) *NullableContactProfileDtoListEnvelope {
	return &NullableContactProfileDtoListEnvelope{value: val, isSet: true}
}

func (v NullableContactProfileDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactProfileDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
