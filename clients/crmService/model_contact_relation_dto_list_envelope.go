...
// checks if the ContactRelationDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactRelationDtoListEnvelope{}

// ContactRelationDtoListEnvelope struct for ContactRelationDtoListEnvelope
type ContactRelationDtoListEnvelope struct {
	...
	Result []ContactRelationDto `json:"result,omitempty"`
}
...
func NewContactRelationDtoListEnvelope() *ContactRelationDtoListEnvelope {
	this := ContactRelationDtoListEnvelope{}
	return &this
}
...
func (o *ContactRelationDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ContactRelationDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ContactRelationDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ContactRelationDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ContactRelationDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ContactRelationDto and assigns it to the Result field.
func (o *ContactRelationDtoListEnvelope) SetResult(v []ContactRelationDto) {
	o.Result = v
}

func (o ContactRelationDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ContactRelationDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableContactRelationDtoListEnvelope struct {
	value *ContactRelationDtoListEnvelope
	isSet bool
}

func (v NullableContactRelationDtoListEnvelope) Get() *ContactRelationDtoListEnvelope {
	return v.value
}

func (v *NullableContactRelationDtoListEnvelope) Set(val *ContactRelationDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableContactRelationDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableContactRelationDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactRelationDtoListEnvelope(val *ContactRelationDtoListEnvelope) *NullableContactRelationDtoListEnvelope {
	return &NullableContactRelationDtoListEnvelope{value: val, isSet: true}
}

func (v NullableContactRelationDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactRelationDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
