...
// checks if the ContactDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactDtoCollectionQueryParameters{}

// ContactDtoCollectionQueryParameters struct for ContactDtoCollectionQueryParameters
type ContactDtoCollectionQueryParameters struct {
...
func NewContactDtoCollectionQueryParameters() *ContactDtoCollectionQueryParameters {
	this := ContactDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ContactDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ContactDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ContactDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ContactDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ContactDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ContactDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ContactDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ContactDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ContactDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableContactDtoCollectionQueryParameters struct {
	value *ContactDtoCollectionQueryParameters
	isSet bool
}

func (v NullableContactDtoCollectionQueryParameters) Get() *ContactDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableContactDtoCollectionQueryParameters) Set(val *ContactDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableContactDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableContactDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactDtoCollectionQueryParameters(val *ContactDtoCollectionQueryParameters) *NullableContactDtoCollectionQueryParameters {
	return &NullableContactDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableContactDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
