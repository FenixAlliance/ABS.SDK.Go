...
// checks if the ContactDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactDtoEnvelope{}

// ContactDtoEnvelope struct for ContactDtoEnvelope
type ContactDtoEnvelope struct {
...
func (o *ContactDtoEnvelope) SetErrorMessageNil() {
...
func (o *ContactDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ContactDtoEnvelope) SetHttpStatusNil() {
...
func (o *ContactDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ContactDtoEnvelope) SetActivityIdNil() {
...
func (o ContactDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ContactDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableContactDtoEnvelope struct {
	value *ContactDtoEnvelope
	isSet bool
}

func (v NullableContactDtoEnvelope) Get() *ContactDtoEnvelope {
	return v.value
}

func (v *NullableContactDtoEnvelope) Set(val *ContactDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableContactDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableContactDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactDtoEnvelope(val *ContactDtoEnvelope) *NullableContactDtoEnvelope {
	return &NullableContactDtoEnvelope{value: val, isSet: true}
}

func (v NullableContactDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
