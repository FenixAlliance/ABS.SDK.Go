...
// checks if the ContactProfileDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactProfileDtoCollectionQueryParameters{}

// ContactProfileDtoCollectionQueryParameters struct for ContactProfileDtoCollectionQueryParameters
type ContactProfileDtoCollectionQueryParameters struct {
...
func NewContactProfileDtoCollectionQueryParameters() *ContactProfileDtoCollectionQueryParameters {
	this := ContactProfileDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ContactProfileDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ContactProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ContactProfileDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableContactProfileDtoCollectionQueryParameters struct {
	value *ContactProfileDtoCollectionQueryParameters
	isSet bool
}

func (v NullableContactProfileDtoCollectionQueryParameters) Get() *ContactProfileDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableContactProfileDtoCollectionQueryParameters) Set(val *ContactProfileDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableContactProfileDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableContactProfileDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactProfileDtoCollectionQueryParameters(val *ContactProfileDtoCollectionQueryParameters) *NullableContactProfileDtoCollectionQueryParameters {
	return &NullableContactProfileDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableContactProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactProfileDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
