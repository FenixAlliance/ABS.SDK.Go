...
// checks if the ContactSourceDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactSourceDtoCollectionQueryParameters{}

// ContactSourceDtoCollectionQueryParameters struct for ContactSourceDtoCollectionQueryParameters
type ContactSourceDtoCollectionQueryParameters struct {
...
func NewContactSourceDtoCollectionQueryParameters() *ContactSourceDtoCollectionQueryParameters {
	this := ContactSourceDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ContactSourceDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ContactSourceDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ContactSourceDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableContactSourceDtoCollectionQueryParameters struct {
	value *ContactSourceDtoCollectionQueryParameters
	isSet bool
}

func (v NullableContactSourceDtoCollectionQueryParameters) Get() *ContactSourceDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableContactSourceDtoCollectionQueryParameters) Set(val *ContactSourceDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableContactSourceDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableContactSourceDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactSourceDtoCollectionQueryParameters(val *ContactSourceDtoCollectionQueryParameters) *NullableContactSourceDtoCollectionQueryParameters {
	return &NullableContactSourceDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableContactSourceDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactSourceDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
