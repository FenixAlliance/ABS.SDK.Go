...
// checks if the ContactSourceDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ContactSourceDtoListEnvelope{}

// ContactSourceDtoListEnvelope struct for ContactSourceDtoListEnvelope
type ContactSourceDtoListEnvelope struct {
	...
	Result []ContactSourceDto `json:"result,omitempty"`
}
...
func NewContactSourceDtoListEnvelope() *ContactSourceDtoListEnvelope {
	this := ContactSourceDtoListEnvelope{}
	return &this
}
...
func (o *ContactSourceDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ContactSourceDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ContactSourceDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ContactSourceDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ContactSourceDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ContactSourceDto and assigns it to the Result field.
func (o *ContactSourceDtoListEnvelope) SetResult(v []ContactSourceDto) {
	o.Result = v
}

func (o ContactSourceDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ContactSourceDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableContactSourceDtoListEnvelope struct {
	value *ContactSourceDtoListEnvelope
	isSet bool
}

func (v NullableContactSourceDtoListEnvelope) Get() *ContactSourceDtoListEnvelope {
	return v.value
}

func (v *NullableContactSourceDtoListEnvelope) Set(val *ContactSourceDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableContactSourceDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableContactSourceDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactSourceDtoListEnvelope(val *ContactSourceDtoListEnvelope) *NullableContactSourceDtoListEnvelope {
	return &NullableContactSourceDtoListEnvelope{value: val, isSet: true}
}

func (v NullableContactSourceDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactSourceDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
