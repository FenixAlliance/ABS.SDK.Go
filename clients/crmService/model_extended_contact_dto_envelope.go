...
// checks if the ExtendedContactDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedContactDtoEnvelope{}

// ExtendedContactDtoEnvelope struct for ExtendedContactDtoEnvelope
type ExtendedContactDtoEnvelope struct {
...
func NewExtendedContactDtoEnvelope() *ExtendedContactDtoEnvelope {
	this := ExtendedContactDtoEnvelope{}
	return &this
}
...
func (o *ExtendedContactDtoEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedContactDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedContactDtoEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedContactDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedContactDtoEnvelope) SetActivityIdNil() {
...
func (o ExtendedContactDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedContactDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedContactDtoEnvelope struct {
	value *ExtendedContactDtoEnvelope
	isSet bool
}

func (v NullableExtendedContactDtoEnvelope) Get() *ExtendedContactDtoEnvelope {
	return v.value
}

func (v *NullableExtendedContactDtoEnvelope) Set(val *ExtendedContactDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedContactDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedContactDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedContactDtoEnvelope(val *ExtendedContactDtoEnvelope) *NullableExtendedContactDtoEnvelope {
	return &NullableExtendedContactDtoEnvelope{value: val, isSet: true}
}

func (v NullableExtendedContactDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedContactDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
