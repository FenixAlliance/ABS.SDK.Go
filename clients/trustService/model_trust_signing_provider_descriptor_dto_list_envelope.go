...
// checks if the TrustSigningProviderDescriptorDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustSigningProviderDescriptorDtoListEnvelope{}

// TrustSigningProviderDescriptorDtoListEnvelope struct for TrustSigningProviderDescriptorDtoListEnvelope
type TrustSigningProviderDescriptorDtoListEnvelope struct {
	...
	Result []TrustSigningProviderDescriptorDto `json:"result,omitempty"`
}
...
func NewTrustSigningProviderDescriptorDtoListEnvelope() *TrustSigningProviderDescriptorDtoListEnvelope {
	this := TrustSigningProviderDescriptorDtoListEnvelope{}
	return &this
}
...
func (o *TrustSigningProviderDescriptorDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TrustSigningProviderDescriptorDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TrustSigningProviderDescriptorDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TrustSigningProviderDescriptorDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TrustSigningProviderDescriptorDtoListEnvelope) SetActivityIdNil() {
...
func (o *TrustSigningProviderDescriptorDtoListEnvelope) GetResult() []TrustSigningProviderDescriptorDto {
	if o == nil {
		var ret []TrustSigningProviderDescriptorDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []TrustSigningProviderDescriptorDto and assigns it to the Result field.
func (o *TrustSigningProviderDescriptorDtoListEnvelope) SetResult(v []TrustSigningProviderDescriptorDto) {
	o.Result = v
}

func (o TrustSigningProviderDescriptorDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TrustSigningProviderDescriptorDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTrustSigningProviderDescriptorDtoListEnvelope struct {
	value *TrustSigningProviderDescriptorDtoListEnvelope
	isSet bool
}

func (v NullableTrustSigningProviderDescriptorDtoListEnvelope) Get() *TrustSigningProviderDescriptorDtoListEnvelope {
	return v.value
}

func (v *NullableTrustSigningProviderDescriptorDtoListEnvelope) Set(val *TrustSigningProviderDescriptorDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTrustSigningProviderDescriptorDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTrustSigningProviderDescriptorDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrustSigningProviderDescriptorDtoListEnvelope(val *TrustSigningProviderDescriptorDtoListEnvelope) *NullableTrustSigningProviderDescriptorDtoListEnvelope {
	return &NullableTrustSigningProviderDescriptorDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTrustSigningProviderDescriptorDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrustSigningProviderDescriptorDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
