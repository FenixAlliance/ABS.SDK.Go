...
// checks if the ServiceLevelDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceLevelDtoEnvelope{}

// ServiceLevelDtoEnvelope struct for ServiceLevelDtoEnvelope
type ServiceLevelDtoEnvelope struct {
...
func (o *ServiceLevelDtoEnvelope) SetErrorMessageNil() {
...
func (o *ServiceLevelDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceLevelDtoEnvelope) SetHttpStatusNil() {
...
func (o *ServiceLevelDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceLevelDtoEnvelope) SetActivityIdNil() {
...
func (o ServiceLevelDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceLevelDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceLevelDtoEnvelope struct {
	value *ServiceLevelDtoEnvelope
	isSet bool
}

func (v NullableServiceLevelDtoEnvelope) Get() *ServiceLevelDtoEnvelope {
	return v.value
}

func (v *NullableServiceLevelDtoEnvelope) Set(val *ServiceLevelDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceLevelDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceLevelDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceLevelDtoEnvelope(val *ServiceLevelDtoEnvelope) *NullableServiceLevelDtoEnvelope {
	return &NullableServiceLevelDtoEnvelope{value: val, isSet: true}
}

func (v NullableServiceLevelDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceLevelDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
