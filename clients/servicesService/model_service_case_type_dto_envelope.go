...
// checks if the ServiceCaseTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceCaseTypeDtoEnvelope{}

// ServiceCaseTypeDtoEnvelope struct for ServiceCaseTypeDtoEnvelope
type ServiceCaseTypeDtoEnvelope struct {
...
func NewServiceCaseTypeDtoEnvelope() *ServiceCaseTypeDtoEnvelope {
	this := ServiceCaseTypeDtoEnvelope{}
	return &this
}
...
func (o *ServiceCaseTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *ServiceCaseTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceCaseTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *ServiceCaseTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceCaseTypeDtoEnvelope) SetActivityIdNil() {
...
func (o ServiceCaseTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceCaseTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceCaseTypeDtoEnvelope struct {
	value *ServiceCaseTypeDtoEnvelope
	isSet bool
}

func (v NullableServiceCaseTypeDtoEnvelope) Get() *ServiceCaseTypeDtoEnvelope {
	return v.value
}

func (v *NullableServiceCaseTypeDtoEnvelope) Set(val *ServiceCaseTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceCaseTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceCaseTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceCaseTypeDtoEnvelope(val *ServiceCaseTypeDtoEnvelope) *NullableServiceCaseTypeDtoEnvelope {
	return &NullableServiceCaseTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableServiceCaseTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceCaseTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
