...
// checks if the ServiceQueueDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQueueDtoIReadOnlyListEnvelope{}

// ServiceQueueDtoIReadOnlyListEnvelope struct for ServiceQueueDtoIReadOnlyListEnvelope
type ServiceQueueDtoIReadOnlyListEnvelope struct {
...
func NewServiceQueueDtoIReadOnlyListEnvelope() *ServiceQueueDtoIReadOnlyListEnvelope {
	this := ServiceQueueDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *ServiceQueueDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *ServiceQueueDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceQueueDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *ServiceQueueDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceQueueDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o ServiceQueueDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceQueueDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQueueDtoIReadOnlyListEnvelope struct {
	value *ServiceQueueDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableServiceQueueDtoIReadOnlyListEnvelope) Get() *ServiceQueueDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableServiceQueueDtoIReadOnlyListEnvelope) Set(val *ServiceQueueDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQueueDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQueueDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQueueDtoIReadOnlyListEnvelope(val *ServiceQueueDtoIReadOnlyListEnvelope) *NullableServiceQueueDtoIReadOnlyListEnvelope {
	return &NullableServiceQueueDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableServiceQueueDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQueueDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
