...
// checks if the ServiceCaseDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceCaseDtoCollectionQueryParameters{}

// ServiceCaseDtoCollectionQueryParameters struct for ServiceCaseDtoCollectionQueryParameters
type ServiceCaseDtoCollectionQueryParameters struct {
...
func NewServiceCaseDtoCollectionQueryParameters() *ServiceCaseDtoCollectionQueryParameters {
	this := ServiceCaseDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ServiceCaseDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ServiceCaseDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ServiceCaseDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableServiceCaseDtoCollectionQueryParameters struct {
	value *ServiceCaseDtoCollectionQueryParameters
	isSet bool
}

func (v NullableServiceCaseDtoCollectionQueryParameters) Get() *ServiceCaseDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableServiceCaseDtoCollectionQueryParameters) Set(val *ServiceCaseDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceCaseDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceCaseDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceCaseDtoCollectionQueryParameters(val *ServiceCaseDtoCollectionQueryParameters) *NullableServiceCaseDtoCollectionQueryParameters {
	return &NullableServiceCaseDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableServiceCaseDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceCaseDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
