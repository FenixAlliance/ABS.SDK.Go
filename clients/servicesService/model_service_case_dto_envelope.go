...
// checks if the ServiceCaseDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceCaseDtoEnvelope{}

// ServiceCaseDtoEnvelope struct for ServiceCaseDtoEnvelope
type ServiceCaseDtoEnvelope struct {
...
func (o *ServiceCaseDtoEnvelope) SetErrorMessageNil() {
...
func (o *ServiceCaseDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceCaseDtoEnvelope) SetHttpStatusNil() {
...
func (o *ServiceCaseDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceCaseDtoEnvelope) SetActivityIdNil() {
...
func (o ServiceCaseDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceCaseDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceCaseDtoEnvelope struct {
	value *ServiceCaseDtoEnvelope
	isSet bool
}

func (v NullableServiceCaseDtoEnvelope) Get() *ServiceCaseDtoEnvelope {
	return v.value
}

func (v *NullableServiceCaseDtoEnvelope) Set(val *ServiceCaseDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceCaseDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceCaseDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceCaseDtoEnvelope(val *ServiceCaseDtoEnvelope) *NullableServiceCaseDtoEnvelope {
	return &NullableServiceCaseDtoEnvelope{value: val, isSet: true}
}

func (v NullableServiceCaseDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceCaseDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
