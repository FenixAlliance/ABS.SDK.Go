...
> ServiceCaseTypeDtoIReadOnlyListEnvelope GetServiceCaseTypesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceCaseTypeDtoCollectionQueryParameters(serviceCaseTypeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	serviceCaseTypeDtoCollectionQueryParameters := *openapiclient.NewServiceCaseTypeDtoCollectionQueryParameters() // ServiceCaseTypeDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceCaseTypesAPI.GetServiceCaseTypesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceCaseTypeDtoCollectionQueryParameters(serviceCaseTypeDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **serviceCaseTypeDtoCollectionQueryParameters** | [**ServiceCaseTypeDtoCollectionQueryParameters**](ServiceCaseTypeDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetServiceCaseTypesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceCaseTypeDtoCollectionQueryParameters(serviceCaseTypeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceCaseTypesAPI.GetServiceCaseTypesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceCaseTypeDtoCollectionQueryParameters(serviceCaseTypeDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> Envelope PatchServiceCaseTypeAsync(ctx, serviceCaseTypeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceCaseTypesAPI.PatchServiceCaseTypeAsync(context.Background(), serviceCaseTypeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ServiceCaseTypesAPI.PatchServiceCaseTypeAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchServiceCaseTypeAsync`: Envelope
	fmt.Fprintf(os.Stdout, "Response from `ServiceCaseTypesAPI.PatchServiceCaseTypeAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchServiceCaseTypeAsyncRequest struct via the builder pattern
