...
> ServiceQueueDtoIReadOnlyListEnvelope GetServiceQueuesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceQueueDtoCollectionQueryParameters(serviceQueueDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	serviceQueueDtoCollectionQueryParameters := *openapiclient.NewServiceQueueDtoCollectionQueryParameters() // ServiceQueueDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceQueuesAPI.GetServiceQueuesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceQueueDtoCollectionQueryParameters(serviceQueueDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **serviceQueueDtoCollectionQueryParameters** | [**ServiceQueueDtoCollectionQueryParameters**](ServiceQueueDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetServiceQueuesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceQueueDtoCollectionQueryParameters(serviceQueueDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceQueuesAPI.GetServiceQueuesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceQueueDtoCollectionQueryParameters(serviceQueueDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> Envelope PatchServiceQueueAsync(ctx, serviceQueueId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceQueuesAPI.PatchServiceQueueAsync(context.Background(), serviceQueueId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ServiceQueuesAPI.PatchServiceQueueAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchServiceQueueAsync`: Envelope
	fmt.Fprintf(os.Stdout, "Response from `ServiceQueuesAPI.PatchServiceQueueAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchServiceQueueAsyncRequest struct via the builder pattern
