...
> ServiceLevelAgreementDtoIReadOnlyListEnvelope GetServiceLevelAgreementsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceLevelAgreementDtoCollectionQueryParameters(serviceLevelAgreementDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	serviceLevelAgreementDtoCollectionQueryParameters := *openapiclient.NewServiceLevelAgreementDtoCollectionQueryParameters() // ServiceLevelAgreementDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceLevelAgreementsAPI.GetServiceLevelAgreementsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceLevelAgreementDtoCollectionQueryParameters(serviceLevelAgreementDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **serviceLevelAgreementDtoCollectionQueryParameters** | [**ServiceLevelAgreementDtoCollectionQueryParameters**](ServiceLevelAgreementDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetServiceLevelAgreementsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceLevelAgreementDtoCollectionQueryParameters(serviceLevelAgreementDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceLevelAgreementsAPI.GetServiceLevelAgreementsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).ServiceLevelAgreementDtoCollectionQueryParameters(serviceLevelAgreementDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> Envelope PatchServiceLevelAgreementAsync(ctx, serviceLevelAgreementId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ServiceLevelAgreementsAPI.PatchServiceLevelAgreementAsync(context.Background(), serviceLevelAgreementId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ServiceLevelAgreementsAPI.PatchServiceLevelAgreementAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchServiceLevelAgreementAsync`: Envelope
	fmt.Fprintf(os.Stdout, "Response from `ServiceLevelAgreementsAPI.PatchServiceLevelAgreementAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchServiceLevelAgreementAsyncRequest struct via the builder pattern
