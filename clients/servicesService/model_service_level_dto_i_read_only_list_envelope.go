...
// checks if the ServiceLevelDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceLevelDtoIReadOnlyListEnvelope{}

// ServiceLevelDtoIReadOnlyListEnvelope struct for ServiceLevelDtoIReadOnlyListEnvelope
type ServiceLevelDtoIReadOnlyListEnvelope struct {
	...
	Result []ServiceLevelDto `json:"result,omitempty"`
}
...
func NewServiceLevelDtoIReadOnlyListEnvelope() *ServiceLevelDtoIReadOnlyListEnvelope {
	this := ServiceLevelDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *ServiceLevelDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *ServiceLevelDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceLevelDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *ServiceLevelDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceLevelDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ServiceLevelDto and assigns it to the Result field.
func (o *ServiceLevelDtoIReadOnlyListEnvelope) SetResult(v []ServiceLevelDto) {
	o.Result = v
}

func (o ServiceLevelDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceLevelDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceLevelDtoIReadOnlyListEnvelope struct {
	value *ServiceLevelDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableServiceLevelDtoIReadOnlyListEnvelope) Get() *ServiceLevelDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableServiceLevelDtoIReadOnlyListEnvelope) Set(val *ServiceLevelDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceLevelDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceLevelDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceLevelDtoIReadOnlyListEnvelope(val *ServiceLevelDtoIReadOnlyListEnvelope) *NullableServiceLevelDtoIReadOnlyListEnvelope {
	return &NullableServiceLevelDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableServiceLevelDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceLevelDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
