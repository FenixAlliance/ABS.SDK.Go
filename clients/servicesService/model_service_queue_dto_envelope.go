...
// checks if the ServiceQueueDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQueueDtoEnvelope{}

// ServiceQueueDtoEnvelope struct for ServiceQueueDtoEnvelope
type ServiceQueueDtoEnvelope struct {
	...
	Result *ServiceQueueDto `json:"result,omitempty"`
}
...
func (o *ServiceQueueDtoEnvelope) SetErrorMessageNil() {
...
func (o *ServiceQueueDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceQueueDtoEnvelope) SetHttpStatusNil() {
...
func (o *ServiceQueueDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceQueueDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given ServiceQueueDto and assigns it to the Result field.
func (o *ServiceQueueDtoEnvelope) SetResult(v ServiceQueueDto) {
	o.Result = &v
}

func (o ServiceQueueDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceQueueDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQueueDtoEnvelope struct {
	value *ServiceQueueDtoEnvelope
	isSet bool
}

func (v NullableServiceQueueDtoEnvelope) Get() *ServiceQueueDtoEnvelope {
	return v.value
}

func (v *NullableServiceQueueDtoEnvelope) Set(val *ServiceQueueDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQueueDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQueueDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQueueDtoEnvelope(val *ServiceQueueDtoEnvelope) *NullableServiceQueueDtoEnvelope {
	return &NullableServiceQueueDtoEnvelope{value: val, isSet: true}
}

func (v NullableServiceQueueDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQueueDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
