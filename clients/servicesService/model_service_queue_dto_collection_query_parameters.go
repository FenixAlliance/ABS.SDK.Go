...
// checks if the ServiceQueueDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceQueueDtoCollectionQueryParameters{}

// ServiceQueueDtoCollectionQueryParameters struct for ServiceQueueDtoCollectionQueryParameters
type ServiceQueueDtoCollectionQueryParameters struct {
...
func NewServiceQueueDtoCollectionQueryParameters() *ServiceQueueDtoCollectionQueryParameters {
	this := ServiceQueueDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ServiceQueueDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ServiceQueueDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ServiceQueueDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableServiceQueueDtoCollectionQueryParameters struct {
	value *ServiceQueueDtoCollectionQueryParameters
	isSet bool
}

func (v NullableServiceQueueDtoCollectionQueryParameters) Get() *ServiceQueueDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableServiceQueueDtoCollectionQueryParameters) Set(val *ServiceQueueDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceQueueDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceQueueDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceQueueDtoCollectionQueryParameters(val *ServiceQueueDtoCollectionQueryParameters) *NullableServiceQueueDtoCollectionQueryParameters {
	return &NullableServiceQueueDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableServiceQueueDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceQueueDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
