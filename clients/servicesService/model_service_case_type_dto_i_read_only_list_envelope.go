...
// checks if the ServiceCaseTypeDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceCaseTypeDtoIReadOnlyListEnvelope{}

// ServiceCaseTypeDtoIReadOnlyListEnvelope struct for ServiceCaseTypeDtoIReadOnlyListEnvelope
type ServiceCaseTypeDtoIReadOnlyListEnvelope struct {
	...
	Result []ServiceCaseTypeDto `json:"result,omitempty"`
}
...
func NewServiceCaseTypeDtoIReadOnlyListEnvelope() *ServiceCaseTypeDtoIReadOnlyListEnvelope {
	this := ServiceCaseTypeDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *ServiceCaseTypeDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *ServiceCaseTypeDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *ServiceCaseTypeDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *ServiceCaseTypeDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ServiceCaseTypeDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ServiceCaseTypeDto and assigns it to the Result field.
func (o *ServiceCaseTypeDtoIReadOnlyListEnvelope) SetResult(v []ServiceCaseTypeDto) {
	o.Result = v
}

func (o ServiceCaseTypeDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ServiceCaseTypeDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableServiceCaseTypeDtoIReadOnlyListEnvelope struct {
	value *ServiceCaseTypeDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableServiceCaseTypeDtoIReadOnlyListEnvelope) Get() *ServiceCaseTypeDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableServiceCaseTypeDtoIReadOnlyListEnvelope) Set(val *ServiceCaseTypeDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceCaseTypeDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceCaseTypeDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceCaseTypeDtoIReadOnlyListEnvelope(val *ServiceCaseTypeDtoIReadOnlyListEnvelope) *NullableServiceCaseTypeDtoIReadOnlyListEnvelope {
	return &NullableServiceCaseTypeDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableServiceCaseTypeDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceCaseTypeDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
