...
// checks if the IValidationFailureListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IValidationFailureListEnvelope{}

// IValidationFailureListEnvelope struct for IValidationFailureListEnvelope
type IValidationFailureListEnvelope struct {
	...
	Result []IValidationFailure `json:"result,omitempty"`
}
...
func NewIValidationFailureListEnvelope() *IValidationFailureListEnvelope {
	this := IValidationFailureListEnvelope{}
	return &this
}
...
func (o *IValidationFailureListEnvelope) SetErrorMessageNil() {
...
func (o *IValidationFailureListEnvelope) SetCorrelationIdNil() {
...
func (o *IValidationFailureListEnvelope) SetHttpStatusNil() {
...
func (o *IValidationFailureListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *IValidationFailureListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []IValidationFailure and assigns it to the Result field.
func (o *IValidationFailureListEnvelope) SetResult(v []IValidationFailure) {
	o.Result = v
}

func (o IValidationFailureListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o IValidationFailureListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableIValidationFailureListEnvelope struct {
	value *IValidationFailureListEnvelope
	isSet bool
}

func (v NullableIValidationFailureListEnvelope) Get() *IValidationFailureListEnvelope {
	return v.value
}

func (v *NullableIValidationFailureListEnvelope) Set(val *IValidationFailureListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableIValidationFailureListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableIValidationFailureListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIValidationFailureListEnvelope(val *IValidationFailureListEnvelope) *NullableIValidationFailureListEnvelope {
	return &NullableIValidationFailureListEnvelope{value: val, isSet: true}
}

func (v NullableIValidationFailureListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIValidationFailureListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
