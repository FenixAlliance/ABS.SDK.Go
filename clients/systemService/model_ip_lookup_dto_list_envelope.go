...
// checks if the IPLookupDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPLookupDtoListEnvelope{}

// IPLookupDtoListEnvelope struct for IPLookupDtoListEnvelope
type IPLookupDtoListEnvelope struct {
...
func (o *IPLookupDtoListEnvelope) SetErrorMessageNil() {
...
func (o *IPLookupDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *IPLookupDtoListEnvelope) SetHttpStatusNil() {
...
func (o *IPLookupDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *IPLookupDtoListEnvelope) SetActivityIdNil() {
...
func (o IPLookupDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o IPLookupDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableIPLookupDtoListEnvelope struct {
	value *IPLookupDtoListEnvelope
	isSet bool
}

func (v NullableIPLookupDtoListEnvelope) Get() *IPLookupDtoListEnvelope {
	return v.value
}

func (v *NullableIPLookupDtoListEnvelope) Set(val *IPLookupDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableIPLookupDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableIPLookupDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPLookupDtoListEnvelope(val *IPLookupDtoListEnvelope) *NullableIPLookupDtoListEnvelope {
	return &NullableIPLookupDtoListEnvelope{value: val, isSet: true}
}

func (v NullableIPLookupDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPLookupDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
