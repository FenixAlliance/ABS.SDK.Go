...
// checks if the UserDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDtoListEnvelope{}

// UserDtoListEnvelope struct for UserDtoListEnvelope
type UserDtoListEnvelope struct {
...
func (o *UserDtoListEnvelope) SetErrorMessageNil() {
...
func (o *UserDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *UserDtoListEnvelope) SetHttpStatusNil() {
...
func (o *UserDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *UserDtoListEnvelope) SetActivityIdNil() {
...
func (o UserDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o UserDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableUserDtoListEnvelope struct {
	value *UserDtoListEnvelope
	isSet bool
}

func (v NullableUserDtoListEnvelope) Get() *UserDtoListEnvelope {
	return v.value
}

func (v *NullableUserDtoListEnvelope) Set(val *UserDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDtoListEnvelope(val *UserDtoListEnvelope) *NullableUserDtoListEnvelope {
	return &NullableUserDtoListEnvelope{value: val, isSet: true}
}

func (v NullableUserDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
