...
// APIClient manages communication with the SystemService API v2.1.2.5401
...
type APIClient struct {
	...
	ContactOptionsAPI *ContactOptionsAPIService
	...
	TenantOptionsAPI *TenantOptionsAPIService

	TenantsAPI *TenantsAPIService

	UserOptionsAPI *UserOptionsAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.UserOptionsAPI = (*UserOptionsAPIService)(&c.common)
