...
// checks if the GuestCartPurgeResultDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GuestCartPurgeResultDtoEnvelope{}

// GuestCartPurgeResultDtoEnvelope struct for GuestCartPurgeResultDtoEnvelope
type GuestCartPurgeResultDtoEnvelope struct {
	...
	Result *GuestCartPurgeResultDto `json:"result,omitempty"`
}
...
func NewGuestCartPurgeResultDtoEnvelope() *GuestCartPurgeResultDtoEnvelope {
	this := GuestCartPurgeResultDtoEnvelope{}
	return &this
}
...
func (o *GuestCartPurgeResultDtoEnvelope) SetErrorMessageNil() {
...
func (o *GuestCartPurgeResultDtoEnvelope) SetCorrelationIdNil() {
...
func (o *GuestCartPurgeResultDtoEnvelope) SetHttpStatusNil() {
...
func (o *GuestCartPurgeResultDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *GuestCartPurgeResultDtoEnvelope) SetActivityIdNil() {
...
func (o *GuestCartPurgeResultDtoEnvelope) GetResult() GuestCartPurgeResultDto {
	if o == nil || IsNil(o.Result) {
		var ret GuestCartPurgeResultDto
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given GuestCartPurgeResultDto and assigns it to the Result field.
func (o *GuestCartPurgeResultDtoEnvelope) SetResult(v GuestCartPurgeResultDto) {
	o.Result = &v
}

func (o GuestCartPurgeResultDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o GuestCartPurgeResultDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableGuestCartPurgeResultDtoEnvelope struct {
	value *GuestCartPurgeResultDtoEnvelope
	isSet bool
}

func (v NullableGuestCartPurgeResultDtoEnvelope) Get() *GuestCartPurgeResultDtoEnvelope {
	return v.value
}

func (v *NullableGuestCartPurgeResultDtoEnvelope) Set(val *GuestCartPurgeResultDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableGuestCartPurgeResultDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableGuestCartPurgeResultDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGuestCartPurgeResultDtoEnvelope(val *GuestCartPurgeResultDtoEnvelope) *NullableGuestCartPurgeResultDtoEnvelope {
	return &NullableGuestCartPurgeResultDtoEnvelope{value: val, isSet: true}
}

func (v NullableGuestCartPurgeResultDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGuestCartPurgeResultDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
