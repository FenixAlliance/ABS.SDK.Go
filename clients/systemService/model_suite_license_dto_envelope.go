...
// checks if the SuiteLicenseDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SuiteLicenseDtoEnvelope{}

// SuiteLicenseDtoEnvelope struct for SuiteLicenseDtoEnvelope
type SuiteLicenseDtoEnvelope struct {
...
func (o *SuiteLicenseDtoEnvelope) SetErrorMessageNil() {
...
func (o *SuiteLicenseDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SuiteLicenseDtoEnvelope) SetHttpStatusNil() {
...
func (o *SuiteLicenseDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SuiteLicenseDtoEnvelope) SetActivityIdNil() {
...
func (o SuiteLicenseDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SuiteLicenseDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSuiteLicenseDtoEnvelope struct {
	value *SuiteLicenseDtoEnvelope
	isSet bool
}

func (v NullableSuiteLicenseDtoEnvelope) Get() *SuiteLicenseDtoEnvelope {
	return v.value
}

func (v *NullableSuiteLicenseDtoEnvelope) Set(val *SuiteLicenseDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSuiteLicenseDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSuiteLicenseDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSuiteLicenseDtoEnvelope(val *SuiteLicenseDtoEnvelope) *NullableSuiteLicenseDtoEnvelope {
	return &NullableSuiteLicenseDtoEnvelope{value: val, isSet: true}
}

func (v NullableSuiteLicenseDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSuiteLicenseDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
