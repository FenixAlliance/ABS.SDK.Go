...
// checks if the StudioModuleListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StudioModuleListEnvelope{}

// StudioModuleListEnvelope struct for StudioModuleListEnvelope
type StudioModuleListEnvelope struct {
	...
	Result []StudioModule `json:"result,omitempty"`
}
...
func (o *StudioModuleListEnvelope) SetErrorMessageNil() {
...
func (o *StudioModuleListEnvelope) SetCorrelationIdNil() {
...
func (o *StudioModuleListEnvelope) SetHttpStatusNil() {
...
func (o *StudioModuleListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *StudioModuleListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []StudioModule and assigns it to the Result field.
func (o *StudioModuleListEnvelope) SetResult(v []StudioModule) {
	o.Result = v
}

func (o StudioModuleListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o StudioModuleListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableStudioModuleListEnvelope struct {
	value *StudioModuleListEnvelope
	isSet bool
}

func (v NullableStudioModuleListEnvelope) Get() *StudioModuleListEnvelope {
	return v.value
}

func (v *NullableStudioModuleListEnvelope) Set(val *StudioModuleListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableStudioModuleListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableStudioModuleListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStudioModuleListEnvelope(val *StudioModuleListEnvelope) *NullableStudioModuleListEnvelope {
	return &NullableStudioModuleListEnvelope{value: val, isSet: true}
}

func (v NullableStudioModuleListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStudioModuleListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
