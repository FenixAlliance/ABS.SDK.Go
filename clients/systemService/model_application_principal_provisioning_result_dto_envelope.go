...
// checks if the ApplicationPrincipalProvisioningResultDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationPrincipalProvisioningResultDtoEnvelope{}

// ApplicationPrincipalProvisioningResultDtoEnvelope struct for ApplicationPrincipalProvisioningResultDtoEnvelope
type ApplicationPrincipalProvisioningResultDtoEnvelope struct {
	...
	Result *ApplicationPrincipalProvisioningResultDto `json:"result,omitempty"`
}
...
func NewApplicationPrincipalProvisioningResultDtoEnvelope() *ApplicationPrincipalProvisioningResultDtoEnvelope {
	this := ApplicationPrincipalProvisioningResultDtoEnvelope{}
	return &this
}
...
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) SetErrorMessageNil() {
...
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) SetHttpStatusNil() {
...
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) SetActivityIdNil() {
...
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) GetResult() ApplicationPrincipalProvisioningResultDto {
	if o == nil || IsNil(o.Result) {
		var ret ApplicationPrincipalProvisioningResultDto
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ApplicationPrincipalProvisioningResultDto and assigns it to the Result field.
func (o *ApplicationPrincipalProvisioningResultDtoEnvelope) SetResult(v ApplicationPrincipalProvisioningResultDto) {
	o.Result = &v
}

func (o ApplicationPrincipalProvisioningResultDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ApplicationPrincipalProvisioningResultDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationPrincipalProvisioningResultDtoEnvelope struct {
	value *ApplicationPrincipalProvisioningResultDtoEnvelope
	isSet bool
}

func (v NullableApplicationPrincipalProvisioningResultDtoEnvelope) Get() *ApplicationPrincipalProvisioningResultDtoEnvelope {
	return v.value
}

func (v *NullableApplicationPrincipalProvisioningResultDtoEnvelope) Set(val *ApplicationPrincipalProvisioningResultDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationPrincipalProvisioningResultDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationPrincipalProvisioningResultDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationPrincipalProvisioningResultDtoEnvelope(val *ApplicationPrincipalProvisioningResultDtoEnvelope) *NullableApplicationPrincipalProvisioningResultDtoEnvelope {
	return &NullableApplicationPrincipalProvisioningResultDtoEnvelope{value: val, isSet: true}
}

func (v NullableApplicationPrincipalProvisioningResultDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationPrincipalProvisioningResultDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
