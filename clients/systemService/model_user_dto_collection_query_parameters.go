...
// checks if the UserDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDtoCollectionQueryParameters{}

// UserDtoCollectionQueryParameters struct for UserDtoCollectionQueryParameters
type UserDtoCollectionQueryParameters struct {
...
func NewUserDtoCollectionQueryParameters() *UserDtoCollectionQueryParameters {
	this := UserDtoCollectionQueryParameters{}
	return &this
}
...
func (o *UserDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *UserDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *UserDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *UserDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *UserDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *UserDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *UserDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o UserDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o UserDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableUserDtoCollectionQueryParameters struct {
	value *UserDtoCollectionQueryParameters
	isSet bool
}

func (v NullableUserDtoCollectionQueryParameters) Get() *UserDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableUserDtoCollectionQueryParameters) Set(val *UserDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDtoCollectionQueryParameters(val *UserDtoCollectionQueryParameters) *NullableUserDtoCollectionQueryParameters {
	return &NullableUserDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableUserDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
