...
// checks if the InboxMessageDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InboxMessageDtoIReadOnlyListEnvelope{}

// InboxMessageDtoIReadOnlyListEnvelope struct for InboxMessageDtoIReadOnlyListEnvelope
type InboxMessageDtoIReadOnlyListEnvelope struct {
...
func NewInboxMessageDtoIReadOnlyListEnvelope() *InboxMessageDtoIReadOnlyListEnvelope {
	this := InboxMessageDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *InboxMessageDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *InboxMessageDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *InboxMessageDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *InboxMessageDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *InboxMessageDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o InboxMessageDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InboxMessageDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInboxMessageDtoIReadOnlyListEnvelope struct {
	value *InboxMessageDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableInboxMessageDtoIReadOnlyListEnvelope) Get() *InboxMessageDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableInboxMessageDtoIReadOnlyListEnvelope) Set(val *InboxMessageDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInboxMessageDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInboxMessageDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInboxMessageDtoIReadOnlyListEnvelope(val *InboxMessageDtoIReadOnlyListEnvelope) *NullableInboxMessageDtoIReadOnlyListEnvelope {
	return &NullableInboxMessageDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableInboxMessageDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInboxMessageDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
