...
// checks if the ExtendedUserDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedUserDtoEnvelope{}

// ExtendedUserDtoEnvelope struct for ExtendedUserDtoEnvelope
type ExtendedUserDtoEnvelope struct {
...
func (o *ExtendedUserDtoEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedUserDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedUserDtoEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedUserDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedUserDtoEnvelope) SetActivityIdNil() {
...
func (o ExtendedUserDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedUserDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedUserDtoEnvelope struct {
	value *ExtendedUserDtoEnvelope
	isSet bool
}

func (v NullableExtendedUserDtoEnvelope) Get() *ExtendedUserDtoEnvelope {
	return v.value
}

func (v *NullableExtendedUserDtoEnvelope) Set(val *ExtendedUserDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedUserDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedUserDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedUserDtoEnvelope(val *ExtendedUserDtoEnvelope) *NullableExtendedUserDtoEnvelope {
	return &NullableExtendedUserDtoEnvelope{value: val, isSet: true}
}

func (v NullableExtendedUserDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedUserDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
