...
// checks if the IPLookupDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPLookupDtoEnvelope{}

// IPLookupDtoEnvelope struct for IPLookupDtoEnvelope
type IPLookupDtoEnvelope struct {
	...
	Result *IPLookupDto `json:"result,omitempty"`
}
...
func (o *IPLookupDtoEnvelope) SetErrorMessageNil() {
...
func (o *IPLookupDtoEnvelope) SetCorrelationIdNil() {
...
func (o *IPLookupDtoEnvelope) SetHttpStatusNil() {
...
func (o *IPLookupDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *IPLookupDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given IPLookupDto and assigns it to the Result field.
func (o *IPLookupDtoEnvelope) SetResult(v IPLookupDto) {
	o.Result = &v
}

func (o IPLookupDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o IPLookupDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableIPLookupDtoEnvelope struct {
	value *IPLookupDtoEnvelope
	isSet bool
}

func (v NullableIPLookupDtoEnvelope) Get() *IPLookupDtoEnvelope {
	return v.value
}

func (v *NullableIPLookupDtoEnvelope) Set(val *IPLookupDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableIPLookupDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableIPLookupDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPLookupDtoEnvelope(val *IPLookupDtoEnvelope) *NullableIPLookupDtoEnvelope {
	return &NullableIPLookupDtoEnvelope{value: val, isSet: true}
}

func (v NullableIPLookupDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPLookupDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
