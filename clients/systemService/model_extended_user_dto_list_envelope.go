...
// checks if the ExtendedUserDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedUserDtoListEnvelope{}

// ExtendedUserDtoListEnvelope struct for ExtendedUserDtoListEnvelope
type ExtendedUserDtoListEnvelope struct {
	...
	Result []ExtendedUserDto `json:"result,omitempty"`
}
...
func NewExtendedUserDtoListEnvelope() *ExtendedUserDtoListEnvelope {
	this := ExtendedUserDtoListEnvelope{}
	return &this
}
...
func (o *ExtendedUserDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedUserDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedUserDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedUserDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedUserDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ExtendedUserDto and assigns it to the Result field.
func (o *ExtendedUserDtoListEnvelope) SetResult(v []ExtendedUserDto) {
	o.Result = v
}

func (o ExtendedUserDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedUserDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedUserDtoListEnvelope struct {
	value *ExtendedUserDtoListEnvelope
	isSet bool
}

func (v NullableExtendedUserDtoListEnvelope) Get() *ExtendedUserDtoListEnvelope {
	return v.value
}

func (v *NullableExtendedUserDtoListEnvelope) Set(val *ExtendedUserDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedUserDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedUserDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedUserDtoListEnvelope(val *ExtendedUserDtoListEnvelope) *NullableExtendedUserDtoListEnvelope {
	return &NullableExtendedUserDtoListEnvelope{value: val, isSet: true}
}

func (v NullableExtendedUserDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedUserDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
