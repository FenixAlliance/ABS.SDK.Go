...
// checks if the TenantDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantDtoCollectionQueryParameters{}

// TenantDtoCollectionQueryParameters struct for TenantDtoCollectionQueryParameters
type TenantDtoCollectionQueryParameters struct {
...
func NewTenantDtoCollectionQueryParameters() *TenantDtoCollectionQueryParameters {
	this := TenantDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TenantDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TenantDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TenantDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TenantDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TenantDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TenantDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TenantDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TenantDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TenantDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTenantDtoCollectionQueryParameters struct {
	value *TenantDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTenantDtoCollectionQueryParameters) Get() *TenantDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTenantDtoCollectionQueryParameters) Set(val *TenantDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantDtoCollectionQueryParameters(val *TenantDtoCollectionQueryParameters) *NullableTenantDtoCollectionQueryParameters {
	return &NullableTenantDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTenantDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
