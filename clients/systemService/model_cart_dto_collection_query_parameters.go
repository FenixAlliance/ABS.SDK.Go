...
// checks if the CartDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartDtoCollectionQueryParameters{}

// CartDtoCollectionQueryParameters struct for CartDtoCollectionQueryParameters
type CartDtoCollectionQueryParameters struct {
...
func NewCartDtoCollectionQueryParameters() *CartDtoCollectionQueryParameters {
	this := CartDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CartDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CartDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CartDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CartDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CartDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CartDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CartDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CartDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CartDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCartDtoCollectionQueryParameters struct {
	value *CartDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCartDtoCollectionQueryParameters) Get() *CartDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCartDtoCollectionQueryParameters) Set(val *CartDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCartDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCartDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartDtoCollectionQueryParameters(val *CartDtoCollectionQueryParameters) *NullableCartDtoCollectionQueryParameters {
	return &NullableCartDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCartDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
