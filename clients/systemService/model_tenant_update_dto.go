...
func (o *TenantUpdateDto) SetKindNil() {
	o.Kind.Set(nil)
}
...
func (o *TenantUpdateDto) SetHandlerNil() {
	o.Handler.Set(nil)
}
...
func (o *TenantUpdateDto) SetAvatarUrlNil() {
	o.AvatarUrl.Set(nil)
}
...
func (o *TenantUpdateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varTenantUpdateDto := _TenantUpdateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTenantUpdateDto)

	if err != nil {
		return err
	}

	*o = TenantUpdateDto(varTenantUpdateDto)
