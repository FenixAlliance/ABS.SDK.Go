...
// checks if the WebPortalDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebPortalDtoCollectionQueryParameters{}

// WebPortalDtoCollectionQueryParameters struct for WebPortalDtoCollectionQueryParameters
type WebPortalDtoCollectionQueryParameters struct {
...
func NewWebPortalDtoCollectionQueryParameters() *WebPortalDtoCollectionQueryParameters {
	this := WebPortalDtoCollectionQueryParameters{}
	return &this
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *WebPortalDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o WebPortalDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o WebPortalDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableWebPortalDtoCollectionQueryParameters struct {
	value *WebPortalDtoCollectionQueryParameters
	isSet bool
}

func (v NullableWebPortalDtoCollectionQueryParameters) Get() *WebPortalDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableWebPortalDtoCollectionQueryParameters) Set(val *WebPortalDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableWebPortalDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableWebPortalDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebPortalDtoCollectionQueryParameters(val *WebPortalDtoCollectionQueryParameters) *NullableWebPortalDtoCollectionQueryParameters {
	return &NullableWebPortalDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableWebPortalDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebPortalDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
