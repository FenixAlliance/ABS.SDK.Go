...
> OptionDtoListEnvelope GetSystemTenantOptions(ctx, tenantId).PortalId(portalId).ApiVersion(apiVersion).XApiVersion(xApiVersion).OptionDtoCollectionQueryParameters(optionDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TenantOptionsAPI.GetSystemTenantOptions(context.Background(), tenantId).PortalId(portalId).ApiVersion(apiVersion).XApiVersion(xApiVersion).OptionDtoCollectionQueryParameters(optionDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> Int32Envelope GetSystemTenantOptionsCount(ctx, tenantId).PortalId(portalId).ApiVersion(apiVersion).XApiVersion(xApiVersion).OptionDtoCollectionQueryParameters(optionDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TenantOptionsAPI.GetSystemTenantOptionsCount(context.Background(), tenantId).PortalId(portalId).ApiVersion(apiVersion).XApiVersion(xApiVersion).OptionDtoCollectionQueryParameters(optionDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchSystemTenantOption(ctx, tenantId, optionId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TenantOptionsAPI.PatchSystemTenantOption(context.Background(), tenantId, optionId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TenantOptionsAPI.PatchSystemTenantOption``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchSystemTenantOption`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `TenantOptionsAPI.PatchSystemTenantOption`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchSystemTenantOptionRequest struct via the builder pattern
