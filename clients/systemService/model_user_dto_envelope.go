...
// checks if the UserDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserDtoEnvelope{}

// UserDtoEnvelope struct for UserDtoEnvelope
type UserDtoEnvelope struct {
...
func (o *UserDtoEnvelope) SetErrorMessageNil() {
...
func (o *UserDtoEnvelope) SetCorrelationIdNil() {
...
func (o *UserDtoEnvelope) SetHttpStatusNil() {
...
func (o *UserDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *UserDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given UserDto and assigns it to the Result field.
func (o *UserDtoEnvelope) SetResult(v UserDto) {
	o.Result = &v
}

func (o UserDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o UserDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableUserDtoEnvelope struct {
	value *UserDtoEnvelope
	isSet bool
}

func (v NullableUserDtoEnvelope) Get() *UserDtoEnvelope {
	return v.value
}

func (v *NullableUserDtoEnvelope) Set(val *UserDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableUserDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableUserDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserDtoEnvelope(val *UserDtoEnvelope) *NullableUserDtoEnvelope {
	return &NullableUserDtoEnvelope{value: val, isSet: true}
}

func (v NullableUserDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
