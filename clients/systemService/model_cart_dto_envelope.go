...
// checks if the CartDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CartDtoEnvelope{}

// CartDtoEnvelope struct for CartDtoEnvelope
type CartDtoEnvelope struct {
...
func (o *CartDtoEnvelope) SetErrorMessageNil() {
...
func (o *CartDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CartDtoEnvelope) SetHttpStatusNil() {
...
func (o *CartDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CartDtoEnvelope) SetActivityIdNil() {
...
func (o CartDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CartDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCartDtoEnvelope struct {
	value *CartDtoEnvelope
	isSet bool
}

func (v NullableCartDtoEnvelope) Get() *CartDtoEnvelope {
	return v.value
}

func (v *NullableCartDtoEnvelope) Set(val *CartDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCartDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCartDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCartDtoEnvelope(val *CartDtoEnvelope) *NullableCartDtoEnvelope {
	return &NullableCartDtoEnvelope{value: val, isSet: true}
}

func (v NullableCartDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCartDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
