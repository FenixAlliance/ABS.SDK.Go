...
// checks if the CountryCallingCodeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountryCallingCodeDtoCollectionQueryParameters{}

// CountryCallingCodeDtoCollectionQueryParameters struct for CountryCallingCodeDtoCollectionQueryParameters
type CountryCallingCodeDtoCollectionQueryParameters struct {
...
func NewCountryCallingCodeDtoCollectionQueryParameters() *CountryCallingCodeDtoCollectionQueryParameters {
	this := CountryCallingCodeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CountryCallingCodeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CountryCallingCodeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CountryCallingCodeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCountryCallingCodeDtoCollectionQueryParameters struct {
	value *CountryCallingCodeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCountryCallingCodeDtoCollectionQueryParameters) Get() *CountryCallingCodeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCountryCallingCodeDtoCollectionQueryParameters) Set(val *CountryCallingCodeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCountryCallingCodeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCountryCallingCodeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountryCallingCodeDtoCollectionQueryParameters(val *CountryCallingCodeDtoCollectionQueryParameters) *NullableCountryCallingCodeDtoCollectionQueryParameters {
	return &NullableCountryCallingCodeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCountryCallingCodeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountryCallingCodeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
