...
// checks if the TimezoneDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TimezoneDtoListEnvelope{}

// TimezoneDtoListEnvelope struct for TimezoneDtoListEnvelope
type TimezoneDtoListEnvelope struct {
...
func (o *TimezoneDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TimezoneDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TimezoneDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TimezoneDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TimezoneDtoListEnvelope) SetActivityIdNil() {
...
func (o TimezoneDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TimezoneDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTimezoneDtoListEnvelope struct {
	value *TimezoneDtoListEnvelope
	isSet bool
}

func (v NullableTimezoneDtoListEnvelope) Get() *TimezoneDtoListEnvelope {
	return v.value
}

func (v *NullableTimezoneDtoListEnvelope) Set(val *TimezoneDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTimezoneDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTimezoneDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTimezoneDtoListEnvelope(val *TimezoneDtoListEnvelope) *NullableTimezoneDtoListEnvelope {
	return &NullableTimezoneDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTimezoneDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTimezoneDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
