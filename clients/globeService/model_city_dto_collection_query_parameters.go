...
// checks if the CityDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CityDtoCollectionQueryParameters{}

// CityDtoCollectionQueryParameters struct for CityDtoCollectionQueryParameters
type CityDtoCollectionQueryParameters struct {
...
func NewCityDtoCollectionQueryParameters() *CityDtoCollectionQueryParameters {
	this := CityDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CityDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CityDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CityDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CityDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CityDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CityDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CityDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CityDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CityDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCityDtoCollectionQueryParameters struct {
	value *CityDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCityDtoCollectionQueryParameters) Get() *CityDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCityDtoCollectionQueryParameters) Set(val *CityDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCityDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCityDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCityDtoCollectionQueryParameters(val *CityDtoCollectionQueryParameters) *NullableCityDtoCollectionQueryParameters {
	return &NullableCityDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCityDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCityDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
