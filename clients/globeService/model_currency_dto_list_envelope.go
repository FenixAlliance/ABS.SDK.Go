...
// checks if the CurrencyDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrencyDtoListEnvelope{}

// CurrencyDtoListEnvelope struct for CurrencyDtoListEnvelope
type CurrencyDtoListEnvelope struct {
	...
	Result []CurrencyDto `json:"result,omitempty"`
}
...
func (o *CurrencyDtoListEnvelope) SetErrorMessageNil() {
...
func (o *CurrencyDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *CurrencyDtoListEnvelope) SetHttpStatusNil() {
...
func (o *CurrencyDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CurrencyDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []CurrencyDto and assigns it to the Result field.
func (o *CurrencyDtoListEnvelope) SetResult(v []CurrencyDto) {
	o.Result = v
}

func (o CurrencyDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CurrencyDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCurrencyDtoListEnvelope struct {
	value *CurrencyDtoListEnvelope
	isSet bool
}

func (v NullableCurrencyDtoListEnvelope) Get() *CurrencyDtoListEnvelope {
	return v.value
}

func (v *NullableCurrencyDtoListEnvelope) Set(val *CurrencyDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCurrencyDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCurrencyDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurrencyDtoListEnvelope(val *CurrencyDtoListEnvelope) *NullableCurrencyDtoListEnvelope {
	return &NullableCurrencyDtoListEnvelope{value: val, isSet: true}
}

func (v NullableCurrencyDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurrencyDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
