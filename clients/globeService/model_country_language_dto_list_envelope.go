...
// checks if the CountryLanguageDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CountryLanguageDtoListEnvelope{}

// CountryLanguageDtoListEnvelope struct for CountryLanguageDtoListEnvelope
type CountryLanguageDtoListEnvelope struct {
...
func NewCountryLanguageDtoListEnvelope() *CountryLanguageDtoListEnvelope {
	this := CountryLanguageDtoListEnvelope{}
	return &this
}
...
func (o *CountryLanguageDtoListEnvelope) SetErrorMessageNil() {
...
func (o *CountryLanguageDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *CountryLanguageDtoListEnvelope) SetHttpStatusNil() {
...
func (o *CountryLanguageDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CountryLanguageDtoListEnvelope) SetActivityIdNil() {
...
func (o CountryLanguageDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CountryLanguageDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCountryLanguageDtoListEnvelope struct {
	value *CountryLanguageDtoListEnvelope
	isSet bool
}

func (v NullableCountryLanguageDtoListEnvelope) Get() *CountryLanguageDtoListEnvelope {
	return v.value
}

func (v *NullableCountryLanguageDtoListEnvelope) Set(val *CountryLanguageDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCountryLanguageDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCountryLanguageDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCountryLanguageDtoListEnvelope(val *CountryLanguageDtoListEnvelope) *NullableCountryLanguageDtoListEnvelope {
	return &NullableCountryLanguageDtoListEnvelope{value: val, isSet: true}
}

func (v NullableCountryLanguageDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCountryLanguageDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
