...
// checks if the ProjectTimeLogDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectTimeLogDtoListEnvelope{}

// ProjectTimeLogDtoListEnvelope struct for ProjectTimeLogDtoListEnvelope
type ProjectTimeLogDtoListEnvelope struct {
...
func NewProjectTimeLogDtoListEnvelope() *ProjectTimeLogDtoListEnvelope {
	this := ProjectTimeLogDtoListEnvelope{}
	return &this
}
...
func (o *ProjectTimeLogDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ProjectTimeLogDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ProjectTimeLogDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ProjectTimeLogDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProjectTimeLogDtoListEnvelope) SetActivityIdNil() {
...
func (o ProjectTimeLogDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProjectTimeLogDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProjectTimeLogDtoListEnvelope struct {
	value *ProjectTimeLogDtoListEnvelope
	isSet bool
}

func (v NullableProjectTimeLogDtoListEnvelope) Get() *ProjectTimeLogDtoListEnvelope {
	return v.value
}

func (v *NullableProjectTimeLogDtoListEnvelope) Set(val *ProjectTimeLogDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectTimeLogDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectTimeLogDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectTimeLogDtoListEnvelope(val *ProjectTimeLogDtoListEnvelope) *NullableProjectTimeLogDtoListEnvelope {
	return &NullableProjectTimeLogDtoListEnvelope{value: val, isSet: true}
}

func (v NullableProjectTimeLogDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectTimeLogDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
