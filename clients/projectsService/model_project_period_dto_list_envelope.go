...
// checks if the ProjectPeriodDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectPeriodDtoListEnvelope{}

// ProjectPeriodDtoListEnvelope struct for ProjectPeriodDtoListEnvelope
type ProjectPeriodDtoListEnvelope struct {
	...
	Result []ProjectPeriodDto `json:"result,omitempty"`
}
...
func NewProjectPeriodDtoListEnvelope() *ProjectPeriodDtoListEnvelope {
	this := ProjectPeriodDtoListEnvelope{}
	return &this
}
...
func (o *ProjectPeriodDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ProjectPeriodDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ProjectPeriodDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ProjectPeriodDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProjectPeriodDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ProjectPeriodDto and assigns it to the Result field.
func (o *ProjectPeriodDtoListEnvelope) SetResult(v []ProjectPeriodDto) {
	o.Result = v
}

func (o ProjectPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProjectPeriodDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProjectPeriodDtoListEnvelope struct {
	value *ProjectPeriodDtoListEnvelope
	isSet bool
}

func (v NullableProjectPeriodDtoListEnvelope) Get() *ProjectPeriodDtoListEnvelope {
	return v.value
}

func (v *NullableProjectPeriodDtoListEnvelope) Set(val *ProjectPeriodDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectPeriodDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectPeriodDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectPeriodDtoListEnvelope(val *ProjectPeriodDtoListEnvelope) *NullableProjectPeriodDtoListEnvelope {
	return &NullableProjectPeriodDtoListEnvelope{value: val, isSet: true}
}

func (v NullableProjectPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectPeriodDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
