...
// checks if the ProjectTaskDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectTaskDtoEnvelope{}

// ProjectTaskDtoEnvelope struct for ProjectTaskDtoEnvelope
type ProjectTaskDtoEnvelope struct {
...
func (o *ProjectTaskDtoEnvelope) SetErrorMessageNil() {
...
func (o *ProjectTaskDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ProjectTaskDtoEnvelope) SetHttpStatusNil() {
...
func (o *ProjectTaskDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProjectTaskDtoEnvelope) SetActivityIdNil() {
...
func (o ProjectTaskDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProjectTaskDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProjectTaskDtoEnvelope struct {
	value *ProjectTaskDtoEnvelope
	isSet bool
}

func (v NullableProjectTaskDtoEnvelope) Get() *ProjectTaskDtoEnvelope {
	return v.value
}

func (v *NullableProjectTaskDtoEnvelope) Set(val *ProjectTaskDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectTaskDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectTaskDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectTaskDtoEnvelope(val *ProjectTaskDtoEnvelope) *NullableProjectTaskDtoEnvelope {
	return &NullableProjectTaskDtoEnvelope{value: val, isSet: true}
}

func (v NullableProjectTaskDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectTaskDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
