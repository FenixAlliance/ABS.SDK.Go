...
// checks if the ProjectDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectDtoListEnvelope{}

// ProjectDtoListEnvelope struct for ProjectDtoListEnvelope
type ProjectDtoListEnvelope struct {
	...
	Result []ProjectDto `json:"result,omitempty"`
}
...
func (o *ProjectDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ProjectDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ProjectDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ProjectDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProjectDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ProjectDto and assigns it to the Result field.
func (o *ProjectDtoListEnvelope) SetResult(v []ProjectDto) {
	o.Result = v
}

func (o ProjectDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProjectDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProjectDtoListEnvelope struct {
	value *ProjectDtoListEnvelope
	isSet bool
}

func (v NullableProjectDtoListEnvelope) Get() *ProjectDtoListEnvelope {
	return v.value
}

func (v *NullableProjectDtoListEnvelope) Set(val *ProjectDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectDtoListEnvelope(val *ProjectDtoListEnvelope) *NullableProjectDtoListEnvelope {
	return &NullableProjectDtoListEnvelope{value: val, isSet: true}
}

func (v NullableProjectDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
