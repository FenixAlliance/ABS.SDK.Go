...
// checks if the ProjectTaskDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectTaskDtoListEnvelope{}

// ProjectTaskDtoListEnvelope struct for ProjectTaskDtoListEnvelope
type ProjectTaskDtoListEnvelope struct {
	...
	Result []ProjectTaskDto `json:"result,omitempty"`
}
...
func NewProjectTaskDtoListEnvelope() *ProjectTaskDtoListEnvelope {
	this := ProjectTaskDtoListEnvelope{}
	return &this
}
...
func (o *ProjectTaskDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ProjectTaskDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ProjectTaskDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ProjectTaskDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProjectTaskDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ProjectTaskDto and assigns it to the Result field.
func (o *ProjectTaskDtoListEnvelope) SetResult(v []ProjectTaskDto) {
	o.Result = v
}

func (o ProjectTaskDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProjectTaskDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProjectTaskDtoListEnvelope struct {
	value *ProjectTaskDtoListEnvelope
	isSet bool
}

func (v NullableProjectTaskDtoListEnvelope) Get() *ProjectTaskDtoListEnvelope {
	return v.value
}

func (v *NullableProjectTaskDtoListEnvelope) Set(val *ProjectTaskDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectTaskDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectTaskDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectTaskDtoListEnvelope(val *ProjectTaskDtoListEnvelope) *NullableProjectTaskDtoListEnvelope {
	return &NullableProjectTaskDtoListEnvelope{value: val, isSet: true}
}

func (v NullableProjectTaskDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectTaskDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
