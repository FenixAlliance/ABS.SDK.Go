...
// checks if the ProjectTimeLogDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectTimeLogDtoCollectionQueryParameters{}

// ProjectTimeLogDtoCollectionQueryParameters struct for ProjectTimeLogDtoCollectionQueryParameters
type ProjectTimeLogDtoCollectionQueryParameters struct {
...
func NewProjectTimeLogDtoCollectionQueryParameters() *ProjectTimeLogDtoCollectionQueryParameters {
	this := ProjectTimeLogDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ProjectTimeLogDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ProjectTimeLogDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ProjectTimeLogDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableProjectTimeLogDtoCollectionQueryParameters struct {
	value *ProjectTimeLogDtoCollectionQueryParameters
	isSet bool
}

func (v NullableProjectTimeLogDtoCollectionQueryParameters) Get() *ProjectTimeLogDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableProjectTimeLogDtoCollectionQueryParameters) Set(val *ProjectTimeLogDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectTimeLogDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectTimeLogDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectTimeLogDtoCollectionQueryParameters(val *ProjectTimeLogDtoCollectionQueryParameters) *NullableProjectTimeLogDtoCollectionQueryParameters {
	return &NullableProjectTimeLogDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableProjectTimeLogDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectTimeLogDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
