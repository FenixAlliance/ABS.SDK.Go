...
// checks if the ProjectTaskDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectTaskDtoCollectionQueryParameters{}

// ProjectTaskDtoCollectionQueryParameters struct for ProjectTaskDtoCollectionQueryParameters
type ProjectTaskDtoCollectionQueryParameters struct {
...
func NewProjectTaskDtoCollectionQueryParameters() *ProjectTaskDtoCollectionQueryParameters {
	this := ProjectTaskDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ProjectTaskDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ProjectTaskDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ProjectTaskDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableProjectTaskDtoCollectionQueryParameters struct {
	value *ProjectTaskDtoCollectionQueryParameters
	isSet bool
}

func (v NullableProjectTaskDtoCollectionQueryParameters) Get() *ProjectTaskDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableProjectTaskDtoCollectionQueryParameters) Set(val *ProjectTaskDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectTaskDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectTaskDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectTaskDtoCollectionQueryParameters(val *ProjectTaskDtoCollectionQueryParameters) *NullableProjectTaskDtoCollectionQueryParameters {
	return &NullableProjectTaskDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableProjectTaskDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectTaskDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
