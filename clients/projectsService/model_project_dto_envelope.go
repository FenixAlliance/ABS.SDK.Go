...
// checks if the ProjectDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProjectDtoEnvelope{}

// ProjectDtoEnvelope struct for ProjectDtoEnvelope
type ProjectDtoEnvelope struct {
...
func (o *ProjectDtoEnvelope) SetErrorMessageNil() {
...
func (o *ProjectDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ProjectDtoEnvelope) SetHttpStatusNil() {
...
func (o *ProjectDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProjectDtoEnvelope) SetActivityIdNil() {
...
func (o ProjectDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProjectDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProjectDtoEnvelope struct {
	value *ProjectDtoEnvelope
	isSet bool
}

func (v NullableProjectDtoEnvelope) Get() *ProjectDtoEnvelope {
	return v.value
}

func (v *NullableProjectDtoEnvelope) Set(val *ProjectDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProjectDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProjectDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProjectDtoEnvelope(val *ProjectDtoEnvelope) *NullableProjectDtoEnvelope {
	return &NullableProjectDtoEnvelope{value: val, isSet: true}
}

func (v NullableProjectDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProjectDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
