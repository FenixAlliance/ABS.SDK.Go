...
// checks if the ShareIssuanceDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareIssuanceDtoEnvelope{}

// ShareIssuanceDtoEnvelope struct for ShareIssuanceDtoEnvelope
type ShareIssuanceDtoEnvelope struct {
...
func (o *ShareIssuanceDtoEnvelope) SetErrorMessageNil() {
...
func (o *ShareIssuanceDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ShareIssuanceDtoEnvelope) SetHttpStatusNil() {
...
func (o *ShareIssuanceDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShareIssuanceDtoEnvelope) SetActivityIdNil() {
...
func (o ShareIssuanceDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShareIssuanceDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShareIssuanceDtoEnvelope struct {
	value *ShareIssuanceDtoEnvelope
	isSet bool
}

func (v NullableShareIssuanceDtoEnvelope) Get() *ShareIssuanceDtoEnvelope {
	return v.value
}

func (v *NullableShareIssuanceDtoEnvelope) Set(val *ShareIssuanceDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShareIssuanceDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShareIssuanceDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareIssuanceDtoEnvelope(val *ShareIssuanceDtoEnvelope) *NullableShareIssuanceDtoEnvelope {
	return &NullableShareIssuanceDtoEnvelope{value: val, isSet: true}
}

func (v NullableShareIssuanceDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShareIssuanceDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
