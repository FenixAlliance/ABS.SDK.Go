...
// checks if the BankDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankDtoEnvelope{}

// BankDtoEnvelope struct for BankDtoEnvelope
type BankDtoEnvelope struct {
...
func (o *BankDtoEnvelope) SetErrorMessageNil() {
...
func (o *BankDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BankDtoEnvelope) SetHttpStatusNil() {
...
func (o *BankDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BankDtoEnvelope) SetActivityIdNil() {
...
func (o BankDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BankDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBankDtoEnvelope struct {
	value *BankDtoEnvelope
	isSet bool
}

func (v NullableBankDtoEnvelope) Get() *BankDtoEnvelope {
	return v.value
}

func (v *NullableBankDtoEnvelope) Set(val *BankDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBankDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBankDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankDtoEnvelope(val *BankDtoEnvelope) *NullableBankDtoEnvelope {
	return &NullableBankDtoEnvelope{value: val, isSet: true}
}

func (v NullableBankDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
