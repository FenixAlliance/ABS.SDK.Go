...
// checks if the PaymentCommissionDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentCommissionDtoListEnvelope{}

// PaymentCommissionDtoListEnvelope struct for PaymentCommissionDtoListEnvelope
type PaymentCommissionDtoListEnvelope struct {
	...
	Result []PaymentCommissionDto `json:"result,omitempty"`
}
...
func NewPaymentCommissionDtoListEnvelope() *PaymentCommissionDtoListEnvelope {
	this := PaymentCommissionDtoListEnvelope{}
	return &this
}
...
func (o *PaymentCommissionDtoListEnvelope) SetErrorMessageNil() {
...
func (o *PaymentCommissionDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *PaymentCommissionDtoListEnvelope) SetHttpStatusNil() {
...
func (o *PaymentCommissionDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PaymentCommissionDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []PaymentCommissionDto and assigns it to the Result field.
func (o *PaymentCommissionDtoListEnvelope) SetResult(v []PaymentCommissionDto) {
	o.Result = v
}

func (o PaymentCommissionDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PaymentCommissionDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentCommissionDtoListEnvelope struct {
	value *PaymentCommissionDtoListEnvelope
	isSet bool
}

func (v NullablePaymentCommissionDtoListEnvelope) Get() *PaymentCommissionDtoListEnvelope {
	return v.value
}

func (v *NullablePaymentCommissionDtoListEnvelope) Set(val *PaymentCommissionDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentCommissionDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentCommissionDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentCommissionDtoListEnvelope(val *PaymentCommissionDtoListEnvelope) *NullablePaymentCommissionDtoListEnvelope {
	return &NullablePaymentCommissionDtoListEnvelope{value: val, isSet: true}
}

func (v NullablePaymentCommissionDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentCommissionDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
