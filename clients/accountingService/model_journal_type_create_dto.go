...
// checks if the JournalTypeCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalTypeCreateDto{}

// JournalTypeCreateDto struct for JournalTypeCreateDto
type JournalTypeCreateDto struct {
...
func (o *JournalTypeCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *JournalTypeCreateDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *JournalTypeCreateDto) SetEnrollmentIdNil() {
...
func (o JournalTypeCreateDto) MarshalJSON() ([]byte, error) {
...
func (o JournalTypeCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableJournalTypeCreateDto struct {
	value *JournalTypeCreateDto
	isSet bool
}

func (v NullableJournalTypeCreateDto) Get() *JournalTypeCreateDto {
	return v.value
}

func (v *NullableJournalTypeCreateDto) Set(val *JournalTypeCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJournalTypeCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJournalTypeCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJournalTypeCreateDto(val *JournalTypeCreateDto) *NullableJournalTypeCreateDto {
	return &NullableJournalTypeCreateDto{value: val, isSet: true}
}

func (v NullableJournalTypeCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJournalTypeCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
