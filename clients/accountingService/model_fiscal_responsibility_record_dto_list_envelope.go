...
// checks if the FiscalResponsibilityRecordDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalResponsibilityRecordDtoListEnvelope{}

// FiscalResponsibilityRecordDtoListEnvelope struct for FiscalResponsibilityRecordDtoListEnvelope
type FiscalResponsibilityRecordDtoListEnvelope struct {
...
func NewFiscalResponsibilityRecordDtoListEnvelope() *FiscalResponsibilityRecordDtoListEnvelope {
	this := FiscalResponsibilityRecordDtoListEnvelope{}
	return &this
}
...
func (o *FiscalResponsibilityRecordDtoListEnvelope) SetErrorMessageNil() {
...
func (o *FiscalResponsibilityRecordDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *FiscalResponsibilityRecordDtoListEnvelope) SetHttpStatusNil() {
...
func (o *FiscalResponsibilityRecordDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *FiscalResponsibilityRecordDtoListEnvelope) SetActivityIdNil() {
...
func (o FiscalResponsibilityRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o FiscalResponsibilityRecordDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalResponsibilityRecordDtoListEnvelope struct {
	value *FiscalResponsibilityRecordDtoListEnvelope
	isSet bool
}

func (v NullableFiscalResponsibilityRecordDtoListEnvelope) Get() *FiscalResponsibilityRecordDtoListEnvelope {
	return v.value
}

func (v *NullableFiscalResponsibilityRecordDtoListEnvelope) Set(val *FiscalResponsibilityRecordDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalResponsibilityRecordDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalResponsibilityRecordDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalResponsibilityRecordDtoListEnvelope(val *FiscalResponsibilityRecordDtoListEnvelope) *NullableFiscalResponsibilityRecordDtoListEnvelope {
	return &NullableFiscalResponsibilityRecordDtoListEnvelope{value: val, isSet: true}
}

func (v NullableFiscalResponsibilityRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalResponsibilityRecordDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
