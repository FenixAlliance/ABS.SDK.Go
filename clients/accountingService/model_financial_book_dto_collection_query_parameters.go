...
// checks if the FinancialBookDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FinancialBookDtoCollectionQueryParameters{}

// FinancialBookDtoCollectionQueryParameters struct for FinancialBookDtoCollectionQueryParameters
type FinancialBookDtoCollectionQueryParameters struct {
...
func NewFinancialBookDtoCollectionQueryParameters() *FinancialBookDtoCollectionQueryParameters {
	this := FinancialBookDtoCollectionQueryParameters{}
	return &this
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *FinancialBookDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o FinancialBookDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o FinancialBookDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableFinancialBookDtoCollectionQueryParameters struct {
	value *FinancialBookDtoCollectionQueryParameters
	isSet bool
}

func (v NullableFinancialBookDtoCollectionQueryParameters) Get() *FinancialBookDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableFinancialBookDtoCollectionQueryParameters) Set(val *FinancialBookDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialBookDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialBookDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialBookDtoCollectionQueryParameters(val *FinancialBookDtoCollectionQueryParameters) *NullableFinancialBookDtoCollectionQueryParameters {
	return &NullableFinancialBookDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableFinancialBookDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialBookDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
