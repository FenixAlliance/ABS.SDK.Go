...
// checks if the FiscalRegimeCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalRegimeCreateDto{}

// FiscalRegimeCreateDto struct for FiscalRegimeCreateDto
type FiscalRegimeCreateDto struct {
...
func (o *FiscalRegimeCreateDto) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *FiscalRegimeCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *FiscalRegimeCreateDto) SetFiscalAuthorityIdNil() {
...
func (o *FiscalRegimeCreateDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *FiscalRegimeCreateDto) SetEnrollmentIdNil() {
...
func (o FiscalRegimeCreateDto) MarshalJSON() ([]byte, error) {
...
func (o FiscalRegimeCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalRegimeCreateDto struct {
	value *FiscalRegimeCreateDto
	isSet bool
}

func (v NullableFiscalRegimeCreateDto) Get() *FiscalRegimeCreateDto {
	return v.value
}

func (v *NullableFiscalRegimeCreateDto) Set(val *FiscalRegimeCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalRegimeCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalRegimeCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalRegimeCreateDto(val *FiscalRegimeCreateDto) *NullableFiscalRegimeCreateDto {
	return &NullableFiscalRegimeCreateDto{value: val, isSet: true}
}

func (v NullableFiscalRegimeCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalRegimeCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
