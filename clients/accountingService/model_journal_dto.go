...
// checks if the JournalDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalDto{}

// JournalDto struct for JournalDto
...
func (o *JournalDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *JournalDto) SetDescriptionNil() {
...
func (o *JournalDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *JournalDto) SetLedgerIdNil() {
	o.LedgerId.Set(nil)
}
...
func (o *JournalDto) SetEnrollmentIdNil() {
...
func (o *JournalDto) SetFiscalYearIdNil() {
...
func (o *JournalDto) SetJournalTypeIdNil() {
...
func (o *JournalDto) SetParentJournalIdNil() {
...
func (o *JournalDto) SetFinancialBookIdNil() {
...
func (o JournalDto) MarshalJSON() ([]byte, error) {
...
func (o JournalDto) ToMap() (map[string]interface{}, error) {
...
type NullableJournalDto struct {
	value *JournalDto
	isSet bool
}

func (v NullableJournalDto) Get() *JournalDto {
	return v.value
}

func (v *NullableJournalDto) Set(val *JournalDto) {
	v.value = val
	v.isSet = true
}

func (v NullableJournalDto) IsSet() bool {
	return v.isSet
}

func (v *NullableJournalDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJournalDto(val *JournalDto) *NullableJournalDto {
	return &NullableJournalDto{value: val, isSet: true}
}

func (v NullableJournalDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJournalDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
