...
// checks if the JournalTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalTypeDtoEnvelope{}

// JournalTypeDtoEnvelope struct for JournalTypeDtoEnvelope
type JournalTypeDtoEnvelope struct {
...
func (o *JournalTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *JournalTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *JournalTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *JournalTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JournalTypeDtoEnvelope) SetActivityIdNil() {
...
func (o JournalTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JournalTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJournalTypeDtoEnvelope struct {
	value *JournalTypeDtoEnvelope
	isSet bool
}

func (v NullableJournalTypeDtoEnvelope) Get() *JournalTypeDtoEnvelope {
	return v.value
}

func (v *NullableJournalTypeDtoEnvelope) Set(val *JournalTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJournalTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJournalTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJournalTypeDtoEnvelope(val *JournalTypeDtoEnvelope) *NullableJournalTypeDtoEnvelope {
	return &NullableJournalTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableJournalTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJournalTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
