...
// checks if the FiscalIdentificationTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalIdentificationTypeDtoEnvelope{}

// FiscalIdentificationTypeDtoEnvelope struct for FiscalIdentificationTypeDtoEnvelope
type FiscalIdentificationTypeDtoEnvelope struct {
...
func NewFiscalIdentificationTypeDtoEnvelope() *FiscalIdentificationTypeDtoEnvelope {
	this := FiscalIdentificationTypeDtoEnvelope{}
	return &this
}
...
func (o *FiscalIdentificationTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *FiscalIdentificationTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *FiscalIdentificationTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *FiscalIdentificationTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *FiscalIdentificationTypeDtoEnvelope) SetActivityIdNil() {
...
func (o FiscalIdentificationTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o FiscalIdentificationTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalIdentificationTypeDtoEnvelope struct {
	value *FiscalIdentificationTypeDtoEnvelope
	isSet bool
}

func (v NullableFiscalIdentificationTypeDtoEnvelope) Get() *FiscalIdentificationTypeDtoEnvelope {
	return v.value
}

func (v *NullableFiscalIdentificationTypeDtoEnvelope) Set(val *FiscalIdentificationTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalIdentificationTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalIdentificationTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalIdentificationTypeDtoEnvelope(val *FiscalIdentificationTypeDtoEnvelope) *NullableFiscalIdentificationTypeDtoEnvelope {
	return &NullableFiscalIdentificationTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableFiscalIdentificationTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalIdentificationTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
