...
// checks if the TransactionDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionDtoCollectionQueryParameters{}

// TransactionDtoCollectionQueryParameters struct for TransactionDtoCollectionQueryParameters
type TransactionDtoCollectionQueryParameters struct {
...
func NewTransactionDtoCollectionQueryParameters() *TransactionDtoCollectionQueryParameters {
	this := TransactionDtoCollectionQueryParameters{}
	return &this
}
...
func (o *TransactionDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *TransactionDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *TransactionDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *TransactionDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *TransactionDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *TransactionDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *TransactionDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o TransactionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o TransactionDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionDtoCollectionQueryParameters struct {
	value *TransactionDtoCollectionQueryParameters
	isSet bool
}

func (v NullableTransactionDtoCollectionQueryParameters) Get() *TransactionDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableTransactionDtoCollectionQueryParameters) Set(val *TransactionDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionDtoCollectionQueryParameters(val *TransactionDtoCollectionQueryParameters) *NullableTransactionDtoCollectionQueryParameters {
	return &NullableTransactionDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableTransactionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
