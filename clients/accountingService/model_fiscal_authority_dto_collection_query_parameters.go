...
// checks if the FiscalAuthorityDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalAuthorityDtoCollectionQueryParameters{}

// FiscalAuthorityDtoCollectionQueryParameters struct for FiscalAuthorityDtoCollectionQueryParameters
type FiscalAuthorityDtoCollectionQueryParameters struct {
...
func NewFiscalAuthorityDtoCollectionQueryParameters() *FiscalAuthorityDtoCollectionQueryParameters {
	this := FiscalAuthorityDtoCollectionQueryParameters{}
	return &this
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *FiscalAuthorityDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o FiscalAuthorityDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o FiscalAuthorityDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalAuthorityDtoCollectionQueryParameters struct {
	value *FiscalAuthorityDtoCollectionQueryParameters
	isSet bool
}

func (v NullableFiscalAuthorityDtoCollectionQueryParameters) Get() *FiscalAuthorityDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableFiscalAuthorityDtoCollectionQueryParameters) Set(val *FiscalAuthorityDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalAuthorityDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalAuthorityDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalAuthorityDtoCollectionQueryParameters(val *FiscalAuthorityDtoCollectionQueryParameters) *NullableFiscalAuthorityDtoCollectionQueryParameters {
	return &NullableFiscalAuthorityDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableFiscalAuthorityDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalAuthorityDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
