...
// checks if the FiscalPeriodDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalPeriodDto{}

// FiscalPeriodDto struct for FiscalPeriodDto
...
func (o *FiscalPeriodDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *FiscalPeriodDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *FiscalPeriodDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *FiscalPeriodDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *FiscalPeriodDto) SetEnrollmentIdNil() {
...
func (o *FiscalPeriodDto) SetFiscalYearIdNil() {
...
func (o FiscalPeriodDto) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalPeriodDto struct {
	value *FiscalPeriodDto
	isSet bool
}

func (v NullableFiscalPeriodDto) Get() *FiscalPeriodDto {
	return v.value
}

func (v *NullableFiscalPeriodDto) Set(val *FiscalPeriodDto) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalPeriodDto) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalPeriodDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalPeriodDto(val *FiscalPeriodDto) *NullableFiscalPeriodDto {
	return &NullableFiscalPeriodDto{value: val, isSet: true}
}

func (v NullableFiscalPeriodDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalPeriodDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
