...
// checks if the FinancialBookDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FinancialBookDtoEnvelope{}

// FinancialBookDtoEnvelope struct for FinancialBookDtoEnvelope
type FinancialBookDtoEnvelope struct {
...
func (o *FinancialBookDtoEnvelope) SetErrorMessageNil() {
...
func (o *FinancialBookDtoEnvelope) SetCorrelationIdNil() {
...
func (o *FinancialBookDtoEnvelope) SetHttpStatusNil() {
...
func (o *FinancialBookDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *FinancialBookDtoEnvelope) SetActivityIdNil() {
...
func (o FinancialBookDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o FinancialBookDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableFinancialBookDtoEnvelope struct {
	value *FinancialBookDtoEnvelope
	isSet bool
}

func (v NullableFinancialBookDtoEnvelope) Get() *FinancialBookDtoEnvelope {
	return v.value
}

func (v *NullableFinancialBookDtoEnvelope) Set(val *FinancialBookDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableFinancialBookDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableFinancialBookDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFinancialBookDtoEnvelope(val *FinancialBookDtoEnvelope) *NullableFinancialBookDtoEnvelope {
	return &NullableFinancialBookDtoEnvelope{value: val, isSet: true}
}

func (v NullableFinancialBookDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFinancialBookDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
