...
// checks if the LoanTypeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoanTypeDtoCollectionQueryParameters{}

// LoanTypeDtoCollectionQueryParameters struct for LoanTypeDtoCollectionQueryParameters
type LoanTypeDtoCollectionQueryParameters struct {
...
func NewLoanTypeDtoCollectionQueryParameters() *LoanTypeDtoCollectionQueryParameters {
	this := LoanTypeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LoanTypeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LoanTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LoanTypeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLoanTypeDtoCollectionQueryParameters struct {
	value *LoanTypeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLoanTypeDtoCollectionQueryParameters) Get() *LoanTypeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLoanTypeDtoCollectionQueryParameters) Set(val *LoanTypeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLoanTypeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLoanTypeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoanTypeDtoCollectionQueryParameters(val *LoanTypeDtoCollectionQueryParameters) *NullableLoanTypeDtoCollectionQueryParameters {
	return &NullableLoanTypeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLoanTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoanTypeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
