...
// checks if the ShareTransferDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareTransferDtoCollectionQueryParameters{}

// ShareTransferDtoCollectionQueryParameters struct for ShareTransferDtoCollectionQueryParameters
type ShareTransferDtoCollectionQueryParameters struct {
...
func NewShareTransferDtoCollectionQueryParameters() *ShareTransferDtoCollectionQueryParameters {
	this := ShareTransferDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ShareTransferDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ShareTransferDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ShareTransferDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableShareTransferDtoCollectionQueryParameters struct {
	value *ShareTransferDtoCollectionQueryParameters
	isSet bool
}

func (v NullableShareTransferDtoCollectionQueryParameters) Get() *ShareTransferDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableShareTransferDtoCollectionQueryParameters) Set(val *ShareTransferDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableShareTransferDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableShareTransferDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareTransferDtoCollectionQueryParameters(val *ShareTransferDtoCollectionQueryParameters) *NullableShareTransferDtoCollectionQueryParameters {
	return &NullableShareTransferDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableShareTransferDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShareTransferDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
