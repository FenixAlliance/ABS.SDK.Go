...
// checks if the LoanDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoanDtoEnvelope{}

// LoanDtoEnvelope struct for LoanDtoEnvelope
type LoanDtoEnvelope struct {
...
func (o *LoanDtoEnvelope) SetErrorMessageNil() {
...
func (o *LoanDtoEnvelope) SetCorrelationIdNil() {
...
func (o *LoanDtoEnvelope) SetHttpStatusNil() {
...
func (o *LoanDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LoanDtoEnvelope) SetActivityIdNil() {
...
func (o LoanDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LoanDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLoanDtoEnvelope struct {
	value *LoanDtoEnvelope
	isSet bool
}

func (v NullableLoanDtoEnvelope) Get() *LoanDtoEnvelope {
	return v.value
}

func (v *NullableLoanDtoEnvelope) Set(val *LoanDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLoanDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLoanDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoanDtoEnvelope(val *LoanDtoEnvelope) *NullableLoanDtoEnvelope {
	return &NullableLoanDtoEnvelope{value: val, isSet: true}
}

func (v NullableLoanDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoanDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
