...
// checks if the ShareTransferReasonDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareTransferReasonDtoEnvelope{}

// ShareTransferReasonDtoEnvelope struct for ShareTransferReasonDtoEnvelope
type ShareTransferReasonDtoEnvelope struct {
...
func NewShareTransferReasonDtoEnvelope() *ShareTransferReasonDtoEnvelope {
	this := ShareTransferReasonDtoEnvelope{}
	return &this
}
...
func (o *ShareTransferReasonDtoEnvelope) SetErrorMessageNil() {
...
func (o *ShareTransferReasonDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ShareTransferReasonDtoEnvelope) SetHttpStatusNil() {
...
func (o *ShareTransferReasonDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShareTransferReasonDtoEnvelope) SetActivityIdNil() {
...
func (o ShareTransferReasonDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShareTransferReasonDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShareTransferReasonDtoEnvelope struct {
	value *ShareTransferReasonDtoEnvelope
	isSet bool
}

func (v NullableShareTransferReasonDtoEnvelope) Get() *ShareTransferReasonDtoEnvelope {
	return v.value
}

func (v *NullableShareTransferReasonDtoEnvelope) Set(val *ShareTransferReasonDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShareTransferReasonDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShareTransferReasonDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareTransferReasonDtoEnvelope(val *ShareTransferReasonDtoEnvelope) *NullableShareTransferReasonDtoEnvelope {
	return &NullableShareTransferReasonDtoEnvelope{value: val, isSet: true}
}

func (v NullableShareTransferReasonDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShareTransferReasonDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
