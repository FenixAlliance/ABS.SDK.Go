...
// checks if the LoanApplicationDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoanApplicationDtoCollectionQueryParameters{}

// LoanApplicationDtoCollectionQueryParameters struct for LoanApplicationDtoCollectionQueryParameters
type LoanApplicationDtoCollectionQueryParameters struct {
...
func NewLoanApplicationDtoCollectionQueryParameters() *LoanApplicationDtoCollectionQueryParameters {
	this := LoanApplicationDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LoanApplicationDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LoanApplicationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LoanApplicationDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLoanApplicationDtoCollectionQueryParameters struct {
	value *LoanApplicationDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLoanApplicationDtoCollectionQueryParameters) Get() *LoanApplicationDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLoanApplicationDtoCollectionQueryParameters) Set(val *LoanApplicationDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLoanApplicationDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLoanApplicationDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoanApplicationDtoCollectionQueryParameters(val *LoanApplicationDtoCollectionQueryParameters) *NullableLoanApplicationDtoCollectionQueryParameters {
	return &NullableLoanApplicationDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLoanApplicationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoanApplicationDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
