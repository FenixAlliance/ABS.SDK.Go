...
// checks if the TaxRateDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxRateDtoEnvelope{}

// TaxRateDtoEnvelope struct for TaxRateDtoEnvelope
type TaxRateDtoEnvelope struct {
...
func (o *TaxRateDtoEnvelope) SetErrorMessageNil() {
...
func (o *TaxRateDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TaxRateDtoEnvelope) SetHttpStatusNil() {
...
func (o *TaxRateDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TaxRateDtoEnvelope) SetActivityIdNil() {
...
func (o TaxRateDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TaxRateDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTaxRateDtoEnvelope struct {
	value *TaxRateDtoEnvelope
	isSet bool
}

func (v NullableTaxRateDtoEnvelope) Get() *TaxRateDtoEnvelope {
	return v.value
}

func (v *NullableTaxRateDtoEnvelope) Set(val *TaxRateDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxRateDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxRateDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxRateDtoEnvelope(val *TaxRateDtoEnvelope) *NullableTaxRateDtoEnvelope {
	return &NullableTaxRateDtoEnvelope{value: val, isSet: true}
}

func (v NullableTaxRateDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxRateDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
