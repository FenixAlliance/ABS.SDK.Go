...
// checks if the ShareTransferReasonCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShareTransferReasonCreateDto{}

// ShareTransferReasonCreateDto struct for ShareTransferReasonCreateDto
type ShareTransferReasonCreateDto struct {
...
func NewShareTransferReasonCreateDto() *ShareTransferReasonCreateDto {
	this := ShareTransferReasonCreateDto{}
	return &this
}
...
func (o *ShareTransferReasonCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *ShareTransferReasonCreateDto) SetDescriptionNil() {
...
func (o *ShareTransferReasonCreateDto) GetEnrollmentId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ShareTransferReasonCreateDto) GetEnrollmentIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ShareTransferReasonCreateDto) HasEnrollmentId() bool {
...
func (o *ShareTransferReasonCreateDto) SetEnrollmentId(v string) {
	o.EnrollmentId.Set(&v)
}
// SetEnrollmentIdNil sets the value for EnrollmentId to be an explicit nil
func (o *ShareTransferReasonCreateDto) SetEnrollmentIdNil() {
	o.EnrollmentId.Set(nil)
}

// UnsetEnrollmentId ensures that no value is present for EnrollmentId, not even an explicit nil
func (o *ShareTransferReasonCreateDto) UnsetEnrollmentId() {
	o.EnrollmentId.Unset()
}

// GetTenantId returns the TenantId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ShareTransferReasonCreateDto) GetTenantId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ShareTransferReasonCreateDto) GetTenantIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ShareTransferReasonCreateDto) HasTenantId() bool {
...
func (o *ShareTransferReasonCreateDto) SetTenantId(v string) {
	o.TenantId.Set(&v)
}
// SetTenantIdNil sets the value for TenantId to be an explicit nil
func (o *ShareTransferReasonCreateDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}

// UnsetTenantId ensures that no value is present for TenantId, not even an explicit nil
func (o *ShareTransferReasonCreateDto) UnsetTenantId() {
	o.TenantId.Unset()
}

func (o ShareTransferReasonCreateDto) MarshalJSON() ([]byte, error) {
...
func (o ShareTransferReasonCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableShareTransferReasonCreateDto struct {
	value *ShareTransferReasonCreateDto
	isSet bool
}

func (v NullableShareTransferReasonCreateDto) Get() *ShareTransferReasonCreateDto {
	return v.value
}

func (v *NullableShareTransferReasonCreateDto) Set(val *ShareTransferReasonCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableShareTransferReasonCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableShareTransferReasonCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShareTransferReasonCreateDto(val *ShareTransferReasonCreateDto) *NullableShareTransferReasonCreateDto {
	return &NullableShareTransferReasonCreateDto{value: val, isSet: true}
}

func (v NullableShareTransferReasonCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShareTransferReasonCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
