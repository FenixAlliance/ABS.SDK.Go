...
// checks if the LoanTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoanTypeDtoEnvelope{}

// LoanTypeDtoEnvelope struct for LoanTypeDtoEnvelope
type LoanTypeDtoEnvelope struct {
...
func (o *LoanTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *LoanTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *LoanTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *LoanTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LoanTypeDtoEnvelope) SetActivityIdNil() {
...
func (o LoanTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LoanTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLoanTypeDtoEnvelope struct {
	value *LoanTypeDtoEnvelope
	isSet bool
}

func (v NullableLoanTypeDtoEnvelope) Get() *LoanTypeDtoEnvelope {
	return v.value
}

func (v *NullableLoanTypeDtoEnvelope) Set(val *LoanTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLoanTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLoanTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoanTypeDtoEnvelope(val *LoanTypeDtoEnvelope) *NullableLoanTypeDtoEnvelope {
	return &NullableLoanTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableLoanTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoanTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
