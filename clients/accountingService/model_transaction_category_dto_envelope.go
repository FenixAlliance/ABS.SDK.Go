...
// checks if the TransactionCategoryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionCategoryDtoEnvelope{}

// TransactionCategoryDtoEnvelope struct for TransactionCategoryDtoEnvelope
type TransactionCategoryDtoEnvelope struct {
...
func NewTransactionCategoryDtoEnvelope() *TransactionCategoryDtoEnvelope {
	this := TransactionCategoryDtoEnvelope{}
	return &this
}
...
func (o *TransactionCategoryDtoEnvelope) SetErrorMessageNil() {
...
func (o *TransactionCategoryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TransactionCategoryDtoEnvelope) SetHttpStatusNil() {
...
func (o *TransactionCategoryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TransactionCategoryDtoEnvelope) SetActivityIdNil() {
...
func (o TransactionCategoryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TransactionCategoryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionCategoryDtoEnvelope struct {
	value *TransactionCategoryDtoEnvelope
	isSet bool
}

func (v NullableTransactionCategoryDtoEnvelope) Get() *TransactionCategoryDtoEnvelope {
	return v.value
}

func (v *NullableTransactionCategoryDtoEnvelope) Set(val *TransactionCategoryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionCategoryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionCategoryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionCategoryDtoEnvelope(val *TransactionCategoryDtoEnvelope) *NullableTransactionCategoryDtoEnvelope {
	return &NullableTransactionCategoryDtoEnvelope{value: val, isSet: true}
}

func (v NullableTransactionCategoryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionCategoryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
