...
// checks if the FiscalYearDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalYearDtoEnvelope{}

// FiscalYearDtoEnvelope struct for FiscalYearDtoEnvelope
type FiscalYearDtoEnvelope struct {
...
func (o *FiscalYearDtoEnvelope) SetErrorMessageNil() {
...
func (o *FiscalYearDtoEnvelope) SetCorrelationIdNil() {
...
func (o *FiscalYearDtoEnvelope) SetHttpStatusNil() {
...
func (o *FiscalYearDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *FiscalYearDtoEnvelope) SetActivityIdNil() {
...
func (o FiscalYearDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o FiscalYearDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalYearDtoEnvelope struct {
	value *FiscalYearDtoEnvelope
	isSet bool
}

func (v NullableFiscalYearDtoEnvelope) Get() *FiscalYearDtoEnvelope {
	return v.value
}

func (v *NullableFiscalYearDtoEnvelope) Set(val *FiscalYearDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalYearDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalYearDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalYearDtoEnvelope(val *FiscalYearDtoEnvelope) *NullableFiscalYearDtoEnvelope {
	return &NullableFiscalYearDtoEnvelope{value: val, isSet: true}
}

func (v NullableFiscalYearDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalYearDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
