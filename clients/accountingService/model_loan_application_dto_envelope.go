...
// checks if the LoanApplicationDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoanApplicationDtoEnvelope{}

// LoanApplicationDtoEnvelope struct for LoanApplicationDtoEnvelope
type LoanApplicationDtoEnvelope struct {
...
func NewLoanApplicationDtoEnvelope() *LoanApplicationDtoEnvelope {
	this := LoanApplicationDtoEnvelope{}
	return &this
}
...
func (o *LoanApplicationDtoEnvelope) SetErrorMessageNil() {
...
func (o *LoanApplicationDtoEnvelope) SetCorrelationIdNil() {
...
func (o *LoanApplicationDtoEnvelope) SetHttpStatusNil() {
...
func (o *LoanApplicationDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LoanApplicationDtoEnvelope) SetActivityIdNil() {
...
func (o LoanApplicationDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LoanApplicationDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLoanApplicationDtoEnvelope struct {
	value *LoanApplicationDtoEnvelope
	isSet bool
}

func (v NullableLoanApplicationDtoEnvelope) Get() *LoanApplicationDtoEnvelope {
	return v.value
}

func (v *NullableLoanApplicationDtoEnvelope) Set(val *LoanApplicationDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLoanApplicationDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLoanApplicationDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoanApplicationDtoEnvelope(val *LoanApplicationDtoEnvelope) *NullableLoanApplicationDtoEnvelope {
	return &NullableLoanApplicationDtoEnvelope{value: val, isSet: true}
}

func (v NullableLoanApplicationDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoanApplicationDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
