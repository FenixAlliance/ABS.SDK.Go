...
// checks if the InvoiceEnumerationRangeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceEnumerationRangeDtoCollectionQueryParameters{}

// InvoiceEnumerationRangeDtoCollectionQueryParameters struct for InvoiceEnumerationRangeDtoCollectionQueryParameters
type InvoiceEnumerationRangeDtoCollectionQueryParameters struct {
...
func NewInvoiceEnumerationRangeDtoCollectionQueryParameters() *InvoiceEnumerationRangeDtoCollectionQueryParameters {
	this := InvoiceEnumerationRangeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o InvoiceEnumerationRangeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o InvoiceEnumerationRangeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceEnumerationRangeDtoCollectionQueryParameters struct {
	value *InvoiceEnumerationRangeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableInvoiceEnumerationRangeDtoCollectionQueryParameters) Get() *InvoiceEnumerationRangeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableInvoiceEnumerationRangeDtoCollectionQueryParameters) Set(val *InvoiceEnumerationRangeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceEnumerationRangeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceEnumerationRangeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceEnumerationRangeDtoCollectionQueryParameters(val *InvoiceEnumerationRangeDtoCollectionQueryParameters) *NullableInvoiceEnumerationRangeDtoCollectionQueryParameters {
	return &NullableInvoiceEnumerationRangeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableInvoiceEnumerationRangeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceEnumerationRangeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
