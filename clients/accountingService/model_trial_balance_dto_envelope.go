...
// checks if the TrialBalanceDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrialBalanceDtoEnvelope{}

// TrialBalanceDtoEnvelope struct for TrialBalanceDtoEnvelope
type TrialBalanceDtoEnvelope struct {
	...
	Result *TrialBalanceDto `json:"result,omitempty"`
}
...
func (o *TrialBalanceDtoEnvelope) SetErrorMessageNil() {
...
func (o *TrialBalanceDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TrialBalanceDtoEnvelope) SetHttpStatusNil() {
...
func (o *TrialBalanceDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TrialBalanceDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given TrialBalanceDto and assigns it to the Result field.
func (o *TrialBalanceDtoEnvelope) SetResult(v TrialBalanceDto) {
	o.Result = &v
}

func (o TrialBalanceDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TrialBalanceDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTrialBalanceDtoEnvelope struct {
	value *TrialBalanceDtoEnvelope
	isSet bool
}

func (v NullableTrialBalanceDtoEnvelope) Get() *TrialBalanceDtoEnvelope {
	return v.value
}

func (v *NullableTrialBalanceDtoEnvelope) Set(val *TrialBalanceDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTrialBalanceDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTrialBalanceDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrialBalanceDtoEnvelope(val *TrialBalanceDtoEnvelope) *NullableTrialBalanceDtoEnvelope {
	return &NullableTrialBalanceDtoEnvelope{value: val, isSet: true}
}

func (v NullableTrialBalanceDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrialBalanceDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
