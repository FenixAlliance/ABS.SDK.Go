...
// checks if the AccountGroupDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountGroupDtoListEnvelope{}

// AccountGroupDtoListEnvelope struct for AccountGroupDtoListEnvelope
type AccountGroupDtoListEnvelope struct {
...
func NewAccountGroupDtoListEnvelope() *AccountGroupDtoListEnvelope {
	this := AccountGroupDtoListEnvelope{}
	return &this
}
...
func (o *AccountGroupDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AccountGroupDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AccountGroupDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AccountGroupDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AccountGroupDtoListEnvelope) SetActivityIdNil() {
...
func (o AccountGroupDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AccountGroupDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAccountGroupDtoListEnvelope struct {
	value *AccountGroupDtoListEnvelope
	isSet bool
}

func (v NullableAccountGroupDtoListEnvelope) Get() *AccountGroupDtoListEnvelope {
	return v.value
}

func (v *NullableAccountGroupDtoListEnvelope) Set(val *AccountGroupDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountGroupDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountGroupDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountGroupDtoListEnvelope(val *AccountGroupDtoListEnvelope) *NullableAccountGroupDtoListEnvelope {
	return &NullableAccountGroupDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAccountGroupDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountGroupDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
