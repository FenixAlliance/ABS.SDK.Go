...
// checks if the PaymentCommissionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentCommissionDtoEnvelope{}

// PaymentCommissionDtoEnvelope struct for PaymentCommissionDtoEnvelope
type PaymentCommissionDtoEnvelope struct {
...
func NewPaymentCommissionDtoEnvelope() *PaymentCommissionDtoEnvelope {
	this := PaymentCommissionDtoEnvelope{}
	return &this
}
...
func (o *PaymentCommissionDtoEnvelope) SetErrorMessageNil() {
...
func (o *PaymentCommissionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *PaymentCommissionDtoEnvelope) SetHttpStatusNil() {
...
func (o *PaymentCommissionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PaymentCommissionDtoEnvelope) SetActivityIdNil() {
...
func (o PaymentCommissionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PaymentCommissionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentCommissionDtoEnvelope struct {
	value *PaymentCommissionDtoEnvelope
	isSet bool
}

func (v NullablePaymentCommissionDtoEnvelope) Get() *PaymentCommissionDtoEnvelope {
	return v.value
}

func (v *NullablePaymentCommissionDtoEnvelope) Set(val *PaymentCommissionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentCommissionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentCommissionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentCommissionDtoEnvelope(val *PaymentCommissionDtoEnvelope) *NullablePaymentCommissionDtoEnvelope {
	return &NullablePaymentCommissionDtoEnvelope{value: val, isSet: true}
}

func (v NullablePaymentCommissionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentCommissionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
