...
// checks if the BankAccountDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankAccountDtoListEnvelope{}

// BankAccountDtoListEnvelope struct for BankAccountDtoListEnvelope
type BankAccountDtoListEnvelope struct {
...
func NewBankAccountDtoListEnvelope() *BankAccountDtoListEnvelope {
	this := BankAccountDtoListEnvelope{}
	return &this
}
...
func (o *BankAccountDtoListEnvelope) SetErrorMessageNil() {
...
func (o *BankAccountDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *BankAccountDtoListEnvelope) SetHttpStatusNil() {
...
func (o *BankAccountDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BankAccountDtoListEnvelope) SetActivityIdNil() {
...
func (o BankAccountDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BankAccountDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBankAccountDtoListEnvelope struct {
	value *BankAccountDtoListEnvelope
	isSet bool
}

func (v NullableBankAccountDtoListEnvelope) Get() *BankAccountDtoListEnvelope {
	return v.value
}

func (v *NullableBankAccountDtoListEnvelope) Set(val *BankAccountDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBankAccountDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBankAccountDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankAccountDtoListEnvelope(val *BankAccountDtoListEnvelope) *NullableBankAccountDtoListEnvelope {
	return &NullableBankAccountDtoListEnvelope{value: val, isSet: true}
}

func (v NullableBankAccountDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankAccountDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
