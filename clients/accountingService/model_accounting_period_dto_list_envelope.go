...
// checks if the AccountingPeriodDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountingPeriodDtoListEnvelope{}

// AccountingPeriodDtoListEnvelope struct for AccountingPeriodDtoListEnvelope
type AccountingPeriodDtoListEnvelope struct {
	...
	Result []AccountingPeriodDto `json:"result,omitempty"`
}
...
func NewAccountingPeriodDtoListEnvelope() *AccountingPeriodDtoListEnvelope {
	this := AccountingPeriodDtoListEnvelope{}
	return &this
}
...
func (o *AccountingPeriodDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AccountingPeriodDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AccountingPeriodDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AccountingPeriodDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AccountingPeriodDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []AccountingPeriodDto and assigns it to the Result field.
func (o *AccountingPeriodDtoListEnvelope) SetResult(v []AccountingPeriodDto) {
	o.Result = v
}

func (o AccountingPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AccountingPeriodDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAccountingPeriodDtoListEnvelope struct {
	value *AccountingPeriodDtoListEnvelope
	isSet bool
}

func (v NullableAccountingPeriodDtoListEnvelope) Get() *AccountingPeriodDtoListEnvelope {
	return v.value
}

func (v *NullableAccountingPeriodDtoListEnvelope) Set(val *AccountingPeriodDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountingPeriodDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountingPeriodDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountingPeriodDtoListEnvelope(val *AccountingPeriodDtoListEnvelope) *NullableAccountingPeriodDtoListEnvelope {
	return &NullableAccountingPeriodDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAccountingPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountingPeriodDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
