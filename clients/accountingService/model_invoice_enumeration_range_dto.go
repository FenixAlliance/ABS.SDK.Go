...
// checks if the InvoiceEnumerationRangeDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceEnumerationRangeDto{}

// InvoiceEnumerationRangeDto struct for InvoiceEnumerationRangeDto
type InvoiceEnumerationRangeDto struct {
...
func NewInvoiceEnumerationRangeDto() *InvoiceEnumerationRangeDto {
	this := InvoiceEnumerationRangeDto{}
	return &this
}
...
func (o *InvoiceEnumerationRangeDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDto) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDto) SetSuffixNil() {
	o.Suffix.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDto) SetIdentifierNil() {
...
func (o *InvoiceEnumerationRangeDto) SetQualifiedNameNil() {
...
func (o *InvoiceEnumerationRangeDto) SetFiscalAuthorityIdNil() {
...
func (o *InvoiceEnumerationRangeDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDto) SetEnrollmentIdNil() {
...
func (o InvoiceEnumerationRangeDto) MarshalJSON() ([]byte, error) {
...
func (o InvoiceEnumerationRangeDto) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceEnumerationRangeDto struct {
	value *InvoiceEnumerationRangeDto
	isSet bool
}

func (v NullableInvoiceEnumerationRangeDto) Get() *InvoiceEnumerationRangeDto {
	return v.value
}

func (v *NullableInvoiceEnumerationRangeDto) Set(val *InvoiceEnumerationRangeDto) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceEnumerationRangeDto) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceEnumerationRangeDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceEnumerationRangeDto(val *InvoiceEnumerationRangeDto) *NullableInvoiceEnumerationRangeDto {
	return &NullableInvoiceEnumerationRangeDto{value: val, isSet: true}
}

func (v NullableInvoiceEnumerationRangeDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceEnumerationRangeDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
