...
// checks if the AppliedItemTaxRecordDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppliedItemTaxRecordDtoIReadOnlyListEnvelope{}

// AppliedItemTaxRecordDtoIReadOnlyListEnvelope struct for AppliedItemTaxRecordDtoIReadOnlyListEnvelope
type AppliedItemTaxRecordDtoIReadOnlyListEnvelope struct {
	...
	Result []AppliedItemTaxRecordDto `json:"result,omitempty"`
}
...
func NewAppliedItemTaxRecordDtoIReadOnlyListEnvelope() *AppliedItemTaxRecordDtoIReadOnlyListEnvelope {
	this := AppliedItemTaxRecordDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) GetResult() []AppliedItemTaxRecordDto {
	if o == nil {
		var ret []AppliedItemTaxRecordDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []AppliedItemTaxRecordDto and assigns it to the Result field.
func (o *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) SetResult(v []AppliedItemTaxRecordDto) {
	o.Result = v
}

func (o AppliedItemTaxRecordDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AppliedItemTaxRecordDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope struct {
	value *AppliedItemTaxRecordDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope) Get() *AppliedItemTaxRecordDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope) Set(val *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope(val *AppliedItemTaxRecordDtoIReadOnlyListEnvelope) *NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope {
	return &NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppliedItemTaxRecordDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
