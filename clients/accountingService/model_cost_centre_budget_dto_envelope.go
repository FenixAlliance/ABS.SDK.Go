...
// checks if the CostCentreBudgetDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CostCentreBudgetDtoEnvelope{}

// CostCentreBudgetDtoEnvelope struct for CostCentreBudgetDtoEnvelope
type CostCentreBudgetDtoEnvelope struct {
...
func NewCostCentreBudgetDtoEnvelope() *CostCentreBudgetDtoEnvelope {
	this := CostCentreBudgetDtoEnvelope{}
	return &this
}
...
func (o *CostCentreBudgetDtoEnvelope) SetErrorMessageNil() {
...
func (o *CostCentreBudgetDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CostCentreBudgetDtoEnvelope) SetHttpStatusNil() {
...
func (o *CostCentreBudgetDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CostCentreBudgetDtoEnvelope) SetActivityIdNil() {
...
func (o CostCentreBudgetDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CostCentreBudgetDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCostCentreBudgetDtoEnvelope struct {
	value *CostCentreBudgetDtoEnvelope
	isSet bool
}

func (v NullableCostCentreBudgetDtoEnvelope) Get() *CostCentreBudgetDtoEnvelope {
	return v.value
}

func (v *NullableCostCentreBudgetDtoEnvelope) Set(val *CostCentreBudgetDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCostCentreBudgetDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCostCentreBudgetDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCostCentreBudgetDtoEnvelope(val *CostCentreBudgetDtoEnvelope) *NullableCostCentreBudgetDtoEnvelope {
	return &NullableCostCentreBudgetDtoEnvelope{value: val, isSet: true}
}

func (v NullableCostCentreBudgetDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCostCentreBudgetDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
