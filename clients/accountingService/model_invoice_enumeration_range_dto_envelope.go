...
// checks if the InvoiceEnumerationRangeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceEnumerationRangeDtoEnvelope{}

// InvoiceEnumerationRangeDtoEnvelope struct for InvoiceEnumerationRangeDtoEnvelope
type InvoiceEnumerationRangeDtoEnvelope struct {
...
func NewInvoiceEnumerationRangeDtoEnvelope() *InvoiceEnumerationRangeDtoEnvelope {
	this := InvoiceEnumerationRangeDtoEnvelope{}
	return &this
}
...
func (o *InvoiceEnumerationRangeDtoEnvelope) SetErrorMessageNil() {
...
func (o *InvoiceEnumerationRangeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *InvoiceEnumerationRangeDtoEnvelope) SetHttpStatusNil() {
...
func (o *InvoiceEnumerationRangeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *InvoiceEnumerationRangeDtoEnvelope) SetActivityIdNil() {
...
func (o InvoiceEnumerationRangeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InvoiceEnumerationRangeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceEnumerationRangeDtoEnvelope struct {
	value *InvoiceEnumerationRangeDtoEnvelope
	isSet bool
}

func (v NullableInvoiceEnumerationRangeDtoEnvelope) Get() *InvoiceEnumerationRangeDtoEnvelope {
	return v.value
}

func (v *NullableInvoiceEnumerationRangeDtoEnvelope) Set(val *InvoiceEnumerationRangeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceEnumerationRangeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceEnumerationRangeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceEnumerationRangeDtoEnvelope(val *InvoiceEnumerationRangeDtoEnvelope) *NullableInvoiceEnumerationRangeDtoEnvelope {
	return &NullableInvoiceEnumerationRangeDtoEnvelope{value: val, isSet: true}
}

func (v NullableInvoiceEnumerationRangeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceEnumerationRangeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
