...
// checks if the AccountRelationDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountRelationDtoListEnvelope{}

// AccountRelationDtoListEnvelope struct for AccountRelationDtoListEnvelope
type AccountRelationDtoListEnvelope struct {
	...
	Result []AccountRelationDto `json:"result,omitempty"`
}
...
func NewAccountRelationDtoListEnvelope() *AccountRelationDtoListEnvelope {
	this := AccountRelationDtoListEnvelope{}
	return &this
}
...
func (o *AccountRelationDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AccountRelationDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AccountRelationDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AccountRelationDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AccountRelationDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []AccountRelationDto and assigns it to the Result field.
func (o *AccountRelationDtoListEnvelope) SetResult(v []AccountRelationDto) {
	o.Result = v
}

func (o AccountRelationDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AccountRelationDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAccountRelationDtoListEnvelope struct {
	value *AccountRelationDtoListEnvelope
	isSet bool
}

func (v NullableAccountRelationDtoListEnvelope) Get() *AccountRelationDtoListEnvelope {
	return v.value
}

func (v *NullableAccountRelationDtoListEnvelope) Set(val *AccountRelationDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountRelationDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountRelationDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountRelationDtoListEnvelope(val *AccountRelationDtoListEnvelope) *NullableAccountRelationDtoListEnvelope {
	return &NullableAccountRelationDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAccountRelationDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountRelationDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
