...
// checks if the CommissionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommissionDtoEnvelope{}

// CommissionDtoEnvelope struct for CommissionDtoEnvelope
type CommissionDtoEnvelope struct {
...
func (o *CommissionDtoEnvelope) SetErrorMessageNil() {
...
func (o *CommissionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CommissionDtoEnvelope) SetHttpStatusNil() {
...
func (o *CommissionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CommissionDtoEnvelope) SetActivityIdNil() {
...
func (o CommissionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CommissionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCommissionDtoEnvelope struct {
	value *CommissionDtoEnvelope
	isSet bool
}

func (v NullableCommissionDtoEnvelope) Get() *CommissionDtoEnvelope {
	return v.value
}

func (v *NullableCommissionDtoEnvelope) Set(val *CommissionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCommissionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCommissionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommissionDtoEnvelope(val *CommissionDtoEnvelope) *NullableCommissionDtoEnvelope {
	return &NullableCommissionDtoEnvelope{value: val, isSet: true}
}

func (v NullableCommissionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommissionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
