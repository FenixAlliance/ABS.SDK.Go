...
// checks if the TaxRateDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaxRateDtoListEnvelope{}

// TaxRateDtoListEnvelope struct for TaxRateDtoListEnvelope
type TaxRateDtoListEnvelope struct {
	...
	Result []TaxRateDto `json:"result,omitempty"`
}
...
func (o *TaxRateDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TaxRateDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TaxRateDtoListEnvelope) SetHttpStatusNil() {
...
func (o *TaxRateDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TaxRateDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []TaxRateDto and assigns it to the Result field.
func (o *TaxRateDtoListEnvelope) SetResult(v []TaxRateDto) {
	o.Result = v
}

func (o TaxRateDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TaxRateDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTaxRateDtoListEnvelope struct {
	value *TaxRateDtoListEnvelope
	isSet bool
}

func (v NullableTaxRateDtoListEnvelope) Get() *TaxRateDtoListEnvelope {
	return v.value
}

func (v *NullableTaxRateDtoListEnvelope) Set(val *TaxRateDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTaxRateDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTaxRateDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaxRateDtoListEnvelope(val *TaxRateDtoListEnvelope) *NullableTaxRateDtoListEnvelope {
	return &NullableTaxRateDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTaxRateDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaxRateDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
