...
// checks if the CostCentreBudgetDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CostCentreBudgetDtoListEnvelope{}

// CostCentreBudgetDtoListEnvelope struct for CostCentreBudgetDtoListEnvelope
type CostCentreBudgetDtoListEnvelope struct {
	...
	Result []CostCentreBudgetDto `json:"result,omitempty"`
}
...
func NewCostCentreBudgetDtoListEnvelope() *CostCentreBudgetDtoListEnvelope {
	this := CostCentreBudgetDtoListEnvelope{}
	return &this
}
...
func (o *CostCentreBudgetDtoListEnvelope) SetErrorMessageNil() {
...
func (o *CostCentreBudgetDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *CostCentreBudgetDtoListEnvelope) SetHttpStatusNil() {
...
func (o *CostCentreBudgetDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CostCentreBudgetDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []CostCentreBudgetDto and assigns it to the Result field.
func (o *CostCentreBudgetDtoListEnvelope) SetResult(v []CostCentreBudgetDto) {
	o.Result = v
}

func (o CostCentreBudgetDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CostCentreBudgetDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCostCentreBudgetDtoListEnvelope struct {
	value *CostCentreBudgetDtoListEnvelope
	isSet bool
}

func (v NullableCostCentreBudgetDtoListEnvelope) Get() *CostCentreBudgetDtoListEnvelope {
	return v.value
}

func (v *NullableCostCentreBudgetDtoListEnvelope) Set(val *CostCentreBudgetDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCostCentreBudgetDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCostCentreBudgetDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCostCentreBudgetDtoListEnvelope(val *CostCentreBudgetDtoListEnvelope) *NullableCostCentreBudgetDtoListEnvelope {
	return &NullableCostCentreBudgetDtoListEnvelope{value: val, isSet: true}
}

func (v NullableCostCentreBudgetDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCostCentreBudgetDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
