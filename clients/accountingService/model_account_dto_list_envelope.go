...
// checks if the AccountDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountDtoListEnvelope{}

// AccountDtoListEnvelope struct for AccountDtoListEnvelope
type AccountDtoListEnvelope struct {
...
func (o *AccountDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AccountDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AccountDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AccountDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AccountDtoListEnvelope) SetActivityIdNil() {
...
func (o AccountDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AccountDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAccountDtoListEnvelope struct {
	value *AccountDtoListEnvelope
	isSet bool
}

func (v NullableAccountDtoListEnvelope) Get() *AccountDtoListEnvelope {
	return v.value
}

func (v *NullableAccountDtoListEnvelope) Set(val *AccountDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountDtoListEnvelope(val *AccountDtoListEnvelope) *NullableAccountDtoListEnvelope {
	return &NullableAccountDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAccountDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
