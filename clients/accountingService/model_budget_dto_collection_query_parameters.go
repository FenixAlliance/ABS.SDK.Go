...
// checks if the BudgetDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BudgetDtoCollectionQueryParameters{}

// BudgetDtoCollectionQueryParameters struct for BudgetDtoCollectionQueryParameters
type BudgetDtoCollectionQueryParameters struct {
...
func NewBudgetDtoCollectionQueryParameters() *BudgetDtoCollectionQueryParameters {
	this := BudgetDtoCollectionQueryParameters{}
	return &this
}
...
func (o *BudgetDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *BudgetDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *BudgetDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *BudgetDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *BudgetDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *BudgetDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *BudgetDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o BudgetDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o BudgetDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableBudgetDtoCollectionQueryParameters struct {
	value *BudgetDtoCollectionQueryParameters
	isSet bool
}

func (v NullableBudgetDtoCollectionQueryParameters) Get() *BudgetDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableBudgetDtoCollectionQueryParameters) Set(val *BudgetDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableBudgetDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableBudgetDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBudgetDtoCollectionQueryParameters(val *BudgetDtoCollectionQueryParameters) *NullableBudgetDtoCollectionQueryParameters {
	return &NullableBudgetDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableBudgetDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBudgetDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
