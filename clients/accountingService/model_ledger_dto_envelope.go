...
// checks if the LedgerDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LedgerDtoEnvelope{}

// LedgerDtoEnvelope struct for LedgerDtoEnvelope
type LedgerDtoEnvelope struct {
...
func (o *LedgerDtoEnvelope) SetErrorMessageNil() {
...
func (o *LedgerDtoEnvelope) SetCorrelationIdNil() {
...
func (o *LedgerDtoEnvelope) SetHttpStatusNil() {
...
func (o *LedgerDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LedgerDtoEnvelope) SetActivityIdNil() {
...
func (o LedgerDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LedgerDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLedgerDtoEnvelope struct {
	value *LedgerDtoEnvelope
	isSet bool
}

func (v NullableLedgerDtoEnvelope) Get() *LedgerDtoEnvelope {
	return v.value
}

func (v *NullableLedgerDtoEnvelope) Set(val *LedgerDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLedgerDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLedgerDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLedgerDtoEnvelope(val *LedgerDtoEnvelope) *NullableLedgerDtoEnvelope {
	return &NullableLedgerDtoEnvelope{value: val, isSet: true}
}

func (v NullableLedgerDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLedgerDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
