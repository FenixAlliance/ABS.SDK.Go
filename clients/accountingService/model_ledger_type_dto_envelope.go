...
// checks if the LedgerTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LedgerTypeDtoEnvelope{}

// LedgerTypeDtoEnvelope struct for LedgerTypeDtoEnvelope
type LedgerTypeDtoEnvelope struct {
	...
	Result *LedgerTypeDto `json:"result,omitempty"`
}
...
func (o *LedgerTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *LedgerTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *LedgerTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *LedgerTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LedgerTypeDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given LedgerTypeDto and assigns it to the Result field.
func (o *LedgerTypeDtoEnvelope) SetResult(v LedgerTypeDto) {
	o.Result = &v
}

func (o LedgerTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LedgerTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLedgerTypeDtoEnvelope struct {
	value *LedgerTypeDtoEnvelope
	isSet bool
}

func (v NullableLedgerTypeDtoEnvelope) Get() *LedgerTypeDtoEnvelope {
	return v.value
}

func (v *NullableLedgerTypeDtoEnvelope) Set(val *LedgerTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLedgerTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLedgerTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLedgerTypeDtoEnvelope(val *LedgerTypeDtoEnvelope) *NullableLedgerTypeDtoEnvelope {
	return &NullableLedgerTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableLedgerTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLedgerTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
