...
// checks if the BankTransactionDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankTransactionDtoEnvelope{}

// BankTransactionDtoEnvelope struct for BankTransactionDtoEnvelope
type BankTransactionDtoEnvelope struct {
...
func NewBankTransactionDtoEnvelope() *BankTransactionDtoEnvelope {
	this := BankTransactionDtoEnvelope{}
	return &this
}
...
func (o *BankTransactionDtoEnvelope) SetErrorMessageNil() {
...
func (o *BankTransactionDtoEnvelope) SetCorrelationIdNil() {
...
func (o *BankTransactionDtoEnvelope) SetHttpStatusNil() {
...
func (o *BankTransactionDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BankTransactionDtoEnvelope) SetActivityIdNil() {
...
func (o BankTransactionDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BankTransactionDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBankTransactionDtoEnvelope struct {
	value *BankTransactionDtoEnvelope
	isSet bool
}

func (v NullableBankTransactionDtoEnvelope) Get() *BankTransactionDtoEnvelope {
	return v.value
}

func (v *NullableBankTransactionDtoEnvelope) Set(val *BankTransactionDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBankTransactionDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBankTransactionDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankTransactionDtoEnvelope(val *BankTransactionDtoEnvelope) *NullableBankTransactionDtoEnvelope {
	return &NullableBankTransactionDtoEnvelope{value: val, isSet: true}
}

func (v NullableBankTransactionDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankTransactionDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
