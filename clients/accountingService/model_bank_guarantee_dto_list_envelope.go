...
// checks if the BankGuaranteeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankGuaranteeDtoListEnvelope{}

// BankGuaranteeDtoListEnvelope struct for BankGuaranteeDtoListEnvelope
type BankGuaranteeDtoListEnvelope struct {
...
func NewBankGuaranteeDtoListEnvelope() *BankGuaranteeDtoListEnvelope {
	this := BankGuaranteeDtoListEnvelope{}
	return &this
}
...
func (o *BankGuaranteeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *BankGuaranteeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *BankGuaranteeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *BankGuaranteeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *BankGuaranteeDtoListEnvelope) SetActivityIdNil() {
...
func (o BankGuaranteeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o BankGuaranteeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableBankGuaranteeDtoListEnvelope struct {
	value *BankGuaranteeDtoListEnvelope
	isSet bool
}

func (v NullableBankGuaranteeDtoListEnvelope) Get() *BankGuaranteeDtoListEnvelope {
	return v.value
}

func (v *NullableBankGuaranteeDtoListEnvelope) Set(val *BankGuaranteeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableBankGuaranteeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableBankGuaranteeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankGuaranteeDtoListEnvelope(val *BankGuaranteeDtoListEnvelope) *NullableBankGuaranteeDtoListEnvelope {
	return &NullableBankGuaranteeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableBankGuaranteeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankGuaranteeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
