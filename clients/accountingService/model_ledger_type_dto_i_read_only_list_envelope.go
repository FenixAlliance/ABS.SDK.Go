...
// checks if the LedgerTypeDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LedgerTypeDtoIReadOnlyListEnvelope{}

// LedgerTypeDtoIReadOnlyListEnvelope struct for LedgerTypeDtoIReadOnlyListEnvelope
type LedgerTypeDtoIReadOnlyListEnvelope struct {
...
func NewLedgerTypeDtoIReadOnlyListEnvelope() *LedgerTypeDtoIReadOnlyListEnvelope {
	this := LedgerTypeDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *LedgerTypeDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *LedgerTypeDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *LedgerTypeDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *LedgerTypeDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LedgerTypeDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o LedgerTypeDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LedgerTypeDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLedgerTypeDtoIReadOnlyListEnvelope struct {
	value *LedgerTypeDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableLedgerTypeDtoIReadOnlyListEnvelope) Get() *LedgerTypeDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableLedgerTypeDtoIReadOnlyListEnvelope) Set(val *LedgerTypeDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLedgerTypeDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLedgerTypeDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLedgerTypeDtoIReadOnlyListEnvelope(val *LedgerTypeDtoIReadOnlyListEnvelope) *NullableLedgerTypeDtoIReadOnlyListEnvelope {
	return &NullableLedgerTypeDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableLedgerTypeDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLedgerTypeDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
