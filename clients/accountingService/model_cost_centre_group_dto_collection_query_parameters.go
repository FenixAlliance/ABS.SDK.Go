...
// checks if the CostCentreGroupDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CostCentreGroupDtoCollectionQueryParameters{}

// CostCentreGroupDtoCollectionQueryParameters struct for CostCentreGroupDtoCollectionQueryParameters
type CostCentreGroupDtoCollectionQueryParameters struct {
...
func NewCostCentreGroupDtoCollectionQueryParameters() *CostCentreGroupDtoCollectionQueryParameters {
	this := CostCentreGroupDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CostCentreGroupDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CostCentreGroupDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CostCentreGroupDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCostCentreGroupDtoCollectionQueryParameters struct {
	value *CostCentreGroupDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCostCentreGroupDtoCollectionQueryParameters) Get() *CostCentreGroupDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCostCentreGroupDtoCollectionQueryParameters) Set(val *CostCentreGroupDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCostCentreGroupDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCostCentreGroupDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCostCentreGroupDtoCollectionQueryParameters(val *CostCentreGroupDtoCollectionQueryParameters) *NullableCostCentreGroupDtoCollectionQueryParameters {
	return &NullableCostCentreGroupDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCostCentreGroupDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCostCentreGroupDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
