...
// checks if the BankTransactionDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankTransactionDtoCollectionQueryParameters{}

// BankTransactionDtoCollectionQueryParameters struct for BankTransactionDtoCollectionQueryParameters
type BankTransactionDtoCollectionQueryParameters struct {
...
func NewBankTransactionDtoCollectionQueryParameters() *BankTransactionDtoCollectionQueryParameters {
	this := BankTransactionDtoCollectionQueryParameters{}
	return &this
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *BankTransactionDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o BankTransactionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o BankTransactionDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableBankTransactionDtoCollectionQueryParameters struct {
	value *BankTransactionDtoCollectionQueryParameters
	isSet bool
}

func (v NullableBankTransactionDtoCollectionQueryParameters) Get() *BankTransactionDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableBankTransactionDtoCollectionQueryParameters) Set(val *BankTransactionDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableBankTransactionDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableBankTransactionDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankTransactionDtoCollectionQueryParameters(val *BankTransactionDtoCollectionQueryParameters) *NullableBankTransactionDtoCollectionQueryParameters {
	return &NullableBankTransactionDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableBankTransactionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankTransactionDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
