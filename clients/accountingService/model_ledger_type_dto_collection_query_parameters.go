...
// checks if the LedgerTypeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LedgerTypeDtoCollectionQueryParameters{}

// LedgerTypeDtoCollectionQueryParameters struct for LedgerTypeDtoCollectionQueryParameters
type LedgerTypeDtoCollectionQueryParameters struct {
...
func NewLedgerTypeDtoCollectionQueryParameters() *LedgerTypeDtoCollectionQueryParameters {
	this := LedgerTypeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LedgerTypeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LedgerTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LedgerTypeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLedgerTypeDtoCollectionQueryParameters struct {
	value *LedgerTypeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLedgerTypeDtoCollectionQueryParameters) Get() *LedgerTypeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLedgerTypeDtoCollectionQueryParameters) Set(val *LedgerTypeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLedgerTypeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLedgerTypeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLedgerTypeDtoCollectionQueryParameters(val *LedgerTypeDtoCollectionQueryParameters) *NullableLedgerTypeDtoCollectionQueryParameters {
	return &NullableLedgerTypeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLedgerTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLedgerTypeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
