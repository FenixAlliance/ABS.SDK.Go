...
// checks if the AccountingPeriodDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountingPeriodDtoEnvelope{}

// AccountingPeriodDtoEnvelope struct for AccountingPeriodDtoEnvelope
type AccountingPeriodDtoEnvelope struct {
...
func NewAccountingPeriodDtoEnvelope() *AccountingPeriodDtoEnvelope {
	this := AccountingPeriodDtoEnvelope{}
	return &this
}
...
func (o *AccountingPeriodDtoEnvelope) SetErrorMessageNil() {
...
func (o *AccountingPeriodDtoEnvelope) SetCorrelationIdNil() {
...
func (o *AccountingPeriodDtoEnvelope) SetHttpStatusNil() {
...
func (o *AccountingPeriodDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AccountingPeriodDtoEnvelope) SetActivityIdNil() {
...
func (o AccountingPeriodDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AccountingPeriodDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAccountingPeriodDtoEnvelope struct {
	value *AccountingPeriodDtoEnvelope
	isSet bool
}

func (v NullableAccountingPeriodDtoEnvelope) Get() *AccountingPeriodDtoEnvelope {
	return v.value
}

func (v *NullableAccountingPeriodDtoEnvelope) Set(val *AccountingPeriodDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountingPeriodDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountingPeriodDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountingPeriodDtoEnvelope(val *AccountingPeriodDtoEnvelope) *NullableAccountingPeriodDtoEnvelope {
	return &NullableAccountingPeriodDtoEnvelope{value: val, isSet: true}
}

func (v NullableAccountingPeriodDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountingPeriodDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
