...
// checks if the AccountingEntryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountingEntryDtoEnvelope{}

// AccountingEntryDtoEnvelope struct for AccountingEntryDtoEnvelope
type AccountingEntryDtoEnvelope struct {
...
func NewAccountingEntryDtoEnvelope() *AccountingEntryDtoEnvelope {
	this := AccountingEntryDtoEnvelope{}
	return &this
}
...
func (o *AccountingEntryDtoEnvelope) SetErrorMessageNil() {
...
func (o *AccountingEntryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *AccountingEntryDtoEnvelope) SetHttpStatusNil() {
...
func (o *AccountingEntryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AccountingEntryDtoEnvelope) SetActivityIdNil() {
...
func (o AccountingEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AccountingEntryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAccountingEntryDtoEnvelope struct {
	value *AccountingEntryDtoEnvelope
	isSet bool
}

func (v NullableAccountingEntryDtoEnvelope) Get() *AccountingEntryDtoEnvelope {
	return v.value
}

func (v *NullableAccountingEntryDtoEnvelope) Set(val *AccountingEntryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountingEntryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountingEntryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountingEntryDtoEnvelope(val *AccountingEntryDtoEnvelope) *NullableAccountingEntryDtoEnvelope {
	return &NullableAccountingEntryDtoEnvelope{value: val, isSet: true}
}

func (v NullableAccountingEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountingEntryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
