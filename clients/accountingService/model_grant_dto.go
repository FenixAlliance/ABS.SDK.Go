...
// checks if the GrantDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GrantDto{}

// GrantDto struct for GrantDto
...
func (o *GrantDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *GrantDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *GrantDto) SetEnrollmentIdNil() {
...
func (o GrantDto) MarshalJSON() ([]byte, error) {
...
func (o GrantDto) ToMap() (map[string]interface{}, error) {
...
type NullableGrantDto struct {
	value *GrantDto
	isSet bool
}

func (v NullableGrantDto) Get() *GrantDto {
	return v.value
}

func (v *NullableGrantDto) Set(val *GrantDto) {
	v.value = val
	v.isSet = true
}

func (v NullableGrantDto) IsSet() bool {
	return v.isSet
}

func (v *NullableGrantDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGrantDto(val *GrantDto) *NullableGrantDto {
	return &NullableGrantDto{value: val, isSet: true}
}

func (v NullableGrantDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGrantDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
