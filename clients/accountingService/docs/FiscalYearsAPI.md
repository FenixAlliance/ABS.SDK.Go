...
[**PatchFiscalYearAsync**](FiscalYearsAPI.md#PatchFiscalYearAsync) | **Patch** /api/v2/AccountingService/FiscalYears/{fiscalYearId} | Patch a fiscal year
...
> FiscalYearDtoIReadOnlyListEnvelope GetFiscalYearsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).FiscalYearDtoCollectionQueryParameters(fiscalYearDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FiscalYearsAPI.GetFiscalYearsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).FiscalYearDtoCollectionQueryParameters(fiscalYearDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> Int32Envelope GetFiscalYearsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).FiscalYearDtoCollectionQueryParameters(fiscalYearDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FiscalYearsAPI.GetFiscalYearsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).FiscalYearDtoCollectionQueryParameters(fiscalYearDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchFiscalYearAsync(ctx, fiscalYearId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.FiscalYearsAPI.PatchFiscalYearAsync(context.Background(), fiscalYearId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `FiscalYearsAPI.PatchFiscalYearAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchFiscalYearAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `FiscalYearsAPI.PatchFiscalYearAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchFiscalYearAsyncRequest struct via the builder pattern
