...
`func (o *TaxPolicyCreateDto) GetTaxSchemeCode() string`

GetTaxSchemeCode returns the TaxSchemeCode field if non-nil, zero value otherwise.

### GetTaxSchemeCodeOk

`func (o *TaxPolicyCreateDto) GetTaxSchemeCodeOk() (*string, bool)`
