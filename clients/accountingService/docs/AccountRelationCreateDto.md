...
`func (o *AccountRelationCreateDto) GetType() string`

GetType returns the Type field if non-nil, zero value otherwise.

### GetTypeOk

`func (o *AccountRelationCreateDto) GetTypeOk() (*string, bool)`
...
`func (o *AccountRelationCreateDto) SetType(v string)`

SetType sets Type field to given value.

### HasType

`func (o *AccountRelationCreateDto) HasType() bool`

HasType returns a boolean if a field has been set.

### SetTypeNil

`func (o *AccountRelationCreateDto) SetTypeNil(b bool)`

 SetTypeNil sets the value for Type to be an explicit nil

### UnsetType
`func (o *AccountRelationCreateDto) UnsetType()`
