...
> GrantDtoIReadOnlyListEnvelope GetGrantsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GrantDtoCollectionQueryParameters(grantDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	grantDtoCollectionQueryParameters := *openapiclient.NewGrantDtoCollectionQueryParameters() // GrantDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GrantsAPI.GetGrantsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GrantDtoCollectionQueryParameters(grantDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **grantDtoCollectionQueryParameters** | [**GrantDtoCollectionQueryParameters**](GrantDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetGrantsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GrantDtoCollectionQueryParameters(grantDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GrantsAPI.GetGrantsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GrantDtoCollectionQueryParameters(grantDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchGrantAsync(ctx, grantId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GrantsAPI.PatchGrantAsync(context.Background(), grantId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `GrantsAPI.PatchGrantAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchGrantAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `GrantsAPI.PatchGrantAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchGrantAsyncRequest struct via the builder pattern
