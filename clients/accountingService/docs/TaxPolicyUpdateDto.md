...
`func (o *TaxPolicyUpdateDto) GetTaxSchemeCode() string`

GetTaxSchemeCode returns the TaxSchemeCode field if non-nil, zero value otherwise.

### GetTaxSchemeCodeOk

`func (o *TaxPolicyUpdateDto) GetTaxSchemeCodeOk() (*string, bool)`
