...
// checks if the FiscalPeriodDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiscalPeriodDtoListEnvelope{}

// FiscalPeriodDtoListEnvelope struct for FiscalPeriodDtoListEnvelope
type FiscalPeriodDtoListEnvelope struct {
...
func NewFiscalPeriodDtoListEnvelope() *FiscalPeriodDtoListEnvelope {
	this := FiscalPeriodDtoListEnvelope{}
	return &this
}
...
func (o *FiscalPeriodDtoListEnvelope) SetErrorMessageNil() {
...
func (o *FiscalPeriodDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *FiscalPeriodDtoListEnvelope) SetHttpStatusNil() {
...
func (o *FiscalPeriodDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *FiscalPeriodDtoListEnvelope) SetActivityIdNil() {
...
func (o FiscalPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o FiscalPeriodDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableFiscalPeriodDtoListEnvelope struct {
	value *FiscalPeriodDtoListEnvelope
	isSet bool
}

func (v NullableFiscalPeriodDtoListEnvelope) Get() *FiscalPeriodDtoListEnvelope {
	return v.value
}

func (v *NullableFiscalPeriodDtoListEnvelope) Set(val *FiscalPeriodDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableFiscalPeriodDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableFiscalPeriodDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFiscalPeriodDtoListEnvelope(val *FiscalPeriodDtoListEnvelope) *NullableFiscalPeriodDtoListEnvelope {
	return &NullableFiscalPeriodDtoListEnvelope{value: val, isSet: true}
}

func (v NullableFiscalPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFiscalPeriodDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
