...
// checks if the ExpenseTypeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExpenseTypeDtoCollectionQueryParameters{}

// ExpenseTypeDtoCollectionQueryParameters struct for ExpenseTypeDtoCollectionQueryParameters
type ExpenseTypeDtoCollectionQueryParameters struct {
...
func NewExpenseTypeDtoCollectionQueryParameters() *ExpenseTypeDtoCollectionQueryParameters {
	this := ExpenseTypeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ExpenseTypeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ExpenseTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ExpenseTypeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableExpenseTypeDtoCollectionQueryParameters struct {
	value *ExpenseTypeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableExpenseTypeDtoCollectionQueryParameters) Get() *ExpenseTypeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableExpenseTypeDtoCollectionQueryParameters) Set(val *ExpenseTypeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableExpenseTypeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableExpenseTypeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExpenseTypeDtoCollectionQueryParameters(val *ExpenseTypeDtoCollectionQueryParameters) *NullableExpenseTypeDtoCollectionQueryParameters {
	return &NullableExpenseTypeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableExpenseTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExpenseTypeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
