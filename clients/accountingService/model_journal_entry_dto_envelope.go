...
// checks if the JournalEntryDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JournalEntryDtoEnvelope{}

// JournalEntryDtoEnvelope struct for JournalEntryDtoEnvelope
type JournalEntryDtoEnvelope struct {
...
func (o *JournalEntryDtoEnvelope) SetErrorMessageNil() {
...
func (o *JournalEntryDtoEnvelope) SetCorrelationIdNil() {
...
func (o *JournalEntryDtoEnvelope) SetHttpStatusNil() {
...
func (o *JournalEntryDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JournalEntryDtoEnvelope) SetActivityIdNil() {
...
func (o JournalEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JournalEntryDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJournalEntryDtoEnvelope struct {
	value *JournalEntryDtoEnvelope
	isSet bool
}

func (v NullableJournalEntryDtoEnvelope) Get() *JournalEntryDtoEnvelope {
	return v.value
}

func (v *NullableJournalEntryDtoEnvelope) Set(val *JournalEntryDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJournalEntryDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJournalEntryDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJournalEntryDtoEnvelope(val *JournalEntryDtoEnvelope) *NullableJournalEntryDtoEnvelope {
	return &NullableJournalEntryDtoEnvelope{value: val, isSet: true}
}

func (v NullableJournalEntryDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJournalEntryDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
