...
// checks if the ItemReturnPolicyCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemReturnPolicyCreateDto{}

// ItemReturnPolicyCreateDto struct for ItemReturnPolicyCreateDto
type ItemReturnPolicyCreateDto struct {
...
type _ItemReturnPolicyCreateDto ItemReturnPolicyCreateDto
...
func NewItemReturnPolicyCreateDto(title string) *ItemReturnPolicyCreateDto {
	this := ItemReturnPolicyCreateDto{}
	this.Title = title
	return &this
}
...
func (o *ItemReturnPolicyCreateDto) SetDescriptionNil() {
...
func (o *ItemReturnPolicyCreateDto) SetShippingCourierIDNil() {
...
func (o *ItemReturnPolicyCreateDto) SetCurrencyIDNil() {
...
func (o *ItemReturnPolicyCreateDto) SetCountryIDNil() {
	o.CountryID.Set(nil)
}
...
func (o *ItemReturnPolicyCreateDto) SetCountryStateIDNil() {
...
func (o *ItemReturnPolicyCreateDto) SetCustomStateNil() {
...
func (o *ItemReturnPolicyCreateDto) SetCustomCityNil() {
...
func (o *ItemReturnPolicyCreateDto) SetCityIDNil() {
	o.CityID.Set(nil)
}
...
func (o ItemReturnPolicyCreateDto) MarshalJSON() ([]byte, error) {
...
func (o ItemReturnPolicyCreateDto) ToMap() (map[string]interface{}, error) {
...
func (o *ItemReturnPolicyCreateDto) UnmarshalJSON(data []byte) (err error) {
	...
	varItemReturnPolicyCreateDto := _ItemReturnPolicyCreateDto{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varItemReturnPolicyCreateDto)

	if err != nil {
		return err
	}

	*o = ItemReturnPolicyCreateDto(varItemReturnPolicyCreateDto)

	return err
}

type NullableItemReturnPolicyCreateDto struct {
	value *ItemReturnPolicyCreateDto
	isSet bool
}

func (v NullableItemReturnPolicyCreateDto) Get() *ItemReturnPolicyCreateDto {
	return v.value
}

func (v *NullableItemReturnPolicyCreateDto) Set(val *ItemReturnPolicyCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableItemReturnPolicyCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableItemReturnPolicyCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemReturnPolicyCreateDto(val *ItemReturnPolicyCreateDto) *NullableItemReturnPolicyCreateDto {
	return &NullableItemReturnPolicyCreateDto{value: val, isSet: true}
}

func (v NullableItemReturnPolicyCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemReturnPolicyCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
