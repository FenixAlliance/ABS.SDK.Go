...
// checks if the KnowledgeArticleDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KnowledgeArticleDtoListEnvelope{}

// KnowledgeArticleDtoListEnvelope struct for KnowledgeArticleDtoListEnvelope
type KnowledgeArticleDtoListEnvelope struct {
...
func NewKnowledgeArticleDtoListEnvelope() *KnowledgeArticleDtoListEnvelope {
	this := KnowledgeArticleDtoListEnvelope{}
	return &this
}
...
func (o *KnowledgeArticleDtoListEnvelope) SetErrorMessageNil() {
...
func (o *KnowledgeArticleDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *KnowledgeArticleDtoListEnvelope) SetHttpStatusNil() {
...
func (o *KnowledgeArticleDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *KnowledgeArticleDtoListEnvelope) SetActivityIdNil() {
...
func (o KnowledgeArticleDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o KnowledgeArticleDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableKnowledgeArticleDtoListEnvelope struct {
	value *KnowledgeArticleDtoListEnvelope
	isSet bool
}

func (v NullableKnowledgeArticleDtoListEnvelope) Get() *KnowledgeArticleDtoListEnvelope {
	return v.value
}

func (v *NullableKnowledgeArticleDtoListEnvelope) Set(val *KnowledgeArticleDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableKnowledgeArticleDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableKnowledgeArticleDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKnowledgeArticleDtoListEnvelope(val *KnowledgeArticleDtoListEnvelope) *NullableKnowledgeArticleDtoListEnvelope {
	return &NullableKnowledgeArticleDtoListEnvelope{value: val, isSet: true}
}

func (v NullableKnowledgeArticleDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKnowledgeArticleDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
