...
// checks if the SupportTicketPriorityDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportTicketPriorityDtoEnvelope{}

// SupportTicketPriorityDtoEnvelope struct for SupportTicketPriorityDtoEnvelope
type SupportTicketPriorityDtoEnvelope struct {
	...
	Result *SupportTicketPriorityDto `json:"result,omitempty"`
}
...
func NewSupportTicketPriorityDtoEnvelope() *SupportTicketPriorityDtoEnvelope {
	this := SupportTicketPriorityDtoEnvelope{}
	return &this
}
...
func (o *SupportTicketPriorityDtoEnvelope) SetErrorMessageNil() {
...
func (o *SupportTicketPriorityDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SupportTicketPriorityDtoEnvelope) SetHttpStatusNil() {
...
func (o *SupportTicketPriorityDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportTicketPriorityDtoEnvelope) SetActivityIdNil() {
...
func (o *SupportTicketPriorityDtoEnvelope) GetResult() SupportTicketPriorityDto {
	if o == nil || IsNil(o.Result) {
		var ret SupportTicketPriorityDto
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given SupportTicketPriorityDto and assigns it to the Result field.
func (o *SupportTicketPriorityDtoEnvelope) SetResult(v SupportTicketPriorityDto) {
	o.Result = &v
}

func (o SupportTicketPriorityDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportTicketPriorityDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportTicketPriorityDtoEnvelope struct {
	value *SupportTicketPriorityDtoEnvelope
	isSet bool
}

func (v NullableSupportTicketPriorityDtoEnvelope) Get() *SupportTicketPriorityDtoEnvelope {
	return v.value
}

func (v *NullableSupportTicketPriorityDtoEnvelope) Set(val *SupportTicketPriorityDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketPriorityDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketPriorityDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketPriorityDtoEnvelope(val *SupportTicketPriorityDtoEnvelope) *NullableSupportTicketPriorityDtoEnvelope {
	return &NullableSupportTicketPriorityDtoEnvelope{value: val, isSet: true}
}

func (v NullableSupportTicketPriorityDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketPriorityDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
