...
// checks if the SupportTicketDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportTicketDtoEnvelope{}

// SupportTicketDtoEnvelope struct for SupportTicketDtoEnvelope
type SupportTicketDtoEnvelope struct {
...
func (o *SupportTicketDtoEnvelope) SetErrorMessageNil() {
...
func (o *SupportTicketDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SupportTicketDtoEnvelope) SetActivityIdNil() {
...
func (o SupportTicketDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportTicketDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportTicketDtoEnvelope struct {
	value *SupportTicketDtoEnvelope
	isSet bool
}

func (v NullableSupportTicketDtoEnvelope) Get() *SupportTicketDtoEnvelope {
	return v.value
}

func (v *NullableSupportTicketDtoEnvelope) Set(val *SupportTicketDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketDtoEnvelope(val *SupportTicketDtoEnvelope) *NullableSupportTicketDtoEnvelope {
	return &NullableSupportTicketDtoEnvelope{value: val, isSet: true}
}

func (v NullableSupportTicketDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
