...
// checks if the ReturnRequestDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnRequestDtoCollectionQueryParameters{}

// ReturnRequestDtoCollectionQueryParameters struct for ReturnRequestDtoCollectionQueryParameters
type ReturnRequestDtoCollectionQueryParameters struct {
...
func NewReturnRequestDtoCollectionQueryParameters() *ReturnRequestDtoCollectionQueryParameters {
	this := ReturnRequestDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ReturnRequestDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ReturnRequestDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ReturnRequestDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableReturnRequestDtoCollectionQueryParameters struct {
	value *ReturnRequestDtoCollectionQueryParameters
	isSet bool
}

func (v NullableReturnRequestDtoCollectionQueryParameters) Get() *ReturnRequestDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableReturnRequestDtoCollectionQueryParameters) Set(val *ReturnRequestDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnRequestDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnRequestDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnRequestDtoCollectionQueryParameters(val *ReturnRequestDtoCollectionQueryParameters) *NullableReturnRequestDtoCollectionQueryParameters {
	return &NullableReturnRequestDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableReturnRequestDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnRequestDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
