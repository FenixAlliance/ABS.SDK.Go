...
// checks if the MaintenanceVisitDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MaintenanceVisitDtoCollectionQueryParameters{}

// MaintenanceVisitDtoCollectionQueryParameters struct for MaintenanceVisitDtoCollectionQueryParameters
type MaintenanceVisitDtoCollectionQueryParameters struct {
...
func NewMaintenanceVisitDtoCollectionQueryParameters() *MaintenanceVisitDtoCollectionQueryParameters {
	this := MaintenanceVisitDtoCollectionQueryParameters{}
	return &this
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *MaintenanceVisitDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o MaintenanceVisitDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o MaintenanceVisitDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableMaintenanceVisitDtoCollectionQueryParameters struct {
	value *MaintenanceVisitDtoCollectionQueryParameters
	isSet bool
}

func (v NullableMaintenanceVisitDtoCollectionQueryParameters) Get() *MaintenanceVisitDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableMaintenanceVisitDtoCollectionQueryParameters) Set(val *MaintenanceVisitDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableMaintenanceVisitDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableMaintenanceVisitDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMaintenanceVisitDtoCollectionQueryParameters(val *MaintenanceVisitDtoCollectionQueryParameters) *NullableMaintenanceVisitDtoCollectionQueryParameters {
	return &NullableMaintenanceVisitDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableMaintenanceVisitDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMaintenanceVisitDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
