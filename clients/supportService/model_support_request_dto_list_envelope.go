...
// checks if the SupportRequestDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportRequestDtoListEnvelope{}

// SupportRequestDtoListEnvelope struct for SupportRequestDtoListEnvelope
type SupportRequestDtoListEnvelope struct {
	...
	Result []SupportRequestDto `json:"result,omitempty"`
}
...
func NewSupportRequestDtoListEnvelope() *SupportRequestDtoListEnvelope {
	this := SupportRequestDtoListEnvelope{}
	return &this
}
...
func (o *SupportRequestDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SupportRequestDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SupportRequestDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SupportRequestDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportRequestDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []SupportRequestDto and assigns it to the Result field.
func (o *SupportRequestDtoListEnvelope) SetResult(v []SupportRequestDto) {
	o.Result = v
}

func (o SupportRequestDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportRequestDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportRequestDtoListEnvelope struct {
	value *SupportRequestDtoListEnvelope
	isSet bool
}

func (v NullableSupportRequestDtoListEnvelope) Get() *SupportRequestDtoListEnvelope {
	return v.value
}

func (v *NullableSupportRequestDtoListEnvelope) Set(val *SupportRequestDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportRequestDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportRequestDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportRequestDtoListEnvelope(val *SupportRequestDtoListEnvelope) *NullableSupportRequestDtoListEnvelope {
	return &NullableSupportRequestDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSupportRequestDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportRequestDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
