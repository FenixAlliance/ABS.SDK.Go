...
// checks if the SupportTicketPriorityDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportTicketPriorityDtoListEnvelope{}

// SupportTicketPriorityDtoListEnvelope struct for SupportTicketPriorityDtoListEnvelope
type SupportTicketPriorityDtoListEnvelope struct {
...
func NewSupportTicketPriorityDtoListEnvelope() *SupportTicketPriorityDtoListEnvelope {
	this := SupportTicketPriorityDtoListEnvelope{}
	return &this
}
...
func (o *SupportTicketPriorityDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SupportTicketPriorityDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SupportTicketPriorityDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SupportTicketPriorityDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportTicketPriorityDtoListEnvelope) SetActivityIdNil() {
...
func (o SupportTicketPriorityDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportTicketPriorityDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportTicketPriorityDtoListEnvelope struct {
	value *SupportTicketPriorityDtoListEnvelope
	isSet bool
}

func (v NullableSupportTicketPriorityDtoListEnvelope) Get() *SupportTicketPriorityDtoListEnvelope {
	return v.value
}

func (v *NullableSupportTicketPriorityDtoListEnvelope) Set(val *SupportTicketPriorityDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketPriorityDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketPriorityDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketPriorityDtoListEnvelope(val *SupportTicketPriorityDtoListEnvelope) *NullableSupportTicketPriorityDtoListEnvelope {
	return &NullableSupportTicketPriorityDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSupportTicketPriorityDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketPriorityDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
