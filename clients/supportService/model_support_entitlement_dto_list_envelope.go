...
// checks if the SupportEntitlementDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportEntitlementDtoListEnvelope{}

// SupportEntitlementDtoListEnvelope struct for SupportEntitlementDtoListEnvelope
type SupportEntitlementDtoListEnvelope struct {
	...
	Result []SupportEntitlementDto `json:"result,omitempty"`
}
...
func NewSupportEntitlementDtoListEnvelope() *SupportEntitlementDtoListEnvelope {
	this := SupportEntitlementDtoListEnvelope{}
	return &this
}
...
func (o *SupportEntitlementDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SupportEntitlementDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SupportEntitlementDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SupportEntitlementDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportEntitlementDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []SupportEntitlementDto and assigns it to the Result field.
func (o *SupportEntitlementDtoListEnvelope) SetResult(v []SupportEntitlementDto) {
	o.Result = v
}

func (o SupportEntitlementDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportEntitlementDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportEntitlementDtoListEnvelope struct {
	value *SupportEntitlementDtoListEnvelope
	isSet bool
}

func (v NullableSupportEntitlementDtoListEnvelope) Get() *SupportEntitlementDtoListEnvelope {
	return v.value
}

func (v *NullableSupportEntitlementDtoListEnvelope) Set(val *SupportEntitlementDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportEntitlementDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportEntitlementDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportEntitlementDtoListEnvelope(val *SupportEntitlementDtoListEnvelope) *NullableSupportEntitlementDtoListEnvelope {
	return &NullableSupportEntitlementDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSupportEntitlementDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportEntitlementDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
