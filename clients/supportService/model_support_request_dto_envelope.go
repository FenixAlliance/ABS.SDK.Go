...
// checks if the SupportRequestDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportRequestDtoEnvelope{}

// SupportRequestDtoEnvelope struct for SupportRequestDtoEnvelope
type SupportRequestDtoEnvelope struct {
...
func NewSupportRequestDtoEnvelope() *SupportRequestDtoEnvelope {
	this := SupportRequestDtoEnvelope{}
	return &this
}
...
func (o *SupportRequestDtoEnvelope) SetErrorMessageNil() {
...
func (o *SupportRequestDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SupportRequestDtoEnvelope) SetHttpStatusNil() {
...
func (o *SupportRequestDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportRequestDtoEnvelope) SetActivityIdNil() {
...
func (o SupportRequestDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportRequestDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportRequestDtoEnvelope struct {
	value *SupportRequestDtoEnvelope
	isSet bool
}

func (v NullableSupportRequestDtoEnvelope) Get() *SupportRequestDtoEnvelope {
	return v.value
}

func (v *NullableSupportRequestDtoEnvelope) Set(val *SupportRequestDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportRequestDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportRequestDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportRequestDtoEnvelope(val *SupportRequestDtoEnvelope) *NullableSupportRequestDtoEnvelope {
	return &NullableSupportRequestDtoEnvelope{value: val, isSet: true}
}

func (v NullableSupportRequestDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportRequestDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
