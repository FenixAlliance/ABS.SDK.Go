...
// checks if the SupportTicketTypeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportTicketTypeDtoListEnvelope{}

// SupportTicketTypeDtoListEnvelope struct for SupportTicketTypeDtoListEnvelope
type SupportTicketTypeDtoListEnvelope struct {
...
func NewSupportTicketTypeDtoListEnvelope() *SupportTicketTypeDtoListEnvelope {
	this := SupportTicketTypeDtoListEnvelope{}
	return &this
}
...
func (o *SupportTicketTypeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SupportTicketTypeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SupportTicketTypeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SupportTicketTypeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportTicketTypeDtoListEnvelope) SetActivityIdNil() {
...
func (o SupportTicketTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportTicketTypeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportTicketTypeDtoListEnvelope struct {
	value *SupportTicketTypeDtoListEnvelope
	isSet bool
}

func (v NullableSupportTicketTypeDtoListEnvelope) Get() *SupportTicketTypeDtoListEnvelope {
	return v.value
}

func (v *NullableSupportTicketTypeDtoListEnvelope) Set(val *SupportTicketTypeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportTicketTypeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportTicketTypeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportTicketTypeDtoListEnvelope(val *SupportTicketTypeDtoListEnvelope) *NullableSupportTicketTypeDtoListEnvelope {
	return &NullableSupportTicketTypeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSupportTicketTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportTicketTypeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
