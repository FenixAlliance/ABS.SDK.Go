...
// checks if the ReturnRequestDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ReturnRequestDtoEnvelope{}

// ReturnRequestDtoEnvelope struct for ReturnRequestDtoEnvelope
type ReturnRequestDtoEnvelope struct {
...
func (o *ReturnRequestDtoEnvelope) SetErrorMessageNil() {
...
func (o *ReturnRequestDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ReturnRequestDtoEnvelope) SetHttpStatusNil() {
...
func (o *ReturnRequestDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ReturnRequestDtoEnvelope) SetActivityIdNil() {
...
func (o ReturnRequestDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ReturnRequestDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableReturnRequestDtoEnvelope struct {
	value *ReturnRequestDtoEnvelope
	isSet bool
}

func (v NullableReturnRequestDtoEnvelope) Get() *ReturnRequestDtoEnvelope {
	return v.value
}

func (v *NullableReturnRequestDtoEnvelope) Set(val *ReturnRequestDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableReturnRequestDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableReturnRequestDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReturnRequestDtoEnvelope(val *ReturnRequestDtoEnvelope) *NullableReturnRequestDtoEnvelope {
	return &NullableReturnRequestDtoEnvelope{value: val, isSet: true}
}

func (v NullableReturnRequestDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReturnRequestDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
