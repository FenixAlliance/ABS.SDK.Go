...
// checks if the RefundRequestDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RefundRequestDtoListEnvelope{}

// RefundRequestDtoListEnvelope struct for RefundRequestDtoListEnvelope
type RefundRequestDtoListEnvelope struct {
...
func NewRefundRequestDtoListEnvelope() *RefundRequestDtoListEnvelope {
	this := RefundRequestDtoListEnvelope{}
	return &this
}
...
func (o *RefundRequestDtoListEnvelope) SetErrorMessageNil() {
...
func (o *RefundRequestDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *RefundRequestDtoListEnvelope) SetHttpStatusNil() {
...
func (o *RefundRequestDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *RefundRequestDtoListEnvelope) SetActivityIdNil() {
...
func (o RefundRequestDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o RefundRequestDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableRefundRequestDtoListEnvelope struct {
	value *RefundRequestDtoListEnvelope
	isSet bool
}

func (v NullableRefundRequestDtoListEnvelope) Get() *RefundRequestDtoListEnvelope {
	return v.value
}

func (v *NullableRefundRequestDtoListEnvelope) Set(val *RefundRequestDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableRefundRequestDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableRefundRequestDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRefundRequestDtoListEnvelope(val *RefundRequestDtoListEnvelope) *NullableRefundRequestDtoListEnvelope {
	return &NullableRefundRequestDtoListEnvelope{value: val, isSet: true}
}

func (v NullableRefundRequestDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRefundRequestDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
