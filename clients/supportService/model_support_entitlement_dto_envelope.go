...
// checks if the SupportEntitlementDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SupportEntitlementDtoEnvelope{}

// SupportEntitlementDtoEnvelope struct for SupportEntitlementDtoEnvelope
type SupportEntitlementDtoEnvelope struct {
...
func NewSupportEntitlementDtoEnvelope() *SupportEntitlementDtoEnvelope {
	this := SupportEntitlementDtoEnvelope{}
	return &this
}
...
func (o *SupportEntitlementDtoEnvelope) SetErrorMessageNil() {
...
func (o *SupportEntitlementDtoEnvelope) SetCorrelationIdNil() {
...
func (o *SupportEntitlementDtoEnvelope) SetHttpStatusNil() {
...
func (o *SupportEntitlementDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SupportEntitlementDtoEnvelope) SetActivityIdNil() {
...
func (o SupportEntitlementDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SupportEntitlementDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSupportEntitlementDtoEnvelope struct {
	value *SupportEntitlementDtoEnvelope
	isSet bool
}

func (v NullableSupportEntitlementDtoEnvelope) Get() *SupportEntitlementDtoEnvelope {
	return v.value
}

func (v *NullableSupportEntitlementDtoEnvelope) Set(val *SupportEntitlementDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSupportEntitlementDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSupportEntitlementDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSupportEntitlementDtoEnvelope(val *SupportEntitlementDtoEnvelope) *NullableSupportEntitlementDtoEnvelope {
	return &NullableSupportEntitlementDtoEnvelope{value: val, isSet: true}
}

func (v NullableSupportEntitlementDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSupportEntitlementDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
