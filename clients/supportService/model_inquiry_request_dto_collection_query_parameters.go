...
// checks if the InquiryRequestDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InquiryRequestDtoCollectionQueryParameters{}

// InquiryRequestDtoCollectionQueryParameters struct for InquiryRequestDtoCollectionQueryParameters
type InquiryRequestDtoCollectionQueryParameters struct {
...
func NewInquiryRequestDtoCollectionQueryParameters() *InquiryRequestDtoCollectionQueryParameters {
	this := InquiryRequestDtoCollectionQueryParameters{}
	return &this
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *InquiryRequestDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o InquiryRequestDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o InquiryRequestDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableInquiryRequestDtoCollectionQueryParameters struct {
	value *InquiryRequestDtoCollectionQueryParameters
	isSet bool
}

func (v NullableInquiryRequestDtoCollectionQueryParameters) Get() *InquiryRequestDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableInquiryRequestDtoCollectionQueryParameters) Set(val *InquiryRequestDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableInquiryRequestDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableInquiryRequestDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInquiryRequestDtoCollectionQueryParameters(val *InquiryRequestDtoCollectionQueryParameters) *NullableInquiryRequestDtoCollectionQueryParameters {
	return &NullableInquiryRequestDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableInquiryRequestDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInquiryRequestDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
