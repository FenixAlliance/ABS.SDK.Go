...
// checks if the PriceListDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceListDtoCollectionQueryParameters{}

// PriceListDtoCollectionQueryParameters struct for PriceListDtoCollectionQueryParameters
type PriceListDtoCollectionQueryParameters struct {
...
func NewPriceListDtoCollectionQueryParameters() *PriceListDtoCollectionQueryParameters {
	this := PriceListDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PriceListDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PriceListDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PriceListDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PriceListDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PriceListDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PriceListDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PriceListDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PriceListDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PriceListDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePriceListDtoCollectionQueryParameters struct {
	value *PriceListDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePriceListDtoCollectionQueryParameters) Get() *PriceListDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePriceListDtoCollectionQueryParameters) Set(val *PriceListDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceListDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceListDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceListDtoCollectionQueryParameters(val *PriceListDtoCollectionQueryParameters) *NullablePriceListDtoCollectionQueryParameters {
	return &NullablePriceListDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePriceListDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceListDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
