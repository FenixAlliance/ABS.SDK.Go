...
// checks if the RoundingPolicyDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoundingPolicyDtoCollectionQueryParameters{}

// RoundingPolicyDtoCollectionQueryParameters struct for RoundingPolicyDtoCollectionQueryParameters
type RoundingPolicyDtoCollectionQueryParameters struct {
...
func NewRoundingPolicyDtoCollectionQueryParameters() *RoundingPolicyDtoCollectionQueryParameters {
	this := RoundingPolicyDtoCollectionQueryParameters{}
	return &this
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *RoundingPolicyDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o RoundingPolicyDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o RoundingPolicyDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableRoundingPolicyDtoCollectionQueryParameters struct {
	value *RoundingPolicyDtoCollectionQueryParameters
	isSet bool
}

func (v NullableRoundingPolicyDtoCollectionQueryParameters) Get() *RoundingPolicyDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableRoundingPolicyDtoCollectionQueryParameters) Set(val *RoundingPolicyDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableRoundingPolicyDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableRoundingPolicyDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoundingPolicyDtoCollectionQueryParameters(val *RoundingPolicyDtoCollectionQueryParameters) *NullableRoundingPolicyDtoCollectionQueryParameters {
	return &NullableRoundingPolicyDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableRoundingPolicyDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoundingPolicyDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
