...
type DiscountListDto struct {
	...
	DiscountListType *string `json:"discountListType,omitempty"`
...
// GetDiscountListType returns the DiscountListType field value if set, zero value otherwise.
func (o *DiscountListDto) GetDiscountListType() string {
	if o == nil || IsNil(o.DiscountListType) {
		var ret string
		return ret
	}
	return *o.DiscountListType
}

// GetDiscountListTypeOk returns a tuple with the DiscountListType field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DiscountListDto) GetDiscountListTypeOk() (*string, bool) {
	if o == nil || IsNil(o.DiscountListType) {
		return nil, false
	}
	return o.DiscountListType, true
}
...
// SetDiscountListType gets a reference to the given string and assigns it to the DiscountListType field.
func (o *DiscountListDto) SetDiscountListType(v string) {
	o.DiscountListType = &v
}
...
func (o *DiscountListDto) SetEnrollmentIdNil() {
...
func (o DiscountListDto) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.DiscountListType) {
		toSerialize["discountListType"] = o.DiscountListType
	}
