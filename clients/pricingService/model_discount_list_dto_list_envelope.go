...
// checks if the DiscountListDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscountListDtoListEnvelope{}

// DiscountListDtoListEnvelope struct for DiscountListDtoListEnvelope
type DiscountListDtoListEnvelope struct {
	...
	Result []DiscountListDto `json:"result,omitempty"`
}
...
func NewDiscountListDtoListEnvelope() *DiscountListDtoListEnvelope {
	this := DiscountListDtoListEnvelope{}
	return &this
}
...
func (o *DiscountListDtoListEnvelope) SetErrorMessageNil() {
...
func (o *DiscountListDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *DiscountListDtoListEnvelope) SetHttpStatusNil() {
...
func (o *DiscountListDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DiscountListDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []DiscountListDto and assigns it to the Result field.
func (o *DiscountListDtoListEnvelope) SetResult(v []DiscountListDto) {
	o.Result = v
}

func (o DiscountListDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DiscountListDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDiscountListDtoListEnvelope struct {
	value *DiscountListDtoListEnvelope
	isSet bool
}

func (v NullableDiscountListDtoListEnvelope) Get() *DiscountListDtoListEnvelope {
	return v.value
}

func (v *NullableDiscountListDtoListEnvelope) Set(val *DiscountListDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscountListDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscountListDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscountListDtoListEnvelope(val *DiscountListDtoListEnvelope) *NullableDiscountListDtoListEnvelope {
	return &NullableDiscountListDtoListEnvelope{value: val, isSet: true}
}

func (v NullableDiscountListDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscountListDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
