...
// checks if the DiscountDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscountDtoListEnvelope{}

// DiscountDtoListEnvelope struct for DiscountDtoListEnvelope
type DiscountDtoListEnvelope struct {
...
func (o *DiscountDtoListEnvelope) SetErrorMessageNil() {
...
func (o *DiscountDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *DiscountDtoListEnvelope) SetHttpStatusNil() {
...
func (o *DiscountDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DiscountDtoListEnvelope) SetActivityIdNil() {
...
func (o DiscountDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DiscountDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDiscountDtoListEnvelope struct {
	value *DiscountDtoListEnvelope
	isSet bool
}

func (v NullableDiscountDtoListEnvelope) Get() *DiscountDtoListEnvelope {
	return v.value
}

func (v *NullableDiscountDtoListEnvelope) Set(val *DiscountDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscountDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscountDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscountDtoListEnvelope(val *DiscountDtoListEnvelope) *NullableDiscountDtoListEnvelope {
	return &NullableDiscountDtoListEnvelope{value: val, isSet: true}
}

func (v NullableDiscountDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscountDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
