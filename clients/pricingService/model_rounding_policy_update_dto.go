...
// checks if the RoundingPolicyUpdateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoundingPolicyUpdateDto{}

// RoundingPolicyUpdateDto struct for RoundingPolicyUpdateDto
type RoundingPolicyUpdateDto struct {
...
func (o *RoundingPolicyUpdateDto) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *RoundingPolicyUpdateDto) SetTitleNil() {
	o.Title.Set(nil)
}
...
func (o *RoundingPolicyUpdateDto) SetDescriptionNil() {
...
func (o *RoundingPolicyUpdateDto) SetCurrencyIdNil() {
...
func (o *RoundingPolicyUpdateDto) SetCountryIdNil() {
	o.CountryId.Set(nil)
}
...
func (o *RoundingPolicyUpdateDto) SetCountryStateIdNil() {
...
func (o *RoundingPolicyUpdateDto) SetCustomStateNil() {
...
func (o *RoundingPolicyUpdateDto) SetCustomCityNil() {
...
func (o *RoundingPolicyUpdateDto) SetCityIdNil() {
	o.CityId.Set(nil)
}
...
func (o RoundingPolicyUpdateDto) MarshalJSON() ([]byte, error) {
...
func (o RoundingPolicyUpdateDto) ToMap() (map[string]interface{}, error) {
...
type NullableRoundingPolicyUpdateDto struct {
	value *RoundingPolicyUpdateDto
	isSet bool
}

func (v NullableRoundingPolicyUpdateDto) Get() *RoundingPolicyUpdateDto {
	return v.value
}

func (v *NullableRoundingPolicyUpdateDto) Set(val *RoundingPolicyUpdateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableRoundingPolicyUpdateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableRoundingPolicyUpdateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoundingPolicyUpdateDto(val *RoundingPolicyUpdateDto) *NullableRoundingPolicyUpdateDto {
	return &NullableRoundingPolicyUpdateDto{value: val, isSet: true}
}

func (v NullableRoundingPolicyUpdateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoundingPolicyUpdateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
