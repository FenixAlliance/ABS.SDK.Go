...
// checks if the RoundingPolicyDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RoundingPolicyDtoListEnvelope{}

// RoundingPolicyDtoListEnvelope struct for RoundingPolicyDtoListEnvelope
type RoundingPolicyDtoListEnvelope struct {
...
func NewRoundingPolicyDtoListEnvelope() *RoundingPolicyDtoListEnvelope {
	this := RoundingPolicyDtoListEnvelope{}
	return &this
}
...
func (o *RoundingPolicyDtoListEnvelope) SetErrorMessageNil() {
...
func (o *RoundingPolicyDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *RoundingPolicyDtoListEnvelope) SetHttpStatusNil() {
...
func (o *RoundingPolicyDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *RoundingPolicyDtoListEnvelope) SetActivityIdNil() {
...
func (o RoundingPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o RoundingPolicyDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableRoundingPolicyDtoListEnvelope struct {
	value *RoundingPolicyDtoListEnvelope
	isSet bool
}

func (v NullableRoundingPolicyDtoListEnvelope) Get() *RoundingPolicyDtoListEnvelope {
	return v.value
}

func (v *NullableRoundingPolicyDtoListEnvelope) Set(val *RoundingPolicyDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableRoundingPolicyDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableRoundingPolicyDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRoundingPolicyDtoListEnvelope(val *RoundingPolicyDtoListEnvelope) *NullableRoundingPolicyDtoListEnvelope {
	return &NullableRoundingPolicyDtoListEnvelope{value: val, isSet: true}
}

func (v NullableRoundingPolicyDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRoundingPolicyDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
