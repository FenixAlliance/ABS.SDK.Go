...
// checks if the PriceCalculationDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PriceCalculationDtoEnvelope{}

// PriceCalculationDtoEnvelope struct for PriceCalculationDtoEnvelope
type PriceCalculationDtoEnvelope struct {
	...
	Result *PriceCalculationDto `json:"result,omitempty"`
}
...
func NewPriceCalculationDtoEnvelope() *PriceCalculationDtoEnvelope {
	this := PriceCalculationDtoEnvelope{}
	return &this
}
...
func (o *PriceCalculationDtoEnvelope) SetErrorMessageNil() {
...
func (o *PriceCalculationDtoEnvelope) SetCorrelationIdNil() {
...
func (o *PriceCalculationDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given PriceCalculationDto and assigns it to the Result field.
func (o *PriceCalculationDtoEnvelope) SetResult(v PriceCalculationDto) {
	o.Result = &v
}

func (o PriceCalculationDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PriceCalculationDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePriceCalculationDtoEnvelope struct {
	value *PriceCalculationDtoEnvelope
	isSet bool
}

func (v NullablePriceCalculationDtoEnvelope) Get() *PriceCalculationDtoEnvelope {
	return v.value
}

func (v *NullablePriceCalculationDtoEnvelope) Set(val *PriceCalculationDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePriceCalculationDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePriceCalculationDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePriceCalculationDtoEnvelope(val *PriceCalculationDtoEnvelope) *NullablePriceCalculationDtoEnvelope {
	return &NullablePriceCalculationDtoEnvelope{value: val, isSet: true}
}

func (v NullablePriceCalculationDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePriceCalculationDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
