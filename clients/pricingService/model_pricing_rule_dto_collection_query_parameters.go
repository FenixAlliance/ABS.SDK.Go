...
// checks if the PricingRuleDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PricingRuleDtoCollectionQueryParameters{}

// PricingRuleDtoCollectionQueryParameters struct for PricingRuleDtoCollectionQueryParameters
type PricingRuleDtoCollectionQueryParameters struct {
...
func NewPricingRuleDtoCollectionQueryParameters() *PricingRuleDtoCollectionQueryParameters {
	this := PricingRuleDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PricingRuleDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PricingRuleDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PricingRuleDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePricingRuleDtoCollectionQueryParameters struct {
	value *PricingRuleDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePricingRuleDtoCollectionQueryParameters) Get() *PricingRuleDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePricingRuleDtoCollectionQueryParameters) Set(val *PricingRuleDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePricingRuleDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePricingRuleDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePricingRuleDtoCollectionQueryParameters(val *PricingRuleDtoCollectionQueryParameters) *NullablePricingRuleDtoCollectionQueryParameters {
	return &NullablePricingRuleDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePricingRuleDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePricingRuleDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
