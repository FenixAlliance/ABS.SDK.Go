...
// checks if the ItemPriceCalculationEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemPriceCalculationEnvelope{}

// ItemPriceCalculationEnvelope struct for ItemPriceCalculationEnvelope
type ItemPriceCalculationEnvelope struct {
	...
	Result *ItemPriceCalculation `json:"result,omitempty"`
}
...
func NewItemPriceCalculationEnvelope() *ItemPriceCalculationEnvelope {
	this := ItemPriceCalculationEnvelope{}
	return &this
}
...
func (o *ItemPriceCalculationEnvelope) SetErrorMessageNil() {
...
func (o *ItemPriceCalculationEnvelope) SetCorrelationIdNil() {
...
func (o *ItemPriceCalculationEnvelope) SetHttpStatusNil() {
...
func (o *ItemPriceCalculationEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemPriceCalculationEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given ItemPriceCalculation and assigns it to the Result field.
func (o *ItemPriceCalculationEnvelope) SetResult(v ItemPriceCalculation) {
	o.Result = &v
}

func (o ItemPriceCalculationEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemPriceCalculationEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemPriceCalculationEnvelope struct {
	value *ItemPriceCalculationEnvelope
	isSet bool
}

func (v NullableItemPriceCalculationEnvelope) Get() *ItemPriceCalculationEnvelope {
	return v.value
}

func (v *NullableItemPriceCalculationEnvelope) Set(val *ItemPriceCalculationEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemPriceCalculationEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemPriceCalculationEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemPriceCalculationEnvelope(val *ItemPriceCalculationEnvelope) *NullableItemPriceCalculationEnvelope {
	return &NullableItemPriceCalculationEnvelope{value: val, isSet: true}
}

func (v NullableItemPriceCalculationEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemPriceCalculationEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
