...
// checks if the DiscountListDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiscountListDtoEnvelope{}

// DiscountListDtoEnvelope struct for DiscountListDtoEnvelope
type DiscountListDtoEnvelope struct {
...
func (o *DiscountListDtoEnvelope) SetErrorMessageNil() {
...
func (o *DiscountListDtoEnvelope) SetCorrelationIdNil() {
...
func (o *DiscountListDtoEnvelope) SetHttpStatusNil() {
...
func (o *DiscountListDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DiscountListDtoEnvelope) SetActivityIdNil() {
...
func (o DiscountListDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DiscountListDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDiscountListDtoEnvelope struct {
	value *DiscountListDtoEnvelope
	isSet bool
}

func (v NullableDiscountListDtoEnvelope) Get() *DiscountListDtoEnvelope {
	return v.value
}

func (v *NullableDiscountListDtoEnvelope) Set(val *DiscountListDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscountListDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscountListDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscountListDtoEnvelope(val *DiscountListDtoEnvelope) *NullableDiscountListDtoEnvelope {
	return &NullableDiscountListDtoEnvelope{value: val, isSet: true}
}

func (v NullableDiscountListDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscountListDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
