...
// checks if the OAuthApplicationDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OAuthApplicationDtoListEnvelope{}

// OAuthApplicationDtoListEnvelope struct for OAuthApplicationDtoListEnvelope
type OAuthApplicationDtoListEnvelope struct {
...
func NewOAuthApplicationDtoListEnvelope() *OAuthApplicationDtoListEnvelope {
	this := OAuthApplicationDtoListEnvelope{}
	return &this
}
...
func (o *OAuthApplicationDtoListEnvelope) SetErrorMessageNil() {
...
func (o *OAuthApplicationDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *OAuthApplicationDtoListEnvelope) SetHttpStatusNil() {
...
func (o *OAuthApplicationDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *OAuthApplicationDtoListEnvelope) SetActivityIdNil() {
...
func (o OAuthApplicationDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o OAuthApplicationDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableOAuthApplicationDtoListEnvelope struct {
	value *OAuthApplicationDtoListEnvelope
	isSet bool
}

func (v NullableOAuthApplicationDtoListEnvelope) Get() *OAuthApplicationDtoListEnvelope {
	return v.value
}

func (v *NullableOAuthApplicationDtoListEnvelope) Set(val *OAuthApplicationDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableOAuthApplicationDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableOAuthApplicationDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOAuthApplicationDtoListEnvelope(val *OAuthApplicationDtoListEnvelope) *NullableOAuthApplicationDtoListEnvelope {
	return &NullableOAuthApplicationDtoListEnvelope{value: val, isSet: true}
}

func (v NullableOAuthApplicationDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOAuthApplicationDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
