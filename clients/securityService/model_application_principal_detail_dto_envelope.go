...
// checks if the ApplicationPrincipalDetailDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationPrincipalDetailDtoEnvelope{}

// ApplicationPrincipalDetailDtoEnvelope struct for ApplicationPrincipalDetailDtoEnvelope
type ApplicationPrincipalDetailDtoEnvelope struct {
	...
	Result *ApplicationPrincipalDetailDto `json:"result,omitempty"`
}
...
func NewApplicationPrincipalDetailDtoEnvelope() *ApplicationPrincipalDetailDtoEnvelope {
	this := ApplicationPrincipalDetailDtoEnvelope{}
	return &this
}
...
func (o *ApplicationPrincipalDetailDtoEnvelope) SetErrorMessageNil() {
...
func (o *ApplicationPrincipalDetailDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ApplicationPrincipalDetailDtoEnvelope) SetHttpStatusNil() {
...
func (o *ApplicationPrincipalDetailDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ApplicationPrincipalDetailDtoEnvelope) SetActivityIdNil() {
...
func (o *ApplicationPrincipalDetailDtoEnvelope) GetResult() ApplicationPrincipalDetailDto {
	if o == nil || IsNil(o.Result) {
		var ret ApplicationPrincipalDetailDto
		return ret
	}
	return *o.Result
}
...
// SetResult gets a reference to the given ApplicationPrincipalDetailDto and assigns it to the Result field.
func (o *ApplicationPrincipalDetailDtoEnvelope) SetResult(v ApplicationPrincipalDetailDto) {
	o.Result = &v
}

func (o ApplicationPrincipalDetailDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ApplicationPrincipalDetailDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationPrincipalDetailDtoEnvelope struct {
	value *ApplicationPrincipalDetailDtoEnvelope
	isSet bool
}

func (v NullableApplicationPrincipalDetailDtoEnvelope) Get() *ApplicationPrincipalDetailDtoEnvelope {
	return v.value
}

func (v *NullableApplicationPrincipalDetailDtoEnvelope) Set(val *ApplicationPrincipalDetailDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationPrincipalDetailDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationPrincipalDetailDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationPrincipalDetailDtoEnvelope(val *ApplicationPrincipalDetailDtoEnvelope) *NullableApplicationPrincipalDetailDtoEnvelope {
	return &NullableApplicationPrincipalDetailDtoEnvelope{value: val, isSet: true}
}

func (v NullableApplicationPrincipalDetailDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationPrincipalDetailDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
