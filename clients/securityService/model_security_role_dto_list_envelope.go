...
// checks if the SecurityRoleDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecurityRoleDtoListEnvelope{}

// SecurityRoleDtoListEnvelope struct for SecurityRoleDtoListEnvelope
type SecurityRoleDtoListEnvelope struct {
...
func NewSecurityRoleDtoListEnvelope() *SecurityRoleDtoListEnvelope {
	this := SecurityRoleDtoListEnvelope{}
	return &this
}
...
func (o *SecurityRoleDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SecurityRoleDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SecurityRoleDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SecurityRoleDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SecurityRoleDtoListEnvelope) SetActivityIdNil() {
...
func (o SecurityRoleDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SecurityRoleDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSecurityRoleDtoListEnvelope struct {
	value *SecurityRoleDtoListEnvelope
	isSet bool
}

func (v NullableSecurityRoleDtoListEnvelope) Get() *SecurityRoleDtoListEnvelope {
	return v.value
}

func (v *NullableSecurityRoleDtoListEnvelope) Set(val *SecurityRoleDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityRoleDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityRoleDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityRoleDtoListEnvelope(val *SecurityRoleDtoListEnvelope) *NullableSecurityRoleDtoListEnvelope {
	return &NullableSecurityRoleDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSecurityRoleDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityRoleDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
