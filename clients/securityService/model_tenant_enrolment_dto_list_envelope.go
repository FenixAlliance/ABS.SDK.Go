...
// checks if the TenantEnrolmentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TenantEnrolmentDtoListEnvelope{}

// TenantEnrolmentDtoListEnvelope struct for TenantEnrolmentDtoListEnvelope
type TenantEnrolmentDtoListEnvelope struct {
...
func NewTenantEnrolmentDtoListEnvelope() *TenantEnrolmentDtoListEnvelope {
	this := TenantEnrolmentDtoListEnvelope{}
	return &this
}
...
func (o *TenantEnrolmentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *TenantEnrolmentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *TenantEnrolmentDtoListEnvelope) SetActivityIdNil() {
...
func (o TenantEnrolmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TenantEnrolmentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTenantEnrolmentDtoListEnvelope struct {
	value *TenantEnrolmentDtoListEnvelope
	isSet bool
}

func (v NullableTenantEnrolmentDtoListEnvelope) Get() *TenantEnrolmentDtoListEnvelope {
	return v.value
}

func (v *NullableTenantEnrolmentDtoListEnvelope) Set(val *TenantEnrolmentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTenantEnrolmentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTenantEnrolmentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTenantEnrolmentDtoListEnvelope(val *TenantEnrolmentDtoListEnvelope) *NullableTenantEnrolmentDtoListEnvelope {
	return &NullableTenantEnrolmentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableTenantEnrolmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTenantEnrolmentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
