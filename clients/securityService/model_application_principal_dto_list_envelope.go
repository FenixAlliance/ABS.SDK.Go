...
// checks if the ApplicationPrincipalDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApplicationPrincipalDtoListEnvelope{}

// ApplicationPrincipalDtoListEnvelope struct for ApplicationPrincipalDtoListEnvelope
type ApplicationPrincipalDtoListEnvelope struct {
...
func NewApplicationPrincipalDtoListEnvelope() *ApplicationPrincipalDtoListEnvelope {
	this := ApplicationPrincipalDtoListEnvelope{}
	return &this
}
...
func (o *ApplicationPrincipalDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ApplicationPrincipalDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ApplicationPrincipalDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ApplicationPrincipalDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ApplicationPrincipalDtoListEnvelope) SetActivityIdNil() {
...
func (o ApplicationPrincipalDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ApplicationPrincipalDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableApplicationPrincipalDtoListEnvelope struct {
	value *ApplicationPrincipalDtoListEnvelope
	isSet bool
}

func (v NullableApplicationPrincipalDtoListEnvelope) Get() *ApplicationPrincipalDtoListEnvelope {
	return v.value
}

func (v *NullableApplicationPrincipalDtoListEnvelope) Set(val *ApplicationPrincipalDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableApplicationPrincipalDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableApplicationPrincipalDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableApplicationPrincipalDtoListEnvelope(val *ApplicationPrincipalDtoListEnvelope) *NullableApplicationPrincipalDtoListEnvelope {
	return &NullableApplicationPrincipalDtoListEnvelope{value: val, isSet: true}
}

func (v NullableApplicationPrincipalDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableApplicationPrincipalDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
