...
// checks if the LogDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LogDtoCollectionQueryParameters{}

// LogDtoCollectionQueryParameters struct for LogDtoCollectionQueryParameters
type LogDtoCollectionQueryParameters struct {
...
func NewLogDtoCollectionQueryParameters() *LogDtoCollectionQueryParameters {
	this := LogDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LogDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LogDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LogDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LogDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LogDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LogDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LogDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LogDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LogDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLogDtoCollectionQueryParameters struct {
	value *LogDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLogDtoCollectionQueryParameters) Get() *LogDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLogDtoCollectionQueryParameters) Set(val *LogDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLogDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLogDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLogDtoCollectionQueryParameters(val *LogDtoCollectionQueryParameters) *NullableLogDtoCollectionQueryParameters {
	return &NullableLogDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLogDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLogDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
