...
// checks if the PaymentMethodDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentMethodDtoEnvelope{}

// PaymentMethodDtoEnvelope struct for PaymentMethodDtoEnvelope
type PaymentMethodDtoEnvelope struct {
...
func (o *PaymentMethodDtoEnvelope) SetErrorMessageNil() {
...
func (o *PaymentMethodDtoEnvelope) SetCorrelationIdNil() {
...
func (o *PaymentMethodDtoEnvelope) SetHttpStatusNil() {
...
func (o *PaymentMethodDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PaymentMethodDtoEnvelope) SetActivityIdNil() {
...
func (o PaymentMethodDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PaymentMethodDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentMethodDtoEnvelope struct {
	value *PaymentMethodDtoEnvelope
	isSet bool
}

func (v NullablePaymentMethodDtoEnvelope) Get() *PaymentMethodDtoEnvelope {
	return v.value
}

func (v *NullablePaymentMethodDtoEnvelope) Set(val *PaymentMethodDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentMethodDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentMethodDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentMethodDtoEnvelope(val *PaymentMethodDtoEnvelope) *NullablePaymentMethodDtoEnvelope {
	return &NullablePaymentMethodDtoEnvelope{value: val, isSet: true}
}

func (v NullablePaymentMethodDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentMethodDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
