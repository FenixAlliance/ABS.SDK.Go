...
// checks if the PaymentModeDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentModeDtoIReadOnlyListEnvelope{}

// PaymentModeDtoIReadOnlyListEnvelope struct for PaymentModeDtoIReadOnlyListEnvelope
type PaymentModeDtoIReadOnlyListEnvelope struct {
	...
	Result []PaymentModeDto `json:"result,omitempty"`
}
...
func NewPaymentModeDtoIReadOnlyListEnvelope() *PaymentModeDtoIReadOnlyListEnvelope {
	this := PaymentModeDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *PaymentModeDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *PaymentModeDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *PaymentModeDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *PaymentModeDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PaymentModeDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []PaymentModeDto and assigns it to the Result field.
func (o *PaymentModeDtoIReadOnlyListEnvelope) SetResult(v []PaymentModeDto) {
	o.Result = v
}

func (o PaymentModeDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PaymentModeDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentModeDtoIReadOnlyListEnvelope struct {
	value *PaymentModeDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullablePaymentModeDtoIReadOnlyListEnvelope) Get() *PaymentModeDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullablePaymentModeDtoIReadOnlyListEnvelope) Set(val *PaymentModeDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentModeDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentModeDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentModeDtoIReadOnlyListEnvelope(val *PaymentModeDtoIReadOnlyListEnvelope) *NullablePaymentModeDtoIReadOnlyListEnvelope {
	return &NullablePaymentModeDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullablePaymentModeDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentModeDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
