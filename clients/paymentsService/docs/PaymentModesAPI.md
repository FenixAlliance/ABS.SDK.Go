...
> PaymentModeDtoIReadOnlyListEnvelope GetPaymentModesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentModeDtoCollectionQueryParameters(paymentModeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	paymentModeDtoCollectionQueryParameters := *openapiclient.NewPaymentModeDtoCollectionQueryParameters() // PaymentModeDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PaymentModesAPI.GetPaymentModesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentModeDtoCollectionQueryParameters(paymentModeDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **paymentModeDtoCollectionQueryParameters** | [**PaymentModeDtoCollectionQueryParameters**](PaymentModeDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetPaymentModesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentModeDtoCollectionQueryParameters(paymentModeDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PaymentModesAPI.GetPaymentModesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentModeDtoCollectionQueryParameters(paymentModeDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchPaymentModeAsync(ctx, paymentModeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PaymentModesAPI.PatchPaymentModeAsync(context.Background(), paymentModeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `PaymentModesAPI.PatchPaymentModeAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchPaymentModeAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `PaymentModesAPI.PatchPaymentModeAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchPaymentModeAsyncRequest struct via the builder pattern
