...
> PaymentTermDtoIReadOnlyListEnvelope GetPaymentTermsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentTermDtoCollectionQueryParameters(paymentTermDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	paymentTermDtoCollectionQueryParameters := *openapiclient.NewPaymentTermDtoCollectionQueryParameters() // PaymentTermDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PaymentTermsAPI.GetPaymentTermsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentTermDtoCollectionQueryParameters(paymentTermDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **paymentTermDtoCollectionQueryParameters** | [**PaymentTermDtoCollectionQueryParameters**](PaymentTermDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetPaymentTermsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentTermDtoCollectionQueryParameters(paymentTermDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PaymentTermsAPI.GetPaymentTermsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PaymentTermDtoCollectionQueryParameters(paymentTermDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchPaymentTermAsync(ctx, paymentTermId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PaymentTermsAPI.PatchPaymentTermAsync(context.Background(), paymentTermId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `PaymentTermsAPI.PatchPaymentTermAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchPaymentTermAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `PaymentTermsAPI.PatchPaymentTermAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchPaymentTermAsyncRequest struct via the builder pattern
