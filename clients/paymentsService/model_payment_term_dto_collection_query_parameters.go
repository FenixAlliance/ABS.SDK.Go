...
// checks if the PaymentTermDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentTermDtoCollectionQueryParameters{}

// PaymentTermDtoCollectionQueryParameters struct for PaymentTermDtoCollectionQueryParameters
type PaymentTermDtoCollectionQueryParameters struct {
...
func NewPaymentTermDtoCollectionQueryParameters() *PaymentTermDtoCollectionQueryParameters {
	this := PaymentTermDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PaymentTermDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PaymentTermDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PaymentTermDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentTermDtoCollectionQueryParameters struct {
	value *PaymentTermDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePaymentTermDtoCollectionQueryParameters) Get() *PaymentTermDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePaymentTermDtoCollectionQueryParameters) Set(val *PaymentTermDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentTermDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentTermDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentTermDtoCollectionQueryParameters(val *PaymentTermDtoCollectionQueryParameters) *NullablePaymentTermDtoCollectionQueryParameters {
	return &NullablePaymentTermDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePaymentTermDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentTermDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
