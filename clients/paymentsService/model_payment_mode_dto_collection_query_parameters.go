...
// checks if the PaymentModeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentModeDtoCollectionQueryParameters{}

// PaymentModeDtoCollectionQueryParameters struct for PaymentModeDtoCollectionQueryParameters
type PaymentModeDtoCollectionQueryParameters struct {
...
func NewPaymentModeDtoCollectionQueryParameters() *PaymentModeDtoCollectionQueryParameters {
	this := PaymentModeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PaymentModeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PaymentModeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PaymentModeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentModeDtoCollectionQueryParameters struct {
	value *PaymentModeDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePaymentModeDtoCollectionQueryParameters) Get() *PaymentModeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePaymentModeDtoCollectionQueryParameters) Set(val *PaymentModeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentModeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentModeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentModeDtoCollectionQueryParameters(val *PaymentModeDtoCollectionQueryParameters) *NullablePaymentModeDtoCollectionQueryParameters {
	return &NullablePaymentModeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePaymentModeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentModeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
