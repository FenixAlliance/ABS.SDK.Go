...
// checks if the PaymentModeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentModeDtoEnvelope{}

// PaymentModeDtoEnvelope struct for PaymentModeDtoEnvelope
type PaymentModeDtoEnvelope struct {
...
func (o *PaymentModeDtoEnvelope) SetErrorMessageNil() {
...
func (o *PaymentModeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *PaymentModeDtoEnvelope) SetHttpStatusNil() {
...
func (o *PaymentModeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PaymentModeDtoEnvelope) SetActivityIdNil() {
...
func (o PaymentModeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PaymentModeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentModeDtoEnvelope struct {
	value *PaymentModeDtoEnvelope
	isSet bool
}

func (v NullablePaymentModeDtoEnvelope) Get() *PaymentModeDtoEnvelope {
	return v.value
}

func (v *NullablePaymentModeDtoEnvelope) Set(val *PaymentModeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentModeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentModeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentModeDtoEnvelope(val *PaymentModeDtoEnvelope) *NullablePaymentModeDtoEnvelope {
	return &NullablePaymentModeDtoEnvelope{value: val, isSet: true}
}

func (v NullablePaymentModeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentModeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
