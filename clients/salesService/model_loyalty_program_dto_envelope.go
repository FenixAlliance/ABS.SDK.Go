...
// checks if the LoyaltyProgramDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyProgramDtoEnvelope{}

// LoyaltyProgramDtoEnvelope struct for LoyaltyProgramDtoEnvelope
type LoyaltyProgramDtoEnvelope struct {
...
func NewLoyaltyProgramDtoEnvelope() *LoyaltyProgramDtoEnvelope {
	this := LoyaltyProgramDtoEnvelope{}
	return &this
}
...
func (o *LoyaltyProgramDtoEnvelope) SetErrorMessageNil() {
...
func (o *LoyaltyProgramDtoEnvelope) SetCorrelationIdNil() {
...
func (o *LoyaltyProgramDtoEnvelope) SetHttpStatusNil() {
...
func (o *LoyaltyProgramDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LoyaltyProgramDtoEnvelope) SetActivityIdNil() {
...
func (o LoyaltyProgramDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LoyaltyProgramDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLoyaltyProgramDtoEnvelope struct {
	value *LoyaltyProgramDtoEnvelope
	isSet bool
}

func (v NullableLoyaltyProgramDtoEnvelope) Get() *LoyaltyProgramDtoEnvelope {
	return v.value
}

func (v *NullableLoyaltyProgramDtoEnvelope) Set(val *LoyaltyProgramDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLoyaltyProgramDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLoyaltyProgramDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoyaltyProgramDtoEnvelope(val *LoyaltyProgramDtoEnvelope) *NullableLoyaltyProgramDtoEnvelope {
	return &NullableLoyaltyProgramDtoEnvelope{value: val, isSet: true}
}

func (v NullableLoyaltyProgramDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoyaltyProgramDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
