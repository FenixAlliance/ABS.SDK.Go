...
// checks if the SalesLiteratureDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalesLiteratureDtoListEnvelope{}

// SalesLiteratureDtoListEnvelope struct for SalesLiteratureDtoListEnvelope
type SalesLiteratureDtoListEnvelope struct {
...
func NewSalesLiteratureDtoListEnvelope() *SalesLiteratureDtoListEnvelope {
	this := SalesLiteratureDtoListEnvelope{}
	return &this
}
...
func (o *SalesLiteratureDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SalesLiteratureDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SalesLiteratureDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SalesLiteratureDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SalesLiteratureDtoListEnvelope) SetActivityIdNil() {
...
func (o SalesLiteratureDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SalesLiteratureDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSalesLiteratureDtoListEnvelope struct {
	value *SalesLiteratureDtoListEnvelope
	isSet bool
}

func (v NullableSalesLiteratureDtoListEnvelope) Get() *SalesLiteratureDtoListEnvelope {
	return v.value
}

func (v *NullableSalesLiteratureDtoListEnvelope) Set(val *SalesLiteratureDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSalesLiteratureDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSalesLiteratureDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalesLiteratureDtoListEnvelope(val *SalesLiteratureDtoListEnvelope) *NullableSalesLiteratureDtoListEnvelope {
	return &NullableSalesLiteratureDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSalesLiteratureDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalesLiteratureDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
