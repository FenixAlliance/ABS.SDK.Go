...
// checks if the ExtendedSalesLiteratureDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedSalesLiteratureDtoListEnvelope{}

// ExtendedSalesLiteratureDtoListEnvelope struct for ExtendedSalesLiteratureDtoListEnvelope
type ExtendedSalesLiteratureDtoListEnvelope struct {
	...
	Result []ExtendedSalesLiteratureDto `json:"result,omitempty"`
}
...
func NewExtendedSalesLiteratureDtoListEnvelope() *ExtendedSalesLiteratureDtoListEnvelope {
	this := ExtendedSalesLiteratureDtoListEnvelope{}
	return &this
}
...
func (o *ExtendedSalesLiteratureDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedSalesLiteratureDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedSalesLiteratureDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedSalesLiteratureDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedSalesLiteratureDtoListEnvelope) SetActivityIdNil() {
...
func (o *ExtendedSalesLiteratureDtoListEnvelope) GetResult() []ExtendedSalesLiteratureDto {
	if o == nil {
		var ret []ExtendedSalesLiteratureDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []ExtendedSalesLiteratureDto and assigns it to the Result field.
func (o *ExtendedSalesLiteratureDtoListEnvelope) SetResult(v []ExtendedSalesLiteratureDto) {
	o.Result = v
}

func (o ExtendedSalesLiteratureDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedSalesLiteratureDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedSalesLiteratureDtoListEnvelope struct {
	value *ExtendedSalesLiteratureDtoListEnvelope
	isSet bool
}

func (v NullableExtendedSalesLiteratureDtoListEnvelope) Get() *ExtendedSalesLiteratureDtoListEnvelope {
	return v.value
}

func (v *NullableExtendedSalesLiteratureDtoListEnvelope) Set(val *ExtendedSalesLiteratureDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedSalesLiteratureDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedSalesLiteratureDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedSalesLiteratureDtoListEnvelope(val *ExtendedSalesLiteratureDtoListEnvelope) *NullableExtendedSalesLiteratureDtoListEnvelope {
	return &NullableExtendedSalesLiteratureDtoListEnvelope{value: val, isSet: true}
}

func (v NullableExtendedSalesLiteratureDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedSalesLiteratureDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
