...
// checks if the LoyaltyProgramDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LoyaltyProgramDtoListEnvelope{}

// LoyaltyProgramDtoListEnvelope struct for LoyaltyProgramDtoListEnvelope
type LoyaltyProgramDtoListEnvelope struct {
	...
	Result []LoyaltyProgramDto `json:"result,omitempty"`
}
...
func NewLoyaltyProgramDtoListEnvelope() *LoyaltyProgramDtoListEnvelope {
	this := LoyaltyProgramDtoListEnvelope{}
	return &this
}
...
func (o *LoyaltyProgramDtoListEnvelope) SetErrorMessageNil() {
...
func (o *LoyaltyProgramDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *LoyaltyProgramDtoListEnvelope) SetHttpStatusNil() {
...
func (o *LoyaltyProgramDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LoyaltyProgramDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []LoyaltyProgramDto and assigns it to the Result field.
func (o *LoyaltyProgramDtoListEnvelope) SetResult(v []LoyaltyProgramDto) {
	o.Result = v
}

func (o LoyaltyProgramDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LoyaltyProgramDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLoyaltyProgramDtoListEnvelope struct {
	value *LoyaltyProgramDtoListEnvelope
	isSet bool
}

func (v NullableLoyaltyProgramDtoListEnvelope) Get() *LoyaltyProgramDtoListEnvelope {
	return v.value
}

func (v *NullableLoyaltyProgramDtoListEnvelope) Set(val *LoyaltyProgramDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLoyaltyProgramDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLoyaltyProgramDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLoyaltyProgramDtoListEnvelope(val *LoyaltyProgramDtoListEnvelope) *NullableLoyaltyProgramDtoListEnvelope {
	return &NullableLoyaltyProgramDtoListEnvelope{value: val, isSet: true}
}

func (v NullableLoyaltyProgramDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLoyaltyProgramDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
