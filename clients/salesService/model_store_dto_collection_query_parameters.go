...
// checks if the StoreDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StoreDtoCollectionQueryParameters{}

// StoreDtoCollectionQueryParameters struct for StoreDtoCollectionQueryParameters
type StoreDtoCollectionQueryParameters struct {
...
func NewStoreDtoCollectionQueryParameters() *StoreDtoCollectionQueryParameters {
	this := StoreDtoCollectionQueryParameters{}
	return &this
}
...
func (o *StoreDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *StoreDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *StoreDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *StoreDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *StoreDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *StoreDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *StoreDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o StoreDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o StoreDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableStoreDtoCollectionQueryParameters struct {
	value *StoreDtoCollectionQueryParameters
	isSet bool
}

func (v NullableStoreDtoCollectionQueryParameters) Get() *StoreDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableStoreDtoCollectionQueryParameters) Set(val *StoreDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableStoreDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableStoreDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStoreDtoCollectionQueryParameters(val *StoreDtoCollectionQueryParameters) *NullableStoreDtoCollectionQueryParameters {
	return &NullableStoreDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableStoreDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStoreDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
