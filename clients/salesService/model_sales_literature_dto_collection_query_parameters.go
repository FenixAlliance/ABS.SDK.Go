...
// checks if the SalesLiteratureDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalesLiteratureDtoCollectionQueryParameters{}

// SalesLiteratureDtoCollectionQueryParameters struct for SalesLiteratureDtoCollectionQueryParameters
type SalesLiteratureDtoCollectionQueryParameters struct {
...
func NewSalesLiteratureDtoCollectionQueryParameters() *SalesLiteratureDtoCollectionQueryParameters {
	this := SalesLiteratureDtoCollectionQueryParameters{}
	return &this
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *SalesLiteratureDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o SalesLiteratureDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o SalesLiteratureDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableSalesLiteratureDtoCollectionQueryParameters struct {
	value *SalesLiteratureDtoCollectionQueryParameters
	isSet bool
}

func (v NullableSalesLiteratureDtoCollectionQueryParameters) Get() *SalesLiteratureDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableSalesLiteratureDtoCollectionQueryParameters) Set(val *SalesLiteratureDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableSalesLiteratureDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableSalesLiteratureDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalesLiteratureDtoCollectionQueryParameters(val *SalesLiteratureDtoCollectionQueryParameters) *NullableSalesLiteratureDtoCollectionQueryParameters {
	return &NullableSalesLiteratureDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableSalesLiteratureDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalesLiteratureDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
