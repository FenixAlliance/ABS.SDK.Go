...
// checks if the OpenIdConfigurationEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OpenIdConfigurationEnvelope{}

// OpenIdConfigurationEnvelope struct for OpenIdConfigurationEnvelope
type OpenIdConfigurationEnvelope struct {
	...
	Result *OpenIdConfiguration `json:"result,omitempty"`
}
...
func NewOpenIdConfigurationEnvelope() *OpenIdConfigurationEnvelope {
	this := OpenIdConfigurationEnvelope{}
	return &this
}
...
func (o *OpenIdConfigurationEnvelope) SetErrorMessageNil() {
...
func (o *OpenIdConfigurationEnvelope) SetCorrelationIdNil() {
...
func (o *OpenIdConfigurationEnvelope) SetHttpStatusNil() {
...
func (o *OpenIdConfigurationEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *OpenIdConfigurationEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given OpenIdConfiguration and assigns it to the Result field.
func (o *OpenIdConfigurationEnvelope) SetResult(v OpenIdConfiguration) {
	o.Result = &v
}

func (o OpenIdConfigurationEnvelope) MarshalJSON() ([]byte, error) {
...
func (o OpenIdConfigurationEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableOpenIdConfigurationEnvelope struct {
	value *OpenIdConfigurationEnvelope
	isSet bool
}

func (v NullableOpenIdConfigurationEnvelope) Get() *OpenIdConfigurationEnvelope {
	return v.value
}

func (v *NullableOpenIdConfigurationEnvelope) Set(val *OpenIdConfigurationEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableOpenIdConfigurationEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableOpenIdConfigurationEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOpenIdConfigurationEnvelope(val *OpenIdConfigurationEnvelope) *NullableOpenIdConfigurationEnvelope {
	return &NullableOpenIdConfigurationEnvelope{value: val, isSet: true}
}

func (v NullableOpenIdConfigurationEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOpenIdConfigurationEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
