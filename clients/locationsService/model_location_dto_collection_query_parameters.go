...
// checks if the LocationDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LocationDtoCollectionQueryParameters{}

// LocationDtoCollectionQueryParameters struct for LocationDtoCollectionQueryParameters
type LocationDtoCollectionQueryParameters struct {
...
func NewLocationDtoCollectionQueryParameters() *LocationDtoCollectionQueryParameters {
	this := LocationDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LocationDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LocationDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LocationDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LocationDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LocationDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LocationDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LocationDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LocationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LocationDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLocationDtoCollectionQueryParameters struct {
	value *LocationDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLocationDtoCollectionQueryParameters) Get() *LocationDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLocationDtoCollectionQueryParameters) Set(val *LocationDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLocationDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLocationDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocationDtoCollectionQueryParameters(val *LocationDtoCollectionQueryParameters) *NullableLocationDtoCollectionQueryParameters {
	return &NullableLocationDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLocationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocationDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
