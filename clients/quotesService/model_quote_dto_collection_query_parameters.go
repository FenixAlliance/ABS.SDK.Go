...
// checks if the QuoteDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuoteDtoCollectionQueryParameters{}

// QuoteDtoCollectionQueryParameters struct for QuoteDtoCollectionQueryParameters
type QuoteDtoCollectionQueryParameters struct {
...
func NewQuoteDtoCollectionQueryParameters() *QuoteDtoCollectionQueryParameters {
	this := QuoteDtoCollectionQueryParameters{}
	return &this
}
...
func (o *QuoteDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *QuoteDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *QuoteDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *QuoteDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *QuoteDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *QuoteDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *QuoteDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o QuoteDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o QuoteDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableQuoteDtoCollectionQueryParameters struct {
	value *QuoteDtoCollectionQueryParameters
	isSet bool
}

func (v NullableQuoteDtoCollectionQueryParameters) Get() *QuoteDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableQuoteDtoCollectionQueryParameters) Set(val *QuoteDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableQuoteDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableQuoteDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuoteDtoCollectionQueryParameters(val *QuoteDtoCollectionQueryParameters) *NullableQuoteDtoCollectionQueryParameters {
	return &NullableQuoteDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableQuoteDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuoteDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
