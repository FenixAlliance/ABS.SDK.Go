...
// checks if the ExtendedQuoteDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedQuoteDtoListEnvelope{}

// ExtendedQuoteDtoListEnvelope struct for ExtendedQuoteDtoListEnvelope
type ExtendedQuoteDtoListEnvelope struct {
	...
	Result []ExtendedQuoteDto `json:"result,omitempty"`
}
...
func NewExtendedQuoteDtoListEnvelope() *ExtendedQuoteDtoListEnvelope {
	this := ExtendedQuoteDtoListEnvelope{}
	return &this
}
...
func (o *ExtendedQuoteDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedQuoteDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedQuoteDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedQuoteDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedQuoteDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ExtendedQuoteDto and assigns it to the Result field.
func (o *ExtendedQuoteDtoListEnvelope) SetResult(v []ExtendedQuoteDto) {
	o.Result = v
}

func (o ExtendedQuoteDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedQuoteDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedQuoteDtoListEnvelope struct {
	value *ExtendedQuoteDtoListEnvelope
	isSet bool
}

func (v NullableExtendedQuoteDtoListEnvelope) Get() *ExtendedQuoteDtoListEnvelope {
	return v.value
}

func (v *NullableExtendedQuoteDtoListEnvelope) Set(val *ExtendedQuoteDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedQuoteDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedQuoteDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedQuoteDtoListEnvelope(val *ExtendedQuoteDtoListEnvelope) *NullableExtendedQuoteDtoListEnvelope {
	return &NullableExtendedQuoteDtoListEnvelope{value: val, isSet: true}
}

func (v NullableExtendedQuoteDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedQuoteDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
