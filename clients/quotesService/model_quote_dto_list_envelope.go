...
// checks if the QuoteDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuoteDtoListEnvelope{}

// QuoteDtoListEnvelope struct for QuoteDtoListEnvelope
type QuoteDtoListEnvelope struct {
...
func (o *QuoteDtoListEnvelope) SetErrorMessageNil() {
...
func (o *QuoteDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *QuoteDtoListEnvelope) SetHttpStatusNil() {
...
func (o *QuoteDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *QuoteDtoListEnvelope) SetActivityIdNil() {
...
func (o QuoteDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o QuoteDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableQuoteDtoListEnvelope struct {
	value *QuoteDtoListEnvelope
	isSet bool
}

func (v NullableQuoteDtoListEnvelope) Get() *QuoteDtoListEnvelope {
	return v.value
}

func (v *NullableQuoteDtoListEnvelope) Set(val *QuoteDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableQuoteDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableQuoteDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuoteDtoListEnvelope(val *QuoteDtoListEnvelope) *NullableQuoteDtoListEnvelope {
	return &NullableQuoteDtoListEnvelope{value: val, isSet: true}
}

func (v NullableQuoteDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuoteDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
