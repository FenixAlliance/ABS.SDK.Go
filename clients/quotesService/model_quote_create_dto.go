...
type QuoteCreateDto struct {
	...
	QuoteLines []QuoteLineCreateDto `json:"quoteLines,omitempty"`
}
...
func (o *QuoteCreateDto) SetTotalDetailCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalProfitCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalDiscountsCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalSurchargesCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalShippingCostCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalShippingTaxCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalWithheldTaxCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalTaxBaseCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalTaxesCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalGlobalSurchargesCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalGlobalDiscountsCurrencyIdNil() {
...
func (o *QuoteCreateDto) SetTotalCurrencyIdNil() {
...
// GetQuoteLines returns the QuoteLines field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *QuoteCreateDto) GetQuoteLines() []QuoteLineCreateDto {
	if o == nil {
		var ret []QuoteLineCreateDto
		return ret
	}
	return o.QuoteLines
}

// GetQuoteLinesOk returns a tuple with the QuoteLines field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *QuoteCreateDto) GetQuoteLinesOk() ([]QuoteLineCreateDto, bool) {
	if o == nil || IsNil(o.QuoteLines) {
		return nil, false
	}
	return o.QuoteLines, true
}
...
// SetQuoteLines gets a reference to the given []QuoteLineCreateDto and assigns it to the QuoteLines field.
...
func (o QuoteCreateDto) ToMap() (map[string]interface{}, error) {
	...
	if o.QuoteLines != nil {
		toSerialize["quoteLines"] = o.QuoteLines
	}
