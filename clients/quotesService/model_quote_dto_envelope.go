...
// checks if the QuoteDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &QuoteDtoEnvelope{}

// QuoteDtoEnvelope struct for QuoteDtoEnvelope
type QuoteDtoEnvelope struct {
	...
	Result *QuoteDto `json:"result,omitempty"`
}
...
func (o *QuoteDtoEnvelope) SetErrorMessageNil() {
...
func (o *QuoteDtoEnvelope) SetCorrelationIdNil() {
...
func (o *QuoteDtoEnvelope) SetHttpStatusNil() {
...
func (o *QuoteDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *QuoteDtoEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given QuoteDto and assigns it to the Result field.
func (o *QuoteDtoEnvelope) SetResult(v QuoteDto) {
	o.Result = &v
}

func (o QuoteDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o QuoteDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableQuoteDtoEnvelope struct {
	value *QuoteDtoEnvelope
	isSet bool
}

func (v NullableQuoteDtoEnvelope) Get() *QuoteDtoEnvelope {
	return v.value
}

func (v *NullableQuoteDtoEnvelope) Set(val *QuoteDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableQuoteDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableQuoteDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableQuoteDtoEnvelope(val *QuoteDtoEnvelope) *NullableQuoteDtoEnvelope {
	return &NullableQuoteDtoEnvelope{value: val, isSet: true}
}

func (v NullableQuoteDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableQuoteDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
