...
// checks if the TrainingProgramEventDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrainingProgramEventDtoEnvelope{}

// TrainingProgramEventDtoEnvelope struct for TrainingProgramEventDtoEnvelope
type TrainingProgramEventDtoEnvelope struct {
...
func NewTrainingProgramEventDtoEnvelope() *TrainingProgramEventDtoEnvelope {
	this := TrainingProgramEventDtoEnvelope{}
	return &this
}
...
func (o *TrainingProgramEventDtoEnvelope) SetErrorMessageNil() {
...
func (o *TrainingProgramEventDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TrainingProgramEventDtoEnvelope) SetHttpStatusNil() {
...
func (o *TrainingProgramEventDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TrainingProgramEventDtoEnvelope) SetActivityIdNil() {
...
func (o TrainingProgramEventDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TrainingProgramEventDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTrainingProgramEventDtoEnvelope struct {
	value *TrainingProgramEventDtoEnvelope
	isSet bool
}

func (v NullableTrainingProgramEventDtoEnvelope) Get() *TrainingProgramEventDtoEnvelope {
	return v.value
}

func (v *NullableTrainingProgramEventDtoEnvelope) Set(val *TrainingProgramEventDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTrainingProgramEventDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTrainingProgramEventDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrainingProgramEventDtoEnvelope(val *TrainingProgramEventDtoEnvelope) *NullableTrainingProgramEventDtoEnvelope {
	return &NullableTrainingProgramEventDtoEnvelope{value: val, isSet: true}
}

func (v NullableTrainingProgramEventDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrainingProgramEventDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
