...
// checks if the RequiredSkillRecordDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequiredSkillRecordDtoListEnvelope{}

// RequiredSkillRecordDtoListEnvelope struct for RequiredSkillRecordDtoListEnvelope
type RequiredSkillRecordDtoListEnvelope struct {
...
func NewRequiredSkillRecordDtoListEnvelope() *RequiredSkillRecordDtoListEnvelope {
	this := RequiredSkillRecordDtoListEnvelope{}
	return &this
}
...
func (o *RequiredSkillRecordDtoListEnvelope) SetErrorMessageNil() {
...
func (o *RequiredSkillRecordDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *RequiredSkillRecordDtoListEnvelope) SetHttpStatusNil() {
...
func (o *RequiredSkillRecordDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *RequiredSkillRecordDtoListEnvelope) SetActivityIdNil() {
...
func (o RequiredSkillRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o RequiredSkillRecordDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableRequiredSkillRecordDtoListEnvelope struct {
	value *RequiredSkillRecordDtoListEnvelope
	isSet bool
}

func (v NullableRequiredSkillRecordDtoListEnvelope) Get() *RequiredSkillRecordDtoListEnvelope {
	return v.value
}

func (v *NullableRequiredSkillRecordDtoListEnvelope) Set(val *RequiredSkillRecordDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableRequiredSkillRecordDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableRequiredSkillRecordDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequiredSkillRecordDtoListEnvelope(val *RequiredSkillRecordDtoListEnvelope) *NullableRequiredSkillRecordDtoListEnvelope {
	return &NullableRequiredSkillRecordDtoListEnvelope{value: val, isSet: true}
}

func (v NullableRequiredSkillRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequiredSkillRecordDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
