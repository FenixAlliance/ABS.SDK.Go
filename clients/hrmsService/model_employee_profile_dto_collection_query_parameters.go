...
// checks if the EmployeeProfileDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeeProfileDtoCollectionQueryParameters{}

// EmployeeProfileDtoCollectionQueryParameters struct for EmployeeProfileDtoCollectionQueryParameters
type EmployeeProfileDtoCollectionQueryParameters struct {
...
func NewEmployeeProfileDtoCollectionQueryParameters() *EmployeeProfileDtoCollectionQueryParameters {
	this := EmployeeProfileDtoCollectionQueryParameters{}
	return &this
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *EmployeeProfileDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o EmployeeProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o EmployeeProfileDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableEmployeeProfileDtoCollectionQueryParameters struct {
	value *EmployeeProfileDtoCollectionQueryParameters
	isSet bool
}

func (v NullableEmployeeProfileDtoCollectionQueryParameters) Get() *EmployeeProfileDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableEmployeeProfileDtoCollectionQueryParameters) Set(val *EmployeeProfileDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeeProfileDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeeProfileDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeeProfileDtoCollectionQueryParameters(val *EmployeeProfileDtoCollectionQueryParameters) *NullableEmployeeProfileDtoCollectionQueryParameters {
	return &NullableEmployeeProfileDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableEmployeeProfileDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeeProfileDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
