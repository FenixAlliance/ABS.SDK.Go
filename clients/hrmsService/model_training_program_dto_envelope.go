...
// checks if the TrainingProgramDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrainingProgramDtoEnvelope{}

// TrainingProgramDtoEnvelope struct for TrainingProgramDtoEnvelope
type TrainingProgramDtoEnvelope struct {
...
func NewTrainingProgramDtoEnvelope() *TrainingProgramDtoEnvelope {
	this := TrainingProgramDtoEnvelope{}
	return &this
}
...
func (o *TrainingProgramDtoEnvelope) SetErrorMessageNil() {
...
func (o *TrainingProgramDtoEnvelope) SetCorrelationIdNil() {
...
func (o *TrainingProgramDtoEnvelope) SetHttpStatusNil() {
...
func (o *TrainingProgramDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *TrainingProgramDtoEnvelope) SetActivityIdNil() {
...
func (o TrainingProgramDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o TrainingProgramDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableTrainingProgramDtoEnvelope struct {
	value *TrainingProgramDtoEnvelope
	isSet bool
}

func (v NullableTrainingProgramDtoEnvelope) Get() *TrainingProgramDtoEnvelope {
	return v.value
}

func (v *NullableTrainingProgramDtoEnvelope) Set(val *TrainingProgramDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableTrainingProgramDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableTrainingProgramDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrainingProgramDtoEnvelope(val *TrainingProgramDtoEnvelope) *NullableTrainingProgramDtoEnvelope {
	return &NullableTrainingProgramDtoEnvelope{value: val, isSet: true}
}

func (v NullableTrainingProgramDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrainingProgramDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
