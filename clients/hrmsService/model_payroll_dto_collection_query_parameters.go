...
// checks if the PayrollDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayrollDtoCollectionQueryParameters{}

// PayrollDtoCollectionQueryParameters struct for PayrollDtoCollectionQueryParameters
type PayrollDtoCollectionQueryParameters struct {
...
func NewPayrollDtoCollectionQueryParameters() *PayrollDtoCollectionQueryParameters {
	this := PayrollDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PayrollDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PayrollDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PayrollDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PayrollDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PayrollDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PayrollDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PayrollDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PayrollDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PayrollDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePayrollDtoCollectionQueryParameters struct {
	value *PayrollDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePayrollDtoCollectionQueryParameters) Get() *PayrollDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePayrollDtoCollectionQueryParameters) Set(val *PayrollDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePayrollDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePayrollDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayrollDtoCollectionQueryParameters(val *PayrollDtoCollectionQueryParameters) *NullablePayrollDtoCollectionQueryParameters {
	return &NullablePayrollDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePayrollDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayrollDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
