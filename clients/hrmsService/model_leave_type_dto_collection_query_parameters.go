...
// checks if the LeaveTypeDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeaveTypeDtoCollectionQueryParameters{}

// LeaveTypeDtoCollectionQueryParameters struct for LeaveTypeDtoCollectionQueryParameters
type LeaveTypeDtoCollectionQueryParameters struct {
...
func NewLeaveTypeDtoCollectionQueryParameters() *LeaveTypeDtoCollectionQueryParameters {
	this := LeaveTypeDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LeaveTypeDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LeaveTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LeaveTypeDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLeaveTypeDtoCollectionQueryParameters struct {
	value *LeaveTypeDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLeaveTypeDtoCollectionQueryParameters) Get() *LeaveTypeDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLeaveTypeDtoCollectionQueryParameters) Set(val *LeaveTypeDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLeaveTypeDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLeaveTypeDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeaveTypeDtoCollectionQueryParameters(val *LeaveTypeDtoCollectionQueryParameters) *NullableLeaveTypeDtoCollectionQueryParameters {
	return &NullableLeaveTypeDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLeaveTypeDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeaveTypeDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
