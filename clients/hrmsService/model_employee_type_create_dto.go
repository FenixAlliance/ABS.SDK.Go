...
// checks if the EmployeeTypeCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeeTypeCreateDto{}

// EmployeeTypeCreateDto struct for EmployeeTypeCreateDto
type EmployeeTypeCreateDto struct {
...
func (o *EmployeeTypeCreateDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *EmployeeTypeCreateDto) SetDescriptionNil() {
...
func (o EmployeeTypeCreateDto) MarshalJSON() ([]byte, error) {
...
func (o EmployeeTypeCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableEmployeeTypeCreateDto struct {
	value *EmployeeTypeCreateDto
	isSet bool
}

func (v NullableEmployeeTypeCreateDto) Get() *EmployeeTypeCreateDto {
	return v.value
}

func (v *NullableEmployeeTypeCreateDto) Set(val *EmployeeTypeCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeeTypeCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeeTypeCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeeTypeCreateDto(val *EmployeeTypeCreateDto) *NullableEmployeeTypeCreateDto {
	return &NullableEmployeeTypeCreateDto{value: val, isSet: true}
}

func (v NullableEmployeeTypeCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeeTypeCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
