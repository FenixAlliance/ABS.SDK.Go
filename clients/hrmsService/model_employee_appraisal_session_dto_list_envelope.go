...
// checks if the EmployeeAppraisalSessionDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeeAppraisalSessionDtoListEnvelope{}

// EmployeeAppraisalSessionDtoListEnvelope struct for EmployeeAppraisalSessionDtoListEnvelope
type EmployeeAppraisalSessionDtoListEnvelope struct {
...
func NewEmployeeAppraisalSessionDtoListEnvelope() *EmployeeAppraisalSessionDtoListEnvelope {
	this := EmployeeAppraisalSessionDtoListEnvelope{}
	return &this
}
...
func (o *EmployeeAppraisalSessionDtoListEnvelope) SetErrorMessageNil() {
...
func (o *EmployeeAppraisalSessionDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *EmployeeAppraisalSessionDtoListEnvelope) SetHttpStatusNil() {
...
func (o *EmployeeAppraisalSessionDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoListEnvelope) SetActivityIdNil() {
...
func (o EmployeeAppraisalSessionDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o EmployeeAppraisalSessionDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableEmployeeAppraisalSessionDtoListEnvelope struct {
	value *EmployeeAppraisalSessionDtoListEnvelope
	isSet bool
}

func (v NullableEmployeeAppraisalSessionDtoListEnvelope) Get() *EmployeeAppraisalSessionDtoListEnvelope {
	return v.value
}

func (v *NullableEmployeeAppraisalSessionDtoListEnvelope) Set(val *EmployeeAppraisalSessionDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeeAppraisalSessionDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeeAppraisalSessionDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeeAppraisalSessionDtoListEnvelope(val *EmployeeAppraisalSessionDtoListEnvelope) *NullableEmployeeAppraisalSessionDtoListEnvelope {
	return &NullableEmployeeAppraisalSessionDtoListEnvelope{value: val, isSet: true}
}

func (v NullableEmployeeAppraisalSessionDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeeAppraisalSessionDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
