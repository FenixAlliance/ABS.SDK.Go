...
// checks if the GigApplicationDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GigApplicationDtoCollectionQueryParameters{}

// GigApplicationDtoCollectionQueryParameters struct for GigApplicationDtoCollectionQueryParameters
type GigApplicationDtoCollectionQueryParameters struct {
...
func NewGigApplicationDtoCollectionQueryParameters() *GigApplicationDtoCollectionQueryParameters {
	this := GigApplicationDtoCollectionQueryParameters{}
	return &this
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *GigApplicationDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o GigApplicationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o GigApplicationDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableGigApplicationDtoCollectionQueryParameters struct {
	value *GigApplicationDtoCollectionQueryParameters
	isSet bool
}

func (v NullableGigApplicationDtoCollectionQueryParameters) Get() *GigApplicationDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableGigApplicationDtoCollectionQueryParameters) Set(val *GigApplicationDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableGigApplicationDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableGigApplicationDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGigApplicationDtoCollectionQueryParameters(val *GigApplicationDtoCollectionQueryParameters) *NullableGigApplicationDtoCollectionQueryParameters {
	return &NullableGigApplicationDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableGigApplicationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGigApplicationDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
