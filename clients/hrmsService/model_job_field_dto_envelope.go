...
// checks if the JobFieldDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobFieldDtoEnvelope{}

// JobFieldDtoEnvelope struct for JobFieldDtoEnvelope
type JobFieldDtoEnvelope struct {
...
func (o *JobFieldDtoEnvelope) SetErrorMessageNil() {
...
func (o *JobFieldDtoEnvelope) SetCorrelationIdNil() {
...
func (o *JobFieldDtoEnvelope) SetHttpStatusNil() {
...
func (o *JobFieldDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JobFieldDtoEnvelope) SetActivityIdNil() {
...
func (o JobFieldDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JobFieldDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJobFieldDtoEnvelope struct {
	value *JobFieldDtoEnvelope
	isSet bool
}

func (v NullableJobFieldDtoEnvelope) Get() *JobFieldDtoEnvelope {
	return v.value
}

func (v *NullableJobFieldDtoEnvelope) Set(val *JobFieldDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJobFieldDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJobFieldDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobFieldDtoEnvelope(val *JobFieldDtoEnvelope) *NullableJobFieldDtoEnvelope {
	return &NullableJobFieldDtoEnvelope{value: val, isSet: true}
}

func (v NullableJobFieldDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobFieldDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
