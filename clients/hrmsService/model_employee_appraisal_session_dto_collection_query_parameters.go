...
// checks if the EmployeeAppraisalSessionDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployeeAppraisalSessionDtoCollectionQueryParameters{}

// EmployeeAppraisalSessionDtoCollectionQueryParameters struct for EmployeeAppraisalSessionDtoCollectionQueryParameters
type EmployeeAppraisalSessionDtoCollectionQueryParameters struct {
...
func NewEmployeeAppraisalSessionDtoCollectionQueryParameters() *EmployeeAppraisalSessionDtoCollectionQueryParameters {
	this := EmployeeAppraisalSessionDtoCollectionQueryParameters{}
	return &this
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *EmployeeAppraisalSessionDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o EmployeeAppraisalSessionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o EmployeeAppraisalSessionDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableEmployeeAppraisalSessionDtoCollectionQueryParameters struct {
	value *EmployeeAppraisalSessionDtoCollectionQueryParameters
	isSet bool
}

func (v NullableEmployeeAppraisalSessionDtoCollectionQueryParameters) Get() *EmployeeAppraisalSessionDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableEmployeeAppraisalSessionDtoCollectionQueryParameters) Set(val *EmployeeAppraisalSessionDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployeeAppraisalSessionDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployeeAppraisalSessionDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployeeAppraisalSessionDtoCollectionQueryParameters(val *EmployeeAppraisalSessionDtoCollectionQueryParameters) *NullableEmployeeAppraisalSessionDtoCollectionQueryParameters {
	return &NullableEmployeeAppraisalSessionDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableEmployeeAppraisalSessionDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployeeAppraisalSessionDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
