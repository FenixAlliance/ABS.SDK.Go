...
// checks if the ScheduleDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScheduleDtoCollectionQueryParameters{}

// ScheduleDtoCollectionQueryParameters struct for ScheduleDtoCollectionQueryParameters
type ScheduleDtoCollectionQueryParameters struct {
...
func NewScheduleDtoCollectionQueryParameters() *ScheduleDtoCollectionQueryParameters {
	this := ScheduleDtoCollectionQueryParameters{}
	return &this
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *ScheduleDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o ScheduleDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o ScheduleDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableScheduleDtoCollectionQueryParameters struct {
	value *ScheduleDtoCollectionQueryParameters
	isSet bool
}

func (v NullableScheduleDtoCollectionQueryParameters) Get() *ScheduleDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableScheduleDtoCollectionQueryParameters) Set(val *ScheduleDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableScheduleDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableScheduleDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScheduleDtoCollectionQueryParameters(val *ScheduleDtoCollectionQueryParameters) *NullableScheduleDtoCollectionQueryParameters {
	return &NullableScheduleDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableScheduleDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScheduleDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
