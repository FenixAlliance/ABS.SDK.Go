...
// checks if the AppraisalStageDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppraisalStageDtoEnvelope{}

// AppraisalStageDtoEnvelope struct for AppraisalStageDtoEnvelope
type AppraisalStageDtoEnvelope struct {
...
func NewAppraisalStageDtoEnvelope() *AppraisalStageDtoEnvelope {
	this := AppraisalStageDtoEnvelope{}
	return &this
}
...
func (o *AppraisalStageDtoEnvelope) SetErrorMessageNil() {
...
func (o *AppraisalStageDtoEnvelope) SetCorrelationIdNil() {
...
func (o *AppraisalStageDtoEnvelope) SetHttpStatusNil() {
...
func (o *AppraisalStageDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AppraisalStageDtoEnvelope) SetActivityIdNil() {
...
func (o AppraisalStageDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AppraisalStageDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAppraisalStageDtoEnvelope struct {
	value *AppraisalStageDtoEnvelope
	isSet bool
}

func (v NullableAppraisalStageDtoEnvelope) Get() *AppraisalStageDtoEnvelope {
	return v.value
}

func (v *NullableAppraisalStageDtoEnvelope) Set(val *AppraisalStageDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAppraisalStageDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAppraisalStageDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppraisalStageDtoEnvelope(val *AppraisalStageDtoEnvelope) *NullableAppraisalStageDtoEnvelope {
	return &NullableAppraisalStageDtoEnvelope{value: val, isSet: true}
}

func (v NullableAppraisalStageDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppraisalStageDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
