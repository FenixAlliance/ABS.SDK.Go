...
// checks if the JobOfferApplicationDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobOfferApplicationDtoEnvelope{}

// JobOfferApplicationDtoEnvelope struct for JobOfferApplicationDtoEnvelope
type JobOfferApplicationDtoEnvelope struct {
...
func NewJobOfferApplicationDtoEnvelope() *JobOfferApplicationDtoEnvelope {
	this := JobOfferApplicationDtoEnvelope{}
	return &this
}
...
func (o *JobOfferApplicationDtoEnvelope) SetErrorMessageNil() {
...
func (o *JobOfferApplicationDtoEnvelope) SetCorrelationIdNil() {
...
func (o *JobOfferApplicationDtoEnvelope) SetHttpStatusNil() {
...
func (o *JobOfferApplicationDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JobOfferApplicationDtoEnvelope) SetActivityIdNil() {
...
func (o JobOfferApplicationDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JobOfferApplicationDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJobOfferApplicationDtoEnvelope struct {
	value *JobOfferApplicationDtoEnvelope
	isSet bool
}

func (v NullableJobOfferApplicationDtoEnvelope) Get() *JobOfferApplicationDtoEnvelope {
	return v.value
}

func (v *NullableJobOfferApplicationDtoEnvelope) Set(val *JobOfferApplicationDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJobOfferApplicationDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJobOfferApplicationDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobOfferApplicationDtoEnvelope(val *JobOfferApplicationDtoEnvelope) *NullableJobOfferApplicationDtoEnvelope {
	return &NullableJobOfferApplicationDtoEnvelope{value: val, isSet: true}
}

func (v NullableJobOfferApplicationDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobOfferApplicationDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
