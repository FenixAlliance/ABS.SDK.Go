...
// checks if the LeaveApplicationDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeaveApplicationDtoCollectionQueryParameters{}

// LeaveApplicationDtoCollectionQueryParameters struct for LeaveApplicationDtoCollectionQueryParameters
type LeaveApplicationDtoCollectionQueryParameters struct {
...
func NewLeaveApplicationDtoCollectionQueryParameters() *LeaveApplicationDtoCollectionQueryParameters {
	this := LeaveApplicationDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LeaveApplicationDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LeaveApplicationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LeaveApplicationDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLeaveApplicationDtoCollectionQueryParameters struct {
	value *LeaveApplicationDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLeaveApplicationDtoCollectionQueryParameters) Get() *LeaveApplicationDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLeaveApplicationDtoCollectionQueryParameters) Set(val *LeaveApplicationDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLeaveApplicationDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLeaveApplicationDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeaveApplicationDtoCollectionQueryParameters(val *LeaveApplicationDtoCollectionQueryParameters) *NullableLeaveApplicationDtoCollectionQueryParameters {
	return &NullableLeaveApplicationDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLeaveApplicationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeaveApplicationDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
