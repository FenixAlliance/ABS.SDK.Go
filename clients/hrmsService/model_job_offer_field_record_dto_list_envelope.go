...
// checks if the JobOfferFieldRecordDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobOfferFieldRecordDtoListEnvelope{}

// JobOfferFieldRecordDtoListEnvelope struct for JobOfferFieldRecordDtoListEnvelope
type JobOfferFieldRecordDtoListEnvelope struct {
	...
	Result []JobOfferFieldRecordDto `json:"result,omitempty"`
}
...
func NewJobOfferFieldRecordDtoListEnvelope() *JobOfferFieldRecordDtoListEnvelope {
	this := JobOfferFieldRecordDtoListEnvelope{}
	return &this
}
...
func (o *JobOfferFieldRecordDtoListEnvelope) SetErrorMessageNil() {
...
func (o *JobOfferFieldRecordDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *JobOfferFieldRecordDtoListEnvelope) SetHttpStatusNil() {
...
func (o *JobOfferFieldRecordDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JobOfferFieldRecordDtoListEnvelope) SetActivityIdNil() {
...
func (o *JobOfferFieldRecordDtoListEnvelope) GetResult() []JobOfferFieldRecordDto {
	if o == nil {
		var ret []JobOfferFieldRecordDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []JobOfferFieldRecordDto and assigns it to the Result field.
func (o *JobOfferFieldRecordDtoListEnvelope) SetResult(v []JobOfferFieldRecordDto) {
	o.Result = v
}

func (o JobOfferFieldRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JobOfferFieldRecordDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJobOfferFieldRecordDtoListEnvelope struct {
	value *JobOfferFieldRecordDtoListEnvelope
	isSet bool
}

func (v NullableJobOfferFieldRecordDtoListEnvelope) Get() *JobOfferFieldRecordDtoListEnvelope {
	return v.value
}

func (v *NullableJobOfferFieldRecordDtoListEnvelope) Set(val *JobOfferFieldRecordDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJobOfferFieldRecordDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJobOfferFieldRecordDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobOfferFieldRecordDtoListEnvelope(val *JobOfferFieldRecordDtoListEnvelope) *NullableJobOfferFieldRecordDtoListEnvelope {
	return &NullableJobOfferFieldRecordDtoListEnvelope{value: val, isSet: true}
}

func (v NullableJobOfferFieldRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobOfferFieldRecordDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
