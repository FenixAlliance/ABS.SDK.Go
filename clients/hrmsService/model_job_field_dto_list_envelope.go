...
// checks if the JobFieldDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobFieldDtoListEnvelope{}

// JobFieldDtoListEnvelope struct for JobFieldDtoListEnvelope
type JobFieldDtoListEnvelope struct {
	...
	Result []JobFieldDto `json:"result,omitempty"`
}
...
func (o *JobFieldDtoListEnvelope) SetErrorMessageNil() {
...
func (o *JobFieldDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *JobFieldDtoListEnvelope) SetHttpStatusNil() {
...
func (o *JobFieldDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JobFieldDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []JobFieldDto and assigns it to the Result field.
func (o *JobFieldDtoListEnvelope) SetResult(v []JobFieldDto) {
	o.Result = v
}

func (o JobFieldDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JobFieldDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJobFieldDtoListEnvelope struct {
	value *JobFieldDtoListEnvelope
	isSet bool
}

func (v NullableJobFieldDtoListEnvelope) Get() *JobFieldDtoListEnvelope {
	return v.value
}

func (v *NullableJobFieldDtoListEnvelope) Set(val *JobFieldDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJobFieldDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJobFieldDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobFieldDtoListEnvelope(val *JobFieldDtoListEnvelope) *NullableJobFieldDtoListEnvelope {
	return &NullableJobFieldDtoListEnvelope{value: val, isSet: true}
}

func (v NullableJobFieldDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobFieldDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
