...
// checks if the JobOfferDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobOfferDtoListEnvelope{}

// JobOfferDtoListEnvelope struct for JobOfferDtoListEnvelope
type JobOfferDtoListEnvelope struct {
...
func (o *JobOfferDtoListEnvelope) SetErrorMessageNil() {
...
func (o *JobOfferDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *JobOfferDtoListEnvelope) SetHttpStatusNil() {
...
func (o *JobOfferDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JobOfferDtoListEnvelope) SetActivityIdNil() {
...
func (o JobOfferDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JobOfferDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJobOfferDtoListEnvelope struct {
	value *JobOfferDtoListEnvelope
	isSet bool
}

func (v NullableJobOfferDtoListEnvelope) Get() *JobOfferDtoListEnvelope {
	return v.value
}

func (v *NullableJobOfferDtoListEnvelope) Set(val *JobOfferDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJobOfferDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJobOfferDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobOfferDtoListEnvelope(val *JobOfferDtoListEnvelope) *NullableJobOfferDtoListEnvelope {
	return &NullableJobOfferDtoListEnvelope{value: val, isSet: true}
}

func (v NullableJobOfferDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobOfferDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
