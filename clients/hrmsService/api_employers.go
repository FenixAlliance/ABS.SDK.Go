...
func (r ApiCreateEmployerAsyncRequest) Execute() (*EmptyEnvelope, *http.Response, error) {
	return r.ApiService.CreateEmployerAsyncExecute(r)
}

/*
CreateEmployerAsync Create an employer
...
func (a *EmployersAPIService) CreateEmployerAsyncExecute(r ApiCreateEmployerAsyncRequest) (*EmptyEnvelope, *http.Response, error) {
	var (
...
func (r ApiDeleteEmployerAsyncRequest) Execute() (*EmptyEnvelope, *http.Response, error) {
...
// Execute executes the request
//  @return EmptyEnvelope
func (a *EmployersAPIService) DeleteEmployerAsyncExecute(r ApiDeleteEmployerAsyncRequest) (*EmptyEnvelope, *http.Response, error) {
	var (
...
type ApiGetEmployersAsyncRequest struct {
	...
	apiVersion *string
	xApiVersion *string
	employerProfileDtoCollectionQueryParameters *EmployerProfileDtoCollectionQueryParameters
}
...
func (r ApiGetEmployersAsyncRequest) EmployerProfileDtoCollectionQueryParameters(employerProfileDtoCollectionQueryParameters EmployerProfileDtoCollectionQueryParameters) ApiGetEmployersAsyncRequest {
	r.employerProfileDtoCollectionQueryParameters = &employerProfileDtoCollectionQueryParameters
	return r
}
...
func (a *EmployersAPIService) GetEmployersAsyncExecute(r ApiGetEmployersAsyncRequest) (*EmployerProfileDtoListEnvelope, *http.Response, error) {
	...
	// body params
	localVarPostBody = r.employerProfileDtoCollectionQueryParameters
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
func (r ApiGetEmployersCountAsyncRequest) EmployerProfileDtoCollectionQueryParameters(employerProfileDtoCollectionQueryParameters EmployerProfileDtoCollectionQueryParameters) ApiGetEmployersCountAsyncRequest {
	r.employerProfileDtoCollectionQueryParameters = &employerProfileDtoCollectionQueryParameters
	return r
}
...
type ApiPatchEmployerAsyncRequest struct {
	ctx context.Context
	ApiService *EmployersAPIService
	tenantId *string
	employerId string
...
func (r ApiPatchEmployerAsyncRequest) TenantId(tenantId string) ApiPatchEmployerAsyncRequest {
	r.tenantId = &tenantId
	return r
}

func (r ApiPatchEmployerAsyncRequest) ApiVersion(apiVersion string) ApiPatchEmployerAsyncRequest {
	r.apiVersion = &apiVersion
	return r
}

func (r ApiPatchEmployerAsyncRequest) XApiVersion(xApiVersion string) ApiPatchEmployerAsyncRequest {
	r.xApiVersion = &xApiVersion
	return r
}

func (r ApiPatchEmployerAsyncRequest) PatchOperation(patchOperation []PatchOperation) ApiPatchEmployerAsyncRequest {
	r.patchOperation = &patchOperation
	return r
}

func (r ApiPatchEmployerAsyncRequest) Execute() (*EmptyEnvelope, *http.Response, error) {
	return r.ApiService.PatchEmployerAsyncExecute(r)
}
...
Partially updates an existing employer for the specified tenant.
 ...
 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param employerId
 @return ApiPatchEmployerAsyncRequest
*/
func (a *EmployersAPIService) PatchEmployerAsync(ctx context.Context, employerId string) ApiPatchEmployerAsyncRequest {
	return ApiPatchEmployerAsyncRequest{
		ApiService: a,
		ctx: ctx,
		employerId: employerId,
...
// Execute executes the request
//  @return EmptyEnvelope
func (a *EmployersAPIService) PatchEmployerAsyncExecute(r ApiPatchEmployerAsyncRequest) (*EmptyEnvelope, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EmployersAPIService.PatchEmployerAsync")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateEmployerAsyncRequest) EmployerProfileUpdateDto(employerProfileUpdateDto EmployerProfileUpdateDto) ApiUpdateEmployerAsyncRequest {
	r.employerProfileUpdateDto = &employerProfileUpdateDto
	return r
}

func (r ApiUpdateEmployerAsyncRequest) Execute() (*EmptyEnvelope, *http.Response, error) {
	return r.ApiService.UpdateEmployerAsyncExecute(r)
}

/*
UpdateEmployerAsync Update an employer
...
// Execute executes the request
//  @return EmptyEnvelope
func (a *EmployersAPIService) UpdateEmployerAsyncExecute(r ApiUpdateEmployerAsyncRequest) (*EmptyEnvelope, *http.Response, error) {
	var (
	...
	// body params
	localVarPostBody = r.employerProfileUpdateDto
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
