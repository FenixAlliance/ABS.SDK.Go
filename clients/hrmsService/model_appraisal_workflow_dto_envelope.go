...
// checks if the AppraisalWorkflowDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppraisalWorkflowDtoEnvelope{}

// AppraisalWorkflowDtoEnvelope struct for AppraisalWorkflowDtoEnvelope
type AppraisalWorkflowDtoEnvelope struct {
...
func NewAppraisalWorkflowDtoEnvelope() *AppraisalWorkflowDtoEnvelope {
	this := AppraisalWorkflowDtoEnvelope{}
	return &this
}
...
func (o *AppraisalWorkflowDtoEnvelope) SetErrorMessageNil() {
...
func (o *AppraisalWorkflowDtoEnvelope) SetCorrelationIdNil() {
...
func (o *AppraisalWorkflowDtoEnvelope) SetHttpStatusNil() {
...
func (o *AppraisalWorkflowDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AppraisalWorkflowDtoEnvelope) SetActivityIdNil() {
...
func (o AppraisalWorkflowDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AppraisalWorkflowDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAppraisalWorkflowDtoEnvelope struct {
	value *AppraisalWorkflowDtoEnvelope
	isSet bool
}

func (v NullableAppraisalWorkflowDtoEnvelope) Get() *AppraisalWorkflowDtoEnvelope {
	return v.value
}

func (v *NullableAppraisalWorkflowDtoEnvelope) Set(val *AppraisalWorkflowDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAppraisalWorkflowDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAppraisalWorkflowDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppraisalWorkflowDtoEnvelope(val *AppraisalWorkflowDtoEnvelope) *NullableAppraisalWorkflowDtoEnvelope {
	return &NullableAppraisalWorkflowDtoEnvelope{value: val, isSet: true}
}

func (v NullableAppraisalWorkflowDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppraisalWorkflowDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
