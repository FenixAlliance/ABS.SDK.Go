...
// checks if the SalaryDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SalaryDtoListEnvelope{}

// SalaryDtoListEnvelope struct for SalaryDtoListEnvelope
type SalaryDtoListEnvelope struct {
...
func (o *SalaryDtoListEnvelope) SetErrorMessageNil() {
...
func (o *SalaryDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *SalaryDtoListEnvelope) SetHttpStatusNil() {
...
func (o *SalaryDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *SalaryDtoListEnvelope) SetActivityIdNil() {
...
func (o SalaryDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o SalaryDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableSalaryDtoListEnvelope struct {
	value *SalaryDtoListEnvelope
	isSet bool
}

func (v NullableSalaryDtoListEnvelope) Get() *SalaryDtoListEnvelope {
	return v.value
}

func (v *NullableSalaryDtoListEnvelope) Set(val *SalaryDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableSalaryDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableSalaryDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSalaryDtoListEnvelope(val *SalaryDtoListEnvelope) *NullableSalaryDtoListEnvelope {
	return &NullableSalaryDtoListEnvelope{value: val, isSet: true}
}

func (v NullableSalaryDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSalaryDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
