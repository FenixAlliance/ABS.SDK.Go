...
// checks if the EmployerProfileDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EmployerProfileDtoListEnvelope{}

// EmployerProfileDtoListEnvelope struct for EmployerProfileDtoListEnvelope
type EmployerProfileDtoListEnvelope struct {
...
func NewEmployerProfileDtoListEnvelope() *EmployerProfileDtoListEnvelope {
	this := EmployerProfileDtoListEnvelope{}
	return &this
}
...
func (o *EmployerProfileDtoListEnvelope) SetErrorMessageNil() {
...
func (o *EmployerProfileDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *EmployerProfileDtoListEnvelope) SetHttpStatusNil() {
...
func (o *EmployerProfileDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *EmployerProfileDtoListEnvelope) SetActivityIdNil() {
...
func (o EmployerProfileDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o EmployerProfileDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableEmployerProfileDtoListEnvelope struct {
	value *EmployerProfileDtoListEnvelope
	isSet bool
}

func (v NullableEmployerProfileDtoListEnvelope) Get() *EmployerProfileDtoListEnvelope {
	return v.value
}

func (v *NullableEmployerProfileDtoListEnvelope) Set(val *EmployerProfileDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableEmployerProfileDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableEmployerProfileDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEmployerProfileDtoListEnvelope(val *EmployerProfileDtoListEnvelope) *NullableEmployerProfileDtoListEnvelope {
	return &NullableEmployerProfileDtoListEnvelope{value: val, isSet: true}
}

func (v NullableEmployerProfileDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEmployerProfileDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
