...
// checks if the ShiftDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ShiftDtoEnvelope{}

// ShiftDtoEnvelope struct for ShiftDtoEnvelope
type ShiftDtoEnvelope struct {
...
func (o *ShiftDtoEnvelope) SetErrorMessageNil() {
...
func (o *ShiftDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ShiftDtoEnvelope) SetHttpStatusNil() {
...
func (o *ShiftDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ShiftDtoEnvelope) SetActivityIdNil() {
...
func (o ShiftDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ShiftDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableShiftDtoEnvelope struct {
	value *ShiftDtoEnvelope
	isSet bool
}

func (v NullableShiftDtoEnvelope) Get() *ShiftDtoEnvelope {
	return v.value
}

func (v *NullableShiftDtoEnvelope) Set(val *ShiftDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableShiftDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableShiftDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableShiftDtoEnvelope(val *ShiftDtoEnvelope) *NullableShiftDtoEnvelope {
	return &NullableShiftDtoEnvelope{value: val, isSet: true}
}

func (v NullableShiftDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableShiftDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
