...
// checks if the JobOfferFieldRecordDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JobOfferFieldRecordDtoEnvelope{}

// JobOfferFieldRecordDtoEnvelope struct for JobOfferFieldRecordDtoEnvelope
type JobOfferFieldRecordDtoEnvelope struct {
...
func NewJobOfferFieldRecordDtoEnvelope() *JobOfferFieldRecordDtoEnvelope {
	this := JobOfferFieldRecordDtoEnvelope{}
	return &this
}
...
func (o *JobOfferFieldRecordDtoEnvelope) SetErrorMessageNil() {
...
func (o *JobOfferFieldRecordDtoEnvelope) SetCorrelationIdNil() {
...
func (o *JobOfferFieldRecordDtoEnvelope) SetHttpStatusNil() {
...
func (o *JobOfferFieldRecordDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *JobOfferFieldRecordDtoEnvelope) SetActivityIdNil() {
...
func (o JobOfferFieldRecordDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o JobOfferFieldRecordDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableJobOfferFieldRecordDtoEnvelope struct {
	value *JobOfferFieldRecordDtoEnvelope
	isSet bool
}

func (v NullableJobOfferFieldRecordDtoEnvelope) Get() *JobOfferFieldRecordDtoEnvelope {
	return v.value
}

func (v *NullableJobOfferFieldRecordDtoEnvelope) Set(val *JobOfferFieldRecordDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableJobOfferFieldRecordDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableJobOfferFieldRecordDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJobOfferFieldRecordDtoEnvelope(val *JobOfferFieldRecordDtoEnvelope) *NullableJobOfferFieldRecordDtoEnvelope {
	return &NullableJobOfferFieldRecordDtoEnvelope{value: val, isSet: true}
}

func (v NullableJobOfferFieldRecordDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJobOfferFieldRecordDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
