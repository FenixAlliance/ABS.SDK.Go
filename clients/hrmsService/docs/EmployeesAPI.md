...
> EmployeeProfileDtoListEnvelope GetEmployeesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeProfileDtoCollectionQueryParameters(employeeProfileDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	employeeProfileDtoCollectionQueryParameters := *openapiclient.NewEmployeeProfileDtoCollectionQueryParameters() // EmployeeProfileDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EmployeesAPI.GetEmployeesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeProfileDtoCollectionQueryParameters(employeeProfileDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **employeeProfileDtoCollectionQueryParameters** | [**EmployeeProfileDtoCollectionQueryParameters**](EmployeeProfileDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetEmployeesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeProfileDtoCollectionQueryParameters(employeeProfileDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EmployeesAPI.GetEmployeesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeProfileDtoCollectionQueryParameters(employeeProfileDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchEmployeeAsync(ctx, employeeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EmployeesAPI.PatchEmployeeAsync(context.Background(), employeeId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `EmployeesAPI.PatchEmployeeAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchEmployeeAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `EmployeesAPI.PatchEmployeeAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchEmployeeAsyncRequest struct via the builder pattern
