...
> GigDtoListEnvelope GetGigsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GigDtoCollectionQueryParameters(gigDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	gigDtoCollectionQueryParameters := *openapiclient.NewGigDtoCollectionQueryParameters() // GigDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GigsAPI.GetGigsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GigDtoCollectionQueryParameters(gigDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **gigDtoCollectionQueryParameters** | [**GigDtoCollectionQueryParameters**](GigDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetGigsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GigDtoCollectionQueryParameters(gigDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GigsAPI.GetGigsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).GigDtoCollectionQueryParameters(gigDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchGigAsync(ctx, gigId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.GigsAPI.PatchGigAsync(context.Background(), gigId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `GigsAPI.PatchGigAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchGigAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `GigsAPI.PatchGigAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchGigAsyncRequest struct via the builder pattern
