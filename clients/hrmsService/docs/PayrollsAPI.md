...
> PayrollDtoListEnvelope GetPayrollsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PayrollDtoCollectionQueryParameters(payrollDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	payrollDtoCollectionQueryParameters := *openapiclient.NewPayrollDtoCollectionQueryParameters() // PayrollDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PayrollsAPI.GetPayrollsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PayrollDtoCollectionQueryParameters(payrollDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **payrollDtoCollectionQueryParameters** | [**PayrollDtoCollectionQueryParameters**](PayrollDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetPayrollsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PayrollDtoCollectionQueryParameters(payrollDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PayrollsAPI.GetPayrollsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PayrollDtoCollectionQueryParameters(payrollDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchPayrollAsync(ctx, payrollId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.PayrollsAPI.PatchPayrollAsync(context.Background(), payrollId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
