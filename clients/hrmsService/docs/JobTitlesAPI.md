...
> JobTitleDtoListEnvelope GetJobTitlesAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).JobTitleDtoCollectionQueryParameters(jobTitleDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	jobTitleDtoCollectionQueryParameters := *openapiclient.NewJobTitleDtoCollectionQueryParameters() // JobTitleDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.JobTitlesAPI.GetJobTitlesAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).JobTitleDtoCollectionQueryParameters(jobTitleDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **jobTitleDtoCollectionQueryParameters** | [**JobTitleDtoCollectionQueryParameters**](JobTitleDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetJobTitlesCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).JobTitleDtoCollectionQueryParameters(jobTitleDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.JobTitlesAPI.GetJobTitlesCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).JobTitleDtoCollectionQueryParameters(jobTitleDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchJobTitleAsync(ctx, jobTitleId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.JobTitlesAPI.PatchJobTitleAsync(context.Background(), jobTitleId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
