...
> EmployeeAppraisalSessionDtoListEnvelope GetEmployeeAppraisalSessionsAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeAppraisalSessionDtoCollectionQueryParameters(employeeAppraisalSessionDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	apiVersion := "apiVersion_example" // string |  (optional)
	xApiVersion := "xApiVersion_example" // string |  (optional)
	employeeAppraisalSessionDtoCollectionQueryParameters := *openapiclient.NewEmployeeAppraisalSessionDtoCollectionQueryParameters() // EmployeeAppraisalSessionDtoCollectionQueryParameters |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EmployeeAppraisalSessionsAPI.GetEmployeeAppraisalSessionsAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeAppraisalSessionDtoCollectionQueryParameters(employeeAppraisalSessionDtoCollectionQueryParameters).Execute()
	if err != nil {
 ...
 **apiVersion** | **string** |  | 
 **xApiVersion** | **string** |  | 
 **employeeAppraisalSessionDtoCollectionQueryParameters** | [**EmployeeAppraisalSessionDtoCollectionQueryParameters**](EmployeeAppraisalSessionDtoCollectionQueryParameters.md) |  | 
...
> Int32Envelope GetEmployeeAppraisalSessionsCountAsync(ctx).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeAppraisalSessionDtoCollectionQueryParameters(employeeAppraisalSessionDtoCollectionQueryParameters).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EmployeeAppraisalSessionsAPI.GetEmployeeAppraisalSessionsCountAsync(context.Background()).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).EmployeeAppraisalSessionDtoCollectionQueryParameters(employeeAppraisalSessionDtoCollectionQueryParameters).Execute()
	if err != nil {
...
> EmptyEnvelope PatchEmployeeAppraisalSessionAsync(ctx, sessionId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.EmployeeAppraisalSessionsAPI.PatchEmployeeAppraisalSessionAsync(context.Background(), sessionId).TenantId(tenantId).ApiVersion(apiVersion).XApiVersion(xApiVersion).PatchOperation(patchOperation).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `EmployeeAppraisalSessionsAPI.PatchEmployeeAppraisalSessionAsync``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `PatchEmployeeAppraisalSessionAsync`: EmptyEnvelope
	fmt.Fprintf(os.Stdout, "Response from `EmployeeAppraisalSessionsAPI.PatchEmployeeAppraisalSessionAsync`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiPatchEmployeeAppraisalSessionAsyncRequest struct via the builder pattern
