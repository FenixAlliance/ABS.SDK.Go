...
// checks if the LeaveTypeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LeaveTypeDtoListEnvelope{}

// LeaveTypeDtoListEnvelope struct for LeaveTypeDtoListEnvelope
type LeaveTypeDtoListEnvelope struct {
...
func (o *LeaveTypeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *LeaveTypeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *LeaveTypeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *LeaveTypeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LeaveTypeDtoListEnvelope) SetActivityIdNil() {
...
func (o LeaveTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LeaveTypeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLeaveTypeDtoListEnvelope struct {
	value *LeaveTypeDtoListEnvelope
	isSet bool
}

func (v NullableLeaveTypeDtoListEnvelope) Get() *LeaveTypeDtoListEnvelope {
	return v.value
}

func (v *NullableLeaveTypeDtoListEnvelope) Set(val *LeaveTypeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLeaveTypeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLeaveTypeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLeaveTypeDtoListEnvelope(val *LeaveTypeDtoListEnvelope) *NullableLeaveTypeDtoListEnvelope {
	return &NullableLeaveTypeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableLeaveTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLeaveTypeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
