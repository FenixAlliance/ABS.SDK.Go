...
// checks if the PayrollPeriodDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PayrollPeriodDtoListEnvelope{}

// PayrollPeriodDtoListEnvelope struct for PayrollPeriodDtoListEnvelope
type PayrollPeriodDtoListEnvelope struct {
...
func NewPayrollPeriodDtoListEnvelope() *PayrollPeriodDtoListEnvelope {
	this := PayrollPeriodDtoListEnvelope{}
	return &this
}
...
func (o *PayrollPeriodDtoListEnvelope) SetErrorMessageNil() {
...
func (o *PayrollPeriodDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *PayrollPeriodDtoListEnvelope) SetHttpStatusNil() {
...
func (o *PayrollPeriodDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *PayrollPeriodDtoListEnvelope) SetActivityIdNil() {
...
func (o PayrollPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o PayrollPeriodDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullablePayrollPeriodDtoListEnvelope struct {
	value *PayrollPeriodDtoListEnvelope
	isSet bool
}

func (v NullablePayrollPeriodDtoListEnvelope) Get() *PayrollPeriodDtoListEnvelope {
	return v.value
}

func (v *NullablePayrollPeriodDtoListEnvelope) Set(val *PayrollPeriodDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullablePayrollPeriodDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullablePayrollPeriodDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayrollPeriodDtoListEnvelope(val *PayrollPeriodDtoListEnvelope) *NullablePayrollPeriodDtoListEnvelope {
	return &NullablePayrollPeriodDtoListEnvelope{value: val, isSet: true}
}

func (v NullablePayrollPeriodDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayrollPeriodDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
