...
// checks if the DealUnitLineDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DealUnitLineDtoListEnvelope{}

// DealUnitLineDtoListEnvelope struct for DealUnitLineDtoListEnvelope
type DealUnitLineDtoListEnvelope struct {
...
func NewDealUnitLineDtoListEnvelope() *DealUnitLineDtoListEnvelope {
	this := DealUnitLineDtoListEnvelope{}
	return &this
}
...
func (o *DealUnitLineDtoListEnvelope) SetErrorMessageNil() {
...
func (o *DealUnitLineDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *DealUnitLineDtoListEnvelope) SetHttpStatusNil() {
...
func (o *DealUnitLineDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DealUnitLineDtoListEnvelope) SetActivityIdNil() {
...
func (o DealUnitLineDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DealUnitLineDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDealUnitLineDtoListEnvelope struct {
	value *DealUnitLineDtoListEnvelope
	isSet bool
}

func (v NullableDealUnitLineDtoListEnvelope) Get() *DealUnitLineDtoListEnvelope {
	return v.value
}

func (v *NullableDealUnitLineDtoListEnvelope) Set(val *DealUnitLineDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUnitLineDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUnitLineDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUnitLineDtoListEnvelope(val *DealUnitLineDtoListEnvelope) *NullableDealUnitLineDtoListEnvelope {
	return &NullableDealUnitLineDtoListEnvelope{value: val, isSet: true}
}

func (v NullableDealUnitLineDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUnitLineDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
