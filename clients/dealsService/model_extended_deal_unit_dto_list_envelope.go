...
// checks if the ExtendedDealUnitDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedDealUnitDtoListEnvelope{}

// ExtendedDealUnitDtoListEnvelope struct for ExtendedDealUnitDtoListEnvelope
type ExtendedDealUnitDtoListEnvelope struct {
	...
	Result []ExtendedDealUnitDto `json:"result,omitempty"`
}
...
func NewExtendedDealUnitDtoListEnvelope() *ExtendedDealUnitDtoListEnvelope {
	this := ExtendedDealUnitDtoListEnvelope{}
	return &this
}
...
func (o *ExtendedDealUnitDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedDealUnitDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedDealUnitDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedDealUnitDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedDealUnitDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ExtendedDealUnitDto and assigns it to the Result field.
func (o *ExtendedDealUnitDtoListEnvelope) SetResult(v []ExtendedDealUnitDto) {
	o.Result = v
}

func (o ExtendedDealUnitDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedDealUnitDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedDealUnitDtoListEnvelope struct {
	value *ExtendedDealUnitDtoListEnvelope
	isSet bool
}

func (v NullableExtendedDealUnitDtoListEnvelope) Get() *ExtendedDealUnitDtoListEnvelope {
	return v.value
}

func (v *NullableExtendedDealUnitDtoListEnvelope) Set(val *ExtendedDealUnitDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedDealUnitDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedDealUnitDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedDealUnitDtoListEnvelope(val *ExtendedDealUnitDtoListEnvelope) *NullableExtendedDealUnitDtoListEnvelope {
	return &NullableExtendedDealUnitDtoListEnvelope{value: val, isSet: true}
}

func (v NullableExtendedDealUnitDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedDealUnitDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
