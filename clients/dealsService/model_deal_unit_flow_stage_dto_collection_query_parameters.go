...
// checks if the DealUnitFlowStageDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DealUnitFlowStageDtoCollectionQueryParameters{}

// DealUnitFlowStageDtoCollectionQueryParameters struct for DealUnitFlowStageDtoCollectionQueryParameters
type DealUnitFlowStageDtoCollectionQueryParameters struct {
...
func NewDealUnitFlowStageDtoCollectionQueryParameters() *DealUnitFlowStageDtoCollectionQueryParameters {
	this := DealUnitFlowStageDtoCollectionQueryParameters{}
	return &this
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *DealUnitFlowStageDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o DealUnitFlowStageDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o DealUnitFlowStageDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableDealUnitFlowStageDtoCollectionQueryParameters struct {
	value *DealUnitFlowStageDtoCollectionQueryParameters
	isSet bool
}

func (v NullableDealUnitFlowStageDtoCollectionQueryParameters) Get() *DealUnitFlowStageDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableDealUnitFlowStageDtoCollectionQueryParameters) Set(val *DealUnitFlowStageDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUnitFlowStageDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUnitFlowStageDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUnitFlowStageDtoCollectionQueryParameters(val *DealUnitFlowStageDtoCollectionQueryParameters) *NullableDealUnitFlowStageDtoCollectionQueryParameters {
	return &NullableDealUnitFlowStageDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableDealUnitFlowStageDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUnitFlowStageDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
