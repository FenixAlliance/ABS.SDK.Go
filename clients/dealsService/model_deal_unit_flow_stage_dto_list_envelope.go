...
// checks if the DealUnitFlowStageDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DealUnitFlowStageDtoListEnvelope{}

// DealUnitFlowStageDtoListEnvelope struct for DealUnitFlowStageDtoListEnvelope
type DealUnitFlowStageDtoListEnvelope struct {
...
func NewDealUnitFlowStageDtoListEnvelope() *DealUnitFlowStageDtoListEnvelope {
	this := DealUnitFlowStageDtoListEnvelope{}
	return &this
}
...
func (o *DealUnitFlowStageDtoListEnvelope) SetErrorMessageNil() {
...
func (o *DealUnitFlowStageDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *DealUnitFlowStageDtoListEnvelope) SetHttpStatusNil() {
...
func (o *DealUnitFlowStageDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DealUnitFlowStageDtoListEnvelope) SetActivityIdNil() {
...
func (o DealUnitFlowStageDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DealUnitFlowStageDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDealUnitFlowStageDtoListEnvelope struct {
	value *DealUnitFlowStageDtoListEnvelope
	isSet bool
}

func (v NullableDealUnitFlowStageDtoListEnvelope) Get() *DealUnitFlowStageDtoListEnvelope {
	return v.value
}

func (v *NullableDealUnitFlowStageDtoListEnvelope) Set(val *DealUnitFlowStageDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUnitFlowStageDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUnitFlowStageDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUnitFlowStageDtoListEnvelope(val *DealUnitFlowStageDtoListEnvelope) *NullableDealUnitFlowStageDtoListEnvelope {
	return &NullableDealUnitFlowStageDtoListEnvelope{value: val, isSet: true}
}

func (v NullableDealUnitFlowStageDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUnitFlowStageDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
