...
// checks if the DealUnitDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DealUnitDtoListEnvelope{}

// DealUnitDtoListEnvelope struct for DealUnitDtoListEnvelope
type DealUnitDtoListEnvelope struct {
...
func (o *DealUnitDtoListEnvelope) SetErrorMessageNil() {
...
func (o *DealUnitDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *DealUnitDtoListEnvelope) SetHttpStatusNil() {
...
func (o *DealUnitDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DealUnitDtoListEnvelope) SetActivityIdNil() {
...
func (o DealUnitDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DealUnitDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDealUnitDtoListEnvelope struct {
	value *DealUnitDtoListEnvelope
	isSet bool
}

func (v NullableDealUnitDtoListEnvelope) Get() *DealUnitDtoListEnvelope {
	return v.value
}

func (v *NullableDealUnitDtoListEnvelope) Set(val *DealUnitDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUnitDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUnitDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUnitDtoListEnvelope(val *DealUnitDtoListEnvelope) *NullableDealUnitDtoListEnvelope {
	return &NullableDealUnitDtoListEnvelope{value: val, isSet: true}
}

func (v NullableDealUnitDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUnitDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
