...
// checks if the DealUnitFlowDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DealUnitFlowDtoListEnvelope{}

// DealUnitFlowDtoListEnvelope struct for DealUnitFlowDtoListEnvelope
type DealUnitFlowDtoListEnvelope struct {
...
func NewDealUnitFlowDtoListEnvelope() *DealUnitFlowDtoListEnvelope {
	this := DealUnitFlowDtoListEnvelope{}
	return &this
}
...
func (o *DealUnitFlowDtoListEnvelope) SetErrorMessageNil() {
...
func (o *DealUnitFlowDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *DealUnitFlowDtoListEnvelope) SetHttpStatusNil() {
...
func (o *DealUnitFlowDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *DealUnitFlowDtoListEnvelope) SetActivityIdNil() {
...
func (o DealUnitFlowDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o DealUnitFlowDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableDealUnitFlowDtoListEnvelope struct {
	value *DealUnitFlowDtoListEnvelope
	isSet bool
}

func (v NullableDealUnitFlowDtoListEnvelope) Get() *DealUnitFlowDtoListEnvelope {
	return v.value
}

func (v *NullableDealUnitFlowDtoListEnvelope) Set(val *DealUnitFlowDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableDealUnitFlowDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableDealUnitFlowDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDealUnitFlowDtoListEnvelope(val *DealUnitFlowDtoListEnvelope) *NullableDealUnitFlowDtoListEnvelope {
	return &NullableDealUnitFlowDtoListEnvelope{value: val, isSet: true}
}

func (v NullableDealUnitFlowDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDealUnitFlowDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
