...
// checks if the ExtendedDealUnitDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtendedDealUnitDtoEnvelope{}

// ExtendedDealUnitDtoEnvelope struct for ExtendedDealUnitDtoEnvelope
type ExtendedDealUnitDtoEnvelope struct {
...
func NewExtendedDealUnitDtoEnvelope() *ExtendedDealUnitDtoEnvelope {
	this := ExtendedDealUnitDtoEnvelope{}
	return &this
}
...
func (o *ExtendedDealUnitDtoEnvelope) SetErrorMessageNil() {
...
func (o *ExtendedDealUnitDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ExtendedDealUnitDtoEnvelope) SetHttpStatusNil() {
...
func (o *ExtendedDealUnitDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ExtendedDealUnitDtoEnvelope) SetActivityIdNil() {
...
func (o ExtendedDealUnitDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ExtendedDealUnitDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableExtendedDealUnitDtoEnvelope struct {
	value *ExtendedDealUnitDtoEnvelope
	isSet bool
}

func (v NullableExtendedDealUnitDtoEnvelope) Get() *ExtendedDealUnitDtoEnvelope {
	return v.value
}

func (v *NullableExtendedDealUnitDtoEnvelope) Set(val *ExtendedDealUnitDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableExtendedDealUnitDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableExtendedDealUnitDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtendedDealUnitDtoEnvelope(val *ExtendedDealUnitDtoEnvelope) *NullableExtendedDealUnitDtoEnvelope {
	return &NullableExtendedDealUnitDtoEnvelope{value: val, isSet: true}
}

func (v NullableExtendedDealUnitDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtendedDealUnitDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
