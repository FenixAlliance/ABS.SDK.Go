...
// checks if the WorkOrderDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkOrderDtoCollectionQueryParameters{}

// WorkOrderDtoCollectionQueryParameters struct for WorkOrderDtoCollectionQueryParameters
type WorkOrderDtoCollectionQueryParameters struct {
...
func NewWorkOrderDtoCollectionQueryParameters() *WorkOrderDtoCollectionQueryParameters {
	this := WorkOrderDtoCollectionQueryParameters{}
	return &this
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *WorkOrderDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o WorkOrderDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o WorkOrderDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableWorkOrderDtoCollectionQueryParameters struct {
	value *WorkOrderDtoCollectionQueryParameters
	isSet bool
}

func (v NullableWorkOrderDtoCollectionQueryParameters) Get() *WorkOrderDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableWorkOrderDtoCollectionQueryParameters) Set(val *WorkOrderDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkOrderDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkOrderDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkOrderDtoCollectionQueryParameters(val *WorkOrderDtoCollectionQueryParameters) *NullableWorkOrderDtoCollectionQueryParameters {
	return &NullableWorkOrderDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableWorkOrderDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkOrderDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
