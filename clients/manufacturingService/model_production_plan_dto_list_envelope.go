...
// checks if the ProductionPlanDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProductionPlanDtoListEnvelope{}

// ProductionPlanDtoListEnvelope struct for ProductionPlanDtoListEnvelope
type ProductionPlanDtoListEnvelope struct {
	...
	Result []ProductionPlanDto `json:"result,omitempty"`
}
...
func NewProductionPlanDtoListEnvelope() *ProductionPlanDtoListEnvelope {
	this := ProductionPlanDtoListEnvelope{}
	return &this
}
...
func (o *ProductionPlanDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ProductionPlanDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ProductionPlanDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ProductionPlanDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ProductionPlanDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []ProductionPlanDto and assigns it to the Result field.
func (o *ProductionPlanDtoListEnvelope) SetResult(v []ProductionPlanDto) {
	o.Result = v
}

func (o ProductionPlanDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ProductionPlanDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableProductionPlanDtoListEnvelope struct {
	value *ProductionPlanDtoListEnvelope
	isSet bool
}

func (v NullableProductionPlanDtoListEnvelope) Get() *ProductionPlanDtoListEnvelope {
	return v.value
}

func (v *NullableProductionPlanDtoListEnvelope) Set(val *ProductionPlanDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableProductionPlanDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableProductionPlanDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProductionPlanDtoListEnvelope(val *ProductionPlanDtoListEnvelope) *NullableProductionPlanDtoListEnvelope {
	return &NullableProductionPlanDtoListEnvelope{value: val, isSet: true}
}

func (v NullableProductionPlanDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProductionPlanDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
