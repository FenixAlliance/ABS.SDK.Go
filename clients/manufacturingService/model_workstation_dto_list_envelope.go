...
// checks if the WorkstationDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkstationDtoListEnvelope{}

// WorkstationDtoListEnvelope struct for WorkstationDtoListEnvelope
type WorkstationDtoListEnvelope struct {
	...
	Result []WorkstationDto `json:"result,omitempty"`
}
...
func NewWorkstationDtoListEnvelope() *WorkstationDtoListEnvelope {
	this := WorkstationDtoListEnvelope{}
	return &this
}
...
func (o *WorkstationDtoListEnvelope) SetErrorMessageNil() {
...
func (o *WorkstationDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *WorkstationDtoListEnvelope) SetHttpStatusNil() {
...
func (o *WorkstationDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *WorkstationDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []WorkstationDto and assigns it to the Result field.
func (o *WorkstationDtoListEnvelope) SetResult(v []WorkstationDto) {
	o.Result = v
}

func (o WorkstationDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o WorkstationDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableWorkstationDtoListEnvelope struct {
	value *WorkstationDtoListEnvelope
	isSet bool
}

func (v NullableWorkstationDtoListEnvelope) Get() *WorkstationDtoListEnvelope {
	return v.value
}

func (v *NullableWorkstationDtoListEnvelope) Set(val *WorkstationDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkstationDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkstationDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkstationDtoListEnvelope(val *WorkstationDtoListEnvelope) *NullableWorkstationDtoListEnvelope {
	return &NullableWorkstationDtoListEnvelope{value: val, isSet: true}
}

func (v NullableWorkstationDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkstationDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
