...
// checks if the InvoiceReferenceDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceReferenceDtoCollectionQueryParameters{}

// InvoiceReferenceDtoCollectionQueryParameters struct for InvoiceReferenceDtoCollectionQueryParameters
type InvoiceReferenceDtoCollectionQueryParameters struct {
...
func NewInvoiceReferenceDtoCollectionQueryParameters() *InvoiceReferenceDtoCollectionQueryParameters {
	this := InvoiceReferenceDtoCollectionQueryParameters{}
	return &this
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *InvoiceReferenceDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o InvoiceReferenceDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o InvoiceReferenceDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceReferenceDtoCollectionQueryParameters struct {
	value *InvoiceReferenceDtoCollectionQueryParameters
	isSet bool
}

func (v NullableInvoiceReferenceDtoCollectionQueryParameters) Get() *InvoiceReferenceDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableInvoiceReferenceDtoCollectionQueryParameters) Set(val *InvoiceReferenceDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceReferenceDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceReferenceDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceReferenceDtoCollectionQueryParameters(val *InvoiceReferenceDtoCollectionQueryParameters) *NullableInvoiceReferenceDtoCollectionQueryParameters {
	return &NullableInvoiceReferenceDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableInvoiceReferenceDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceReferenceDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
