...
// checks if the InvoiceDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceDtoEnvelope{}

// InvoiceDtoEnvelope struct for InvoiceDtoEnvelope
type InvoiceDtoEnvelope struct {
...
func (o *InvoiceDtoEnvelope) SetErrorMessageNil() {
...
func (o *InvoiceDtoEnvelope) SetCorrelationIdNil() {
...
func (o *InvoiceDtoEnvelope) SetHttpStatusNil() {
...
func (o *InvoiceDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *InvoiceDtoEnvelope) SetActivityIdNil() {
...
func (o InvoiceDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InvoiceDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceDtoEnvelope struct {
	value *InvoiceDtoEnvelope
	isSet bool
}

func (v NullableInvoiceDtoEnvelope) Get() *InvoiceDtoEnvelope {
	return v.value
}

func (v *NullableInvoiceDtoEnvelope) Set(val *InvoiceDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceDtoEnvelope(val *InvoiceDtoEnvelope) *NullableInvoiceDtoEnvelope {
	return &NullableInvoiceDtoEnvelope{value: val, isSet: true}
}

func (v NullableInvoiceDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
