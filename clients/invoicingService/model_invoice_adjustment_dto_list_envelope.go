...
// checks if the InvoiceAdjustmentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceAdjustmentDtoListEnvelope{}

// InvoiceAdjustmentDtoListEnvelope struct for InvoiceAdjustmentDtoListEnvelope
type InvoiceAdjustmentDtoListEnvelope struct {
...
func NewInvoiceAdjustmentDtoListEnvelope() *InvoiceAdjustmentDtoListEnvelope {
	this := InvoiceAdjustmentDtoListEnvelope{}
	return &this
}
...
func (o *InvoiceAdjustmentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *InvoiceAdjustmentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *InvoiceAdjustmentDtoListEnvelope) SetActivityIdNil() {
...
func (o InvoiceAdjustmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InvoiceAdjustmentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceAdjustmentDtoListEnvelope struct {
	value *InvoiceAdjustmentDtoListEnvelope
	isSet bool
}

func (v NullableInvoiceAdjustmentDtoListEnvelope) Get() *InvoiceAdjustmentDtoListEnvelope {
	return v.value
}

func (v *NullableInvoiceAdjustmentDtoListEnvelope) Set(val *InvoiceAdjustmentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceAdjustmentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceAdjustmentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceAdjustmentDtoListEnvelope(val *InvoiceAdjustmentDtoListEnvelope) *NullableInvoiceAdjustmentDtoListEnvelope {
	return &NullableInvoiceAdjustmentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableInvoiceAdjustmentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceAdjustmentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
