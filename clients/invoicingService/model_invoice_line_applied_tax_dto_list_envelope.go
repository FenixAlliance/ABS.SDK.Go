...
// checks if the InvoiceLineAppliedTaxDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceLineAppliedTaxDtoListEnvelope{}

// InvoiceLineAppliedTaxDtoListEnvelope struct for InvoiceLineAppliedTaxDtoListEnvelope
type InvoiceLineAppliedTaxDtoListEnvelope struct {
...
func NewInvoiceLineAppliedTaxDtoListEnvelope() *InvoiceLineAppliedTaxDtoListEnvelope {
	this := InvoiceLineAppliedTaxDtoListEnvelope{}
	return &this
}
...
func (o *InvoiceLineAppliedTaxDtoListEnvelope) SetErrorMessageNil() {
...
func (o *InvoiceLineAppliedTaxDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *InvoiceLineAppliedTaxDtoListEnvelope) SetActivityIdNil() {
...
func (o InvoiceLineAppliedTaxDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InvoiceLineAppliedTaxDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceLineAppliedTaxDtoListEnvelope struct {
	value *InvoiceLineAppliedTaxDtoListEnvelope
	isSet bool
}

func (v NullableInvoiceLineAppliedTaxDtoListEnvelope) Get() *InvoiceLineAppliedTaxDtoListEnvelope {
	return v.value
}

func (v *NullableInvoiceLineAppliedTaxDtoListEnvelope) Set(val *InvoiceLineAppliedTaxDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceLineAppliedTaxDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceLineAppliedTaxDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceLineAppliedTaxDtoListEnvelope(val *InvoiceLineAppliedTaxDtoListEnvelope) *NullableInvoiceLineAppliedTaxDtoListEnvelope {
	return &NullableInvoiceLineAppliedTaxDtoListEnvelope{value: val, isSet: true}
}

func (v NullableInvoiceLineAppliedTaxDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceLineAppliedTaxDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
