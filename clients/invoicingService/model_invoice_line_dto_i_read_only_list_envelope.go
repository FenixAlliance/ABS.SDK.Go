...
// checks if the InvoiceLineDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceLineDtoIReadOnlyListEnvelope{}

// InvoiceLineDtoIReadOnlyListEnvelope struct for InvoiceLineDtoIReadOnlyListEnvelope
type InvoiceLineDtoIReadOnlyListEnvelope struct {
...
func NewInvoiceLineDtoIReadOnlyListEnvelope() *InvoiceLineDtoIReadOnlyListEnvelope {
	this := InvoiceLineDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *InvoiceLineDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *InvoiceLineDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *InvoiceLineDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *InvoiceLineDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *InvoiceLineDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o InvoiceLineDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InvoiceLineDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceLineDtoIReadOnlyListEnvelope struct {
	value *InvoiceLineDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableInvoiceLineDtoIReadOnlyListEnvelope) Get() *InvoiceLineDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableInvoiceLineDtoIReadOnlyListEnvelope) Set(val *InvoiceLineDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceLineDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceLineDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceLineDtoIReadOnlyListEnvelope(val *InvoiceLineDtoIReadOnlyListEnvelope) *NullableInvoiceLineDtoIReadOnlyListEnvelope {
	return &NullableInvoiceLineDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableInvoiceLineDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceLineDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
