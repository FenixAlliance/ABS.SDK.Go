...
// checks if the PaymentDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentDtoCollectionQueryParameters{}

// PaymentDtoCollectionQueryParameters struct for PaymentDtoCollectionQueryParameters
type PaymentDtoCollectionQueryParameters struct {
...
func NewPaymentDtoCollectionQueryParameters() *PaymentDtoCollectionQueryParameters {
	this := PaymentDtoCollectionQueryParameters{}
	return &this
}
...
func (o *PaymentDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *PaymentDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *PaymentDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *PaymentDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *PaymentDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *PaymentDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *PaymentDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o PaymentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o PaymentDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentDtoCollectionQueryParameters struct {
	value *PaymentDtoCollectionQueryParameters
	isSet bool
}

func (v NullablePaymentDtoCollectionQueryParameters) Get() *PaymentDtoCollectionQueryParameters {
	return v.value
}

func (v *NullablePaymentDtoCollectionQueryParameters) Set(val *PaymentDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentDtoCollectionQueryParameters(val *PaymentDtoCollectionQueryParameters) *NullablePaymentDtoCollectionQueryParameters {
	return &NullablePaymentDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullablePaymentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
