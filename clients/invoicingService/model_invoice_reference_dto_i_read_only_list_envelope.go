...
// checks if the InvoiceReferenceDtoIReadOnlyListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvoiceReferenceDtoIReadOnlyListEnvelope{}

// InvoiceReferenceDtoIReadOnlyListEnvelope struct for InvoiceReferenceDtoIReadOnlyListEnvelope
type InvoiceReferenceDtoIReadOnlyListEnvelope struct {
...
func NewInvoiceReferenceDtoIReadOnlyListEnvelope() *InvoiceReferenceDtoIReadOnlyListEnvelope {
	this := InvoiceReferenceDtoIReadOnlyListEnvelope{}
	return &this
}
...
func (o *InvoiceReferenceDtoIReadOnlyListEnvelope) SetErrorMessageNil() {
...
func (o *InvoiceReferenceDtoIReadOnlyListEnvelope) SetCorrelationIdNil() {
...
func (o *InvoiceReferenceDtoIReadOnlyListEnvelope) SetHttpStatusNil() {
...
func (o *InvoiceReferenceDtoIReadOnlyListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *InvoiceReferenceDtoIReadOnlyListEnvelope) SetActivityIdNil() {
...
func (o InvoiceReferenceDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o InvoiceReferenceDtoIReadOnlyListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableInvoiceReferenceDtoIReadOnlyListEnvelope struct {
	value *InvoiceReferenceDtoIReadOnlyListEnvelope
	isSet bool
}

func (v NullableInvoiceReferenceDtoIReadOnlyListEnvelope) Get() *InvoiceReferenceDtoIReadOnlyListEnvelope {
	return v.value
}

func (v *NullableInvoiceReferenceDtoIReadOnlyListEnvelope) Set(val *InvoiceReferenceDtoIReadOnlyListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceReferenceDtoIReadOnlyListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceReferenceDtoIReadOnlyListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceReferenceDtoIReadOnlyListEnvelope(val *InvoiceReferenceDtoIReadOnlyListEnvelope) *NullableInvoiceReferenceDtoIReadOnlyListEnvelope {
	return &NullableInvoiceReferenceDtoIReadOnlyListEnvelope{value: val, isSet: true}
}

func (v NullableInvoiceReferenceDtoIReadOnlyListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceReferenceDtoIReadOnlyListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
