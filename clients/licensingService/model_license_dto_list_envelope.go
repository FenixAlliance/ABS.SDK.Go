...
// checks if the LicenseDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicenseDtoListEnvelope{}

// LicenseDtoListEnvelope struct for LicenseDtoListEnvelope
type LicenseDtoListEnvelope struct {
	...
	Result []LicenseDto `json:"result,omitempty"`
}
...
func (o *LicenseDtoListEnvelope) SetErrorMessageNil() {
...
func (o *LicenseDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *LicenseDtoListEnvelope) SetHttpStatusNil() {
...
func (o *LicenseDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LicenseDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []LicenseDto and assigns it to the Result field.
func (o *LicenseDtoListEnvelope) SetResult(v []LicenseDto) {
	o.Result = v
}

func (o LicenseDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LicenseDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLicenseDtoListEnvelope struct {
	value *LicenseDtoListEnvelope
	isSet bool
}

func (v NullableLicenseDtoListEnvelope) Get() *LicenseDtoListEnvelope {
	return v.value
}

func (v *NullableLicenseDtoListEnvelope) Set(val *LicenseDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseDtoListEnvelope(val *LicenseDtoListEnvelope) *NullableLicenseDtoListEnvelope {
	return &NullableLicenseDtoListEnvelope{value: val, isSet: true}
}

func (v NullableLicenseDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
