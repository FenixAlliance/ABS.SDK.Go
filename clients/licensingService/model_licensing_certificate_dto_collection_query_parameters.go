...
// checks if the LicensingCertificateDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicensingCertificateDtoCollectionQueryParameters{}

// LicensingCertificateDtoCollectionQueryParameters struct for LicensingCertificateDtoCollectionQueryParameters
type LicensingCertificateDtoCollectionQueryParameters struct {
...
func NewLicensingCertificateDtoCollectionQueryParameters() *LicensingCertificateDtoCollectionQueryParameters {
	this := LicensingCertificateDtoCollectionQueryParameters{}
	return &this
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *LicensingCertificateDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o LicensingCertificateDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o LicensingCertificateDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableLicensingCertificateDtoCollectionQueryParameters struct {
	value *LicensingCertificateDtoCollectionQueryParameters
	isSet bool
}

func (v NullableLicensingCertificateDtoCollectionQueryParameters) Get() *LicensingCertificateDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableLicensingCertificateDtoCollectionQueryParameters) Set(val *LicensingCertificateDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableLicensingCertificateDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableLicensingCertificateDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicensingCertificateDtoCollectionQueryParameters(val *LicensingCertificateDtoCollectionQueryParameters) *NullableLicensingCertificateDtoCollectionQueryParameters {
	return &NullableLicensingCertificateDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableLicensingCertificateDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicensingCertificateDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
