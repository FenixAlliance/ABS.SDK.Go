...
// checks if the LicensingCertificateDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LicensingCertificateDtoListEnvelope{}

// LicensingCertificateDtoListEnvelope struct for LicensingCertificateDtoListEnvelope
type LicensingCertificateDtoListEnvelope struct {
	...
	Result []LicensingCertificateDto `json:"result,omitempty"`
}
...
func NewLicensingCertificateDtoListEnvelope() *LicensingCertificateDtoListEnvelope {
	this := LicensingCertificateDtoListEnvelope{}
	return &this
}
...
func (o *LicensingCertificateDtoListEnvelope) SetErrorMessageNil() {
...
func (o *LicensingCertificateDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *LicensingCertificateDtoListEnvelope) SetHttpStatusNil() {
...
func (o *LicensingCertificateDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *LicensingCertificateDtoListEnvelope) SetActivityIdNil() {
...
func (o *LicensingCertificateDtoListEnvelope) GetResult() []LicensingCertificateDto {
	if o == nil {
		var ret []LicensingCertificateDto
		return ret
	}
	return o.Result
}
...
// SetResult gets a reference to the given []LicensingCertificateDto and assigns it to the Result field.
func (o *LicensingCertificateDtoListEnvelope) SetResult(v []LicensingCertificateDto) {
	o.Result = v
}

func (o LicensingCertificateDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o LicensingCertificateDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableLicensingCertificateDtoListEnvelope struct {
	value *LicensingCertificateDtoListEnvelope
	isSet bool
}

func (v NullableLicensingCertificateDtoListEnvelope) Get() *LicensingCertificateDtoListEnvelope {
	return v.value
}

func (v *NullableLicensingCertificateDtoListEnvelope) Set(val *LicensingCertificateDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableLicensingCertificateDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableLicensingCertificateDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicensingCertificateDtoListEnvelope(val *LicensingCertificateDtoListEnvelope) *NullableLicensingCertificateDtoListEnvelope {
	return &NullableLicensingCertificateDtoListEnvelope{value: val, isSet: true}
}

func (v NullableLicensingCertificateDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicensingCertificateDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
