...
type ProjectTimeLogUpdateDto struct {
	...
	ProjectTimeLogRecordType *string `json:"projectTimeLogRecordType,omitempty"`
}
...
// SetProjectTimeLogRecordType gets a reference to the given string and assigns it to the ProjectTimeLogRecordType field.
