...
// checks if the CognitiveAgentMessageDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentMessageDtoEnvelope{}

// CognitiveAgentMessageDtoEnvelope struct for CognitiveAgentMessageDtoEnvelope
type CognitiveAgentMessageDtoEnvelope struct {
...
func NewCognitiveAgentMessageDtoEnvelope() *CognitiveAgentMessageDtoEnvelope {
	this := CognitiveAgentMessageDtoEnvelope{}
	return &this
}
...
func (o *CognitiveAgentMessageDtoEnvelope) SetErrorMessageNil() {
...
func (o *CognitiveAgentMessageDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CognitiveAgentMessageDtoEnvelope) SetHttpStatusNil() {
...
func (o *CognitiveAgentMessageDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CognitiveAgentMessageDtoEnvelope) SetActivityIdNil() {
...
func (o CognitiveAgentMessageDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentMessageDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentMessageDtoEnvelope struct {
	value *CognitiveAgentMessageDtoEnvelope
	isSet bool
}

func (v NullableCognitiveAgentMessageDtoEnvelope) Get() *CognitiveAgentMessageDtoEnvelope {
	return v.value
}

func (v *NullableCognitiveAgentMessageDtoEnvelope) Set(val *CognitiveAgentMessageDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentMessageDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentMessageDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentMessageDtoEnvelope(val *CognitiveAgentMessageDtoEnvelope) *NullableCognitiveAgentMessageDtoEnvelope {
	return &NullableCognitiveAgentMessageDtoEnvelope{value: val, isSet: true}
}

func (v NullableCognitiveAgentMessageDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentMessageDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
