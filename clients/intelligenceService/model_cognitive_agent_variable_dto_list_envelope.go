...
// checks if the CognitiveAgentVariableDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentVariableDtoListEnvelope{}

// CognitiveAgentVariableDtoListEnvelope struct for CognitiveAgentVariableDtoListEnvelope
type CognitiveAgentVariableDtoListEnvelope struct {
...
func NewCognitiveAgentVariableDtoListEnvelope() *CognitiveAgentVariableDtoListEnvelope {
	this := CognitiveAgentVariableDtoListEnvelope{}
	return &this
}
...
func (o *CognitiveAgentVariableDtoListEnvelope) SetErrorMessageNil() {
...
func (o *CognitiveAgentVariableDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *CognitiveAgentVariableDtoListEnvelope) SetHttpStatusNil() {
...
func (o *CognitiveAgentVariableDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CognitiveAgentVariableDtoListEnvelope) SetActivityIdNil() {
...
func (o CognitiveAgentVariableDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentVariableDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentVariableDtoListEnvelope struct {
	value *CognitiveAgentVariableDtoListEnvelope
	isSet bool
}

func (v NullableCognitiveAgentVariableDtoListEnvelope) Get() *CognitiveAgentVariableDtoListEnvelope {
	return v.value
}

func (v *NullableCognitiveAgentVariableDtoListEnvelope) Set(val *CognitiveAgentVariableDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentVariableDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentVariableDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentVariableDtoListEnvelope(val *CognitiveAgentVariableDtoListEnvelope) *NullableCognitiveAgentVariableDtoListEnvelope {
	return &NullableCognitiveAgentVariableDtoListEnvelope{value: val, isSet: true}
}

func (v NullableCognitiveAgentVariableDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentVariableDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
