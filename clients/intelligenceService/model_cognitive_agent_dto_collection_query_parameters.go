...
// checks if the CognitiveAgentDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentDtoCollectionQueryParameters{}

// CognitiveAgentDtoCollectionQueryParameters struct for CognitiveAgentDtoCollectionQueryParameters
type CognitiveAgentDtoCollectionQueryParameters struct {
...
func NewCognitiveAgentDtoCollectionQueryParameters() *CognitiveAgentDtoCollectionQueryParameters {
	this := CognitiveAgentDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CognitiveAgentDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CognitiveAgentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentDtoCollectionQueryParameters struct {
	value *CognitiveAgentDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCognitiveAgentDtoCollectionQueryParameters) Get() *CognitiveAgentDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCognitiveAgentDtoCollectionQueryParameters) Set(val *CognitiveAgentDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentDtoCollectionQueryParameters(val *CognitiveAgentDtoCollectionQueryParameters) *NullableCognitiveAgentDtoCollectionQueryParameters {
	return &NullableCognitiveAgentDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCognitiveAgentDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
