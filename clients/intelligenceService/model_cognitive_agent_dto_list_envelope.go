...
// checks if the CognitiveAgentDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentDtoListEnvelope{}

// CognitiveAgentDtoListEnvelope struct for CognitiveAgentDtoListEnvelope
type CognitiveAgentDtoListEnvelope struct {
...
func NewCognitiveAgentDtoListEnvelope() *CognitiveAgentDtoListEnvelope {
	this := CognitiveAgentDtoListEnvelope{}
	return &this
}
...
func (o *CognitiveAgentDtoListEnvelope) SetErrorMessageNil() {
...
func (o *CognitiveAgentDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *CognitiveAgentDtoListEnvelope) SetHttpStatusNil() {
...
func (o *CognitiveAgentDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CognitiveAgentDtoListEnvelope) SetActivityIdNil() {
...
func (o CognitiveAgentDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentDtoListEnvelope struct {
	value *CognitiveAgentDtoListEnvelope
	isSet bool
}

func (v NullableCognitiveAgentDtoListEnvelope) Get() *CognitiveAgentDtoListEnvelope {
	return v.value
}

func (v *NullableCognitiveAgentDtoListEnvelope) Set(val *CognitiveAgentDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentDtoListEnvelope(val *CognitiveAgentDtoListEnvelope) *NullableCognitiveAgentDtoListEnvelope {
	return &NullableCognitiveAgentDtoListEnvelope{value: val, isSet: true}
}

func (v NullableCognitiveAgentDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
