...
// checks if the CapabilityDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CapabilityDtoEnvelope{}

// CapabilityDtoEnvelope struct for CapabilityDtoEnvelope
type CapabilityDtoEnvelope struct {
...
func (o *CapabilityDtoEnvelope) SetErrorMessageNil() {
...
func (o *CapabilityDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CapabilityDtoEnvelope) SetHttpStatusNil() {
...
func (o *CapabilityDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CapabilityDtoEnvelope) SetActivityIdNil() {
...
func (o CapabilityDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CapabilityDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCapabilityDtoEnvelope struct {
	value *CapabilityDtoEnvelope
	isSet bool
}

func (v NullableCapabilityDtoEnvelope) Get() *CapabilityDtoEnvelope {
	return v.value
}

func (v *NullableCapabilityDtoEnvelope) Set(val *CapabilityDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCapabilityDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCapabilityDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCapabilityDtoEnvelope(val *CapabilityDtoEnvelope) *NullableCapabilityDtoEnvelope {
	return &NullableCapabilityDtoEnvelope{value: val, isSet: true}
}

func (v NullableCapabilityDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCapabilityDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
