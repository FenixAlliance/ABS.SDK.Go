...
// checks if the CognitiveAgentSkillDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentSkillDtoCollectionQueryParameters{}

// CognitiveAgentSkillDtoCollectionQueryParameters struct for CognitiveAgentSkillDtoCollectionQueryParameters
type CognitiveAgentSkillDtoCollectionQueryParameters struct {
...
func NewCognitiveAgentSkillDtoCollectionQueryParameters() *CognitiveAgentSkillDtoCollectionQueryParameters {
	this := CognitiveAgentSkillDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CognitiveAgentSkillDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CognitiveAgentSkillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentSkillDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentSkillDtoCollectionQueryParameters struct {
	value *CognitiveAgentSkillDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCognitiveAgentSkillDtoCollectionQueryParameters) Get() *CognitiveAgentSkillDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCognitiveAgentSkillDtoCollectionQueryParameters) Set(val *CognitiveAgentSkillDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentSkillDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentSkillDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentSkillDtoCollectionQueryParameters(val *CognitiveAgentSkillDtoCollectionQueryParameters) *NullableCognitiveAgentSkillDtoCollectionQueryParameters {
	return &NullableCognitiveAgentSkillDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCognitiveAgentSkillDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentSkillDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
