...
// checks if the CognitiveAgentConversationCreateDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentConversationCreateDto{}

// CognitiveAgentConversationCreateDto struct for CognitiveAgentConversationCreateDto
type CognitiveAgentConversationCreateDto struct {
...
func NewCognitiveAgentConversationCreateDto() *CognitiveAgentConversationCreateDto {
	this := CognitiveAgentConversationCreateDto{}
	return &this
}
...
func (o *CognitiveAgentConversationCreateDto) SetChannelIDNil() {
	o.ChannelID.Set(nil)
}
...
func (o *CognitiveAgentConversationCreateDto) SetConversationIDNil() {
...
func (o *CognitiveAgentConversationCreateDto) SetStateNil() {
	o.State.Set(nil)
}
...
func (o *CognitiveAgentConversationCreateDto) SetAccountHolderIdNil() {
...
func (o *CognitiveAgentConversationCreateDto) SetIndividualIdNil() {
...
func (o *CognitiveAgentConversationCreateDto) SetOrganizationIdNil() {
...
func (o *CognitiveAgentConversationCreateDto) SetReceiverBusinessIdNil() {
...
func (o CognitiveAgentConversationCreateDto) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentConversationCreateDto) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentConversationCreateDto struct {
	value *CognitiveAgentConversationCreateDto
	isSet bool
}

func (v NullableCognitiveAgentConversationCreateDto) Get() *CognitiveAgentConversationCreateDto {
	return v.value
}

func (v *NullableCognitiveAgentConversationCreateDto) Set(val *CognitiveAgentConversationCreateDto) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentConversationCreateDto) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentConversationCreateDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentConversationCreateDto(val *CognitiveAgentConversationCreateDto) *NullableCognitiveAgentConversationCreateDto {
	return &NullableCognitiveAgentConversationCreateDto{value: val, isSet: true}
}

func (v NullableCognitiveAgentConversationCreateDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentConversationCreateDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
