...
// checks if the CognitiveSkillDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveSkillDtoEnvelope{}

// CognitiveSkillDtoEnvelope struct for CognitiveSkillDtoEnvelope
type CognitiveSkillDtoEnvelope struct {
...
func NewCognitiveSkillDtoEnvelope() *CognitiveSkillDtoEnvelope {
	this := CognitiveSkillDtoEnvelope{}
	return &this
}
...
func (o *CognitiveSkillDtoEnvelope) SetErrorMessageNil() {
...
func (o *CognitiveSkillDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CognitiveSkillDtoEnvelope) SetHttpStatusNil() {
...
func (o *CognitiveSkillDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CognitiveSkillDtoEnvelope) SetActivityIdNil() {
...
func (o CognitiveSkillDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CognitiveSkillDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveSkillDtoEnvelope struct {
	value *CognitiveSkillDtoEnvelope
	isSet bool
}

func (v NullableCognitiveSkillDtoEnvelope) Get() *CognitiveSkillDtoEnvelope {
	return v.value
}

func (v *NullableCognitiveSkillDtoEnvelope) Set(val *CognitiveSkillDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveSkillDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveSkillDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveSkillDtoEnvelope(val *CognitiveSkillDtoEnvelope) *NullableCognitiveSkillDtoEnvelope {
	return &NullableCognitiveSkillDtoEnvelope{value: val, isSet: true}
}

func (v NullableCognitiveSkillDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveSkillDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
