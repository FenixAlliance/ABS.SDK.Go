...
// checks if the CognitiveAgentConversationDtoCollectionQueryParameters type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CognitiveAgentConversationDtoCollectionQueryParameters{}

// CognitiveAgentConversationDtoCollectionQueryParameters struct for CognitiveAgentConversationDtoCollectionQueryParameters
type CognitiveAgentConversationDtoCollectionQueryParameters struct {
...
func NewCognitiveAgentConversationDtoCollectionQueryParameters() *CognitiveAgentConversationDtoCollectionQueryParameters {
	this := CognitiveAgentConversationDtoCollectionQueryParameters{}
	return &this
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetTopNil() {
	o.Top.Set(nil)
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetSkipNil() {
	o.Skip.Set(nil)
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetOrderByNil() {
	o.OrderBy.Set(nil)
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetSearchNil() {
	o.Search.Set(nil)
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetSelectNil() {
	o.Select.Set(nil)
}
...
func (o *CognitiveAgentConversationDtoCollectionQueryParameters) SetExpandNil() {
	o.Expand.Set(nil)
}
...
func (o CognitiveAgentConversationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
...
func (o CognitiveAgentConversationDtoCollectionQueryParameters) ToMap() (map[string]interface{}, error) {
...
type NullableCognitiveAgentConversationDtoCollectionQueryParameters struct {
	value *CognitiveAgentConversationDtoCollectionQueryParameters
	isSet bool
}

func (v NullableCognitiveAgentConversationDtoCollectionQueryParameters) Get() *CognitiveAgentConversationDtoCollectionQueryParameters {
	return v.value
}

func (v *NullableCognitiveAgentConversationDtoCollectionQueryParameters) Set(val *CognitiveAgentConversationDtoCollectionQueryParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableCognitiveAgentConversationDtoCollectionQueryParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableCognitiveAgentConversationDtoCollectionQueryParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCognitiveAgentConversationDtoCollectionQueryParameters(val *CognitiveAgentConversationDtoCollectionQueryParameters) *NullableCognitiveAgentConversationDtoCollectionQueryParameters {
	return &NullableCognitiveAgentConversationDtoCollectionQueryParameters{value: val, isSet: true}
}

func (v NullableCognitiveAgentConversationDtoCollectionQueryParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCognitiveAgentConversationDtoCollectionQueryParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true
