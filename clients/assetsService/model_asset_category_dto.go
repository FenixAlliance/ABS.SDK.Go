...
// checks if the AssetCategoryDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetCategoryDto{}

// AssetCategoryDto struct for AssetCategoryDto
...
func (o *AssetCategoryDto) SetIdNil() {
	o.Id.Set(nil)
}
...
func (o *AssetCategoryDto) SetTenantIdNil() {
	o.TenantId.Set(nil)
}
...
func (o *AssetCategoryDto) SetBusinessNameNil() {
...
func (o *AssetCategoryDto) SetEnrollmentIdNil() {
...
func (o *AssetCategoryDto) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *AssetCategoryDto) SetDescriptionNil() {
...
func (o AssetCategoryDto) MarshalJSON() ([]byte, error) {
...
func (o AssetCategoryDto) ToMap() (map[string]interface{}, error) {
...
type NullableAssetCategoryDto struct {
	value *AssetCategoryDto
	isSet bool
}

func (v NullableAssetCategoryDto) Get() *AssetCategoryDto {
	return v.value
}

func (v *NullableAssetCategoryDto) Set(val *AssetCategoryDto) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetCategoryDto) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetCategoryDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetCategoryDto(val *AssetCategoryDto) *NullableAssetCategoryDto {
	return &NullableAssetCategoryDto{value: val, isSet: true}
}

func (v NullableAssetCategoryDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetCategoryDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
