...
type AssetDto struct {
	...
	AssetTypeId NullableString `json:"assetTypeId,omitempty"`
...
func (o *AssetDto) SetTimestampNil() {
	o.Timestamp.Set(nil)
}
...
func (o *AssetDto) SetEnrollmentIdNil() {
...
// GetAssetTypeId returns the AssetTypeId field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AssetDto) GetAssetTypeId() string {
	if o == nil || IsNil(o.AssetTypeId.Get()) {
		var ret string
		return ret
	}
	return *o.AssetTypeId.Get()
}
...
// SetAssetTypeId gets a reference to the given NullableString and assigns it to the AssetTypeId field.
func (o *AssetDto) SetAssetTypeId(v string) {
	o.AssetTypeId.Set(&v)
}
// SetAssetTypeIdNil sets the value for AssetTypeId to be an explicit nil
func (o *AssetDto) SetAssetTypeIdNil() {
	o.AssetTypeId.Set(nil)
}
...
func (o *AssetDto) SetAssetTypeNameNil() {
...
func (o AssetDto) ToMap() (map[string]interface{}, error) {
	...
	if o.AssetTypeId.IsSet() {
		toSerialize["assetTypeId"] = o.AssetTypeId.Get()
	}
