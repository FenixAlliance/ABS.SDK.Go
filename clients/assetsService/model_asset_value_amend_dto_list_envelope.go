...
// checks if the AssetValueAmendDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetValueAmendDtoListEnvelope{}

// AssetValueAmendDtoListEnvelope struct for AssetValueAmendDtoListEnvelope
type AssetValueAmendDtoListEnvelope struct {
...
func NewAssetValueAmendDtoListEnvelope() *AssetValueAmendDtoListEnvelope {
	this := AssetValueAmendDtoListEnvelope{}
	return &this
}
...
func (o *AssetValueAmendDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AssetValueAmendDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AssetValueAmendDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AssetValueAmendDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AssetValueAmendDtoListEnvelope) SetActivityIdNil() {
...
func (o AssetValueAmendDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AssetValueAmendDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAssetValueAmendDtoListEnvelope struct {
	value *AssetValueAmendDtoListEnvelope
	isSet bool
}

func (v NullableAssetValueAmendDtoListEnvelope) Get() *AssetValueAmendDtoListEnvelope {
	return v.value
}

func (v *NullableAssetValueAmendDtoListEnvelope) Set(val *AssetValueAmendDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetValueAmendDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetValueAmendDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetValueAmendDtoListEnvelope(val *AssetValueAmendDtoListEnvelope) *NullableAssetValueAmendDtoListEnvelope {
	return &NullableAssetValueAmendDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAssetValueAmendDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetValueAmendDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
