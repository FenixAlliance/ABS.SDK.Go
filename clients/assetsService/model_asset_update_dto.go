...
type AssetUpdateDto struct {
	...
	AssetClass NullableString `json:"assetClass,omitempty"`
...
func (o *AssetUpdateDto) SetAssetClassNil() {
...
func (o *AssetUpdateDto) SetAssetTypeIdNil() {
...
func (o AssetUpdateDto) ToMap() (map[string]interface{}, error) {
	...
	if o.AssetClass.IsSet() {
		toSerialize["assetClass"] = o.AssetClass.Get()
	}
