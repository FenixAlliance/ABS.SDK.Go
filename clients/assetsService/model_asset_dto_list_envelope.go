...
// checks if the AssetDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetDtoListEnvelope{}

// AssetDtoListEnvelope struct for AssetDtoListEnvelope
type AssetDtoListEnvelope struct {
...
func (o *AssetDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AssetDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AssetDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AssetDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AssetDtoListEnvelope) SetActivityIdNil() {
...
func (o AssetDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AssetDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAssetDtoListEnvelope struct {
	value *AssetDtoListEnvelope
	isSet bool
}

func (v NullableAssetDtoListEnvelope) Get() *AssetDtoListEnvelope {
	return v.value
}

func (v *NullableAssetDtoListEnvelope) Set(val *AssetDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetDtoListEnvelope(val *AssetDtoListEnvelope) *NullableAssetDtoListEnvelope {
	return &NullableAssetDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAssetDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
