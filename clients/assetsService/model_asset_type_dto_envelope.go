...
// checks if the AssetTypeDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetTypeDtoEnvelope{}

// AssetTypeDtoEnvelope struct for AssetTypeDtoEnvelope
type AssetTypeDtoEnvelope struct {
...
func (o *AssetTypeDtoEnvelope) SetErrorMessageNil() {
...
func (o *AssetTypeDtoEnvelope) SetCorrelationIdNil() {
...
func (o *AssetTypeDtoEnvelope) SetHttpStatusNil() {
...
func (o *AssetTypeDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AssetTypeDtoEnvelope) SetActivityIdNil() {
...
func (o AssetTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AssetTypeDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAssetTypeDtoEnvelope struct {
	value *AssetTypeDtoEnvelope
	isSet bool
}

func (v NullableAssetTypeDtoEnvelope) Get() *AssetTypeDtoEnvelope {
	return v.value
}

func (v *NullableAssetTypeDtoEnvelope) Set(val *AssetTypeDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetTypeDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetTypeDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetTypeDtoEnvelope(val *AssetTypeDtoEnvelope) *NullableAssetTypeDtoEnvelope {
	return &NullableAssetTypeDtoEnvelope{value: val, isSet: true}
}

func (v NullableAssetTypeDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetTypeDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
