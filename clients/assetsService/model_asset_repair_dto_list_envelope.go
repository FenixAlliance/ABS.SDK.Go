...
// checks if the AssetRepairDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetRepairDtoListEnvelope{}

// AssetRepairDtoListEnvelope struct for AssetRepairDtoListEnvelope
type AssetRepairDtoListEnvelope struct {
...
func NewAssetRepairDtoListEnvelope() *AssetRepairDtoListEnvelope {
	this := AssetRepairDtoListEnvelope{}
	return &this
}
...
func (o *AssetRepairDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AssetRepairDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AssetRepairDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AssetRepairDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AssetRepairDtoListEnvelope) SetActivityIdNil() {
...
func (o AssetRepairDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AssetRepairDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAssetRepairDtoListEnvelope struct {
	value *AssetRepairDtoListEnvelope
	isSet bool
}

func (v NullableAssetRepairDtoListEnvelope) Get() *AssetRepairDtoListEnvelope {
	return v.value
}

func (v *NullableAssetRepairDtoListEnvelope) Set(val *AssetRepairDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetRepairDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetRepairDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetRepairDtoListEnvelope(val *AssetRepairDtoListEnvelope) *NullableAssetRepairDtoListEnvelope {
	return &NullableAssetRepairDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAssetRepairDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetRepairDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
