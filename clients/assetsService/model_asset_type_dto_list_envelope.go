...
// checks if the AssetTypeDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AssetTypeDtoListEnvelope{}

// AssetTypeDtoListEnvelope struct for AssetTypeDtoListEnvelope
type AssetTypeDtoListEnvelope struct {
	...
	Result []AssetTypeDto `json:"result,omitempty"`
}
...
func (o *AssetTypeDtoListEnvelope) SetErrorMessageNil() {
...
func (o *AssetTypeDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *AssetTypeDtoListEnvelope) SetHttpStatusNil() {
...
func (o *AssetTypeDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *AssetTypeDtoListEnvelope) SetActivityIdNil() {
...
// SetResult gets a reference to the given []AssetTypeDto and assigns it to the Result field.
func (o *AssetTypeDtoListEnvelope) SetResult(v []AssetTypeDto) {
	o.Result = v
}

func (o AssetTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o AssetTypeDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableAssetTypeDtoListEnvelope struct {
	value *AssetTypeDtoListEnvelope
	isSet bool
}

func (v NullableAssetTypeDtoListEnvelope) Get() *AssetTypeDtoListEnvelope {
	return v.value
}

func (v *NullableAssetTypeDtoListEnvelope) Set(val *AssetTypeDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableAssetTypeDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableAssetTypeDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAssetTypeDtoListEnvelope(val *AssetTypeDtoListEnvelope) *NullableAssetTypeDtoListEnvelope {
	return &NullableAssetTypeDtoListEnvelope{value: val, isSet: true}
}

func (v NullableAssetTypeDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAssetTypeDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
