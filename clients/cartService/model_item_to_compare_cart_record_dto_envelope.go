...
// checks if the ItemToCompareCartRecordDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemToCompareCartRecordDtoEnvelope{}

// ItemToCompareCartRecordDtoEnvelope struct for ItemToCompareCartRecordDtoEnvelope
type ItemToCompareCartRecordDtoEnvelope struct {
...
func NewItemToCompareCartRecordDtoEnvelope() *ItemToCompareCartRecordDtoEnvelope {
	this := ItemToCompareCartRecordDtoEnvelope{}
	return &this
}
...
func (o *ItemToCompareCartRecordDtoEnvelope) SetErrorMessageNil() {
...
func (o *ItemToCompareCartRecordDtoEnvelope) SetCorrelationIdNil() {
...
func (o *ItemToCompareCartRecordDtoEnvelope) SetHttpStatusNil() {
...
func (o *ItemToCompareCartRecordDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemToCompareCartRecordDtoEnvelope) SetActivityIdNil() {
...
func (o ItemToCompareCartRecordDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemToCompareCartRecordDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemToCompareCartRecordDtoEnvelope struct {
	value *ItemToCompareCartRecordDtoEnvelope
	isSet bool
}

func (v NullableItemToCompareCartRecordDtoEnvelope) Get() *ItemToCompareCartRecordDtoEnvelope {
	return v.value
}

func (v *NullableItemToCompareCartRecordDtoEnvelope) Set(val *ItemToCompareCartRecordDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemToCompareCartRecordDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemToCompareCartRecordDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemToCompareCartRecordDtoEnvelope(val *ItemToCompareCartRecordDtoEnvelope) *NullableItemToCompareCartRecordDtoEnvelope {
	return &NullableItemToCompareCartRecordDtoEnvelope{value: val, isSet: true}
}

func (v NullableItemToCompareCartRecordDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemToCompareCartRecordDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
