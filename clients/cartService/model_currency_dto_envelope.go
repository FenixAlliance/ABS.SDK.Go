...
// checks if the CurrencyDtoEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CurrencyDtoEnvelope{}

// CurrencyDtoEnvelope struct for CurrencyDtoEnvelope
type CurrencyDtoEnvelope struct {
...
func (o *CurrencyDtoEnvelope) SetErrorMessageNil() {
...
func (o *CurrencyDtoEnvelope) SetCorrelationIdNil() {
...
func (o *CurrencyDtoEnvelope) SetHttpStatusNil() {
...
func (o *CurrencyDtoEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *CurrencyDtoEnvelope) SetActivityIdNil() {
...
func (o CurrencyDtoEnvelope) MarshalJSON() ([]byte, error) {
...
func (o CurrencyDtoEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableCurrencyDtoEnvelope struct {
	value *CurrencyDtoEnvelope
	isSet bool
}

func (v NullableCurrencyDtoEnvelope) Get() *CurrencyDtoEnvelope {
	return v.value
}

func (v *NullableCurrencyDtoEnvelope) Set(val *CurrencyDtoEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableCurrencyDtoEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableCurrencyDtoEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCurrencyDtoEnvelope(val *CurrencyDtoEnvelope) *NullableCurrencyDtoEnvelope {
	return &NullableCurrencyDtoEnvelope{value: val, isSet: true}
}

func (v NullableCurrencyDtoEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCurrencyDtoEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
