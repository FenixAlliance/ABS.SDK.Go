...
type ResetPasswordRequest struct {
	...
	ResetCode NullableString `json:"resetCode"`
	NewPassword NullableString `json:"newPassword"`
}
...
// GetResetCode returns the ResetCode field value
// If the value is explicit nil, the zero value for string will be returned
func (o *ResetPasswordRequest) GetResetCode() string {
	if o == nil || o.ResetCode.Get() == nil {
		var ret string
		return ret
	}

	return *o.ResetCode.Get()
}

// GetResetCodeOk returns a tuple with the ResetCode field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ResetPasswordRequest) GetResetCodeOk() (*string, bool) {
	...
	return o.ResetCode.Get(), o.ResetCode.IsSet()
}

// SetResetCode sets field value
...
func (o ResetPasswordRequest) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["resetCode"] = o.ResetCode.Get()
