...
// checks if the ItemCartRecordDtoListEnvelope type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ItemCartRecordDtoListEnvelope{}

// ItemCartRecordDtoListEnvelope struct for ItemCartRecordDtoListEnvelope
type ItemCartRecordDtoListEnvelope struct {
...
func NewItemCartRecordDtoListEnvelope() *ItemCartRecordDtoListEnvelope {
	this := ItemCartRecordDtoListEnvelope{}
	return &this
}
...
func (o *ItemCartRecordDtoListEnvelope) SetErrorMessageNil() {
...
func (o *ItemCartRecordDtoListEnvelope) SetCorrelationIdNil() {
...
func (o *ItemCartRecordDtoListEnvelope) SetHttpStatusNil() {
...
func (o *ItemCartRecordDtoListEnvelope) SetErrorCodeNil() {
	o.ErrorCode.Set(nil)
}
...
func (o *ItemCartRecordDtoListEnvelope) SetActivityIdNil() {
...
func (o ItemCartRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
...
func (o ItemCartRecordDtoListEnvelope) ToMap() (map[string]interface{}, error) {
...
type NullableItemCartRecordDtoListEnvelope struct {
	value *ItemCartRecordDtoListEnvelope
	isSet bool
}

func (v NullableItemCartRecordDtoListEnvelope) Get() *ItemCartRecordDtoListEnvelope {
	return v.value
}

func (v *NullableItemCartRecordDtoListEnvelope) Set(val *ItemCartRecordDtoListEnvelope) {
	v.value = val
	v.isSet = true
}

func (v NullableItemCartRecordDtoListEnvelope) IsSet() bool {
	return v.isSet
}

func (v *NullableItemCartRecordDtoListEnvelope) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableItemCartRecordDtoListEnvelope(val *ItemCartRecordDtoListEnvelope) *NullableItemCartRecordDtoListEnvelope {
	return &NullableItemCartRecordDtoListEnvelope{value: val, isSet: true}
}

func (v NullableItemCartRecordDtoListEnvelope) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableItemCartRecordDtoListEnvelope) UnmarshalJSON(src []byte) error {
	v.isSet = true
